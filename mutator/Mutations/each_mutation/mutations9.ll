...
;----------------------------
  ...
  %result.1 = tail call i32 @detect_vm()
  %must.escape.1 = icmp ne i32 %result.1, 0
...
;----------------------------
  ...
  store i32 %tmp2_v.i3.i, i32* %6, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i4.i, -36
  ...
  %tmp0_v2.i13.i = add i32 %9, 4
  %10 = inttoptr i32 %tmp0_v2.i13.i to i32*
  %11 = load i32, i32* %10, align 4
  %tmp2_v6.i17.i = add i32 %tmp0_v.i4.i, -44
  %12 = inttoptr i32 %tmp2_v6.i17.i to i32*
  store i32 134520900, i32* %12, align 4
  %tmp2_v7.i18.i = add i32 %tmp0_v.i4.i, -48
  %13 = inttoptr i32 %tmp2_v7.i18.i to i32*
  store i32 %11, i32* %13, align 16
  %tmp2_v8.i.i = add i32 %tmp0_v.i4.i, -52
...
BB_804942D.i:                                     ; preds = %Func_804941F.exit.i
  ...
  %tmp0_v1.i22.i = add i32 %24, 4
  %25 = inttoptr i32 %tmp0_v1.i22.i to i32*
  ...
  %.not.i41.i = icmp eq i32 %27, 0
  br i1 %.not.i41.i, label %BB_804944C.i, label %BB_8049453.i

BB_804944C.i:                                     ; preds = %BB_804942D.i
  store i32 134517841, i32* %7, align 4
  %tmp2_v.i18.i.i = add i32 %tmp0_v.i4.i, -40
  %28 = inttoptr i32 %tmp2_v.i18.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %28, align 8
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i22.i.i = add i32 %tmp0_v.i4.i, -84
  %29 = inttoptr i32 %tmp2_v2.i22.i.i to i32*
  store i32 134517482, i32* %29, align 4
  %tmp4_v.i33.i.b.i = load i1, i1* @segs.0, align 1
  %30 = select i1 %tmp4_v.i33.i.b.i, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %31 = load i32, i32* %30, align 4
  store i32 %31, i32* %14, align 4
  %tmp2_v5.i41.i.i = add i32 %tmp0_v.i4.i, -92
  %32 = inttoptr i32 %tmp2_v5.i41.i.i to i32*
  store i32 134520866, i32* %32, align 4
  %tmp2_v7.i43.i.i = add i32 %tmp0_v.i4.i, -96
  %33 = inttoptr i32 %tmp2_v7.i43.i.i to i32*
  store i32 134520869, i32* %33, align 16
  %tmp2_v8.i44.i.i = add i32 %tmp0_v.i4.i, -100
  %34 = inttoptr i32 %tmp2_v8.i44.i.i to i32*
  store i32 134517521, i32* %34, align 4
  %arg.i.i.i9 = load i32, i32* %33, align 16
  %arg2.i.i.i10 = load i32, i32* %32, align 4
  %35 = tail call i32 @fopen(i32 %arg.i.i.i9, i32 %arg2.i.i.i10)
  %tmp2_v.i9.i.i = add i32 %tmp0_v.i4.i, -76
  %36 = inttoptr i32 %tmp2_v.i9.i.i to i32*
  store i32 %35, i32* %36, align 4
  %tmp2_v.i.i.i11 = add i32 %tmp0_v.i4.i, -72
  %37 = inttoptr i32 %tmp2_v.i.i.i11 to i32*
  store i32 1818304585, i32* %37, align 8
  %tmp2_v1.i.i.i12 = add i32 %tmp0_v.i4.i, -68
  %38 = inttoptr i32 %tmp2_v1.i.i.i12 to i32*
  store i32 1701995892, i32* %38, align 4
  %tmp2_v2.i.i.i13 = add i32 %tmp0_v.i4.i, -64
  %39 = inttoptr i32 %tmp2_v2.i.i.i13 to i32*
  store i32 1752440932, i32* %39, align 16
  %tmp2_v3.i.i.i14 = add i32 %tmp0_v.i4.i, -60
  %40 = inttoptr i32 %tmp2_v3.i.i.i14 to i32*
  store i32 1768300645, i32* %40, align 4
  %tmp2_v4.i.i.i15 = add i32 %tmp0_v.i4.i, -56
  %41 = inttoptr i32 %tmp2_v4.i.i.i15 to i32*
  store i32 2188652, i32* %41, align 8
  %42 = load i32, i32* %36, align 4
  store i32 %42, i32* %29, align 4
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i4.i, -88
  %43 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  store i32 20, i32* %43, align 8
  store i32 1, i32* %32, align 4
  store i32 %tmp2_v.i.i.i11, i32* %33, align 16
  store i32 134517622, i32* %34, align 4
  %arg.i.i4.i = load i32, i32* %33, align 16
  %arg2.i.i5.i = load i32, i32* %32, align 4
  %arg4.i.i.i16 = load i32, i32* %43, align 8
  %arg6.i.i.i = load i32, i32* %29, align 4
  %44 = tail call i32 @fwrite(i32 %arg.i.i4.i, i32 %arg2.i.i5.i, i32 %arg4.i.i.i16, i32 %arg6.i.i.i)
...
BB_8049426.i:                                     ; preds = %Func_804941F.exit.i
  ...
  %tmp2_v.i2.i.i = add i32 %tmp0_v.i4.i, -40
  %47 = inttoptr i32 %tmp2_v.i2.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %47, align 8
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i6.i.i17 = add i32 %tmp0_v.i4.i, -68
  %48 = inttoptr i32 %tmp2_v2.i6.i.i17 to i32*
  store i32 134517414, i32* %48, align 4
  %tmp2_v1.i.i.i18 = add i32 %tmp0_v.i4.i, -56
  %49 = inttoptr i32 %tmp2_v1.i.i.i18 to i32*
  store i32 134520840, i32* %49, align 8
  store i32 134520854, i32* %14, align 4
  %50 = load i32, i32* %49, align 8
  %tmp2_v7.i.i.i20 = add i32 %tmp0_v.i4.i, -76
  %51 = inttoptr i32 %tmp2_v7.i.i.i20 to i32*
  store i32 %50, i32* %51, align 4
  %tmp2_v9.i.i.i = add i32 %tmp0_v.i4.i, -80
  %52 = inttoptr i32 %tmp2_v9.i.i.i to i32*
  store i32 134520863, i32* %52, align 16
  %tmp2_v10.i.i.i = add i32 %tmp0_v.i4.i, -84
  %53 = inttoptr i32 %tmp2_v10.i.i.i to i32*
  store i32 134517457, i32* %53, align 4
  %54 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i3.i, i32 inreg noundef 134520863, i32 noundef %tmp2_v9.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32)) #11, !funcname !13
  br label %.exit
...
.exit:                                            ; preds = %BB_8049453.i, %BB_8049426.i, %BB_804944C.i, %BB_8049472.i
  ret void
.escape.1:
  ret void
}
