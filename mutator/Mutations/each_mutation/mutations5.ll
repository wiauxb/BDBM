...
@.str1 = private unnamed_addr constant [1 x i8] c"\0a"
...
Func_804941F.exit.i:
  ...
  %8 = inttoptr i32 %tmp2_v.i22.i to i32*
  %9 = load i32, i32* %8, align 4
  %tmp0_v2.i24.i = add i32 %9, 4
  %10 = inttoptr i32 %tmp0_v2.i24.i to i32*
  %11 = load i32, i32* %10, align 4
  %tmp2_v6.i28.i = add i32 %tmp0_v.i5.i, -44
  %12 = inttoptr i32 %tmp2_v6.i28.i to i32*
  store i32 134520900, i32* %12, align 4
  %tmp2_v7.i29.i = add i32 %tmp0_v.i5.i, -48
  %13 = inttoptr i32 %tmp2_v7.i29.i to i32*
...
BB_8049472.i:                                     ; preds = %BB_8049453.i
  ...
  %21 = inttoptr i32 %tmp2_v2.i19.i.i to i32*
  store i32 134517678, i32* %21, align 4
  store i32 0, i32* %14, align 4
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i5.i, -72
  %22 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  store i32 0, i32* %22, align 8
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i5.i, -76
  ...
  %tmp2_v5.i.i.i = add i32 %tmp0_v.i5.i, -84
...
BB_804942D.i:                                     ; preds = %Func_804941F.exit.i
  ...
  %tmp0_v1.i33.i = add i32 %28, 4
  %29 = inttoptr i32 %tmp0_v1.i33.i to i32*
  ...
  %.not.i53.i = icmp eq i32 %31, 0
  br i1 %.not.i53.i, label %BB_804944C.i, label %BB_8049453.i

BB_8049426.i:                                     ; preds = %Func_804941F.exit.i
  store i32 134517803, i32* %7, align 4
  %tmp2_v.i.i.i11 = add i32 %tmp0_v.i5.i, -40
  %32 = inttoptr i32 %tmp2_v.i.i.i11 to i32*
  store i32 %tmp2_v4.i7.i, i32* %32, align 8
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i.i.i13 = add i32 %tmp0_v.i5.i, -68
  %33 = inttoptr i32 %tmp2_v2.i.i.i13 to i32*
  ...
  %39 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i4.i, i32 inreg noundef 134520863, i32 noundef %tmp2_v9.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32)) #11, !funcname !13
  br label %.exit

BB_804944C.i:                                     ; preds = %BB_804942D.i
  store i32 134517841, i32* %7, align 4
  %tmp2_v.i7.i.i = add i32 %tmp0_v.i5.i, -40
  %40 = inttoptr i32 %tmp2_v.i7.i.i to i32*
  store i32 %tmp2_v4.i7.i, i32* %40, align 8
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i11.i.i = add i32 %tmp0_v.i5.i, -84
  %41 = inttoptr i32 %tmp2_v2.i11.i.i to i32*
  store i32 134517482, i32* %41, align 4
  %tmp4_v.i26.i.b.i = load i1, i1* @segs.0, align 1
  %42 = select i1 %tmp4_v.i26.i.b.i, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %43 = load i32, i32* %42, align 4
  store i32 %43, i32* %14, align 4
  %tmp2_v5.i34.i.i = add i32 %tmp0_v.i5.i, -92
  %44 = inttoptr i32 %tmp2_v5.i34.i.i to i32*
  store i32 134520866, i32* %44, align 4
  %tmp2_v7.i36.i.i = add i32 %tmp0_v.i5.i, -96
  %45 = inttoptr i32 %tmp2_v7.i36.i.i to i32*
  store i32 134520869, i32* %45, align 16
  %tmp2_v8.i37.i.i = add i32 %tmp0_v.i5.i, -100
  %46 = inttoptr i32 %tmp2_v8.i37.i.i to i32*
  store i32 134517521, i32* %46, align 4
  %arg.i.i.i15 = load i32, i32* %45, align 16
  %arg2.i.i.i16 = load i32, i32* %44, align 4
  %47 = tail call i32 @fopen(i32 %arg.i.i.i15, i32 %arg2.i.i.i16)
  %tmp2_v.i4.i.i = add i32 %tmp0_v.i5.i, -76
  %48 = inttoptr i32 %tmp2_v.i4.i.i to i32*
  store i32 %47, i32* %48, align 4
  %tmp2_v.i13.i.i = add i32 %tmp0_v.i5.i, -72
  %49 = inttoptr i32 %tmp2_v.i13.i.i to i32*
  store i32 1818304585, i32* %49, align 8
  %tmp2_v1.i14.i.i = add i32 %tmp0_v.i5.i, -68
  %50 = inttoptr i32 %tmp2_v1.i14.i.i to i32*
  store i32 1701995892, i32* %50, align 4
  %tmp2_v2.i15.i.i = add i32 %tmp0_v.i5.i, -64
  %51 = inttoptr i32 %tmp2_v2.i15.i.i to i32*
  store i32 1752440932, i32* %51, align 16
  %tmp2_v3.i.i.i17 = add i32 %tmp0_v.i5.i, -60
  %52 = inttoptr i32 %tmp2_v3.i.i.i17 to i32*
  store i32 1768300645, i32* %52, align 4
  %tmp2_v4.i.i.i18 = add i32 %tmp0_v.i5.i, -56
  %53 = inttoptr i32 %tmp2_v4.i.i.i18 to i32*
  store i32 2188652, i32* %53, align 8
  %54 = load i32, i32* %48, align 4
  store i32 %54, i32* %41, align 4
  %tmp2_v7.i.i.i19 = add i32 %tmp0_v.i5.i, -88
  %55 = inttoptr i32 %tmp2_v7.i.i.i19 to i32*
  store i32 20, i32* %55, align 8
  store i32 1, i32* %44, align 4
  store i32 %tmp2_v.i13.i.i, i32* %45, align 16
  store i32 134517622, i32* %46, align 4
  %arg.i.i4.i = load i32, i32* %45, align 16
  %arg2.i.i5.i = load i32, i32* %44, align 4
  %arg4.i.i.i20 = load i32, i32* %55, align 8
  %arg6.i.i.i = load i32, i32* %41, align 4
  %56 = tail call i32 @fwrite(i32 %arg.i.i4.i, i32 %arg2.i.i5.i, i32 %arg4.i.i.i20, i32 %arg6.i.i.i)
