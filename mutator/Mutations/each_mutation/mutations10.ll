...
Func_804941F.exit.i:
  ...
  %tmp2_v6.i38.i = add i32 %tmp0_v.i9.i, -44
  %12 = inttoptr i32 %tmp2_v6.i38.i to i32*
  store i32 134520900, i32* %12, align 4
  %tmp2_v7.i39.i = add i32 %tmp0_v.i9.i, -48
  ...
  %.not.i5.i = icmp eq i32 %15, 0
  br i1 %.not.i5.i, label %BB_8049426.i, label %BB_804942D.i

BB_804944C.i:                                     ; preds = %BB_804942D.i
  store i32 134517841, i32* %7, align 4
  %tmp2_v.i12.i.i = add i32 %tmp0_v.i9.i, -40
  %16 = inttoptr i32 %tmp2_v.i12.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %16, align 8
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i17.i.i = add i32 %tmp0_v.i9.i, -84
  %17 = inttoptr i32 %tmp2_v2.i17.i.i to i32*
  store i32 134517482, i32* %17, align 4
  %tmp4_v.i6.i.b.i = load i1, i1* @segs.0, align 1
  %18 = select i1 %tmp4_v.i6.i.b.i, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %19 = load i32, i32* %18, align 4
  store i32 %19, i32* %14, align 4
  %tmp2_v5.i.i.i = add i32 %tmp0_v.i9.i, -92
...
; Replace: store i32 134520866, i32* %20, align 4
  ...
  %sp0.1 = bitcast [3 x i8]* %sp1 to [1 x i8]*
  store [1 x i8] c"\77", [1 x i8]* %sp0.1
  %next0.1 = getelementptr [3 x i8], [3 x i8]* %sp1, i32 0, i32 1
  
  %sp1.1 = bitcast i8* %next0.1 to [1 x i8]*
  store [1 x i8] c"\2b", [1 x i8]* %sp1.1
  %next1.1 = getelementptr [3 x i8], [3 x i8]* %sp1, i32 0, i32 2
  
  %sp2.1 = bitcast i8* %next1.1 to [1 x i8]*
  store [1 x i8] c"\00", [1 x i8]* %sp2.1

  %spi1 = ptrtoint [3 x i8]* %sp1 to i32
  store i32 %spi1, i32* %20, align 4
;-------------------------------
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i9.i, -96
...
; Replace: store i32 134520869, i32* %21, align 16
  ...
  %sp0.2 = bitcast [15 x i8]* %sp2 to [1 x i8]*
  store [1 x i8] c"\74", [1 x i8]* %sp0.2
  %next0.2 = getelementptr [15 x i8], [15 x i8]* %sp2, i32 0, i32 1
  
  %sp1.2 = bitcast i8* %next0.2 to [2 x i8]*
  store [2 x i8] c"\65\78", [2 x i8]* %sp1.2
  %next1.2 = getelementptr [15 x i8], [15 x i8]* %sp2, i32 0, i32 3
  
  %sp2.2 = bitcast i8* %next1.2 to [2 x i8]*
  store [2 x i8] c"\74\5f", [2 x i8]* %sp2.2
  %next2.2 = getelementptr [15 x i8], [15 x i8]* %sp2, i32 0, i32 5
  
  %sp3.2 = bitcast i8* %next2.2 to [2 x i8]*
  store [2 x i8] c"\66\69", [2 x i8]* %sp3.2
  %next3.2 = getelementptr [15 x i8], [15 x i8]* %sp2, i32 0, i32 7
  
  %sp4.2 = bitcast i8* %next3.2 to [2 x i8]*
  store [2 x i8] c"\6c\65", [2 x i8]* %sp4.2
  %next4.2 = getelementptr [15 x i8], [15 x i8]* %sp2, i32 0, i32 9
  
  %sp5.2 = bitcast i8* %next4.2 to [2 x i8]*
  store [2 x i8] c"\33\2e", [2 x i8]* %sp5.2
  %next5.2 = getelementptr [15 x i8], [15 x i8]* %sp2, i32 0, i32 11
  
  %sp6.2 = bitcast i8* %next5.2 to [2 x i8]*
  store [2 x i8] c"\74\78", [2 x i8]* %sp6.2
  %next6.2 = getelementptr [15 x i8], [15 x i8]* %sp2, i32 0, i32 13
  
  %sp7.2 = bitcast i8* %next6.2 to [2 x i8]*
  store [2 x i8] c"\74\00", [2 x i8]* %sp7.2

  %spi2 = ptrtoint [15 x i8]* %sp2 to i32
  store i32 %spi2, i32* %21, align 16
;-------------------------------
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i9.i, -100
  ...
  %tmp2_v.i3.i.i = add i32 %tmp0_v.i9.i, -76
  %24 = inttoptr i32 %tmp2_v.i3.i.i to i32*
  store i32 %23, i32* %24, align 4
  %tmp2_v.i26.i.i = add i32 %tmp0_v.i9.i, -72
  %25 = inttoptr i32 %tmp2_v.i26.i.i to i32*
  store i32 1818304585, i32* %25, align 8
  %tmp2_v1.i27.i.i = add i32 %tmp0_v.i9.i, -68
  %26 = inttoptr i32 %tmp2_v1.i27.i.i to i32*
  store i32 1701995892, i32* %26, align 4
  %tmp2_v2.i28.i.i = add i32 %tmp0_v.i9.i, -64
  %27 = inttoptr i32 %tmp2_v2.i28.i.i to i32*
  store i32 1752440932, i32* %27, align 16
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i9.i, -60
  %28 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  store i32 1768300645, i32* %28, align 4
  %tmp2_v4.i29.i.i = add i32 %tmp0_v.i9.i, -56
  %29 = inttoptr i32 %tmp2_v4.i29.i.i to i32*
  store i32 2188652, i32* %29, align 8
  %30 = load i32, i32* %24, align 4
  store i32 %30, i32* %17, align 4
  %tmp2_v7.i34.i.i = add i32 %tmp0_v.i9.i, -88
  %31 = inttoptr i32 %tmp2_v7.i34.i.i to i32*
  store i32 20, i32* %31, align 8
  store i32 1, i32* %20, align 4
  store i32 %tmp2_v.i26.i.i, i32* %21, align 16
...
BB_8049426.i:                                     ; preds = %Func_804941F.exit.i
  ...
  %tmp2_v.i.i.i = add i32 %tmp0_v.i9.i, -40
  %35 = inttoptr i32 %tmp2_v.i.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %35, align 8
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i.i.i4 = add i32 %tmp0_v.i9.i, -68
  %36 = inttoptr i32 %tmp2_v2.i.i.i4 to i32*
;-------------------------------
; Replace: store i32 134517414, i32* %36, align 4
  %sp3 = alloca [4 x i8]

  
  %sp0.3 = bitcast [4 x i8]* %sp3 to [1 x i8]*
  store [1 x i8] c"\05", [1 x i8]* %sp0.3
  %next0.3 = getelementptr [4 x i8], [4 x i8]* %sp3, i32 0, i32 1
  
  %sp1.3 = bitcast i8* %next0.3 to [1 x i8]*
  store [1 x i8] c"\5a", [1 x i8]* %sp1.3
  %next1.3 = getelementptr [4 x i8], [4 x i8]* %sp3, i32 0, i32 2
  
  %sp2.3 = bitcast i8* %next1.3 to [1 x i8]*
  store [1 x i8] c"\2d", [1 x i8]* %sp2.3
  %next2.3 = getelementptr [4 x i8], [4 x i8]* %sp3, i32 0, i32 3
  
  %sp3.3 = bitcast i8* %next2.3 to [1 x i8]*
  store [1 x i8] c"\00", [1 x i8]* %sp3.3

  %spi3 = ptrtoint [4 x i8]* %sp3 to i32
  store i32 %spi3, i32* %36, align 4
;-------------------------------
  %tmp2_v1.i4.i.i = add i32 %tmp0_v.i9.i, -56
  %37 = inttoptr i32 %tmp2_v1.i4.i.i to i32*
;-------------------------------
; Replace: store i32 134520840, i32* %37, align 8
  %sp4 = alloca [14 x i8]

  
  %sp0.4 = bitcast [14 x i8]* %sp4 to [1 x i8]*
  store [1 x i8] c"\49", [1 x i8]* %sp0.4
  %next0.4 = getelementptr [14 x i8], [14 x i8]* %sp4, i32 0, i32 1
  
  %sp1.4 = bitcast i8* %next0.4 to [2 x i8]*
  store [2 x i8] c"\20\61", [2 x i8]* %sp1.4
  %next1.4 = getelementptr [14 x i8], [14 x i8]* %sp4, i32 0, i32 3
  
  %sp2.4 = bitcast i8* %next1.4 to [2 x i8]*
  store [2 x i8] c"\6d\20", [2 x i8]* %sp2.4
  %next2.4 = getelementptr [14 x i8], [14 x i8]* %sp4, i32 0, i32 5
  
  %sp3.4 = bitcast i8* %next2.4 to [2 x i8]*
  store [2 x i8] c"\65\76", [2 x i8]* %sp3.4
  %next3.4 = getelementptr [14 x i8], [14 x i8]* %sp4, i32 0, i32 7
  
  %sp4.4 = bitcast i8* %next3.4 to [1 x i8]*
  store [1 x i8] c"\69", [1 x i8]* %sp4.4
  %next4.4 = getelementptr [14 x i8], [14 x i8]* %sp4, i32 0, i32 8
  
  %sp5.4 = bitcast i8* %next4.4 to [2 x i8]*
  store [2 x i8] c"\6c\21", [2 x i8]* %sp5.4
  %next5.4 = getelementptr [14 x i8], [14 x i8]* %sp4, i32 0, i32 10
  
  %sp6.4 = bitcast i8* %next5.4 to [2 x i8]*
  store [2 x i8] c"\21\21", [2 x i8]* %sp6.4
  %next6.4 = getelementptr [14 x i8], [14 x i8]* %sp4, i32 0, i32 12
  
  %sp7.4 = bitcast i8* %next6.4 to [2 x i8]*
  store [2 x i8] c"\0a\00", [2 x i8]* %sp7.4

  %spi4 = ptrtoint [14 x i8]* %sp4 to i32
  store i32 %spi4, i32* %37, align 8
;-------------------------------
;-------------------------------
; Replace: store i32 134520854, i32* %14, align 4
  ...
  %sp0.5 = bitcast [9 x i8]* %sp5 to [1 x i8]*
  store [1 x i8] c"\42", [1 x i8]* %sp0.5
  %next0.5 = getelementptr [9 x i8], [9 x i8]* %sp5, i32 0, i32 1
  
  %sp1.5 = bitcast i8* %next0.5 to [1 x i8]*
  store [1 x i8] c"\79", [1 x i8]* %sp1.5
  %next1.5 = getelementptr [9 x i8], [9 x i8]* %sp5, i32 0, i32 2
  
  %sp2.5 = bitcast i8* %next1.5 to [1 x i8]*
  store [1 x i8] c"\65", [1 x i8]* %sp2.5
  %next2.5 = getelementptr [9 x i8], [9 x i8]* %sp5, i32 0, i32 3
  
  %sp3.5 = bitcast i8* %next2.5 to [1 x i8]*
  store [1 x i8] c"\20", [1 x i8]* %sp3.5
  %next3.5 = getelementptr [9 x i8], [9 x i8]* %sp5, i32 0, i32 4
  
  %sp4.5 = bitcast i8* %next3.5 to [1 x i8]*
  store [1 x i8] c"\42", [1 x i8]* %sp4.5
  %next4.5 = getelementptr [9 x i8], [9 x i8]* %sp5, i32 0, i32 5
  
  %sp5.5 = bitcast i8* %next4.5 to [1 x i8]*
  store [1 x i8] c"\79", [1 x i8]* %sp5.5
  %next5.5 = getelementptr [9 x i8], [9 x i8]* %sp5, i32 0, i32 6
  
  %sp6.5 = bitcast i8* %next5.5 to [1 x i8]*
  store [1 x i8] c"\65", [1 x i8]* %sp6.5
  %next6.5 = getelementptr [9 x i8], [9 x i8]* %sp5, i32 0, i32 7
  
  %sp7.5 = bitcast i8* %next6.5 to [2 x i8]*
  store [2 x i8] c"\0a\00", [2 x i8]* %sp7.5

  %spi5 = ptrtoint [9 x i8]* %sp5 to i32
  store i32 %spi5, i32* %14, align 4
;-------------------------------
  %38 = load i32, i32* %37, align 8
  %tmp2_v7.i.i.i6 = add i32 %tmp0_v.i9.i, -76
  %39 = inttoptr i32 %tmp2_v7.i.i.i6 to i32*
  store i32 %38, i32* %39, align 4
  %tmp2_v9.i.i.i = add i32 %tmp0_v.i9.i, -80
  %40 = inttoptr i32 %tmp2_v9.i.i.i to i32*
;-------------------------------
; Replace: store i32 134520863, i32* %40, align 16
  %sp6 = alloca [3 x i8]

  
  %sp0.6 = bitcast [3 x i8]* %sp6 to [1 x i8]*
  store [1 x i8] c"\25", [1 x i8]* %sp0.6
  %next0.6 = getelementptr [3 x i8], [3 x i8]* %sp6, i32 0, i32 1
  
  %sp1.6 = bitcast i8* %next0.6 to [1 x i8]*
  store [1 x i8] c"\73", [1 x i8]* %sp1.6
  %next1.6 = getelementptr [3 x i8], [3 x i8]* %sp6, i32 0, i32 2
  
  %sp2.6 = bitcast i8* %next1.6 to [1 x i8]*
  store [1 x i8] c"\00", [1 x i8]* %sp2.6

  %spi6 = ptrtoint [3 x i8]* %sp6 to i32
  store i32 %spi6, i32* %40, align 16
;-------------------------------
  %tmp2_v10.i.i.i = add i32 %tmp0_v.i9.i, -84
  %41 = inttoptr i32 %tmp2_v10.i.i.i to i32*
  store i32 134517457, i32* %41, align 4
  %42 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef 134520863, i32 noundef %tmp2_v9.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32)) #11, !funcname !13
  br label %.exit

BB_804942D.i:                                     ; preds = %Func_804941F.exit.i
  %43 = load i32, i32* %8, align 4
  %tmp0_v1.i19.i = add i32 %43, 4
  %44 = inttoptr i32 %tmp0_v1.i19.i to i32*
  %45 = load i32, i32* %44, align 4
  store i32 134520902, i32* %12, align 4
  store i32 %45, i32* %13, align 16
  store i32 134517829, i32* %14, align 4
  %arg.i.i7 = load i32, i32* %13, align 16
  %arg2.i.i8 = load i32, i32* %12, align 4
  %46 = tail call i32 @strcmp(i32 %arg.i.i7, i32 %arg2.i.i8)
  %.not.i43.i = icmp eq i32 %46, 0
  br i1 %.not.i43.i, label %BB_804944C.i, label %BB_8049453.i

BB_8049472.i:                                     ; preds = %BB_8049453.i
  store i32 134517879, i32* %7, align 4
  %tmp2_v.i2.i.i = add i32 %tmp0_v.i9.i, -40
  %47 = inttoptr i32 %tmp2_v.i2.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %47, align 8
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i.i.i11 = add i32 %tmp0_v.i9.i, -68
  %48 = inttoptr i32 %tmp2_v2.i.i.i11 to i32*
  store i32 134517678, i32* %48, align 4
  store i32 0, i32* %14, align 4
  %tmp2_v2.i11.i.i = add i32 %tmp0_v.i9.i, -72
  %49 = inttoptr i32 %tmp2_v2.i11.i.i to i32*
  store i32 0, i32* %49, align 8
  %tmp2_v3.i.i.i12 = add i32 %tmp0_v.i9.i, -76
  ...
  %tmp2_v5.i.i.i13 = add i32 %tmp0_v.i9.i, -84
