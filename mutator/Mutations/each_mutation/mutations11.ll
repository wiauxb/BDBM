...
@cipher.2 = constant [5 x i8] c"\64\79\73\41\00"
;-------------------------------
; Replace: store i32 134520869, i32* %21, align 16
@cipher.3 = constant [21 x i8] c"\64\47\56\34\64\46\39\6d\61\57\78\6c\4d\79\35\30\65\48\51\41\00"
;-------------------------------
; Replace: store i32 134520902, i32* %12, align 4
@cipher.4 = constant [5 x i8] c"\4d\67\41\3d\00"
;-------------------------------
; Replace: store i32 134517414, i32* %40, align 4
@cipher.5 = constant [9 x i8] c"\42\56\6f\74\41\41\3d\3d\00"
;-------------------------------
; Replace: store i32 134520840, i32* %41, align 8
@cipher.6 = constant [21 x i8] c"\53\53\42\68\62\53\42\6c\64\6d\6c\73\49\53\45\68\43\67\41\3d\00"
;-------------------------------
; Replace: store i32 134520854, i32* %14, align 4
@cipher.7 = constant [13 x i8] c"\51\6e\6c\6c\49\45\4a\35\5a\51\6f\41\00"
;-------------------------------
; Replace: store i32 134520863, i32* %44, align 16
@cipher.8 = constant [5 x i8] c"\4a\58\4d\41\00"
;-------------------------------
; Replace: store i32 134520904, i32* %12, align 4
@cipher.9 = constant [5 x i8] c"\4d\77\41\3d\00"
...
;-------------------------------
; Replace: store i32 134520902, i32* %12, align 4
  %cipher.ptr.4 = getelementptr inbounds [5 x i8], [5 x i8]* @cipher.4, i32 0, i32 0
  %plain.ptr.4 = tail call i8* @base64_decode(i8* %cipher.ptr.4)
  %spi4 = ptrtoint i8* %plain.ptr.4 to i32
  store i32 %spi4, i32* %12, align 4
;-------------------------------
...
;-------------------------------
; Replace: store i32 134517414, i32* %40, align 4
  %cipher.ptr.5 = getelementptr inbounds [9 x i8], [9 x i8]* @cipher.5, i32 0, i32 0
...
;-------------------------------
; Replace: store i32 134520840, i32* %41, align 8
  %cipher.ptr.6 = getelementptr inbounds [21 x i8], [21 x i8]* @cipher.6, i32 0, i32 0
  %plain.ptr.6 = tail call i8* @base64_decode(i8* %cipher.ptr.6)
  %spi6 = ptrtoint i8* %plain.ptr.6 to i32
  store i32 %spi6, i32* %41, align 8
;-------------------------------
;-------------------------------
; Replace: store i32 134520854, i32* %14, align 4
  %cipher.ptr.7 = getelementptr inbounds [13 x i8], [13 x i8]* @cipher.7, i32 0, i32 0
  %plain.ptr.7 = tail call i8* @base64_decode(i8* %cipher.ptr.7)
  %spi7 = ptrtoint i8* %plain.ptr.7 to i32
  store i32 %spi7, i32* %14, align 4
;-------------------------------
...
;-------------------------------
; Replace: store i32 134520863, i32* %44, align 16
  %cipher.ptr.8 = getelementptr inbounds [5 x i8], [5 x i8]* @cipher.8, i32 0, i32 0
  %plain.ptr.8 = tail call i8* @base64_decode(i8* %cipher.ptr.8)
  %spi8 = ptrtoint i8* %plain.ptr.8 to i32
  store i32 %spi8, i32* %44, align 16
;-------------------------------
