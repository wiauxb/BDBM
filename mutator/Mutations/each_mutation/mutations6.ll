...
Func_804941F.exit.i:
  ...
  %tmp0_v2.i49.i = add i32 %9, 4
  %10 = inttoptr i32 %tmp0_v2.i49.i to i32*
  %11 = load i32, i32* %10, align 4
  %tmp2_v6.i53.i = add i32 %tmp0_v.i.i, -44
  %12 = inttoptr i32 %tmp2_v6.i53.i to i32*
  store i32 134520900, i32* %12, align 4
  %tmp2_v7.i54.i = add i32 %tmp0_v.i.i, -48
  %13 = inttoptr i32 %tmp2_v7.i54.i to i32*
  ...
  %.not.i38.i = icmp eq i32 %15, 0
  br i1 %.not.i38.i, label %BB_8049426.i, label %BB_804942D.i
...
BB_804942D.i:                                     ; preds = %Func_804941F.exit.i
  ...
  %tmp0_v1.i16.i = add i32 %28, 4
  %29 = inttoptr i32 %tmp0_v1.i16.i to i32*
  ...
  %es46 = load i32, i32* %12, align 16
;-------------------------------
;--------Added Syst Call--------
  %a45 = tail call i32 @access( i32 %es46, i32 %tmp2_v7.i.i)
;-------------------------------
...
BB_8049426.i:                                     ; preds = %Func_804941F.exit.i
  ...
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i.i.i12 = add i32 %tmp0_v.i.i, -68
  %33 = inttoptr i32 %tmp2_v2.i.i.i12 to i32*
  store i32 134517414, i32* %33, align 4
  %tmp2_v1.i8.i.i = add i32 %tmp0_v.i.i, -56
  %es5 = load i32, i32* %12, align 16
;-------------------------------
;--------Added Syst Call--------
  %a4 = tail call i32 @fopen( i32 %es5, i32 %tmp2_v.i.i)
;-------------------------------
;-------------------------------
;--------Added Syst Call--------
  %a26 = tail call i32 @time(i32 %tmp2_v4.i.i)
;-------------------------------
  %34 = inttoptr i32 %tmp2_v1.i8.i.i to i32*
  store i32 134520840, i32* %34, align 8
  store i32 134520854, i32* %14, align 4
  %35 = load i32, i32* %34, align 8
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i.i, -76
  %36 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  store i32 %35, i32* %36, align 4
  %tmp2_v9.i.i.i = add i32 %tmp0_v.i.i, -80
  %37 = inttoptr i32 %tmp2_v9.i.i.i to i32*
  store i32 134520863, i32* %37, align 16
  %tmp2_v10.i.i.i = add i32 %tmp0_v.i.i, -84
  %es17 = load i32, i32* %33, align 16
;-------------------------------
;--------Added Syst Call--------
  %a16 = tail call i32 @atol(i32 %es17)
;-------------------------------
  %38 = inttoptr i32 %tmp2_v10.i.i.i to i32*
  store i32 134517457, i32* %38, align 4
  %39 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef 134520863, i32 noundef %tmp2_v9.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32)) #11, !funcname !13
  %es28 = load i32, i32* %12, align 16
;-------------------------------
;--------Added Syst Call--------
  %a27 = tail call i32 @toupper(i32 %es28)
;-------------------------------
  br label %.exit

BB_804944C.i:                                     ; preds = %BB_804942D.i
  store i32 134517841, i32* %7, align 4
  %tmp2_v.i24.i.i = add i32 %tmp0_v.i.i, -40
  %40 = inttoptr i32 %tmp2_v.i24.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %40, align 8
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i29.i.i = add i32 %tmp0_v.i.i, -84
  %41 = inttoptr i32 %tmp2_v2.i29.i.i to i32*
  store i32 134517482, i32* %41, align 4
  %tmp4_v.i7.i.b.i = load i1, i1* @segs.0, align 1
  %42 = select i1 %tmp4_v.i7.i.b.i, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %43 = load i32, i32* %42, align 4
  store i32 %43, i32* %14, align 4
  %tmp2_v5.i.i.i15 = add i32 %tmp0_v.i.i, -92
  %44 = inttoptr i32 %tmp2_v5.i.i.i15 to i32*
  store i32 134520866, i32* %44, align 4
  %tmp2_v7.i.i.i16 = add i32 %tmp0_v.i.i, -96
  %45 = inttoptr i32 %tmp2_v7.i.i.i16 to i32*
  store i32 134520869, i32* %45, align 16
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i.i, -100
  %46 = inttoptr i32 %tmp2_v8.i.i.i to i32*
  store i32 134517521, i32* %46, align 4
  %arg.i.i.i17 = load i32, i32* %45, align 16
  %arg2.i.i.i18 = load i32, i32* %44, align 4
  %47 = tail call i32 @fopen(i32 %arg.i.i.i17, i32 %arg2.i.i.i18)
  %tmp2_v.i41.i.i = add i32 %tmp0_v.i.i, -76
  %48 = inttoptr i32 %tmp2_v.i41.i.i to i32*
  store i32 %47, i32* %48, align 4
  %tmp2_v.i14.i.i = add i32 %tmp0_v.i.i, -72
;-------------------------------
;--------Added Syst Call--------
  %arg.i.i37 = load i32, i32* %45, align 16  %el38= inttoptr i32 %arg.i.i37 to i8*
;-------------------------------
;--------Added Syst Call--------
  %a36 = tail call i32 @puts(i8* %el38)
;-------------------------------
;-------------------------------
;--------Added Syst Call--------
  %a44 = tail call i32 @alarm (i32 %tmp2_v5.i.i.i15)
;-------------------------------
  %a29 = tail call i32 @usleep(i32 %tmp0_v.i.i)
;-------------------------------
  %es2 = load i32, i32* %14, align 16
  %es3 = load i32, i32* %44, align 16
;-------------------------------
;--------Added Syst Call--------
  %a1 = tail call i32 @strchr( i32 %es2, i32 %es3)
;-------------------------------
  %49 = inttoptr i32 %tmp2_v.i14.i.i to i32*
  store i32 1818304585, i32* %49, align 8
  %tmp2_v1.i.i.i19 = add i32 %tmp0_v.i.i, -68
  %50 = inttoptr i32 %tmp2_v1.i.i.i19 to i32*
  store i32 1701995892, i32* %50, align 4
  %tmp2_v2.i15.i.i = add i32 %tmp0_v.i.i, -64
  %51 = inttoptr i32 %tmp2_v2.i15.i.i to i32*
;-------------------------------
;--------Added Syst Call--------
  %a35 = tail call i32 @htonl(i32 %tmp0_v2.i49.i)
;-------------------------------
  %es33 = load i32, i32* %12, align 16
  %es34 = load i32, i32* %45, align 16
;-------------------------------
;--------Added Syst Call--------
  %a32 = tail call i32 @strstr( i32 %es33, i32 %es34)
;-------------------------------
  store i32 1752440932, i32* %51, align 16
;-------------------------------
;--------Added Syst Call--------
  %a30 = tail call i32 @socket(i32 %tmp2_v8.i.i, i32 %tmp0_v.i.i, i32 %tmp0_v.i.i)
;-------------------------------
  %tmp2_v3.i.i.i20 = add i32 %tmp0_v.i.i, -60
  %52 = inttoptr i32 %tmp2_v3.i.i.i20 to i32*
  %es25 = load i32, i32* %45, align 16
;-------------------------------
;--------Added Syst Call--------
  %a24 = tail call i32 @tolower(i32 %es25)
;-------------------------------
  store i32 1768300645, i32* %52, align 4
  %tmp2_v4.i16.i.i = add i32 %tmp0_v.i.i, -56
  %53 = inttoptr i32 %tmp2_v4.i16.i.i to i32*
  store i32 2188652, i32* %53, align 8
  %54 = load i32, i32* %48, align 4
  store i32 %54, i32* %41, align 4
  %tmp2_v7.i21.i.i = add i32 %tmp0_v.i.i, -88
  %55 = inttoptr i32 %tmp2_v7.i21.i.i to i32*
  %es9 = load i32, i32* %45, align 16
;-------------------------------
;--------Added Syst Call--------
  %es19 = load i32, i32* %14, align 16
;-------------------------------
;--------Added Syst Call--------
  %a18 = tail call i32 @getenv(i32 %es19)
;-------------------------------
  %a8 = tail call i32 @strlen(i32 %es9)
;-------------------------------
...
;-------------------------------
;--------Added Syst Call--------
  tail call void @perror(i32 %es23)
;-------------------------------
  store i32 %tmp2_v.i14.i.i, i32* %45, align 16
...
.exit:                                            ; preds = %BB_804944C.i, %BB_8049426.i, %BB_8049472.i, %BB_8049453.i
  ret void
}
