...
Func_804941F.exit.i:
  ...
  %rand_fin39 = srem i32 %rand_init38, 4
  %rand_init34 = tail call i32 @rand()
  %rand_fin35 = srem i32 %rand_init34, 4
  %rand_init30 = tail call i32 @rand()
  %rand_fin31 = srem i32 %rand_init30, 4
...
;-------------------------------
;----------Random Cond----------
  %.not36.i.i = icmp eq i32 1 , %rand_fin35 
...
;-------------------------------
  ...
  %tmp2_v7.i31.i = add i32 %tmp0_v.i24.i, -20
  %6 = inttoptr i32 %tmp2_v7.i31.i to i32*
  store i32 %tmp2_v.i23.i, i32* %6, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i24.i, -36
...
next20:
;-------------------------------
  %.not16.i.i = icmp eq i32 2 , %rand_fin15 
...
;-------------------------------
;----------Random Cond----------
  %.not4.i.i = icmp eq i32 3 , %rand_fin3 
  br i1 %.not4.i.i, label %next4, label %BB_4
next4:
;-------------------------------
  store i32 134517803, i32* %7, align 4
  %tmp2_v.i2.i.i = add i32 %tmp0_v.i24.i, -40
  %20 = inttoptr i32 %tmp2_v.i2.i.i to i32*
  store i32 %tmp2_v4.i26.i, i32* %20, align 8
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i24.i, -68
  %21 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  store i32 134517414, i32* %21, align 4
  %tmp2_v1.i8.i.i = add i32 %tmp0_v.i24.i, -56
  %22 = inttoptr i32 %tmp2_v1.i8.i.i to i32*
  store i32 134520840, i32* %22, align 8
  store i32 134520854, i32* %14, align 4
  %23 = load i32, i32* %22, align 8
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i24.i, -76
  %24 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  store i32 %23, i32* %24, align 4
  %tmp2_v9.i.i.i = add i32 %tmp0_v.i24.i, -80
  %25 = inttoptr i32 %tmp2_v9.i.i.i to i32*
  store i32 134520863, i32* %25, align 16
  %tmp2_v10.i.i.i = add i32 %tmp0_v.i24.i, -84
  %26 = inttoptr i32 %tmp2_v10.i.i.i to i32*
  store i32 134517457, i32* %26, align 4
  %27 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i23.i, i32 inreg noundef 134520863, i32 noundef %tmp2_v9.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32)) #11, !funcname !13
  br label %.exit

BB_8049472.i:                                     ; preds = %BB_8049453.i
  store i32 134517879, i32* %7, align 4
  %tmp2_v.i.i.i = add i32 %tmp0_v.i24.i, -40
  %28 = inttoptr i32 %tmp2_v.i.i.i to i32*
  store i32 %tmp2_v4.i26.i, i32* %28, align 8
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i.i.i9 = add i32 %tmp0_v.i24.i, -68
  %29 = inttoptr i32 %tmp2_v2.i.i.i9 to i32*
  store i32 134517678, i32* %29, align 4
  store i32 0, i32* %14, align 4
  %tmp2_v2.i18.i.i = add i32 %tmp0_v.i24.i, -72
  %30 = inttoptr i32 %tmp2_v2.i18.i.i to i32*
  store i32 0, i32* %30, align 8
  %tmp2_v3.i.i.i10 = add i32 %tmp0_v.i24.i, -76
  %31 = inttoptr i32 %tmp2_v3.i.i.i10 to i32*
  store i32 1, i32* %31, align 4
  %tmp2_v4.i.i.i = add i32 %tmp0_v.i24.i, -80
  %32 = inttoptr i32 %tmp2_v4.i.i.i to i32*
  store i32 2, i32* %32, align 16
  %tmp2_v5.i19.i.i = add i32 %tmp0_v.i24.i, -84
  %33 = inttoptr i32 %tmp2_v5.i19.i.i to i32*
;-------------------------------
;----------Random Cond----------
...
BB_804942D.i:                                     ; preds = %Func_804941F.exit.i
  ...
  %tmp0_v1.i35.i = add i32 %36, 4
  %37 = inttoptr i32 %tmp0_v1.i35.i to i32*
...
;-------------------------------
;----------Random Cond----------
  %.not28.i.i = icmp eq i32 3 , %rand_fin27 
  br i1 %.not28.i.i, label %next28, label %BB_4
next28:
;-------------------------------
  %.not12.i.i = icmp eq i32 2 , %rand_fin11 
  br i1 %.not12.i.i, label %next12, label %BB_4
next12:
;-------------------------------
  %39 = tail call i32 @strcmp(i32 %arg.i.i11, i32 %arg2.i.i12)
  %.not.i20.i = icmp eq i32 %39, 0
  br i1 %.not.i20.i, label %BB_804944C.i, label %BB_8049453.i

BB_804944C.i:                                     ; preds = %BB_804942D.i
  store i32 134517841, i32* %7, align 4
  %tmp2_v.i21.i.i = add i32 %tmp0_v.i24.i, -40
  %40 = inttoptr i32 %tmp2_v.i21.i.i to i32*
  store i32 %tmp2_v4.i26.i, i32* %40, align 8
  store i32 134529024, i32* %12, align 4
  %tmp2_v2.i26.i.i = add i32 %tmp0_v.i24.i, -84
  %41 = inttoptr i32 %tmp2_v2.i26.i.i to i32*
  store i32 134517482, i32* %41, align 4
  %tmp4_v.i6.i.b.i = load i1, i1* @segs.0, align 1
;-------------------------------
;----------Random Cond----------
  %.not24.i.i = icmp eq i32 0 , %rand_fin23 
  br i1 %.not24.i.i, label %next24, label %BB_4
next24:
;-------------------------------
  %42 = select i1 %tmp4_v.i6.i.b.i, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %43 = load i32, i32* %42, align 4
  store i32 %43, i32* %14, align 4
  %tmp2_v5.i.i.i = add i32 %tmp0_v.i24.i, -92
  %44 = inttoptr i32 %tmp2_v5.i.i.i to i32*
  store i32 134520866, i32* %44, align 4
  %tmp2_v7.i.i.i15 = add i32 %tmp0_v.i24.i, -96
  %45 = inttoptr i32 %tmp2_v7.i.i.i15 to i32*
  store i32 134520869, i32* %45, align 16
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i24.i, -100
  %46 = inttoptr i32 %tmp2_v8.i.i.i to i32*
  store i32 134517521, i32* %46, align 4
  %arg.i.i.i16 = load i32, i32* %45, align 16
  %arg2.i.i.i17 = load i32, i32* %44, align 4
  %47 = tail call i32 @fopen(i32 %arg.i.i.i16, i32 %arg2.i.i.i17)
  %tmp2_v.i3.i.i = add i32 %tmp0_v.i24.i, -76
  %48 = inttoptr i32 %tmp2_v.i3.i.i to i32*
  store i32 %47, i32* %48, align 4
  %tmp2_v.i35.i.i = add i32 %tmp0_v.i24.i, -72
  %49 = inttoptr i32 %tmp2_v.i35.i.i to i32*
  store i32 1818304585, i32* %49, align 8
  %tmp2_v1.i36.i.i = add i32 %tmp0_v.i24.i, -68
  %50 = inttoptr i32 %tmp2_v1.i36.i.i to i32*
  store i32 1701995892, i32* %50, align 4
  %tmp2_v2.i37.i.i = add i32 %tmp0_v.i24.i, -64
  %51 = inttoptr i32 %tmp2_v2.i37.i.i to i32*
  store i32 1752440932, i32* %51, align 16
  %tmp2_v3.i.i.i18 = add i32 %tmp0_v.i24.i, -60
  %52 = inttoptr i32 %tmp2_v3.i.i.i18 to i32*
  store i32 1768300645, i32* %52, align 4
  %tmp2_v4.i38.i.i = add i32 %tmp0_v.i24.i, -56
  %53 = inttoptr i32 %tmp2_v4.i38.i.i to i32*
  store i32 2188652, i32* %53, align 8
  %54 = load i32, i32* %48, align 4
  store i32 %54, i32* %41, align 4
  %tmp2_v7.i43.i.i = add i32 %tmp0_v.i24.i, -88
  %55 = inttoptr i32 %tmp2_v7.i43.i.i to i32*
  store i32 20, i32* %55, align 8
  store i32 1, i32* %44, align 4
  store i32 %tmp2_v.i35.i.i, i32* %45, align 16
