...
@str.48 = constant [13 x i8] c"a count: %d\0a\00"
...
define internal fastcc void @count_chars_recursion49(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v.i10.i = add i32 %23, 4
  %26 = inttoptr i32 %tmp2_v.i10.i to i32*
  store i32 %24, i32* %26, align 4
  %27 = inttoptr i32 %23 to i32*
  %spi48 = ptrtoint[13 x i8]* @str.48 to i32
  store i32 %spi48, i32* %27, align 4
  %tmp2_v4.i12.i = add i32 %23, -4
  %28 = inttoptr i32 %tmp2_v4.i12.i to i32*
  store i32 134517310, i32* %28, align 4
  %29 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i23.i, i32 inreg noundef %25, i32 noundef %23, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
Func_8049270.exit.i:
  ...
  %tmp2_v1.i16.i = add i32 %arg_esp, -32
  ...
  %tmp2_v2.i39.i = add i32 %arg_esp, -16
  %4 = trunc i32 %3 to i8
  %5 = inttoptr i32 %tmp2_v2.i39.i to i8*
  ...
  %.not.i41.i = icmp eq i8 %9, 0
  br i1 %.not.i41.i, label %.exit, label %BB_804928C.i

BB_80492B3.i:                                     ; preds = %BB_804928C.i
  store i32 134517447, i32* %20, align 4
  %10 = tail call fastcc { i32, i32, i32, i32 } @Func_count_occurrences(i32 %tmp2_v7.i27.i, i32 %tmp0_v3.i22.i, i32 %tmp2_v.i13.i)
...
BB_8049297.i:                                     ; preds = %BB_804928C.i
  store i32 134517419, i32* %20, align 4
  %14 = tail call fastcc { i32, i32, i32, i32 } @Func_count_occurrences(i32 %tmp2_v7.i27.i, i32 %tmp0_v3.i22.i, i32 %tmp2_v.i13.i)
  %15 = extractvalue { i32, i32, i32, i32 } %14, 1
  %16 = extractvalue { i32, i32, i32, i32 } %14, 2
  %17 = extractvalue { i32, i32, i32, i32 } %14, 3
  %tmp0_v1.i11.i = add i32 %15, 1
  br label %.exit

BB_804928C.i:                                     ; preds = %Func_8049270.exit.i
  %tmp0_v1.i31.i = zext i8 %9 to i32
  %cc_dst_v.i.i = sub i32 %3, %tmp0_v1.i31.i
  %tmp4_v.i33.i = and i32 %cc_dst_v.i.i, 255
  %.not.i.i = icmp eq i32 %tmp4_v.i33.i, 0
  %sext23 = shl i32 %3, 24
  %tmp0_v.i19.i = ashr exact i32 %sext23, 24
  %tmp0_v3.i22.i = add i32 %7, 1
  %tmp2_v5.i25.i = add i32 %arg_esp, -40
  %18 = inttoptr i32 %tmp2_v5.i25.i to i32*
  store i32 %tmp0_v.i19.i, i32* %18, align 4
  %tmp2_v6.i26.i = add i32 %arg_esp, -44
  %19 = inttoptr i32 %tmp2_v6.i26.i to i32*
  store i32 %tmp0_v3.i22.i, i32* %19, align 4
  %tmp2_v7.i27.i = add i32 %arg_esp, -48
  %20 = inttoptr i32 %tmp2_v7.i27.i to i32*
  br i1 %.not.i.i, label %BB_8049297.i, label %BB_80492B3.i

.exit:                                            ; preds = %BB_8049297.i, %BB_80492B3.i, %Func_8049270.exit.i
  %r_ebp.0 = phi i32 [ %13, %BB_80492B3.i ], [ %17, %BB_8049297.i ], [ %tmp2_v.i13.i, %Func_8049270.exit.i ]
  %r_eax.0 = phi i32 [ %11, %BB_80492B3.i ], [ %tmp0_v1.i11.i, %BB_8049297.i ], [ 0, %Func_8049270.exit.i ]
  %r_edx.0 = phi i32 [ %12, %BB_80492B3.i ], [ %16, %BB_8049297.i ], [ %arg_edx, %Func_8049270.exit.i ]
...
!14 = !{i32 0, i32 2, i32 3}
  ...
  tail call fastcc void @count_chars_recursion49(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
