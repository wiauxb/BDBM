...
@str.331 = constant [20 x i8] c"Rest Of String: %s\0a\00"
...
define internal fastcc void @strpbrk_implementation332(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v7.i25.i = add i32 %tmp0_v.i.i, -24
  %14 = inttoptr i32 %tmp2_v7.i25.i to i32*
  store i32 3044204, i32* %14, align 8
  %tmp2_v8.i26.i = add i32 %tmp0_v.i.i, -51
  ...
  store i32 %tmp2_v8.i26.i, i32* %19, align 4
  ...
  %tmp2_v1.i42.i.i = add i32 %tmp0_v.i.i, -92
  %24 = inttoptr i32 %tmp2_v1.i42.i.i to i32*
  br label %BB_80492BE.i.i

BB_8049297.i.i:                                   ; preds = %BB_80492B0.i.i, %BB_80492BE.i.i
  %25 = phi i8 [ %34, %BB_80492B0.i.i ], [ %32, %BB_80492BE.i.i ]
  %storemerge18.i = phi i32 [ %tmp0_v1.i28.i.i, %BB_80492B0.i.i ], [ %30, %BB_80492BE.i.i ]
  %26 = load i32, i32* %20, align 16
  %27 = inttoptr i32 %26 to i8*
  %28 = load i8, i8* %27, align 1
  %tmp0_v1.i.i.i = zext i8 %28 to i32
  %tmp0_v4.i.i.i = zext i8 %25 to i32
  %cc_dst_v.i.i.i = sub nsw i32 %tmp0_v1.i.i.i, %tmp0_v4.i.i.i
  %tmp4_v.i.i.i1 = and i32 %cc_dst_v.i.i.i, 255
  %.not.i.i.i = icmp eq i32 %tmp4_v.i.i.i1, 0
  %tmp0_v1.i28.i.i = add i32 %storemerge18.i, 1
...
BB_80492BE.i.i:                                   ; preds = %BB_80492BA.i.i, %.exit
  ...
  %.not.i53.i17.i = icmp eq i8 %32, 0
  br i1 %.not.i53.i17.i, label %BB_80492BA.i.i, label %BB_8049297.i.i

BB_80492B0.i.i:                                   ; preds = %BB_8049297.i.i
  store i32 %tmp0_v1.i28.i.i, i32* %24, align 4
  %33 = inttoptr i32 %tmp0_v1.i28.i.i to i8*
...
Func__strpbrk.exit:                               ; preds = %BB_8049297.i.i
  ...
  %tmp2_v.i8.i = add i32 %35, -48
  %36 = inttoptr i32 %tmp2_v.i8.i to i32*
  store i32 %26, i32* %36, align 4
  store i32 %26, i32* %19, align 4
  %spi331 = ptrtoint[20 x i8]* @str.331 to i32
  store i32 %spi331, i32* %20, align 16
  store i32 134517317, i32* %21, align 4
  %37 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %tmp0_v1.i.i.i, i32 noundef %tmp2_v16.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @strpbrk_implementation332(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
