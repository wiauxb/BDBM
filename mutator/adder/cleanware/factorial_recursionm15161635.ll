...
define internal fastcc void @factorial_recursionm15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
BB_80491C0.i.preheader:
  ...
  %tmp2_v.i36.i = add i32 %tmp0_v.i13.i, -20
...
BB_80491C0.i:                                     ; preds = %BB_80491C0.i, %BB_80491C0.i.preheader
  %8 = phi i32 [ %tmp0_v2.i.i, %BB_80491C0.i ], [ 1, %BB_80491C0.i.preheader ]
  %r_esp.06 = phi i32 [ %tmp0_v.i.i, %BB_80491C0.i ], [ %tmp4_v.i.i.i, %BB_80491C0.i.preheader ]
  %r_edx.05 = phi i32 [ %23, %BB_80491C0.i ], [ 0, %BB_80491C0.i.preheader ]
  %r_ebp.04 = phi i32 [ %14, %BB_80491C0.i ], [ %tmp2_v4.i16.i, %BB_80491C0.i.preheader ]
  %tmp2_v2.i.i = add i32 %r_esp.06, -16
  %9 = inttoptr i32 %tmp2_v2.i.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i6.i = add i32 %r_esp.06, -20
  %10 = inttoptr i32 %tmp2_v3.i6.i to i32*
  store i32 134517195, i32* %10, align 4
  %11 = tail call fastcc { i32, i32, i32 } @Func_factorial(i32 %tmp2_v3.i6.i, i32 %r_ebp.04)
  ...
  store i32 134520840, i32* %19, align 4
  %tmp2_v7.i.i = add i32 %12, -4
  %20 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 134517217, i32* %20, align 4
  %21 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i12.i, i32 inreg noundef %r_edx.05, i32 noundef %12, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %22 = lshr i64 %21, 32
  %23 = trunc i64 %22 to i32
  %tmp0_v.i.i = add i32 %12, 16
  %24 = load i32, i32* %16, align 4
  %tmp0_v2.i.i = add i32 %24, 1
  store i32 %tmp0_v2.i.i, i32* %16, align 4
  %25 = icmp slt i32 %tmp0_v2.i.i, 31
...
.exit:                                            ; preds = %BB_804921E.i, %Func_804920C.exit.i..exit_crit_edge
  %tmp4_v2.i.i.pre-phi = phi i32 [ %.pre14, %Func_804920C.exit.i..exit_crit_edge ], [ %tmp2_v.i3.i, %BB_804921E.i ]
...
!14 = !{i32 0, i32 2}
  ...
  tail call fastcc void @factorial_recursionm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
