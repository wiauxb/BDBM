...
@str.385 = constant [20 x i8] c"Error opening file.\00"
@str.386 = constant [9 x i8] c"file.txt\00"
@str.387 = constant [2 x i8] c"r\00"
...
define internal fastcc void @files_lines_to_dynamic_array388(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
.exit:
  ...
  %5 = inttoptr i32 %tmp2_v6.i18.i to i32*
  store i32 0, i32* %5, align 16
  %tmp2_v7.i.i = add i32 %tmp0_v.i12.i, -20
  %6 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 %tmp2_v.i11.i, i32* %6, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i12.i, -84
  %7 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 134517458, i32* %7, align 4
  %tmp2_v2.i.i = add i32 %tmp0_v.i12.i, -92
  %8 = inttoptr i32 %tmp2_v2.i.i to i32*
  %spi387 = ptrtoint[2 x i8]* @str.387 to i32
  store i32 %spi387, i32* %8, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i12.i, -96
  %9 = inttoptr i32 %tmp2_v4.i.i to i32*
  %spi386 = ptrtoint[9 x i8]* @str.386 to i32
  store i32 %spi386, i32* %9, align 16
  %tmp2_v5.i.i = add i32 %tmp0_v.i12.i, -100
  ...
  %tmp2_v.i9.i = add i32 %tmp0_v.i12.i, -44
  %12 = inttoptr i32 %tmp2_v.i9.i to i32*
  store i32 %11, i32* %12, align 4
  %spi385 = ptrtoint[20 x i8]* @str.385 to i32
  store i32 %spi385, i32* %9, align 16
...
!10 = !{i32 0, i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @files_lines_to_dynamic_array388(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
