...
@str.490 = constant [7 x i8] c"e: %s\0a\00"
@str.491 = constant [7 x i8] c"d: %s\0a\00"
...
.exit:
  ...
  %tmp2_v8.i44.i = add i32 %tmp0_v.i36.i, -100
  %6 = inttoptr i32 %tmp2_v8.i44.i to i32*
  ...
  %tmp2_v.i20.i = add i32 %tmp0_v.i36.i, -75
  %43 = inttoptr i32 %tmp2_v.i20.i to i8*
  store i8 0, i8* %43, align 1
  store i32 %tmp2_v5.i15.i, i32* %34, align 4
  %spi.bis.490 = ptrtoint[7 x i8]* @str.490 to i32
  store i32 %spi.bis.490, i32* %35, align 16
  store i32 134517422, i32* %36, align 4
  %44 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i35.i, i32 inreg noundef %39, i32 noundef %tmp2_v39.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
