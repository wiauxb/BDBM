...
.exit:
  ...
  %tmp2_v.i4.i = add i32 %tmp0_v.i29.i, -75
  %43 = inttoptr i32 %tmp2_v.i4.i to i8*
  store i8 0, i8* %43, align 1
  store i32 %tmp2_v5.i.i, i32* %34, align 4
  %spi490 = ptrtoint[7 x i8]* @str.490 to i32
  store i32 %spi490, i32* %35, align 16
  store i32 134517422, i32* %36, align 4
  %44 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i28.i, i32 inreg noundef %39, i32 noundef %tmp2_v39.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
