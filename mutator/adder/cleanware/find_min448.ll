...
@str.443 = constant [10 x i8] c"min2: %d\0a\00"
@str.444 = constant [10 x i8] c"min1: %d\0a\00"
...
.exit:
  ...
  %tmp2_v8.i27.i = add i32 %tmp0_v.i20.i, -100
  ...
  %tmp2_v3.i.i = add i32 %tmp0_v.i20.i, -56
  %10 = inttoptr i32 %tmp2_v3.i.i to i32*
  store i32 5, i32* %10, align 8
  %tmp2_v4.i14.i = add i32 %tmp0_v.i20.i, -52
  %11 = inttoptr i32 %tmp2_v4.i14.i to i32*
  store i32 9, i32* %11, align 4
  %tmp2_v5.i15.i = add i32 %tmp0_v.i20.i, -48
  %12 = inttoptr i32 %tmp2_v5.i15.i to i32*
  store i32 10, i32* %12, align 16
  %tmp2_v6.i.i = add i32 %tmp0_v.i20.i, -44
  %13 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 11, i32* %13, align 4
  %tmp2_v7.i16.i = add i32 %tmp0_v.i20.i, -40
  %14 = inttoptr i32 %tmp2_v7.i16.i to i32*
  store i32 4, i32* %14, align 8
  %tmp2_v8.i.i = add i32 %tmp0_v.i20.i, -36
  %15 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 3, i32* %15, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i20.i, -32
  %16 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 1, i32* %16, align 16
  %tmp2_v10.i.i = add i32 %tmp0_v.i20.i, -28
  %17 = inttoptr i32 %tmp2_v10.i.i to i32*
  store i32 6, i32* %17, align 4
  %tmp2_v11.i.i = add i32 %tmp0_v.i20.i, -24
  %18 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 7, i32* %18, align 8
  %tmp2_v12.i.i = add i32 %tmp0_v.i20.i, -84
  ...
  %tmp2_v4.i.i.i = add i32 %tmp0_v.i20.i, -124
...
BB_80492E9.i.i:                                   ; preds = %BB_8049313.i.i, %.exit
  %storemerge13.i = phi i32 [ %tmp0_v1.i32.i.i, %BB_8049313.i.i ], [ 1, %.exit ]
  %tmp4_v.i4.i.i = shl i32 %storemerge13.i, 2
  %38 = load i32, i32* %27, align 16
  %tmp0_v3.i.i.i = add i32 %38, %tmp4_v.i4.i.i
...
BB_8049313.i.i:                                   ; preds = %BB_80492FF.i.i, %BB_80492E9.i.i
  ...
  %tmp0_v1.i32.i.i = add i32 %42, 1
  store i32 %tmp0_v1.i32.i.i, i32* %35, align 4
  %43 = load i32, i32* %26, align 4
  %44 = icmp slt i32 %tmp0_v1.i32.i.i, %43
  br i1 %44, label %BB_80492E9.i.i, label %Func_find_min.exit

Func_find_min.exit:                               ; preds = %BB_8049313.i.i, %.exit
  %r_edx.0.lcssa.i = phi i32 [ 0, %.exit ], [ %tmp4_v.i4.i.i, %BB_8049313.i.i ]
  %45 = load i32, i32* %34, align 16
  %46 = load i32, i32* %29, align 8
  %tmp2_v.i41.i = add i32 %46, -84
  %47 = inttoptr i32 %tmp2_v.i41.i to i32*
  store i32 %45, i32* %47, align 4
  store i32 7, i32* %26, align 4
  %tmp2_v3.i45.i = add i32 %46, -76
  store i32 %tmp2_v3.i45.i, i32* %27, align 16
...
BB_80492E9.i.i12:                                 ; preds = %BB_8049313.i.i16, %Func_find_min.exit
  %storemerge13.i8 = phi i32 [ %tmp0_v1.i32.i.i15, %BB_8049313.i.i16 ], [ 1, %Func_find_min.exit ]
  %tmp4_v.i4.i.i9 = shl i32 %storemerge13.i8, 2
  %53 = load i32, i32* %27, align 16
  %tmp0_v3.i.i.i10 = add i32 %53, %tmp4_v.i4.i.i9
...
BB_8049313.i.i16:                                 ; preds = %BB_80492FF.i.i14, %BB_80492E9.i.i12
  ...
  %tmp0_v1.i32.i.i15 = add i32 %57, 1
  store i32 %tmp0_v1.i32.i.i15, i32* %35, align 4
  %58 = load i32, i32* %26, align 4
  %59 = icmp slt i32 %tmp0_v1.i32.i.i15, %58
  br i1 %59, label %BB_80492E9.i.i12, label %Func_find_min.exit21

Func_find_min.exit21:                             ; preds = %BB_8049313.i.i16, %Func_find_min.exit
  %r_edx.0.lcssa.i17 = phi i32 [ %r_edx.0.lcssa.i, %Func_find_min.exit ], [ %tmp4_v.i4.i.i9, %BB_8049313.i.i16 ]
  %60 = load i32, i32* %34, align 16
  %61 = load i32, i32* %29, align 8
  %tmp2_v.i.i = add i32 %61, -80
