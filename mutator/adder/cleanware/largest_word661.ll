...
.exit:
  ...
  %tmp2_v.i29.i.i = add i32 %tmp0_v.i10.i, -112
  %32 = inttoptr i32 %tmp2_v.i29.i.i to i32*
  store i32 %31, i32* %32, align 16
  %tmp2_v1.i31.i.i = add i32 %tmp0_v.i10.i, -124
  %33 = inttoptr i32 %tmp2_v1.i31.i.i to i32*
  store i32 0, i32* %33, align 4
  %tmp2_v2.i32.i.i = add i32 %tmp0_v.i10.i, -120
  %34 = inttoptr i32 %tmp2_v2.i32.i.i to i32*
  store i32 -1, i32* %34, align 8
  %tmp2_v3.i33.i.i = add i32 %tmp0_v.i10.i, -107
  %35 = inttoptr i32 %tmp2_v3.i33.i.i to i32*
  store i32 992751136, i32* %35, align 4
  %tmp2_v4.i.i.i = add i32 %tmp0_v.i10.i, -103
  %36 = inttoptr i32 %tmp2_v4.i.i.i to i16*
  store i16 2314, i16* %36, align 2
  %tmp2_v5.i34.i.i = add i32 %tmp0_v.i10.i, -101
  %37 = inttoptr i32 %tmp2_v5.i34.i.i to i8*
  store i8 0, i8* %37, align 1
  %tmp2_v6.i.i.i = add i32 %tmp0_v.i10.i, -116
...
BB_8049331.i.preheader.lr.ph.i:                   ; preds = %.exit
  %tmp2_v7.i115.i.i = add i32 %tmp0_v.i10.i, -156
  %41 = inttoptr i32 %tmp2_v7.i115.i.i to i32*
...
BB_804933B.i.i:                                   ; preds = %BB_8049331.i.preheader.i, %BB_8049329.i.i
  ...
  %.not.i.i.i = icmp sgt i32 %42, %43
  br i1 %.not.i.i.i, label %BB_8049344.i.i, label %BB_8049374.i.preheader.i

BB_8049374.i.preheader.i:                         ; preds = %BB_8049344.i.i, %BB_804933B.i.i
  %44 = load i32, i32* %38, align 4
  %45 = load i32, i32* %32, align 16
  %46 = icmp slt i32 %44, %45
  br i1 %46, label %BB_804934C.i.i, label %BB_804937C.i.loopexit.i
...
BB_8049329.i.i:                                   ; preds = %BB_8049331.i.preheader.i, %BB_8049329.i.i
  ...
  %tmp0_v4.i22.i.i = add i32 %48, 1
  store i32 %tmp0_v4.i22.i.i, i32* %33, align 4
  %49 = load i32, i32* %38, align 4
  %50 = load i32, i32* %24, align 4
  %tmp0_v3.i110.i.i = add i32 %50, %49
  %51 = inttoptr i32 %tmp0_v3.i110.i.i to i8*
  %52 = load i8, i8* %51, align 1
  %tmp0_v5.i112.i.i = sext i8 %52 to i32
  store i32 %tmp0_v5.i112.i.i, i32* %41, align 4
  store i32 %tmp2_v3.i33.i.i, i32* %29, align 16
  ...
  %.not.i74.i.i = icmp eq i32 %53, 0
  br i1 %.not.i74.i.i, label %BB_8049329.i.i, label %BB_804933B.i.i
...
BB_804937C.i.loopexit.i:                          ; preds = %BB_804934C.i.BB_804937C.i.loopexit.loopexit_crit_edge.i, %BB_8049370.i.i, %BB_8049374.i.preheader.i
  %54 = phi i32 [ %45, %BB_8049374.i.preheader.i ], [ %.pre22.pre.i, %BB_804934C.i.BB_804937C.i.loopexit.loopexit_crit_edge.i ], [ %62, %BB_8049370.i.i ]
  %55 = phi i32 [ %44, %BB_8049374.i.preheader.i ], [ %.pre.pre.i, %BB_804934C.i.BB_804937C.i.loopexit.loopexit_crit_edge.i ], [ %tmp0_v1.i64.i.i, %BB_8049370.i.i ]
...
BB_8049331.i.preheader.i:                         ; preds = %BB_804937C.i.loopexit.i, %BB_8049331.i.preheader.lr.ph.i
  ...
  store i32 %tmp0_v5.i112.i13.i, i32* %41, align 4
  store i32 %tmp2_v3.i33.i.i, i32* %29, align 16
  store i32 134517538, i32* %30, align 4
  ...
  %.not.i74.i16.i = icmp eq i32 %61, 0
  br i1 %.not.i74.i16.i, label %BB_8049329.i.i, label %BB_804933B.i.i

BB_8049370.i.i:                                   ; preds = %BB_804934C.i.i
  %tmp0_v1.i64.i.i = add i32 %.pre.pre.i, 1
  store i32 %tmp0_v1.i64.i.i, i32* %38, align 4
  %62 = load i32, i32* %32, align 16
  %63 = icmp slt i32 %tmp0_v1.i64.i.i, %62
  br i1 %63, label %BB_804934C.i.i, label %BB_804937C.i.loopexit.i

BB_804934C.i.i:                                   ; preds = %BB_8049370.i.i, %BB_8049374.i.preheader.i
  %64 = phi i32 [ %tmp0_v1.i64.i.i, %BB_8049370.i.i ], [ %44, %BB_8049374.i.preheader.i ]
  %65 = load i32, i32* %24, align 4
  %tmp0_v3.i94.i.i = add i32 %65, %64
  %66 = inttoptr i32 %tmp0_v3.i94.i.i to i8*
  %67 = load i8, i8* %66, align 1
  %tmp0_v5.i.i.i = sext i8 %67 to i32
  ...
  %.not.i2.i.i = icmp eq i32 %68, 0
  %.pre.pre.i = load i32, i32* %38, align 4
  br i1 %.not.i2.i.i, label %BB_804934C.i.BB_804937C.i.loopexit.loopexit_crit_edge.i, label %BB_8049370.i.i
...
Func_largest_word.exit:                           ; preds = %BB_804937C.i.loopexit.i, %.exit
  ...
  %tmp2_v.i21.i = add i32 %74, -48
  %75 = inttoptr i32 %tmp2_v.i21.i to i32*
  store i32 %69, i32* %75, align 4
  %tmp2_v4.i25.i = add i32 %tmp0_v.i10.i, -76
  %76 = inttoptr i32 %tmp2_v4.i25.i to i32*
  store i32 %69, i32* %76, align 4
  %tmp2_v5.i27.i = add i32 %73, -8184
  store i32 %tmp2_v5.i27.i, i32* %18, align 16
