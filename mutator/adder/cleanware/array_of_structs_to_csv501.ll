...
@str.497 = constant [23 x i8] c"\0a%d records written.\0a\0a\00"
@str.498 = constant [15 x i8] c"%c,%s,%d,%.2f\0a\00"
@str.499 = constant [9 x i8] c"file.csv\00"
@str.500 = constant [2 x i8] c"w\00"
...
define internal fastcc void @array_of_structs_to_csv501(i32 %arg_esp) unnamed_addr  norecurse  !retregs !18 {
Func_804929C.exit.i:
  ...
  %tmp4_v.i22.i.b = load i1, i1* @segs.0, align 1
  %8 = inttoptr i32 %arg_esp to i32*
  %9 = load i32, i32* %8, align 4
  %tmp2_v2.i26.i = add i32 %tmp0_v.i2.i, -36
  %10 = inttoptr i32 %tmp2_v2.i26.i to i32*
  store i32 %9, i32* %10, align 4
  %tmp2_v5.i30.i = add i32 %tmp0_v.i2.i, -252
  %11 = inttoptr i32 %tmp2_v5.i30.i to i32*
  %spi500 = ptrtoint[2 x i8]* @str.500 to i32
  store i32 %spi500, i32* %11, align 4
  %tmp2_v7.i32.i = add i32 %tmp0_v.i2.i, -256
  %12 = inttoptr i32 %tmp2_v7.i32.i to i32*
  %spi499 = ptrtoint[9 x i8]* @str.499 to i32
  store i32 %spi499, i32* %12, align 16
  ...
  %mrv.i1 = insertvalue { i32, i32 } undef, i32 %tmp2_v7.i32.i, 0
  %tmp2_v.i49.i = add i32 %tmp0_v.i2.i, -232
  %15 = inttoptr i32 %tmp2_v.i49.i to i32*
  store i32 %14, i32* %15, align 8
  %tmp2_v.i54.i = add i32 %tmp0_v.i2.i, -228
  %16 = inttoptr i32 %tmp2_v.i54.i to i8*
  store i8 85, i8* %16, align 4
  %tmp0_v.i56.i = add i32 %tmp0_v.i2.i, -227
  %17 = inttoptr i32 %tmp0_v.i56.i to i32*
  store i32 1701273934, i32* %17, align 4
  %tmp2_v2.i57.i = add i32 %tmp0_v.i2.i, -223
  %18 = inttoptr i32 %tmp2_v2.i57.i to i16*
  store i16 25189, i16* %18, align 2
  %tmp2_v3.i58.i = add i32 %tmp0_v.i2.i, -221
  %19 = inttoptr i32 %tmp2_v3.i58.i to i8*
  store i8 0, i8* %19, align 1
  %tmp2_v4.i59.i = add i32 %tmp0_v.i2.i, -176
  %20 = inttoptr i32 %tmp2_v4.i59.i to i32*
  ...
  %tmp2_v7.i62.i = add i32 %tmp0_v.i2.i, -172
  %tmp5_v8.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %22 = inttoptr i32 %tmp2_v7.i62.i to i64*
  ...
  %tmp0_v12.i.i = add i32 %tmp0_v.i2.i, -163
  ...
  %tmp2_v14.i.i = add i32 %tmp0_v.i2.i, -112
  ...
  %tmp2_v19.i.i = add i32 %tmp0_v.i2.i, -108
  ...
  %tmp0_v24.i.i = add i32 %tmp0_v.i2.i, -99
  ...
  %tmp2_v32.i.i = add i32 %tmp0_v.i2.i, -44
  ...
  tail call fastcc void @helper_fpop()
  %tmp2_v35.i.i = add i32 %tmp0_v.i2.i, -236
  %36 = inttoptr i32 %tmp2_v35.i.i to i32*
  %tmp2_v2.i76.i = add i32 %tmp0_v.i2.i, -32
  store i32 0, i32* %36, align 4
  br label %BB_804936B.i

BB_804936B.i:                                     ; preds = %BB_804936B.i, %Func_804929C.exit.i
  %r_esp.0.in13 = phi i32 [ %tmp2_v7.i32.i, %Func_804929C.exit.i ], [ %r_esp.0.in, %BB_804936B.i ]
  %.pn912 = phi i32 [ %14, %Func_804929C.exit.i ], [ %54, %BB_804936B.i ]
  %mrv.i1.pn11 = phi { i32, i32 } [ %mrv.i1, %Func_804929C.exit.i ], [ %.pn, %BB_804936B.i ]
  %storemerge10 = phi i32 [ 0, %Func_804929C.exit.i ], [ %tmp0_v1.i.i, %BB_804936B.i ]
  %.pn = insertvalue { i32, i32 } %mrv.i1.pn11, i32 %.pn912, 1
  %tmp0_v1.i75.i = shl i32 %storemerge10, 6
  %tmp2_v5.i78.i = add i32 %tmp2_v7.i62.i, %tmp0_v1.i75.i
  %37 = inttoptr i32 %tmp2_v5.i78.i to i64*
  %38 = load i64, i64* %37, align 4
  tail call fastcc void @helper_fldl_ST0(i64 %38)
  %39 = load i32, i32* %36, align 4
  %tmp0_v9.i.i = shl i32 %39, 6
  %tmp0_v11.i.i = add i32 %tmp0_v9.i.i, %tmp2_v2.i76.i
  %tmp0_v12.i84.i = add i32 %tmp0_v11.i.i, -144
  %40 = inttoptr i32 %tmp0_v12.i84.i to i32*
  %41 = load i32, i32* %40, align 16
  %tmp0_v18.i.i = add i32 %tmp0_v9.i.i, %tmp2_v.i54.i
  %tmp2_v19.i86.i = or i32 %tmp0_v18.i.i, 1
  %tmp0_v25.i.i = add i32 %tmp0_v11.i.i, -196
  %42 = inttoptr i32 %tmp0_v25.i.i to i8*
  %43 = load i8, i8* %42, align 4
  %tmp0_v27.i.i = sext i8 %43 to i32
  %tmp2_v29.i90.i = add i32 %r_esp.0.in13, 4
  %tmp5_v30.i91.i = tail call fastcc i64 @helper_fstl_ST0()
  %44 = inttoptr i32 %tmp2_v29.i90.i to i64*
  store i64 %tmp5_v30.i91.i, i64* %44, align 4
  tail call fastcc void @helper_fpop()
  %45 = inttoptr i32 %r_esp.0.in13 to i32*
  store i32 %41, i32* %45, align 4
  %tmp2_v33.i.i = add i32 %r_esp.0.in13, -4
  %46 = inttoptr i32 %tmp2_v33.i.i to i32*
  store i32 %tmp2_v19.i86.i, i32* %46, align 4
  ...
  %spi498 = ptrtoint[15 x i8]* @str.498 to i32
  store i32 %spi498, i32* %48, align 4
  ...
  %52 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v19.i86.i, i32 inreg noundef %41, i32 noundef %tmp2_v40.i.i, i32 noundef ptrtoint (i32 ()* @fprintf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  ...
  %tmp0_v1.i.i = add i32 %55, 1
  %r_esp.0.in = extractvalue { i32, i32 } %mrv.i1.pn11, 0
  store i32 %tmp0_v1.i.i, i32* %36, align 4
  %56 = icmp slt i32 %tmp0_v1.i.i, 3
...
BB_8049427.i:                                     ; preds = %BB_804936B.i
  ...
  %tmp2_v3.i102.i = add i32 %r_esp.0.in.le, -4
  %61 = inttoptr i32 %tmp2_v3.i102.i to i32*
  store i32 134517813, i32* %61, align 4
  %arg.i.i8 = load i32, i32* %60, align 4
  %62 = tail call i32 @fclose(i32 %arg.i.i8)
  %tmp2_v.i16.i = add i32 %r_esp.0.in.le, 4
  %63 = inttoptr i32 %tmp2_v.i16.i to i32*
  store i32 3, i32* %63, align 4
  %spi497 = ptrtoint[23 x i8]* @str.497 to i32
  store i32 %spi497, i32* %60, align 4
  store i32 134517833, i32* %61, align 4
  %64 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v19.i86.i, i32 inreg noundef %58, i32 noundef %r_esp.0.in.le, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !20
  ret void
}
...
!20 = !{!"printf"}
  ...
  tail call fastcc void @array_of_structs_to_csv501(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
