...
define internal fastcc void @void_function_returnm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v4.i21.i = add i32 %tmp0_v.i24.i, -56
  %10 = inttoptr i32 %tmp2_v4.i21.i to i32*
  store i32 134517471, i32* %10, align 8
  %tmp2_v.i2.i.i = add i32 %tmp0_v.i24.i, -60
  %11 = inttoptr i32 %tmp2_v.i2.i.i to i32*
  store i32 %tmp2_v4.i26.i, i32* %11, align 4
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i24.i, -64
  ...
  %tmp2_v4.i.i = add i32 %tmp0_v.i24.i, -68
  %15 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 134517490, i32* %15, align 4
  %16 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i23.i, i32 inreg noundef 0, i32 noundef %tmp2_v1.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ...
  %tmp2_v.i1.i.i = add i32 %tmp0_v.i24.i, -72
  %22 = inttoptr i32 %tmp2_v.i1.i.i to i32*
  store i32 %14, i32* %22, align 8
  %tmp2_v1.i.i.i3 = add i32 %tmp0_v.i24.i, -76
  %23 = inttoptr i32 %tmp2_v1.i.i.i3 to i32*
  store i32 134529024, i32* %23, align 4
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i24.i, -100
  %24 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  store i32 134517343, i32* %24, align 4
  %tmp2_v.i2.i.i.i = add i32 %tmp0_v.i24.i, -104
  %25 = inttoptr i32 %tmp2_v.i2.i.i.i to i32*
  store i32 %tmp2_v.i1.i.i, i32* %25, align 8
  %tmp2_v1.i.i.i.i = add i32 %tmp0_v.i24.i, -108
  %26 = inttoptr i32 %tmp2_v1.i.i.i.i to i32*
  store i32 134529024, i32* %26, align 4
  %tmp2_v2.i.i.i.i = add i32 %tmp0_v.i24.i, -116
  %27 = inttoptr i32 %tmp2_v2.i.i.i.i to i32*
  store i32 134517279, i32* %27, align 4
  %tmp2_v2.i9.i.i.i = add i32 %tmp0_v.i24.i, -128
  %28 = inttoptr i32 %tmp2_v2.i9.i.i.i to i32*
  store i32 134520840, i32* %28, align 16
  %tmp2_v3.i.i.i.i = add i32 %tmp0_v.i24.i, -132
  ...
  %tmp2_v.i.i.i4 = add i32 %32, -4
  %33 = inttoptr i32 %tmp2_v.i.i.i4 to i32*
  %34 = load i32, i32* %33, align 4
  %tmp4_v3.i.i.i = add i32 %32, 8
  %tmp2_v.i10.i = add i32 %34, -8154
  %35 = inttoptr i32 %tmp4_v3.i.i.i to i32*
  store i32 %tmp2_v.i10.i, i32* %35, align 4
  %tmp2_v3.i11.i = add i32 %32, 4
  %36 = inttoptr i32 %tmp2_v3.i11.i to i32*
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @void_function_returnm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
