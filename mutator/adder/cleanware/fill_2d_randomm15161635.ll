...
define internal fastcc void @fill_2d_randomm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v2.i53.i = add i32 %tmp0_v.i2.i, -20
  %10 = inttoptr i32 %tmp2_v2.i53.i to i32*
  store i32 %9, i32* %10, align 4
  %tmp2_v4.i56.i = add i32 %tmp0_v.i2.i, -96
  %11 = inttoptr i32 %tmp2_v4.i56.i to i32*
  store i32 0, i32* %11, align 16
  %tmp2_v5.i57.i = add i32 %tmp0_v.i2.i, -100
  %12 = inttoptr i32 %tmp2_v5.i57.i to i32*
  ...
  %tmp2_v.i19.i = add i32 %tmp0_v.i2.i, -92
  %14 = inttoptr i32 %tmp2_v.i19.i to i32*
  store i32 10, i32* %14, align 4
  %tmp2_v2.i.i = add i32 %tmp0_v.i2.i, -68
  store i32 %tmp2_v2.i.i, i32* %11, align 16
  store i32 134517385, i32* %12, align 4
  %tmp2_v.i4.i.i = add i32 %tmp0_v.i2.i, -104
  %15 = inttoptr i32 %tmp2_v.i4.i.i to i32*
  store i32 %tmp2_v4.i3.i, i32* %15, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i2.i, -108
  %16 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 134529024, i32* %16, align 4
  %tmp2_v2.i8.i.i = add i32 %tmp0_v.i2.i, -132
  %17 = inttoptr i32 %tmp2_v2.i8.i.i to i32*
  %tmp2_v.i.i.i = add i32 %tmp0_v.i2.i, -120
  %18 = inttoptr i32 %tmp2_v.i.i.i to i32*
  %tmp2_v.i33.i.i = add i32 %tmp0_v.i2.i, -116
  %19 = inttoptr i32 %tmp2_v.i33.i.i to i32*
  store i32 0, i32* %18, align 8
  br label %BB_8049324.i.i

BB_8049358.i.i:                                   ; preds = %BB_804932D.i.i
  %20 = load i32, i32* %18, align 8
  %tmp0_v1.i.i.i = add i32 %20, 1
  store i32 %tmp0_v1.i.i.i, i32* %18, align 8
  %21 = icmp slt i32 %tmp0_v1.i.i.i, 3
...
BB_804932D.i.i:                                   ; preds = %BB_8049324.i.i, %BB_804932D.i.i
  ...
  %tmp0_v.i24.i.i = ashr i32 %22, 31
  %23 = load i32, i32* %14, align 4
  %24 = zext i32 %22 to i64
  %25 = zext i32 %tmp0_v.i24.i.i to i64
  ...
  %.frozen12 = freeze i64 %29
  %30 = sdiv i64 %.frozen, %.frozen12
  %31 = add i64 %30, 2147483648
  %32 = icmp ult i64 %31, 4294967296
  tail call void @llvm.assume(i1 %32)
  %33 = mul i64 %30, %.frozen12
  ...
  %tmp4_v.i29.i.i = shl i32 %37, 2
  %tmp2_v12.i.i.i = add i32 %tmp0_v8.i.i.i, %tmp4_v.i29.i.i
...
Func_fill_random.exit:                            ; preds = %BB_8049358.i.i
  ...
  %tmp2_v.i46.i = add i32 %42, -68
  %43 = inttoptr i32 %tmp2_v.i46.i to i32*
  %tmp2_v.i6.i = add i32 %42, -64
  %44 = inttoptr i32 %tmp2_v.i6.i to i32*
  %tmp2_v4.i29.i = add i32 %42, -60
...
BB_804929E.i:                                     ; preds = %BB_804929E.i, %BB_8049295.i
  %storemerge311 = phi i32 [ 0, %BB_8049295.i ], [ %tmp0_v2.i39.i, %BB_804929E.i ]
  %45 = load i32, i32* %43, align 4
  %tmp4_v.i25.i = shl i32 %45, 2
  %tmp0_v3.i28.i = add i32 %tmp4_v.i25.i, %storemerge311
  %tmp4_v5.i.i = shl i32 %tmp0_v3.i28.i, 2
  %tmp2_v6.i30.i = add i32 %tmp2_v4.i29.i, %tmp4_v5.i.i
  %46 = inttoptr i32 %tmp2_v6.i30.i to i32*
  %47 = load i32, i32* %46, align 4
  store i32 %47, i32* %14, align 4
  store i32 %tmp2_v10.i.i, i32* %11, align 16
  store i32 134517441, i32* %12, align 4
  %48 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v9.i.i.i, i32 inreg noundef %tmp4_v.i25.i, i32 noundef %tmp2_v4.i56.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %49 = load i32, i32* %44, align 4
  %tmp0_v2.i39.i = add i32 %49, 1
  store i32 %tmp0_v2.i39.i, i32* %44, align 4
  %50 = icmp slt i32 %tmp0_v2.i39.i, 4
  br i1 %50, label %BB_804929E.i, label %BB_80492CE.i

BB_80492CE.i:                                     ; preds = %BB_804929E.i
  store i32 10, i32* %11, align 16
  store i32 134517464, i32* %12, align 4
  %arg.i.i10 = load i32, i32* %11, align 16
  %51 = tail call i32 @putchar(i32 %arg.i.i10)  nounwind 
  %52 = load i32, i32* %43, align 4
  %tmp0_v2.i67.i = add i32 %52, 1
  store i32 %tmp0_v2.i67.i, i32* %43, align 4
  %53 = icmp slt i32 %tmp0_v2.i67.i, 3
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @fill_2d_randomm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
