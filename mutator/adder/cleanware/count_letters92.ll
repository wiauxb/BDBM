...
define internal fastcc void @count_letters92(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  store i32 %tmp2_v3.i29.i, i32* %22, align 16
  %tmp2_v18.i.i = add i32 %tmp0_v.i.i, -100
  %23 = inttoptr i32 %tmp2_v18.i.i to i32*
  store i32 134517377, i32* %23, align 4
  %tmp2_v.i12.i.i = add i32 %tmp0_v.i.i, -104
  %24 = inttoptr i32 %tmp2_v.i12.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %24, align 8
  %tmp2_v1.i14.i.i = add i32 %tmp0_v.i.i, -108
  %25 = inttoptr i32 %tmp2_v1.i14.i.i to i32*
  store i32 134529024, i32* %25, align 4
  %tmp2_v2.i16.i.i = add i32 %tmp0_v.i.i, -132
  %26 = inttoptr i32 %tmp2_v2.i16.i.i to i32*
  ...
  %tmp2_v4.i52.i.i = add i32 %tmp0_v.i.i, -148
  %29 = inttoptr i32 %tmp2_v4.i52.i.i to i32*
  store i32 134517469, i32* %29, align 4
  %arg.i.i.i = load i32, i32* %28, align 16
  %30 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i7.i.i = add i32 %tmp0_v.i.i, -116
  %31 = inttoptr i32 %tmp2_v.i7.i.i to i32*
  store i32 %30, i32* %31, align 4
  %tmp2_v1.i8.i.i = add i32 %tmp0_v.i.i, -124
...
BB_80492F3.i.i:                                   ; preds = %BB_804931F.i.i, %.exit
  ...
  %tmp0_v4.i33.i.i = add i32 %40, %39
  %41 = inttoptr i32 %tmp0_v4.i33.i.i to i8*
  %42 = load i8, i8* %41, align 1
  %tmp0_v6.i34.i.i = sext i8 %42 to i32
  %tmp0_v7.i.i.i = shl nsw i32 %tmp0_v6.i34.i.i, 1
  %tmp0_v8.i.i.i = add i32 %tmp0_v7.i.i.i, %38
  %43 = inttoptr i32 %tmp0_v8.i.i.i to i16*
  %44 = load i16, i16* %43, align 2
  %45 = and i16 %44, 1024
  %46 = icmp eq i16 %45, 0
  br i1 %46, label %BB_804931F.i.i, label %BB_804931B.i.i
...
BB_804931F.i.i:                                   ; preds = %BB_804931B.i.i, %BB_80492F3.i.i
  %48 = phi i32 [ %39, %BB_80492F3.i.i ], [ %.pre.i, %BB_804931B.i.i ]
...
Func_count_letters.exit:                          ; preds = %BB_804931F.i.i, %.exit
  ...
  %r_ecx.0.lcssa.i = phi i32 [ %tmp2_v.i.i, %.exit ], [ %39, %BB_804931F.i.i ]
  %51 = load i32, i32* %32, align 4
  %52 = load i32, i32* %25, align 4
  %53 = load i32, i32* %24, align 8
  %tmp2_v.i4.i = add i32 %53, -64
  %54 = inttoptr i32 %tmp2_v.i4.i to i32*
  store i32 %51, i32* %54, align 4
  %tmp2_v4.i5.i = add i32 %tmp0_v.i.i, -92
  %55 = inttoptr i32 %tmp2_v4.i5.i to i32*
  store i32 %51, i32* %55, align 4
  %tmp2_v5.i7.i = add i32 %52, -8184
  store i32 %tmp2_v5.i7.i, i32* %22, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @count_letters92(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
