...
define internal fastcc void @modfm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !18 {
.exit:
  ...
  %tmp2_v8.i25.i = add i32 %tmp0_v.i17.i, -52
  ...
  %tmp2_v1.i.i = add i32 %tmp0_v.i17.i, -40
  ...
  %tmp2_v4.i31.i = add i32 %tmp0_v.i17.i, -32
  %tmp5_v5.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %12 = inttoptr i32 %tmp2_v4.i31.i to i64*
  store i64 %tmp5_v5.i.i, i64* %12, align 16
  tail call fastcc void @helper_fpop()
  tail call fastcc void @helper_fpush()
  tail call fastcc void @helper_fldz_ST0()
  %tmp2_v7.i32.i = add i32 %tmp0_v.i17.i, -48
  %tmp5_v8.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %13 = inttoptr i32 %tmp2_v7.i32.i to i64*
  store i64 %tmp5_v8.i.i, i64* %13, align 16
  tail call fastcc void @helper_fpop()
  %tmp2_v11.i36.i = add i32 %tmp0_v.i17.i, -56
  %14 = inttoptr i32 %tmp2_v11.i36.i to i32*
  store i32 %tmp2_v7.i32.i, i32* %14, align 8
  %tmp2_v12.i37.i = add i32 %tmp0_v.i17.i, -36
  %15 = inttoptr i32 %tmp2_v12.i37.i to i32*
  ...
  %tmp2_v17.i40.i = add i32 %tmp0_v.i17.i, -64
  %20 = inttoptr i32 %tmp2_v17.i40.i to i32*
  store i32 %19, i32* %20, align 16
  %tmp2_v18.i.i = add i32 %tmp0_v.i17.i, -68
  %21 = inttoptr i32 %tmp2_v18.i.i to i32*
  store i32 134517287, i32* %21, align 4
  %22 = inttoptr i32 %tmp2_v17.i40.i to i64*
  ...
  %tmp5_v.i12.i = tail call fastcc i64 @helper_fstl_ST0()
  store i64 %tmp5_v.i12.i, i64* %12, align 16
  tail call fastcc void @helper_fpop()
  %tmp2_v4.i.i = add i32 %tmp0_v.i17.i, -28
  %25 = inttoptr i32 %tmp2_v4.i.i to i32*
  %26 = load i32, i32* %25, align 4
  store i32 %26, i32* %14, align 8
  %27 = inttoptr i32 %tmp2_v4.i31.i to i32*
  %28 = load i32, i32* %27, align 16
  store i32 %28, i32* %17, align 4
  store i32 134520840, i32* %20, align 16
  store i32 134517314, i32* %21, align 4
  %29 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i16.i, i32 inreg noundef 0, i32 noundef %tmp2_v17.i40.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %30 = lshr i64 %29, 32
  ...
  tail call fastcc void @helper_fpop()
  store i32 134520850, i32* %20, align 16
  store i32 134517342, i32* %21, align 4
  %34 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i16.i, i32 inreg noundef %31, i32 noundef %tmp2_v17.i40.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  ret void
}
...
!19 = !{!"printf"}
  ...
  tail call fastcc void @modfm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
