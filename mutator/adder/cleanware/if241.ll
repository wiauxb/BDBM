...
label_1.i62.i:
  ...
  %tmp2_v.i57.i = add i32 %tmp0_v.i11.i, -20
  %7 = inttoptr i32 %tmp2_v.i57.i to i32*
  store i32 4, i32* %7, align 4
  %tmp2_v1.i5.i = add i32 %tmp0_v.i11.i, -48
  %8 = inttoptr i32 %tmp2_v1.i5.i to i32*
  %spi239 = ptrtoint[12 x i8]* @str.239 to i32
  store i32 %spi239, i32* %8, align 16
  %tmp2_v2.i6.i = add i32 %tmp0_v.i11.i, -52
  ...
  %spi238 = ptrtoint[15 x i8]* @str.238 to i32
  store i32 %spi238, i32* %8, align 16
  ...
  %spi237 = ptrtoint[2 x i8]* @str.237 to i32
  store i32 %spi237, i32* %8, align 16
  ...
  %spi236 = ptrtoint[10 x i8]* @str.236 to i32
  store i32 %spi236, i32* %8, align 16
  ...
  %spi235 = ptrtoint[16 x i8]* @str.235 to i32
  store i32 %spi235, i32* %8, align 16
