...
define internal fastcc void @matrix_multiplicationm15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
...
BB_8049428.i.i:                                   ; preds = %BB_804941A.i.i
  ...
  %tmp0_v1.i4.i.i = add i32 %48, 1
  store i32 %tmp0_v1.i4.i.i, i32* %42, align 8
  %49 = icmp slt i32 %tmp0_v1.i4.i.i, 3
  br i1 %49, label %BB_804937B.i.i, label %Func_matrix_mult.exit
...
BB_80493AD.i.i:                                   ; preds = %BB_80493AD.i.i, %BB_8049387.i.i
  ...
  %tmp0_v3.i36.i.i = mul i32 %50, 12
  %51 = load i32, i32* %35, align 8
  %tmp0_v6.i39.i.i = add i32 %tmp0_v3.i36.i.i, %51
  %52 = load i32, i32* %43, align 4
  %tmp4_v.i42.i.i = shl i32 %52, 2
  %tmp2_v9.i43.i.i = add i32 %tmp0_v6.i39.i.i, %tmp4_v.i42.i.i
  %53 = inttoptr i32 %tmp2_v9.i43.i.i to i32*
  ...
  %tmp0_v31.i.i.i = add i32 %tmp4_v.i42.i.i, %tmp0_v28.i.i.i
...
BB_804941A.i.i:                                   ; preds = %BB_80493AD.i.i
  ...
  store i32 %tmp0_v1.i53.i.i, i32* %43, align 4
  %64 = icmp slt i32 %tmp0_v1.i53.i.i, 3
  br i1 %64, label %BB_8049387.i.i, label %BB_8049428.i.i

Func_matrix_mult.exit:                            ; preds = %BB_8049428.i.i
  %65 = load i32, i32* %40, align 4
  %66 = load i32, i32* %39, align 8
  %tmp2_v.i31.i = add i32 %66, -152
  %67 = inttoptr i32 %tmp2_v.i31.i to i32*
  %tmp2_v.i33.i = add i32 %66, -148
  %68 = inttoptr i32 %tmp2_v.i33.i to i32*
  %tmp2_v6.i42.i = add i32 %66, -144
  %tmp2_v11.i48.i = add i32 %65, -8184
...
BB_80492DF.i:                                     ; preds = %BB_80492DF.i, %BB_80492D3.i
  ...
  %tmp0_v2.i38.i = mul i32 %72, 3
  %tmp0_v5.i41.i = add i32 %tmp0_v2.i38.i, %storemerge16
  %tmp4_v.i43.i = shl i32 %tmp0_v5.i41.i, 2
  %tmp2_v7.i44.i = add i32 %tmp2_v6.i42.i, %tmp4_v.i43.i
  %73 = inttoptr i32 %tmp2_v7.i44.i to i32*
  %74 = load i32, i32* %73, align 4
  store i32 %74, i32* %36, align 4
  store i32 %tmp2_v11.i48.i, i32* %37, align 16
  ...
  %tmp0_v2.i61.i = add i32 %76, 1
  store i32 %tmp0_v2.i61.i, i32* %68, align 4
  %77 = icmp slt i32 %tmp0_v2.i61.i, 3
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @matrix_multiplicationm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
