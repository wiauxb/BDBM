...
define internal fastcc void @convert_vowels_uppercasem15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v8.i32.i = add i32 %tmp0_v.i25.i, -68
  %6 = inttoptr i32 %tmp2_v8.i32.i to i32*
  store i32 134517297, i32* %6, align 4
  %tmp2_v.i3.i = add i32 %arg_esp, 8
  %7 = inttoptr i32 %tmp2_v.i3.i to i32*
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i6.i = add i32 %tmp0_v.i25.i, -52
  ...
  %tmp2_v5.i8.i = add i32 %tmp0_v.i25.i, -20
  %12 = inttoptr i32 %tmp2_v5.i8.i to i32*
  store i32 %11, i32* %12, align 4
  %tmp2_v6.i.i = add i32 %tmp0_v.i25.i, -46
  %13 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 661939532, i32* %13, align 4
  %tmp2_v7.i.i = add i32 %tmp0_v.i25.i, -42
  %14 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 1634541683, i32* %14, align 4
  %tmp2_v8.i.i = add i32 %tmp0_v.i25.i, -38
  %15 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 1629513067, i32* %15, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i25.i, -34
  %16 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 1936028704, i32* %16, align 4
  %tmp2_v10.i.i = add i32 %tmp0_v.i25.i, -30
  %17 = inttoptr i32 %tmp2_v10.i.i to i32*
  store i32 1953702004, i32* %17, align 4
  %tmp2_v11.i.i = add i32 %tmp0_v.i25.i, -26
  %18 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 1735289202, i32* %18, align 4
  %tmp2_v12.i.i = add i32 %tmp0_v.i25.i, -22
  %19 = inttoptr i32 %tmp2_v12.i.i to i16*
  store i16 46, i16* %19, align 2
  %tmp2_v15.i.i = add i32 %tmp0_v.i25.i, -80
  %20 = inttoptr i32 %tmp2_v15.i.i to i32*
  store i32 %tmp2_v6.i.i, i32* %20, align 16
  %tmp2_v16.i.i = add i32 %tmp0_v.i25.i, -84
  %21 = inttoptr i32 %tmp2_v16.i.i to i32*
  store i32 134517382, i32* %21, align 4
  %tmp2_v.i27.i.i = add i32 %tmp0_v.i25.i, -88
  %22 = inttoptr i32 %tmp2_v.i27.i.i to i32*
  store i32 %tmp2_v4.i27.i, i32* %22, align 8
  %tmp2_v1.i29.i.i = add i32 %tmp0_v.i25.i, -92
  %23 = inttoptr i32 %tmp2_v1.i29.i.i to i32*
  store i32 134529024, i32* %23, align 4
  %tmp2_v2.i32.i.i = add i32 %tmp0_v.i25.i, -116
  %24 = inttoptr i32 %tmp2_v2.i32.i.i to i32*
  store i32 134517455, i32* %24, align 4
  %25 = load i32, i32* %20, align 16
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i25.i, -128
  %26 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  store i32 %25, i32* %26, align 16
  %tmp2_v4.i.i.i = add i32 %tmp0_v.i25.i, -132
  ...
  %tmp2_v.i16.i.i = add i32 %tmp0_v.i25.i, -100
  %29 = inttoptr i32 %tmp2_v.i16.i.i to i32*
  store i32 %28, i32* %29, align 4
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i25.i, -104
...
BB_804938D.i.i:                                   ; preds = %BB_8049365.i.i, %BB_804931A.i.i, %BB_80492F2.i.i
  %33 = phi i32 [ %39, %BB_80492F2.i.i ], [ %.pre.i, %BB_8049365.i.i ], [ %39, %BB_804931A.i.i ]
  %r_ecx.0.i = phi i32 [ %39, %BB_80492F2.i.i ], [ %47, %BB_8049365.i.i ], [ %39, %BB_804931A.i.i ]
  %r_edx.0.i = phi i32 [ %tmp0_v7.i.i.i, %BB_80492F2.i.i ], [ %47, %BB_8049365.i.i ], [ %39, %BB_804931A.i.i ]
  %tmp0_v1.i9.i.i = add i32 %33, 1
  store i32 %tmp0_v1.i9.i.i, i32* %30, align 8
  %34 = load i32, i32* %29, align 4
  %35 = icmp slt i32 %tmp0_v1.i9.i.i, %34
  br i1 %35, label %BB_80492F2.i.i, label %Func_convert_vowels.exit

BB_80492F2.i.i:                                   ; preds = %BB_804938D.i.i, %.exit
  store i32 134517495, i32* %24, align 4
  %36 = tail call i32 @__ctype_b_loc()
  %37 = inttoptr i32 %36 to i32*
  %38 = load i32, i32* %37, align 4
  %39 = load i32, i32* %30, align 8
  %40 = load i32, i32* %20, align 16
  %tmp0_v4.i77.i.i = add i32 %40, %39
  %41 = inttoptr i32 %tmp0_v4.i77.i.i to i8*
  %42 = load i8, i8* %41, align 1
  %tmp0_v6.i.i.i = sext i8 %42 to i32
  %tmp0_v7.i.i.i = shl nsw i32 %tmp0_v6.i.i.i, 1
  %tmp0_v8.i.i.i = add i32 %tmp0_v7.i.i.i, %38
  %43 = inttoptr i32 %tmp0_v8.i.i.i to i16*
  %44 = load i16, i16* %43, align 2
  %45 = and i16 %44, 512
  %46 = icmp eq i16 %45, 0
  br i1 %46, label %BB_804938D.i.i, label %BB_804931A.i.i

BB_804931A.i.i:                                   ; preds = %BB_80492F2.i.i
  switch i8 %42, label %BB_804938D.i.i [
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @convert_vowels_uppercasem15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
