...
define internal fastcc void @matrix_equalitym15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
label_1.i.i:
  ...
  %tmp2_v8.i.i = add i32 %tmp0_v.i3.i, -132
  ...
  %tmp2_v3.i21.i = add i32 %tmp0_v.i3.i, -116
  %10 = inttoptr i32 %tmp2_v3.i21.i to i32*
  store i32 1, i32* %10, align 4
  %tmp2_v4.i22.i = add i32 %tmp0_v.i3.i, -112
  %11 = inttoptr i32 %tmp2_v4.i22.i to i32*
  store i32 2, i32* %11, align 16
  %tmp2_v5.i23.i = add i32 %tmp0_v.i3.i, -108
  %12 = inttoptr i32 %tmp2_v5.i23.i to i32*
  store i32 3, i32* %12, align 4
  %tmp2_v6.i24.i = add i32 %tmp0_v.i3.i, -104
  %13 = inttoptr i32 %tmp2_v6.i24.i to i32*
  store i32 4, i32* %13, align 8
  %tmp2_v7.i.i = add i32 %tmp0_v.i3.i, -100
  %14 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 1, i32* %14, align 4
  %tmp2_v8.i25.i = add i32 %tmp0_v.i3.i, -96
  %15 = inttoptr i32 %tmp2_v8.i25.i to i32*
  store i32 2, i32* %15, align 16
  %tmp2_v9.i.i = add i32 %tmp0_v.i3.i, -92
  %16 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 3, i32* %16, align 4
  %tmp2_v10.i.i = add i32 %tmp0_v.i3.i, -88
...
BB_8049342.i.i:                                   ; preds = %BB_8049342.i.3.i, %label_1.i.i
  ...
  %tmp0_v1.i18.i.1.i = shl i32 %49, 4
  %50 = load i32, i32* %35, align 16
  %tmp0_v4.i.i.1.i = or i32 %tmp0_v1.i18.i.1.i, 4
...
BB_8049342.i.1.i:                                 ; preds = %BB_8049342.i.i
  ...
  %tmp0_v1.i18.i.2.i = shl i32 %57, 4
  %58 = load i32, i32* %35, align 16
  %tmp0_v4.i.i.2.i = or i32 %tmp0_v1.i18.i.2.i, 8
...
BB_8049342.i.2.i:                                 ; preds = %BB_8049342.i.1.i
  ...
  %tmp0_v1.i18.i.3.i = shl i32 %65, 4
  %66 = load i32, i32* %35, align 16
  %tmp0_v4.i.i.3.i = or i32 %tmp0_v1.i18.i.3.i, 12
...
BB_8049342.i.3.i:                                 ; preds = %BB_8049342.i.2.i
  ...
  %tmp0_v1.i29.i.i = add i32 %73, 1
  store i32 %tmp0_v1.i29.i.i, i32* %39, align 16
  store i32 0, i32* %40, align 4
  %74 = load i32, i32* %39, align 16
  %tmp0_v1.i18.i.i = shl i32 %74, 4
  %75 = load i32, i32* %35, align 16
  %tmp2_v7.i.i.i = add i32 %tmp0_v1.i18.i.i, %75
  %76 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  %77 = load i32, i32* %76, align 4
  %78 = load i32, i32* %34, align 4
  %tmp2_v19.i.i.i = add i32 %78, %tmp0_v1.i18.i.i
...
Func_matrix_equality.exit:                        ; preds = %BB_8049342.i.3.i, %BB_8049342.i.2.i, %BB_8049342.i.1.i, %BB_8049342.i.i, %label_1.i.i
  store i32 134520844, i32* %35, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @matrix_equalitym15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
