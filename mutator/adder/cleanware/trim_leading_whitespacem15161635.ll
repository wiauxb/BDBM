...
define internal fastcc void @trim_leading_whitespacem15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %7 = select i1 %tmp4_v.i15.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i19.i = add i32 %tmp0_v.i7.i, -20
  %9 = inttoptr i32 %tmp2_v2.i19.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i20.i = add i32 %tmp0_v.i7.i, -44
  %10 = inttoptr i32 %tmp2_v3.i20.i to i32*
  store i32 168435744, i32* %10, align 4
  %tmp2_v4.i21.i = add i32 %tmp0_v.i7.i, -40
  %11 = inttoptr i32 %tmp2_v4.i21.i to i32*
  store i32 1411391497, i32* %11, align 8
  %tmp2_v5.i22.i = add i32 %tmp0_v.i7.i, -36
  %12 = inttoptr i32 %tmp2_v5.i22.i to i32*
  store i32 544434536, i32* %12, align 4
  %tmp2_v6.i23.i = add i32 %tmp0_v.i7.i, -32
  %13 = inttoptr i32 %tmp2_v6.i23.i to i32*
  store i32 1948283753, i32* %13, align 16
  %tmp2_v7.i.i = add i32 %tmp0_v.i7.i, -28
  %14 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 1998611816, i32* %14, align 4
  %tmp2_v8.i24.i = add i32 %tmp0_v.i7.i, -24
  %15 = inttoptr i32 %tmp2_v8.i24.i to i32*
  store i32 3045729, i32* %15, align 8
  %tmp2_v11.i.i = add i32 %tmp0_v.i7.i, -60
  %16 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 %tmp2_v3.i20.i, i32* %16, align 4
  %tmp2_v13.i.i = add i32 %tmp0_v.i7.i, -64
  %17 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 134520840, i32* %17, align 16
  %tmp2_v14.i.i = add i32 %tmp0_v.i7.i, -68
  %18 = inttoptr i32 %tmp2_v14.i.i to i32*
  store i32 134517279, i32* %18, align 4
  %19 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i6.i, i32 inreg noundef 0, i32 noundef %tmp2_v13.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  store i32 %tmp2_v3.i20.i, i32* %17, align 16
  store i32 134517294, i32* %18, align 4
  %tmp2_v.i.i.i = add i32 %tmp0_v.i7.i, -72
  %20 = inttoptr i32 %tmp2_v.i.i.i to i32*
  store i32 %tmp2_v4.i9.i, i32* %20, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i7.i, -92
  %21 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 134517366, i32* %21, align 4
  %tmp2_v.i60.i.i = add i32 %tmp0_v.i7.i, -80
  %22 = inttoptr i32 %tmp2_v.i60.i.i to i32*
...
BB_8049288.i.i:                                   ; preds = %BB_8049284.i.i, %.exit
  ...
  %tmp0_v3.i.i.i = add i32 %23, %storemerge.i
  %24 = inttoptr i32 %tmp0_v3.i.i.i to i8*
...
Func_80492B5.exit.i.i:                            ; preds = %BB_8049288.i.i
  %tmp2_v.i18.i.i = add i32 %tmp0_v.i7.i, -76
  %26 = inttoptr i32 %tmp2_v.i18.i.i to i32*
  store i32 0, i32* %26, align 4
  %27 = load i32, i32* %22, align 16
  %28 = load i32, i32* %17, align 16
  %tmp0_v6.i.i23.i = add i32 %28, %27
  %29 = inttoptr i32 %tmp0_v6.i.i23.i to i8*
  %30 = load i8, i8* %29, align 1
  %.not.i.i24.i = icmp eq i8 %30, 0
  br i1 %.not.i.i24.i, label %Func_trim.exit, label %BB_80492C4.i.i

BB_80492C4.i.i:                                   ; preds = %BB_80492C4.i.i, %Func_80492B5.exit.i.i
  %31 = phi i8 [ %38, %BB_80492C4.i.i ], [ %30, %Func_80492B5.exit.i.i ]
  %32 = phi i32 [ %36, %BB_80492C4.i.i ], [ %28, %Func_80492B5.exit.i.i ]
  %storemerge1725.i = phi i32 [ %tmp0_v15.i.i.i, %BB_80492C4.i.i ], [ 0, %Func_80492B5.exit.i.i ]
  %tmp0_v11.i.i.i = add i32 %storemerge1725.i, %32
  %33 = inttoptr i32 %tmp0_v11.i.i.i to i8*
  store i8 %31, i8* %33, align 1
  %34 = load i32, i32* %26, align 4
  %tmp0_v15.i.i.i = add i32 %34, 1
  store i32 %tmp0_v15.i.i.i, i32* %26, align 4
  %35 = load i32, i32* %22, align 16
  %36 = load i32, i32* %17, align 16
  %tmp0_v3.i34.i.i = add i32 %35, %tmp0_v15.i.i.i
  %tmp0_v6.i.i.i = add i32 %tmp0_v3.i34.i.i, %36
  %37 = inttoptr i32 %tmp0_v6.i.i.i to i8*
...
Func_trim.exit:                                   ; preds = %BB_80492C4.i.i, %Func_80492B5.exit.i.i
  %storemerge17.lcssa.i = phi i32 [ 0, %Func_80492B5.exit.i.i ], [ %tmp0_v15.i.i.i, %BB_80492C4.i.i ]
  %r_ecx.0.lcssa.i = phi i32 [ %tmp2_v.i6.i, %Func_80492B5.exit.i.i ], [ %storemerge1725.i, %BB_80492C4.i.i ]
  %.lcssa.i = phi i32 [ %28, %Func_80492B5.exit.i.i ], [ %36, %BB_80492C4.i.i ]
  %tmp0_v3.i14.i.i = add i32 %.lcssa.i, %storemerge17.lcssa.i
  %39 = inttoptr i32 %tmp0_v3.i14.i.i to i8*
  store i8 0, i8* %39, align 1
  %40 = load i32, i32* %20, align 8
  %tmp2_v.i.i = add i32 %40, -36
  store i32 %tmp2_v.i.i, i32* %16, align 4
  store i32 134520853, i32* %17, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @trim_leading_whitespacem15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
