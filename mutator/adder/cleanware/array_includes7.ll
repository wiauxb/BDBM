...
@str.5 = constant [29 x i8] c"Could not find 11 in array a\00"
...
define internal fastcc void @array_includes7(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
label_1.i.i:
...
Func_includes.exit:                               ; preds = %BB_80492CB.i.i
  %spi5 = ptrtoint[29 x i8]* @str.5 to i32
  store i32 %spi5, i32* %24, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @array_includes7(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
