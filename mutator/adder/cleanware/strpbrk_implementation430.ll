...
@str.bis.428 = constant [20 x i8] c"\52\65\73\74\20\4f\66\20\53\74\72\69\6e\67\3a\20\25\73\0a\00"
...
.exit:
  ...
  %tmp2_v.i21.i.i = add i32 %tmp0_v.i13.i, -88
  %22 = inttoptr i32 %tmp2_v.i21.i.i to i32*
  store i32 %tmp2_v4.i15.i, i32* %22, align 8
  %tmp2_v1.i24.i.i = add i32 %tmp0_v.i13.i, -108
...
BB_80492BE.i.i:                                   ; preds = %BB_80492BA.i.i, %.exit
  ...
  %.not.i53.i17.i = icmp eq i8 %27, 0
  br i1 %.not.i53.i17.i, label %BB_80492BA.i.i, label %BB_8049297.i.i

BB_8049297.i.i:                                   ; preds = %BB_80492B0.i.i, %BB_80492BE.i.i
  %28 = phi i8 [ %34, %BB_80492B0.i.i ], [ %27, %BB_80492BE.i.i ]
  %storemerge18.i = phi i32 [ %tmp0_v1.i10.i.i, %BB_80492B0.i.i ], [ %25, %BB_80492BE.i.i ]
  %29 = load i32, i32* %20, align 16
  %30 = inttoptr i32 %29 to i8*
  %31 = load i8, i8* %30, align 1
  %tmp0_v1.i28.i.i = zext i8 %31 to i32
  %tmp0_v4.i31.i.i = zext i8 %28 to i32
  %cc_dst_v.i.i.i = sub nsw i32 %tmp0_v1.i28.i.i, %tmp0_v4.i31.i.i
  %tmp4_v.i32.i.i = and i32 %cc_dst_v.i.i.i, 255
  %.not.i33.i.i = icmp eq i32 %tmp4_v.i32.i.i, 0
  %tmp0_v1.i10.i.i = add i32 %storemerge18.i, 1
  br i1 %.not.i33.i.i, label %Func__strpbrk.exit, label %BB_80492B0.i.i

BB_80492BA.i.i:                                   ; preds = %BB_80492B0.i.i, %BB_80492BE.i.i
  %32 = load i32, i32* %20, align 16
  %tmp0_v1.i38.i.i = add i32 %32, 1
  store i32 %tmp0_v1.i38.i.i, i32* %20, align 16
  br label %BB_80492BE.i.i

BB_80492B0.i.i:                                   ; preds = %BB_8049297.i.i
  store i32 %tmp0_v1.i10.i.i, i32* %24, align 4
  %33 = inttoptr i32 %tmp0_v1.i10.i.i to i8*
...
Func__strpbrk.exit:                               ; preds = %BB_8049297.i.i
  ...
  %spi.bis.428 = ptrtoint[20 x i8]* @str.bis.428 to i32
  store i32 %spi.bis.428, i32* %20, align 16
  store i32 134517317, i32* %21, align 4
  %37 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i12.i, i32 inreg noundef %tmp0_v1.i28.i.i, i32 noundef %tmp2_v16.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
