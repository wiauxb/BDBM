...
define internal fastcc void @print_first_repeatm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
.exit:
  ...
  %tmp2_v7.i.i = add i32 %tmp0_v.i10.i, -36
  ...
  %tmp2_v10.i.i = add i32 %tmp0_v.i10.i, -52
  %14 = inttoptr i32 %tmp2_v10.i.i to i32*
  store i32 134517316, i32* %14, align 4
  %tmp2_v.i47.i.i = add i32 %tmp0_v.i10.i, -56
  %15 = inttoptr i32 %tmp2_v.i47.i.i to i32*
  store i32 %tmp2_v4.i12.i, i32* %15, align 8
  %tmp2_v1.i49.i.i = add i32 %tmp0_v.i10.i, -60
  %16 = inttoptr i32 %tmp2_v1.i49.i.i to i32*
  store i32 0, i32* %16, align 4
  %tmp2_v2.i52.i.i = add i32 %tmp0_v.i10.i, -84
  %17 = inttoptr i32 %tmp2_v2.i52.i.i to i32*
  store i32 134517365, i32* %17, align 4
  %18 = load i32, i32* %13, align 16
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i10.i, -96
  %19 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  store i32 %18, i32* %19, align 16
  %tmp2_v4.i74.i.i = add i32 %tmp0_v.i10.i, -100
  %20 = inttoptr i32 %tmp2_v4.i74.i.i to i32*
  store i32 134517382, i32* %20, align 4
  %arg.i.i.i = load i32, i32* %19, align 16
  %21 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i41.i.i = add i32 %tmp0_v.i10.i, -68
  %22 = inttoptr i32 %tmp2_v.i41.i.i to i32*
  store i32 %21, i32* %22, align 4
  %tmp2_v1.i42.i.i = add i32 %tmp0_v.i10.i, -77
  %23 = inttoptr i32 %tmp2_v1.i42.i.i to i8*
  store i8 0, i8* %23, align 1
  %tmp2_v2.i43.i.i = add i32 %tmp0_v.i10.i, -76
  %24 = inttoptr i32 %tmp2_v2.i43.i.i to i32*
...
BB_8049299.i.lr.ph.i:                             ; preds = %.exit
  %tmp2_v.i45.i.i = add i32 %tmp0_v.i10.i, -72
  %27 = inttoptr i32 %tmp2_v.i45.i.i to i32*
...
BB_80492CC.i.i:                                   ; preds = %BB_80492CC.i.i.backedge, %BB_8049299.i.lr.ph.i
  ...
  %tmp0_v1.i60.i.i = add nuw nsw i32 %storemerge1.i, 1
...
BB_80492CC.i.i.backedge:                          ; preds = %Func_80492D4.exit.i.i, %BB_80492CC.i.i
  %storemerge1.i.be = phi i32 [ %tmp0_v1.i60.i.i, %BB_80492CC.i.i ], [ 0, %Func_80492D4.exit.i.i ]
  br label %BB_80492CC.i.i
...
Func_print_first_repeat.exit:                     ; preds = %Func_80492D4.exit.i.i, %.exit
  store i32 134520844, i32* %19, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @print_first_repeatm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
