...
@str.699 = constant [14 x i8] c"number is odd\00"
...
define internal fastcc void @check_parity700(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
label_1.i29.i:
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @check_parity700(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
