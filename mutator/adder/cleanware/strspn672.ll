...
@str.671 = constant [9 x i8] c"pos: %d\0a\00"
...
define internal fastcc void @strspn672(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v.i32.i = add i32 %tmp0_v.i3.i, -60
  %24 = inttoptr i32 %tmp2_v.i32.i to i32*
  store i32 %23, i32* %24, align 4
  store i32 %23, i32* %20, align 4
  %spi671 = ptrtoint[9 x i8]* @str.671 to i32
  store i32 %spi671, i32* %21, align 16
  store i32 134517384, i32* %22, align 4
  %25 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef 0, i32 noundef %tmp2_v17.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %26 = load i32, i32* %24, align 4
  %tmp0_v3.i24.i = add i32 %26, %tmp2_v3.i12.i
  %tmp2_v4.i25.i = add i32 %tmp0_v.i3.i, -56
  %27 = inttoptr i32 %tmp2_v4.i25.i to i32*
  store i32 %tmp0_v3.i24.i, i32* %27, align 8
  store i32 %tmp0_v3.i24.i, i32* %21, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @strspn672(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
