...
define internal fastcc { i32, i32, i32, i32, i32 } @Func_vowel_count(i32 %arg_esp, i32 %arg_ebp, i32 %arg_ebx) unnamed_addr  norecurse  !retregs !12 {
  ...
  %1 = inttoptr i32 %tmp2_v.i60.i to i32*
  store i32 %arg_ebp, i32* %1, align 4
  %tmp2_v1.i62.i = add i32 %arg_esp, -8
  %2 = inttoptr i32 %tmp2_v1.i62.i to i32*
  store i32 %arg_ebx, i32* %2, align 4
  %tmp2_v2.i65.i = add i32 %arg_esp, -32
  %3 = inttoptr i32 %tmp2_v2.i65.i to i32*
  store i32 134517557, i32* %3, align 4
  %tmp2_v.i9.i = add i32 %arg_esp, -20
  %4 = inttoptr i32 %tmp2_v.i9.i to i32*
  store i32 0, i32* %4, align 4
  %tmp2_v1.i10.i = add i32 %arg_esp, -16
  %5 = inttoptr i32 %tmp2_v1.i10.i to i32*
  ...
  %tmp2_v3.i41.i = add i32 %arg_esp, -48
  %8 = inttoptr i32 %tmp2_v3.i41.i to i32*
...
BB_804934B.i:                                     ; preds = %BB_8049380.i, %0
  %13 = phi i32 [ %23, %BB_8049380.i ], [ %11, %0 ]
...
BB_8049380.i:                                     ; preds = %BB_804937C.i, %BB_8049370.i, %BB_804934B.i
  ...
  %22 = tail call i32 @strlen(i32 %arg.i.i27)
  %23 = load i32, i32* %5, align 4
  %24 = icmp ugt i32 %22, %23
  br i1 %24, label %BB_804934B.i, label %.exit

BB_8049370.i:                                     ; preds = %BB_804936D.i, %BB_8049370.i
  %r_eax.0 = phi i32 [ %tmp0_v.i30.i, %BB_804936D.i ], [ 134517616, %BB_8049370.i ]
  %tmp2_v1.i20.i = add nuw nsw i32 %r_eax.0, 134520900
  %25 = inttoptr i32 %tmp2_v1.i20.i to i32*
  %26 = load i32, i32* %25, align 4
  switch i32 %26, label %error.i [
...
BB_804936D.i:                                     ; preds = %BB_804934B.i
  %tmp0_v1.i45.i = shl nuw nsw i32 %17, 2
  %tmp0_v.i30.i = add nsw i32 %tmp0_v1.i45.i, -260
  br label %BB_8049370.i

BB_804937C.i:                                     ; preds = %BB_8049370.i
  %27 = load i32, i32* %4, align 4
  %tmp0_v1.i51.i = add i32 %27, 1
  store i32 %tmp0_v1.i51.i, i32* %4, align 4
...
.exit:                                            ; preds = %BB_8049380.i, %0
  %.lcssa = phi i32 [ %11, %0 ], [ %23, %BB_8049380.i ]
...
; Function Attrs: norecurse
define internal fastcc void @vowel_counter196(i32 %arg_esp) unnamed_addr  norecurse  !retregs !13 {
.exit:
  ...
  %tmp2_v17.i.i = add i32 %tmp0_v.i.i, -72
  %24 = inttoptr i32 %tmp2_v17.i.i to i32*
  store i32 1867475273, i32* %24, align 8
  %tmp2_v18.i.i = add i32 %tmp0_v.i.i, -68
  %25 = inttoptr i32 %tmp2_v18.i.i to i16*
  store i16 30037, i16* %25, align 4
  %tmp2_v19.i.i = add i32 %tmp0_v.i.i, -66
  %26 = inttoptr i32 %tmp2_v19.i.i to i8*
  store i8 0, i8* %26, align 2
  %tmp2_v22.i.i = add i32 %tmp0_v.i.i, -112
  %27 = inttoptr i32 %tmp2_v22.i.i to i32*
  store i32 %tmp2_v3.i5.i, i32* %27, align 16
  %tmp2_v23.i.i = add i32 %tmp0_v.i.i, -116
  %28 = inttoptr i32 %tmp2_v23.i.i to i32*
  store i32 134517404, i32* %28, align 4
  %29 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_vowel_count(i32 %tmp2_v23.i.i, i32 %tmp2_v4.i.i, i32 134529024)
  ...
  %tmp2_v.i42.i = add i32 %32, -80
  %34 = inttoptr i32 %tmp2_v.i42.i to i32*
  store i32 %31, i32* %34, align 4
  %tmp2_v2.i45.i = add i32 %32, -57
  %35 = inttoptr i32 %30 to i32*
  store i32 %tmp2_v2.i45.i, i32* %35, align 4
  %tmp2_v4.i46.i = add i32 %30, -4
  %36 = inttoptr i32 %tmp2_v4.i46.i to i32*
  store i32 134517422, i32* %36, align 4
  %37 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_vowel_count(i32 %tmp2_v4.i46.i, i32 %32, i32 %33)
  ...
  %tmp2_v.i50.i = add i32 %40, -76
  %42 = inttoptr i32 %tmp2_v.i50.i to i32*
  store i32 %39, i32* %42, align 4
  %tmp2_v2.i53.i = add i32 %40, -68
  %43 = inttoptr i32 %38 to i32*
  store i32 %tmp2_v2.i53.i, i32* %43, align 4
  %tmp2_v4.i54.i = add i32 %38, -4
  %44 = inttoptr i32 %tmp2_v4.i54.i to i32*
  store i32 134517440, i32* %44, align 4
  %45 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_vowel_count(i32 %tmp2_v4.i54.i, i32 %40, i32 %41)
  ...
  %tmp2_v.i21.i = add i32 %49, -72
  %51 = inttoptr i32 %tmp2_v.i21.i to i32*
  store i32 %47, i32* %51, align 4
  %tmp2_v2.i23.i = add i32 %49, -80
  %52 = inttoptr i32 %tmp2_v2.i23.i to i32*
  %53 = load i32, i32* %52, align 4
  %tmp2_v4.i25.i = add i32 %46, 4
  %54 = inttoptr i32 %tmp2_v4.i25.i to i32*
  store i32 %53, i32* %54, align 4
  %tmp2_v5.i27.i = add i32 %50, -8184
  %55 = inttoptr i32 %46 to i32*
  store i32 %tmp2_v5.i27.i, i32* %55, align 4
  %tmp2_v7.i28.i = add i32 %46, -4
  %56 = inttoptr i32 %tmp2_v7.i28.i to i32*
  store i32 134517464, i32* %56, align 4
  %57 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %48, i32 noundef %46, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  %58 = lshr i64 %57, 32
  %59 = trunc i64 %58 to i32
  %tmp2_v.i66.i = add i32 %49, -76
  %60 = inttoptr i32 %tmp2_v.i66.i to i32*
  %61 = load i32, i32* %60, align 4
  store i32 %61, i32* %54, align 4
  %tmp2_v4.i70.i = add i32 %50, -8164
  store i32 %tmp2_v4.i70.i, i32* %55, align 4
  store i32 134517485, i32* %56, align 4
  %62 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %59, i32 noundef %46, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  %63 = lshr i64 %62, 32
  %64 = trunc i64 %63 to i32
  %65 = load i32, i32* %51, align 4
  store i32 %65, i32* %54, align 4
  %tmp2_v4.i37.i = add i32 %50, -8144
  store i32 %tmp2_v4.i37.i, i32* %55, align 4
  store i32 134517506, i32* %56, align 4
  %66 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %64, i32 noundef %46, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  ret void
}
...
!14 = !{!"printf"}
  ...
  tail call fastcc void @vowel_counter196(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
