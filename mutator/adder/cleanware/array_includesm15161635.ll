...
define internal fastcc void @array_includesm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
label_1.i8.i:
  ...
  %7 = select i1 %tmp4_v.i11.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i15.i = add i32 %tmp0_v.i3.i, -20
  %9 = inttoptr i32 %tmp2_v2.i15.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i16.i = add i32 %tmp0_v.i3.i, -60
  %10 = inttoptr i32 %tmp2_v3.i16.i to i32*
  store i32 1, i32* %10, align 4
  %tmp2_v4.i17.i = add i32 %tmp0_v.i3.i, -56
  %11 = inttoptr i32 %tmp2_v4.i17.i to i32*
  store i32 2, i32* %11, align 8
  %tmp2_v5.i18.i = add i32 %tmp0_v.i3.i, -52
  %12 = inttoptr i32 %tmp2_v5.i18.i to i32*
  store i32 3, i32* %12, align 4
  %tmp2_v6.i19.i = add i32 %tmp0_v.i3.i, -48
  %13 = inttoptr i32 %tmp2_v6.i19.i to i32*
  store i32 4, i32* %13, align 16
  %tmp2_v7.i.i = add i32 %tmp0_v.i3.i, -44
  %14 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 5, i32* %14, align 4
  %tmp2_v8.i20.i = add i32 %tmp0_v.i3.i, -40
  %15 = inttoptr i32 %tmp2_v8.i20.i to i32*
  ...
  %tmp2_v15.i.i = add i32 %tmp0_v.i3.i, -72
  %21 = inttoptr i32 %tmp2_v15.i.i to i32*
  store i32 11, i32* %21, align 8
  %22 = load i32, i32* %20, align 16
  %tmp2_v18.i.i = add i32 %tmp0_v.i3.i, -76
  %23 = inttoptr i32 %tmp2_v18.i.i to i32*
  store i32 %22, i32* %23, align 4
  %tmp2_v20.i.i = add i32 %tmp0_v.i3.i, -80
  %24 = inttoptr i32 %tmp2_v20.i.i to i32*
  store i32 %tmp2_v3.i16.i, i32* %24, align 16
  %tmp2_v21.i.i = add i32 %tmp0_v.i3.i, -84
...
BB_80492CB.i.i:                                   ; preds = %BB_80492CB.i.i, %label_1.i8.i
  %storemerge.i = phi i32 [ 0, %label_1.i8.i ], [ %tmp0_v1.i6.i.i, %BB_80492CB.i.i ]
  store i32 %storemerge.i, i32* %28, align 4
  %29 = load i32, i32* %23, align 4
  %30 = icmp slt i32 %storemerge.i, %29
  %tmp0_v1.i6.i.i = add nuw nsw i32 %storemerge.i, 1
  br i1 %30, label %BB_80492CB.i.i, label %Func_includes.exit

Func_includes.exit:                               ; preds = %BB_80492CB.i.i
  store i32 134520860, i32* %24, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @array_includesm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
