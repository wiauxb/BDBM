...
define internal fastcc void @print_until_newline380(i32 %arg_esp) unnamed_addr  nofree norecurse nounwind  !retregs !10 {
.exit:
  ...
  %18 = inttoptr i32 %tmp2_v.i28.i.i to i32*
  store i32 %tmp2_v4.i5.i, i32* %18, align 8
  %tmp2_v1.i30.i.i = add i32 %tmp0_v.i3.i, -76
  %19 = inttoptr i32 %tmp2_v1.i30.i.i to i32*
  ...
  %tmp2_v.i.i.i = add i32 %tmp0_v.i3.i, -84
...
BB_8049267.i.lr.ph.i:                             ; preds = %.exit
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i3.i, -112
  %25 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i3.i, -116
...
BB_8049267.i.i:                                   ; preds = %BB_8049267.i.i, %BB_8049267.i.lr.ph.i
  ...
  %tmp0_v2.i8.i.i = add i32 %29, 1
  store i32 %tmp0_v2.i8.i.i, i32* %21, align 4
  %30 = load i32, i32* %16, align 16
  %tmp0_v3.i38.i.i = add i32 %30, %tmp0_v2.i8.i.i
  %31 = inttoptr i32 %tmp0_v3.i38.i.i to i8*
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @print_until_newline380(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
