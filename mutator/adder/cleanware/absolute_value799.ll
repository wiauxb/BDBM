...
@str.797 = constant [13 x i8] c"fabs(y): %f\0a\00"
@str.798 = constant [12 x i8] c"abs(x): %d\0a\00"
...
define internal fastcc void @absolute_value799(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !18 {
  ...
  %tmp2_v.i.i = add i32 %tmp0_v.i20.i, -40
  %8 = inttoptr i32 %tmp2_v.i.i to i32*
  store i32 -5, i32* %8, align 8
  %tmp2_v7.i.i = add i32 %tmp0_v.i20.i, -36
  %9 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 5, i32* %9, align 4
  %tmp2_v11.i.i = add i32 %tmp0_v.i20.i, -60
  %10 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 5, i32* %10, align 4
  %tmp2_v13.i.i = add i32 %tmp0_v.i20.i, -64
  %11 = inttoptr i32 %tmp2_v13.i.i to i32*
  %spi798 = ptrtoint[12 x i8]* @str.798 to i32
  store i32 %spi798, i32* %11, align 16
  %tmp2_v14.i.i = add i32 %tmp0_v.i20.i, -68
  %12 = inttoptr i32 %tmp2_v14.i.i to i32*
  store i32 134517218, i32* %12, align 4
  %13 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i19.i, i32 inreg noundef 5, i32 noundef %tmp2_v13.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %14 = lshr i64 %13, 32
  %15 = trunc i64 %14 to i32
  %16 = load i64, i64* inttoptr (i32 134520872 to i64*), align 8
  tail call fastcc void @helper_fldl_ST0(i64 %16)
  %tmp2_v1.i12.i = add i32 %tmp0_v.i20.i, -32
  %tmp5_v2.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %17 = inttoptr i32 %tmp2_v1.i12.i to i64*
  ...
  %tmp2_v7.i14.i = add i32 %tmp0_v.i20.i, -24
  %tmp5_v8.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %19 = inttoptr i32 %tmp2_v7.i14.i to i64*
  store i64 %tmp5_v8.i.i, i64* %19, align 8
  tail call fastcc void @helper_fpop()
  %tmp2_v12.i16.i = add i32 %tmp0_v.i20.i, -20
  %20 = inttoptr i32 %tmp2_v12.i16.i to i32*
  %21 = load i32, i32* %20, align 4
  %tmp2_v14.i17.i = add i32 %tmp0_v.i20.i, -56
  %22 = inttoptr i32 %tmp2_v14.i17.i to i32*
  store i32 %21, i32* %22, align 8
  %23 = inttoptr i32 %tmp2_v7.i14.i to i32*
  %24 = load i32, i32* %23, align 8
  store i32 %24, i32* %10, align 4
  %spi797 = ptrtoint[13 x i8]* @str.797 to i32
  store i32 %spi797, i32* %11, align 16
  store i32 134517259, i32* %12, align 4
  %25 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i19.i, i32 inreg noundef %15, i32 noundef %tmp2_v13.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  ret void
}
...
!19 = !{!"printf"}
  ...
  tail call fastcc void @absolute_value799(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
