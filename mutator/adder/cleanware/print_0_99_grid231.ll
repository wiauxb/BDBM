...
BB_80491E0.i:                                     ; preds = %BB_804922D.ithread-pre-split, %0
  ...
  %14 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %r_ecx.01, i32 inreg noundef %r_edx.02, i32 noundef %tmp2_v4.i18.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
