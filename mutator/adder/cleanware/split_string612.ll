...
.exit:
  ...
  %tmp2_v3.i5.i = add i32 %tmp0_v.i29.i, -252
  %10 = inttoptr i32 %tmp2_v3.i5.i to i32*
  store i32 1702242121, i32* %10, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i29.i, -248
  ...
  %tmp2_v.i17.i.i = add i32 %tmp0_v.i29.i, -280
  %22 = inttoptr i32 %tmp2_v.i17.i.i to i32*
  store i32 %tmp2_v4.i31.i, i32* %22, align 8
  %tmp2_v1.i19.i.i = add i32 %tmp0_v.i29.i, -284
  ...
  %tmp2_v3.i46.i.i = add i32 %tmp0_v.i29.i, -320
  %26 = inttoptr i32 %tmp2_v3.i46.i.i to i32*
  store i32 %25, i32* %26, align 16
  %tmp2_v4.i47.i.i = add i32 %tmp0_v.i29.i, -324
  %27 = inttoptr i32 %tmp2_v4.i47.i.i to i32*
  store i32 134517460, i32* %27, align 4
  %arg.i.i.i = load i32, i32* %26, align 16
  %28 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i24.i.i = add i32 %tmp0_v.i29.i, -292
  %29 = inttoptr i32 %tmp2_v.i24.i.i to i32*
  store i32 %28, i32* %29, align 4
  %tmp2_v.i31.i.i = add i32 %tmp0_v.i29.i, -300
  %30 = inttoptr i32 %tmp2_v.i31.i.i to i32*
...
BB_804930C.i.i:                                   ; preds = %BB_80492EB.i.i, %.exit
  ...
  %tmp0_v3.i6.i.i = add i32 %41, %.lcssa.i
  %42 = inttoptr i32 %tmp0_v3.i6.i.i to i8*
  store i8 0, i8* %42, align 1
  %43 = load i32, i32* %19, align 4
  %tmp2_v6.i9.i.i = add i32 %tmp0_v.i29.i, -296
  %44 = inttoptr i32 %tmp2_v6.i9.i.i to i32*
  store i32 %43, i32* %44, align 8
  %45 = load i32, i32* %29, align 4
  %.not.i38.i22.i = icmp sgt i32 %43, %45
  br i1 %.not.i38.i22.i, label %Func_string_split.exit, label %BB_804931F.i.i

BB_804931F.i.i:                                   ; preds = %BB_804931F.i.i, %BB_804930C.i.i
  %storemerge1923.i = phi i32 [ %tmp0_v14.i61.i.i, %BB_804931F.i.i ], [ %43, %BB_804930C.i.i ]
  %46 = load i32, i32* %20, align 16
  %tmp2_v3.i53.i.i = add i32 %46, %storemerge1923.i
  %47 = load i32, i32* %19, align 4
  %tmp0_v7.i58.i.i = sub i32 %storemerge1923.i, %47
  %48 = load i32, i32* %6, align 4
  %tmp0_v10.i.i.i = add i32 %tmp0_v7.i58.i.i, %48
  %49 = inttoptr i32 %tmp2_v3.i53.i.i to i8*
  %50 = load i8, i8* %49, align 1
  %51 = inttoptr i32 %tmp0_v10.i.i.i to i8*
  store i8 %50, i8* %51, align 1
  %52 = load i32, i32* %44, align 8
  %tmp0_v14.i61.i.i = add i32 %52, 1
  store i32 %tmp0_v14.i61.i.i, i32* %44, align 8
  %53 = load i32, i32* %29, align 4
  %.not.i38.i.i = icmp sgt i32 %tmp0_v14.i61.i.i, %53
  br i1 %.not.i38.i.i, label %Func_string_split.exit, label %BB_804931F.i.i

Func_string_split.exit:                           ; preds = %BB_804931F.i.i, %BB_804930C.i.i
  %54 = load i32, i32* %22, align 8
  %tmp2_v.i.i = add i32 %54, -212
