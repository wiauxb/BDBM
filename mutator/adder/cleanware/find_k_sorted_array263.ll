...
@str.bis.261 = constant [12 x i8] c"\69\6e\64\65\78\31\3a\20\25\64\0a\00"
...
.exit:
  ...
  %tmp2_v.i20.i.i = add i32 %tmp0_v.i.i, -92
  %25 = inttoptr i32 %tmp2_v.i20.i.i to i32*
  br label %BB_80492A3.i.i

BB_80492A3.i.i:                                   ; preds = %BB_80492A3.i.i, %.exit
  %storemerge.i = phi i32 [ 0, %.exit ], [ %tmp0_v1.i9.i.i, %BB_80492A3.i.i ]
  store i32 %storemerge.i, i32* %25, align 4
  %tmp4_v.i13.i.i = shl i32 %storemerge.i, 2
  %26 = load i32, i32* %21, align 16
  %tmp0_v3.i15.i.i = add i32 %26, %tmp4_v.i13.i.i
  %27 = inttoptr i32 %tmp0_v3.i15.i.i to i32*
  %28 = load i32, i32* %27, align 4
  %29 = load i32, i32* %18, align 8
  %30 = icmp sgt i32 %29, %28
  %tmp0_v1.i9.i.i = add i32 %storemerge.i, 1
...
Func_find_index.exit:                             ; preds = %BB_80492A3.i.i
  ...
  %tmp2_v.i8.i = add i32 %31, -40
  %32 = inttoptr i32 %tmp2_v.i8.i to i32*
  store i32 %storemerge.i, i32* %32, align 4
  store i32 %storemerge.i, i32* %20, align 4
  %spi.bis.261 = ptrtoint[12 x i8]* @str.bis.261 to i32
  store i32 %spi.bis.261, i32* %21, align 16
  store i32 134517316, i32* %22, align 4
  %33 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %tmp4_v.i13.i.i, i32 noundef %tmp2_v19.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
