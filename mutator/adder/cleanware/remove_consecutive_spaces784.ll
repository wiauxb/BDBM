...
.exit:
  ...
  %spi782 = ptrtoint[14 x i8]* @str.782 to i32
  store i32 %spi782, i32* %21, align 16
  ...
  %tmp2_v.i27.i.i = add i32 %tmp0_v.i32.i, -88
  %24 = inttoptr i32 %tmp2_v.i27.i.i to i32*
  store i32 %tmp2_v4.i34.i, i32* %24, align 8
  %tmp2_v1.i29.i.i = add i32 %tmp0_v.i32.i, -92
  %25 = inttoptr i32 %tmp2_v1.i29.i.i to i32*
  store i32 134529024, i32* %25, align 4
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i32.i, -116
  %26 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  store i32 134517424, i32* %26, align 4
  %27 = load i32, i32* %21, align 16
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i32.i, -128
  %28 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  store i32 %27, i32* %28, align 16
  %tmp2_v4.i15.i.i = add i32 %tmp0_v.i32.i, -132
  %29 = inttoptr i32 %tmp2_v4.i15.i.i to i32*
  store i32 134517442, i32* %29, align 4
  %arg.i.i.i = load i32, i32* %28, align 16
  %30 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i45.i.i = add i32 %tmp0_v.i32.i, -100
  %31 = inttoptr i32 %tmp2_v.i45.i.i to i32*
  store i32 %30, i32* %31, align 4
  %tmp2_v1.i47.i.i = add i32 %tmp0_v.i32.i, -108
  %32 = inttoptr i32 %tmp2_v1.i47.i.i to i32*
  store i32 0, i32* %32, align 4
  %tmp2_v2.i48.i.i = add i32 %tmp0_v.i32.i, -109
  %33 = inttoptr i32 %tmp2_v2.i48.i.i to i8*
  store i8 1, i8* %33, align 1
  %tmp2_v3.i49.i.i = add i32 %tmp0_v.i32.i, -104
  %34 = inttoptr i32 %tmp2_v3.i49.i.i to i32*
...
BB_80492DC.i.i:                                   ; preds = %BB_804930A.i.i, %.exit
  ...
  %storemerge28.i = phi i32 [ %tmp0_v1.i53.i.i, %BB_804930A.i.i ], [ 0, %.exit ]
...
BB_804930A.i.i:                                   ; preds = %BB_80492EB.i.i, %BB_80492F1.i.i
  ...
  %r_ecx.1.i = phi i32 [ %r_ecx.029.i, %BB_80492EB.i.i ], [ %40, %BB_80492F1.i.i ]
  %.not.i80.i.i = icmp ne i8 %45, 32
  %spec.select.i = zext i1 %.not.i80.i.i to i8
  store i8 %spec.select.i, i8* %33, align 1
  %46 = load i32, i32* %34, align 8
  %tmp0_v1.i53.i.i = add i32 %46, 1
  store i32 %tmp0_v1.i53.i.i, i32* %34, align 8
  %47 = load i32, i32* %31, align 4
  %48 = icmp slt i32 %tmp0_v1.i53.i.i, %47
...
Func_remove_consecutive_spaces.exit:              ; preds = %BB_804930A.i.i, %.exit
  ...
  %tmp0_v3.i21.i.i = add i32 %50, %49
  %51 = inttoptr i32 %tmp0_v3.i21.i.i to i8*
  store i8 0, i8* %51, align 1
  %52 = load i32, i32* %25, align 4
  %53 = load i32, i32* %24, align 8
  %tmp2_v.i9.i = add i32 %53, -49
  store i32 %tmp2_v.i9.i, i32* %20, align 4
  %tmp2_v3.i10.i = add i32 %52, -8170
  store i32 %tmp2_v3.i10.i, i32* %21, align 16
