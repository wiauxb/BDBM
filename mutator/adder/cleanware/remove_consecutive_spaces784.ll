...
@str.782 = constant [14 x i8] c"Before: '%s'\0a\00"
...
.exit:
  ...
  %tmp2_v8.i25.i = add i32 %tmp0_v.i18.i, -68
  %6 = inttoptr i32 %tmp2_v8.i25.i to i32*
  store i32 134517233, i32* %6, align 4
  %tmp4_v.i.i.b = load i1, i1* @segs.0, align 1
  %7 = inttoptr i32 %arg_esp to i32*
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i.i = add i32 %tmp0_v.i18.i, -20
  %9 = inttoptr i32 %tmp2_v2.i.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i5.i = add i32 %tmp0_v.i18.i, -57
  %10 = inttoptr i32 %tmp2_v3.i5.i to i32*
  store i32 1769108563, i32* %10, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i18.i, -53
  %11 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 538994542, i32* %11, align 4
  %tmp2_v5.i.i = add i32 %tmp0_v.i18.i, -49
  %12 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 1953068832, i32* %12, align 4
  %tmp2_v6.i.i = add i32 %tmp0_v.i18.i, -45
  %13 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 538976360, i32* %13, align 4
  %tmp2_v7.i.i = add i32 %tmp0_v.i18.i, -41
  %14 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 1936617315, i32* %14, align 4
  %tmp2_v8.i.i = add i32 %tmp0_v.i18.i, -37
  %15 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 1953850213, i32* %15, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i18.i, -33
  %16 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 543520361, i32* %16, align 4
  %tmp2_v10.i.i = add i32 %tmp0_v.i18.i, -29
  %17 = inttoptr i32 %tmp2_v10.i.i to i32*
  store i32 1634759456, i32* %17, align 4
  %tmp2_v11.i.i = add i32 %tmp0_v.i18.i, -25
  %18 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 779314531, i32* %18, align 4
  %tmp2_v12.i.i = add i32 %tmp0_v.i18.i, -21
  %19 = inttoptr i32 %tmp2_v12.i.i to i8*
  store i8 0, i8* %19, align 1
  %tmp2_v15.i.i = add i32 %tmp0_v.i18.i, -76
  %20 = inttoptr i32 %tmp2_v15.i.i to i32*
  store i32 %tmp2_v3.i5.i, i32* %20, align 4
  %tmp2_v17.i.i = add i32 %tmp0_v.i18.i, -80
  %21 = inttoptr i32 %tmp2_v17.i.i to i32*
  %spi.bis.782 = ptrtoint[14 x i8]* @str.782 to i32
  store i32 %spi.bis.782, i32* %21, align 16
  %tmp2_v18.i.i = add i32 %tmp0_v.i18.i, -84
  %22 = inttoptr i32 %tmp2_v18.i.i to i32*
  store i32 134517336, i32* %22, align 4
  %23 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i17.i, i32 inreg noundef 0, i32 noundef %tmp2_v17.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  store i32 %tmp2_v3.i5.i, i32* %21, align 16
  store i32 134517351, i32* %22, align 4
  %tmp2_v.i22.i.i = add i32 %tmp0_v.i18.i, -88
  %24 = inttoptr i32 %tmp2_v.i22.i.i to i32*
  store i32 %tmp2_v4.i20.i, i32* %24, align 8
  %tmp2_v1.i24.i.i = add i32 %tmp0_v.i18.i, -92
  %25 = inttoptr i32 %tmp2_v1.i24.i.i to i32*
  store i32 134529024, i32* %25, align 4
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i18.i, -116
  %26 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  store i32 134517424, i32* %26, align 4
  %27 = load i32, i32* %21, align 16
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i18.i, -128
  %28 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  store i32 %27, i32* %28, align 16
  %tmp2_v4.i.i.i = add i32 %tmp0_v.i18.i, -132
  ...
  %tmp2_v.i77.i.i = add i32 %tmp0_v.i18.i, -100
  %31 = inttoptr i32 %tmp2_v.i77.i.i to i32*
  store i32 %30, i32* %31, align 4
  %tmp2_v1.i79.i.i = add i32 %tmp0_v.i18.i, -108
  %32 = inttoptr i32 %tmp2_v1.i79.i.i to i32*
  store i32 0, i32* %32, align 4
  %tmp2_v2.i80.i.i = add i32 %tmp0_v.i18.i, -109
  %33 = inttoptr i32 %tmp2_v2.i80.i.i to i8*
  store i8 1, i8* %33, align 1
  %tmp2_v3.i81.i.i = add i32 %tmp0_v.i18.i, -104
  %34 = inttoptr i32 %tmp2_v3.i81.i.i to i32*
...
BB_80492DC.i.i:                                   ; preds = %BB_804930A.i.i, %.exit
  %r_ecx.029.i = phi i32 [ %r_ecx.1.i, %BB_804930A.i.i ], [ %tmp2_v.i17.i, %.exit ]
  %storemerge28.i = phi i32 [ %tmp0_v1.i67.i.i, %BB_804930A.i.i ], [ 0, %.exit ]
  %37 = load i32, i32* %21, align 16
  %tmp0_v3.i.i.i = add i32 %37, %storemerge28.i
  %38 = inttoptr i32 %tmp0_v3.i.i.i to i8*
  %39 = load i8, i8* %38, align 1
  %.not.i.i.i = icmp eq i8 %39, 32
  br i1 %.not.i.i.i, label %BB_80492EB.i.i, label %BB_80492F1.i.i

BB_80492EB.i.i:                                   ; preds = %BB_80492DC.i.i
  %40 = load i8, i8* %33, align 1
  %41 = icmp eq i8 %40, 0
  br i1 %41, label %BB_804930A.i.i, label %BB_80492F1.i.i

BB_804930A.i.i:                                   ; preds = %BB_80492F1.i.i, %BB_80492EB.i.i
  %42 = phi i8 [ 32, %BB_80492EB.i.i ], [ %.pre, %BB_80492F1.i.i ]
  %r_ecx.1.i = phi i32 [ %r_ecx.029.i, %BB_80492EB.i.i ], [ %46, %BB_80492F1.i.i ]
  %.not.i49.i.i = icmp ne i8 %42, 32
  %spec.select.i = zext i1 %.not.i49.i.i to i8
  store i8 %spec.select.i, i8* %33, align 1
  %43 = load i32, i32* %34, align 8
  %tmp0_v1.i67.i.i = add i32 %43, 1
  store i32 %tmp0_v1.i67.i.i, i32* %34, align 8
  %44 = load i32, i32* %31, align 4
  %45 = icmp slt i32 %tmp0_v1.i67.i.i, %44
  br i1 %45, label %BB_80492DC.i.i, label %Func_remove_consecutive_spaces.exit

BB_80492F1.i.i:                                   ; preds = %BB_80492EB.i.i, %BB_80492DC.i.i
  %46 = load i32, i32* %32, align 4
  %tmp0_v8.i.i.i = add i32 %46, %37
  %47 = inttoptr i32 %tmp0_v8.i.i.i to i8*
  store i8 %39, i8* %47, align 1
  %48 = load i32, i32* %32, align 4
  %tmp0_v12.i.i.i = add i32 %48, 1
...
Func_remove_consecutive_spaces.exit:              ; preds = %BB_804930A.i.i, %.exit
  %r_ecx.0.lcssa.i = phi i32 [ %tmp2_v.i17.i, %.exit ], [ %r_ecx.1.i, %BB_804930A.i.i ]
  %49 = load i32, i32* %32, align 4
  %50 = load i32, i32* %21, align 16
  %tmp0_v3.i18.i.i = add i32 %50, %49
  %51 = inttoptr i32 %tmp0_v3.i18.i.i to i8*
  store i8 0, i8* %51, align 1
  %52 = load i32, i32* %25, align 4
  %53 = load i32, i32* %24, align 8
  %tmp2_v.i11.i = add i32 %53, -49
  store i32 %tmp2_v.i11.i, i32* %20, align 4
  %tmp2_v3.i14.i = add i32 %52, -8170
  store i32 %tmp2_v3.i14.i, i32* %21, align 16
