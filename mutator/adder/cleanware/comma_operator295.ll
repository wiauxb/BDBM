...
Func_80492E5.exit.i:
  ...
  %spi293 = ptrtoint[7 x i8]* @str.293 to i32
  store i32 %spi293, i32* %11, align 16
  ...
  %spi292 = ptrtoint[13 x i8]* @str.292 to i32
  store i32 %spi292, i32* %11, align 16
  ...
  %spi291 = ptrtoint[15 x i8]* @str.291 to i32
  store i32 %spi291, i32* %11, align 16
  ...
  %spi290 = ptrtoint[34 x i8]* @str.290 to i32
  store i32 %spi290, i32* %29, align 16
  %spi289 = ptrtoint[34 x i8]* @str.289 to i32
  store i32 %spi289, i32* %11, align 16
...
BB_8049385.i:                                     ; preds = %BB_804935F.i, %Func_80492E5.exit.i
  ...
  %spi288 = ptrtoint[12 x i8]* @str.288 to i32
  store i32 %spi288, i32* %50, align 8
  %spi287 = ptrtoint[12 x i8]* @str.287 to i32
  store i32 %spi287, i32* %11, align 16
