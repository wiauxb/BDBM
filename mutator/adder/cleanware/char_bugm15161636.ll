...
define internal fastcc void @char_bugm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_80492BB.exit.i:
  ...
  %tmp2_v5.i14.i = add i32 %tmp0_v.i.i, -172
  %10 = inttoptr i32 %tmp2_v5.i14.i to i32*
  store i32 134520840, i32* %10, align 4
  %tmp2_v7.i.i = add i32 %tmp0_v.i.i, -176
  %11 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 134520842, i32* %11, align 16
  %tmp2_v8.i16.i = add i32 %tmp0_v.i.i, -180
  %12 = inttoptr i32 %tmp2_v8.i16.i to i32*
  ...
  %tmp2_v.i20.i = add i32 %tmp0_v.i.i, -156
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @char_bugm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
