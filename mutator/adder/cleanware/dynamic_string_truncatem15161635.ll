...
define internal fastcc void @dynamic_string_truncatem15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v.i4.i = add i32 %tmp0_v.i21.i, -20
  ...
  %tmp2_v4.i.i = add i32 %10, 8
  %14 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 544108320, i32* %14, align 4
  %tmp2_v5.i5.i = add i32 %10, 12
  %15 = inttoptr i32 %tmp2_v5.i5.i to i32*
  ...
  %tmp2_v7.i.i = add i32 %10, 20
  %17 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 3040622, i32* %17, align 4
  %18 = load i32, i32* %11, align 4
  %tmp2_v11.i.i = add i32 %tmp0_v.i21.i, -44
  %19 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 %18, i32* %19, align 4
  store i32 134520840, i32* %8, align 16
  store i32 134517349, i32* %9, align 4
  %20 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i20.i, i32 inreg noundef 0, i32 noundef %tmp2_v.i17.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  store i32 8, i32* %19, align 4
  %21 = load i32, i32* %11, align 4
  store i32 %21, i32* %8, align 16
  store i32 134517365, i32* %9, align 4
  %tmp2_v.i2.i.i = add i32 %tmp0_v.i21.i, -56
  %22 = inttoptr i32 %tmp2_v.i2.i.i to i32*
  store i32 %tmp2_v4.i24.i, i32* %22, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i21.i, -60
  %23 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 134529024, i32* %23, align 4
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i21.i, -68
  ...
  %tmp2_v.i32.i = add i32 %35, -12
  %36 = inttoptr i32 %tmp2_v.i32.i to i32*
  store i32 %33, i32* %36, align 4
  store i32 %33, i32* %19, align 4
  %tmp2_v5.i39.i = add i32 %34, -8165
  store i32 %tmp2_v5.i39.i, i32* %8, align 16
  store i32 134517389, i32* %9, align 4
  %37 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %25, i32 inreg noundef %tmp0_v7.i.i.i, i32 noundef %tmp2_v.i17.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @dynamic_string_truncatem15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
