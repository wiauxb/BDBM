...
define internal fastcc void @shuffle_array307(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %4 = inttoptr i32 %tmp2_v4.i45.i to i32*
  store i32 0, i32* %4, align 8
  %tmp2_v5.i47.i = add i32 %tmp0_v.i42.i, -12
  %5 = inttoptr i32 %tmp2_v5.i47.i to i32*
  store i32 0, i32* %5, align 4
  %tmp2_v6.i49.i = add i32 %tmp0_v.i42.i, -16
  %6 = inttoptr i32 %tmp2_v6.i49.i to i32*
  store i32 %tmp2_v.i41.i, i32* %6, align 16
  %tmp2_v8.i51.i = add i32 %tmp0_v.i42.i, -244
  %7 = inttoptr i32 %tmp2_v8.i51.i to i32*
  store i32 134517300, i32* %7, align 4
  %tmp4_v.i68.i.b = load i1, i1* @segs.0, align 1
  %8 = inttoptr i32 %arg_esp to i32*
  %9 = load i32, i32* %8, align 4
  %tmp2_v2.i72.i = add i32 %tmp0_v.i42.i, -20
  %10 = inttoptr i32 %tmp2_v2.i72.i to i32*
  store i32 %9, i32* %10, align 4
  %tmp2_v3.i73.i = add i32 %tmp0_v.i42.i, -236
  %11 = inttoptr i32 %tmp2_v3.i73.i to i32*
  %tmp2_v4.i.i = add i32 %tmp0_v.i42.i, -228
...
BB_8049251.i:                                     ; preds = %BB_8049251.i, %0
  ...
  %tmp2_v5.i.i = add i32 %tmp2_v4.i.i, %tmp4_v.i.i
...
BB_8049297.i:                                     ; preds = %Func_shuffle.exit, %BB_8049297.i
  %r_edx.110 = phi i32 [ %r_edx.0.lcssa.i, %Func_shuffle.exit ], [ %20, %BB_8049297.i ]
  %storemerge19 = phi i32 [ 0, %Func_shuffle.exit ], [ %tmp0_v2.i.i, %BB_8049297.i ]
  %tmp4_v.i10.i = shl i32 %storemerge19, 2
  %tmp2_v2.i11.i = add i32 %tmp2_v1.i9.i, %tmp4_v.i10.i
  %15 = inttoptr i32 %tmp2_v2.i11.i to i32*
  %16 = load i32, i32* %15, align 4
  store i32 %16, i32* %70, align 8
  %17 = load i32, i32* %69, align 4
  store i32 %17, i32* %71, align 4
  store i32 %tmp2_v9.i18.i, i32* %24, align 16
  store i32 134517434, i32* %72, align 4
  %18 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %r_ecx.0.lcssa.i, i32 inreg noundef %r_edx.110, i32 noundef %tmp2_v2.i64.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %19 = lshr i64 %18, 32
  %20 = trunc i64 %19 to i32
  %21 = load i32, i32* %69, align 4
  %tmp0_v2.i.i = add i32 %21, 1
  store i32 %tmp0_v2.i.i, i32* %69, align 4
  %22 = icmp slt i32 %tmp0_v2.i.i, 52
  br i1 %22, label %BB_8049297.i, label %.exit

BB_8049277.i:                                     ; preds = %BB_8049251.i
  %tmp2_v.i61.i = add i32 %tmp0_v.i42.i, -252
  %23 = inttoptr i32 %tmp2_v.i61.i to i32*
  store i32 52, i32* %23, align 4
  %tmp2_v2.i64.i = add i32 %tmp0_v.i42.i, -256
  %24 = inttoptr i32 %tmp2_v2.i64.i to i32*
  store i32 %tmp2_v4.i.i, i32* %24, align 16
  %tmp2_v3.i65.i = add i32 %tmp0_v.i42.i, -260
  %25 = inttoptr i32 %tmp2_v3.i65.i to i32*
  store i32 134517384, i32* %25, align 4
  %tmp2_v.i23.i.i = add i32 %tmp0_v.i42.i, -264
  %26 = inttoptr i32 %tmp2_v.i23.i.i to i32*
  store i32 %tmp2_v4.i45.i, i32* %26, align 8
  %tmp2_v1.i25.i.i = add i32 %tmp0_v.i42.i, -268
  %27 = inttoptr i32 %tmp2_v1.i25.i.i to i32*
  store i32 134529024, i32* %27, align 4
  %tmp2_v2.i28.i.i = add i32 %tmp0_v.i42.i, -292
  %28 = inttoptr i32 %tmp2_v2.i28.i.i to i32*
  store i32 134517501, i32* %28, align 4
  %tmp2_v.i15.i.i = add i32 %tmp0_v.i42.i, -304
  %29 = inttoptr i32 %tmp2_v.i15.i.i to i32*
  store i32 0, i32* %29, align 16
  %tmp2_v2.i16.i.i = add i32 %tmp0_v.i42.i, -308
  %30 = inttoptr i32 %tmp2_v2.i16.i.i to i32*
  ...
  %tmp2_v.i32.i.i = add i32 %tmp0_v.i42.i, -284
  %32 = inttoptr i32 %tmp2_v.i32.i.i to i32*
...
BB_8049325.i.lr.ph.i:                             ; preds = %BB_8049277.i
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i42.i, -280
  %35 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  %tmp2_v10.i.i.i = add i32 %tmp0_v.i42.i, -276
...
BB_8049325.i.i:                                   ; preds = %BB_8049325.i.i, %BB_8049325.i.lr.ph.i
  ...
  %tmp0_v.i3.i.i = ashr i32 %37, 31
  %38 = load i32, i32* %23, align 4
  %39 = zext i32 %37 to i64
  %40 = zext i32 %tmp0_v.i3.i.i to i64
...
Func_shuffle.exit:                                ; preds = %BB_8049325.i.i, %BB_8049277.i
  %r_ecx.0.lcssa.i = phi i32 [ %tmp2_v.i41.i, %BB_8049277.i ], [ %tmp4_v19.i.i.i, %BB_8049325.i.i ]
  ...
  %tmp2_v.i34.i = add i32 %68, -224
  %69 = inttoptr i32 %tmp2_v.i34.i to i32*
  %tmp2_v1.i9.i = add i32 %68, -220
  %tmp2_v5.i15.i = add i32 %tmp0_v.i42.i, -248
  %70 = inttoptr i32 %tmp2_v5.i15.i to i32*
  %tmp2_v8.i.i = add i32 %tmp0_v.i42.i, -252
  %71 = inttoptr i32 %tmp2_v8.i.i to i32*
  %tmp2_v9.i18.i = add i32 %67, -8184
  %tmp2_v11.i.i = add i32 %tmp0_v.i42.i, -260
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @shuffle_array307(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
