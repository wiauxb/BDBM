...
@str.183 = constant [9 x i8] c"min: %d\0a\00"
...
define internal fastcc { i32, i32, i32, i32 } @Func_min(i32 %arg_esp, i32 %arg_ebp) unnamed_addr  nofree nosync nounwind  !retregs !12 {
Func_8049283.exit.i:
  %tmp2_v.i41.i = add i32 %arg_esp, -4
  %0 = inttoptr i32 %tmp2_v.i41.i to i32*
  store i32 %arg_ebp, i32* %0, align 4
  %tmp2_v1.i44.i = add i32 %arg_esp, -32
  %1 = inttoptr i32 %tmp2_v1.i44.i to i32*
  store i32 134517379, i32* %1, align 4
  %tmp2_v.i35.i = add i32 %arg_esp, 8
  %2 = inttoptr i32 %tmp2_v.i35.i to i32*
  %3 = load i32, i32* %2, align 4
  %.not.i38.i = icmp eq i32 %3, 1
  br i1 %.not.i38.i, label %BB_804928E.i, label %BB_80492A6.i
...
BB_80492A6.i:                                     ; preds = %Func_8049283.exit.i
  ...
  %9 = tail call fastcc { i32, i32, i32, i32 } @Func_min(i32 %tmp2_v7.i.i, i32 %tmp2_v.i41.i)
  %10 = extractvalue { i32, i32, i32, i32 } %9, 1
  %11 = extractvalue { i32, i32, i32, i32 } %9, 3
  %tmp2_v.i9.i = add i32 %11, -12
  %12 = inttoptr i32 %tmp2_v.i9.i to i32*
  store i32 %10, i32* %12, align 4
  %tmp2_v1.i.i = add i32 %11, 12
  %13 = inttoptr i32 %tmp2_v1.i.i to i32*
  %14 = load i32, i32* %13, align 4
  %tmp0_v3.i11.i = shl i32 %14, 2
  %tmp4_v.i12.i = add i32 %tmp0_v3.i11.i, -4
  %tmp2_v4.i13.i = add i32 %11, 8
  %15 = inttoptr i32 %tmp2_v4.i13.i to i32*
  %16 = load i32, i32* %15, align 4
  %tmp0_v6.i15.i = add i32 %tmp4_v.i12.i, %16
  %17 = inttoptr i32 %tmp0_v6.i15.i to i32*
  %18 = load i32, i32* %17, align 4
  %.not.i.i = icmp slt i32 %10, %18
  %spec.select = select i1 %.not.i.i, i32* %12, i32* %17
  %.pre = inttoptr i32 %11 to i32*
  br label %.exit

BB_804928E.i:                                     ; preds = %Func_8049283.exit.i
  %tmp2_v2.i28.i = add i32 %arg_esp, 4
  %19 = inttoptr i32 %tmp2_v2.i28.i to i32*
...
.exit:                                            ; preds = %BB_804928E.i, %BB_80492A6.i
  %tmp4_v2.i.i.pre-phi = phi i32 [ %tmp2_v4.i13.i, %BB_80492A6.i ], [ %.pre19, %BB_804928E.i ]
  %.pre-phi = phi i32* [ %.pre, %BB_80492A6.i ], [ %0, %BB_804928E.i ]
  %r_edx.0 = phi i32 [ %tmp4_v.i12.i, %BB_80492A6.i ], [ 0, %BB_804928E.i ]
...
define internal fastcc void @find_min_recursive184(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !13 {
.exit:
  ...
  %tmp2_v17.i.i = add i32 %tmp0_v.i15.i, -76
  %21 = inttoptr i32 %tmp2_v17.i.i to i32*
  store i32 10, i32* %21, align 4
  %tmp2_v19.i.i = add i32 %tmp0_v.i15.i, -80
  %22 = inttoptr i32 %tmp2_v19.i.i to i32*
  store i32 %tmp2_v3.i26.i, i32* %22, align 16
  %tmp2_v20.i.i = add i32 %tmp0_v.i15.i, -84
  %23 = inttoptr i32 %tmp2_v20.i.i to i32*
  store i32 134517310, i32* %23, align 4
  %24 = tail call fastcc { i32, i32, i32, i32 } @Func_min(i32 %tmp2_v20.i.i, i32 %tmp2_v4.i16.i)
  %25 = extractvalue { i32, i32, i32, i32 } %24, 0
  %26 = extractvalue { i32, i32, i32, i32 } %24, 1
  %27 = extractvalue { i32, i32, i32, i32 } %24, 2
  %tmp2_v.i.i = add i32 %25, 4
  %28 = inttoptr i32 %tmp2_v.i.i to i32*
  store i32 %26, i32* %28, align 4
  %29 = inttoptr i32 %25 to i32*
  %spi183 = ptrtoint[9 x i8]* @str.183 to i32
  store i32 %spi183, i32* %29, align 4
  %tmp2_v4.i.i = add i32 %25, -4
  %30 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 134517329, i32* %30, align 4
  %31 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i14.i, i32 inreg noundef %27, i32 noundef %25, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  ret void
}
...
!14 = !{!"printf"}
  ...
  tail call fastcc void @find_min_recursive184(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
