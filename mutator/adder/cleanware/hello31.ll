...
@str.29 = constant [12 x i8] c"Hello World\00"
...
define internal fastcc void @hello31(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
  ...
  %spi29 = ptrtoint[12 x i8]* @str.29 to i32
  store i32 %spi29, i32* %8, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @hello31(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
