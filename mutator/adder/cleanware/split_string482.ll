...
define internal fastcc void @split_string482(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
.exit:
  ...
  %tmp2_v8.i16.i = add i32 %tmp0_v.i9.i, -260
...
BB_804931F.i.i:                                   ; preds = %BB_804930C.i.i, %BB_804931F.i.i
  %storemerge1923.i = phi i32 [ %tmp0_v14.i28.i.i, %BB_804931F.i.i ], [ %51, %BB_804930C.i.i ]
  %41 = load i32, i32* %20, align 16
  %tmp2_v3.i.i.i = add i32 %41, %storemerge1923.i
  %42 = load i32, i32* %19, align 4
  %tmp0_v7.i25.i.i = sub i32 %storemerge1923.i, %42
  %43 = load i32, i32* %6, align 4
  %tmp0_v10.i.i.i = add i32 %tmp0_v7.i25.i.i, %43
  %44 = inttoptr i32 %tmp2_v3.i.i.i to i8*
  %45 = load i8, i8* %44, align 1
  %46 = inttoptr i32 %tmp0_v10.i.i.i to i8*
  store i8 %45, i8* %46, align 1
  %47 = load i32, i32* %52, align 8
  %tmp0_v14.i28.i.i = add i32 %47, 1
  store i32 %tmp0_v14.i28.i.i, i32* %52, align 8
  %48 = load i32, i32* %29, align 4
  %.not.i49.i.i = icmp sgt i32 %tmp0_v14.i28.i.i, %48
  br i1 %.not.i49.i.i, label %Func_string_split.exit, label %BB_804931F.i.i

BB_804930C.i.i:                                   ; preds = %BB_80492EB.i.i, %.exit
  %.lcssa.i = phi i32 [ %31, %.exit ], [ %39, %BB_80492EB.i.i ]
  %49 = load i32, i32* %18, align 8
  %tmp0_v3.i39.i.i = add i32 %49, %.lcssa.i
  %50 = inttoptr i32 %tmp0_v3.i39.i.i to i8*
  store i8 0, i8* %50, align 1
  %51 = load i32, i32* %19, align 4
  %tmp2_v6.i42.i.i = add i32 %tmp0_v.i9.i, -296
  %52 = inttoptr i32 %tmp2_v6.i42.i.i to i32*
  store i32 %51, i32* %52, align 8
  %53 = load i32, i32* %29, align 4
  %.not.i49.i22.i = icmp sgt i32 %51, %53
  br i1 %.not.i49.i22.i, label %Func_string_split.exit, label %BB_804931F.i.i

Func_string_split.exit:                           ; preds = %BB_804930C.i.i, %BB_804931F.i.i
  %54 = load i32, i32* %22, align 8
  %tmp2_v.i21.i = add i32 %54, -212
  store i32 %tmp2_v.i21.i, i32* %20, align 16
  ...
  %tmp2_v.i35.i = add i32 %54, -112
  store i32 %tmp2_v.i35.i, i32* %20, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @split_string482(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
