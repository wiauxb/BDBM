...
define internal fastcc void @direct_vs_indirect_recursionm15161636(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %tmp2_v.i23.i = add i32 %tmp0_v.i6.i, -48
  %8 = inttoptr i32 %tmp2_v.i23.i to i32*
  store i32 4, i32* %8, align 16
  %tmp2_v2.i24.i = add i32 %tmp0_v.i6.i, -52
  %9 = inttoptr i32 %tmp2_v2.i24.i to i32*
  store i32 134517185, i32* %9, align 4
  %10 = tail call fastcc { i32, i32, i32, i32 } @Func_sum_integers(i32 %tmp2_v2.i24.i, i32 %tmp2_v4.i.i)
  ...
  %tmp2_v.i13.i = add i32 %14, -12
  %15 = inttoptr i32 %tmp2_v.i13.i to i32*
  store i32 %12, i32* %15, align 4
  %tmp2_v4.i16.i = add i32 %11, 4
  %16 = inttoptr i32 %tmp2_v4.i16.i to i32*
  store i32 %12, i32* %16, align 4
  %17 = inttoptr i32 %11 to i32*
  store i32 134520840, i32* %17, align 4
  ...
  %25 = tail call fastcc i32 @Func_print_even(i32 %tmp2_v3.i.i.i, i32 %tmp2_v.i.i.i, i32 134529024, i32 %tmp2_v.i5.i)  nounwind 
  ret void
}

; Function Attrs: nounwind
define internal fastcc i32 @Func_print_even(i32 %arg_esp, i32 %arg_ebp, i32 %arg_ebx, i32 %arg_ecx) unnamed_addr  nounwind  !retregs !14 {
Func_8049281.exit.i:
...
BB_804928C.i:                                     ; preds = %Func_8049281.exit.i
  %tmp2_v2.i19.i = add i32 %arg_esp, -24
  ...
  %tmp2_v5.i21.i = add i32 %arg_esp, -32
  %8 = inttoptr i32 %tmp2_v5.i21.i to i32*
  ...
  %tmp0_v2.i9.i = add i32 %10, -1
  store i32 %tmp0_v2.i9.i, i32* %7, align 4
  store i32 134517426, i32* %8, align 4
  %tmp2_v.i1.i.i = add i32 %arg_esp, -36
  %11 = inttoptr i32 %tmp2_v.i1.i.i to i32*
  store i32 %tmp2_v.i11.i, i32* %11, align 4
  ...
  %tmp2_v2.i9.i.i = add i32 %arg_esp, -56
  %15 = inttoptr i32 %tmp2_v2.i9.i.i to i32*
  store i32 %14, i32* %15, align 4
  %tmp2_v4.i.i.i = add i32 %arg_esp, -60
  %16 = inttoptr i32 %tmp2_v4.i.i.i to i32*
  store i32 134520860, i32* %16, align 4
  %tmp2_v5.i.i.i = add i32 %arg_esp, -64
  %17 = inttoptr i32 %tmp2_v5.i.i.i to i32*
  ...
  %tmp0_v2.i21.i.i = add i32 %19, -1
  store i32 %tmp0_v2.i21.i.i, i32* %16, align 4
  store i32 134517500, i32* %17, align 4
  %20 = tail call fastcc i32 @Func_print_even(i32 %tmp2_v5.i.i.i, i32 %tmp2_v.i1.i.i, i32 134529024, i32 %arg_ecx)
...
define internal fastcc { i32, i32, i32, i32 } @Func_sum_integers(i32 %arg_esp, i32 %arg_ebp) unnamed_addr  nofree nosync nounwind  !retregs !15 {
Func_8049207.exit.i:
...
!13 = !{!"printf"}
!14 = !{i32 0, i32 1, i32 0, i32 0}
!15 = !{i32 0, i32 2, i32 3}

  tail call fastcc void @direct_vs_indirect_recursionm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
