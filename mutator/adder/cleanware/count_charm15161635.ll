...
define internal fastcc { i32, i32, i32, i32, i32 } @Func_count_char(i32 %arg_esp, i32 %arg_ebp, i32 %arg_ebx) unnamed_addr  norecurse  !retregs !12 {
  ...
  %1 = inttoptr i32 %tmp2_v.i6.i to i32*
  ...
  %tmp2_v2.i10.i = add i32 %arg_esp, -48
  %3 = inttoptr i32 %tmp2_v2.i10.i to i32*
  store i32 134517422, i32* %3, align 4
  %tmp2_v.i48.i = add i32 %arg_esp, 8
  %4 = inttoptr i32 %tmp2_v.i48.i to i32*
  %5 = load i32, i32* %4, align 4
  %tmp2_v2.i50.i = add i32 %arg_esp, -32
  %6 = trunc i32 %5 to i8
  %7 = inttoptr i32 %tmp2_v2.i50.i to i8*
  store i8 %6, i8* %7, align 1
  %tmp2_v4.i53.i = add i32 %arg_esp, 4
  %8 = inttoptr i32 %tmp2_v4.i53.i to i32*
  %9 = load i32, i32* %8, align 4
  %tmp2_v6.i.i = add i32 %arg_esp, -60
  %10 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 %9, i32* %10, align 4
  %tmp2_v7.i54.i = add i32 %arg_esp, -64
  %11 = inttoptr i32 %tmp2_v7.i54.i to i32*
  ...
  %14 = inttoptr i32 %tmp2_v1.i4.i to i32*
  store i32 0, i32* %14, align 4
  %tmp2_v2.i.i = add i32 %arg_esp, -20
  %15 = inttoptr i32 %tmp2_v2.i.i to i32*
...
BB_80492DC.i:                                     ; preds = %BB_80492F0.i, %0
  %storemerge20 = phi i32 [ %tmp0_v1.i.i, %BB_80492F0.i ], [ 0, %0 ]
  %18 = load i32, i32* %8, align 4
  %tmp0_v3.i16.i = add i32 %18, %storemerge20
  %19 = inttoptr i32 %tmp0_v3.i16.i to i8*
  %20 = load i8, i8* %19, align 1
  %tmp0_v4.i17.i = zext i8 %20 to i32
  %21 = load i8, i8* %7, align 1
  %tmp0_v6.i.i = zext i8 %21 to i32
  %cc_dst_v.i.i = sub nsw i32 %tmp0_v6.i.i, %tmp0_v4.i17.i
  %tmp4_v.i18.i = and i32 %cc_dst_v.i.i, 255
  %.not.i.i = icmp eq i32 %tmp4_v.i18.i, 0
  br i1 %.not.i.i, label %BB_80492EC.i, label %BB_80492F0.i

BB_80492F0.i:                                     ; preds = %BB_80492EC.i, %BB_80492DC.i
  %22 = phi i32 [ %storemerge20, %BB_80492DC.i ], [ %.pre, %BB_80492EC.i ]
  %tmp0_v1.i.i = add i32 %22, 1
  store i32 %tmp0_v1.i.i, i32* %15, align 4
  %23 = load i32, i32* %13, align 4
  %24 = icmp slt i32 %tmp0_v1.i.i, %23
  br i1 %24, label %BB_80492DC.i, label %.exit

BB_80492EC.i:                                     ; preds = %BB_80492DC.i
  %25 = load i32, i32* %14, align 4
  %tmp0_v1.i36.i = add i32 %25, 1
  store i32 %tmp0_v1.i36.i, i32* %14, align 4
...
.exit:                                            ; preds = %BB_80492F0.i, %0
  ...
  %mrv = insertvalue { i32, i32, i32, i32, i32 } undef, i32 %tmp2_v4.i53.i, 0
...
; Function Attrs: norecurse
define internal fastcc void @count_charm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !13 {
.exit:
  ...
  %tmp2_v8.i23.i = add i32 %tmp0_v.i.i, -24
  ...
  store i32 %tmp2_v3.i19.i, i32* %17, align 16
  %tmp2_v13.i.i = add i32 %tmp0_v.i.i, -84
  %18 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 134517306, i32* %18, align 4
  %19 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_count_char(i32 %tmp2_v13.i.i, i32 %tmp2_v4.i.i, i32 134529024)
  ...
  %tmp2_v.i39.i = add i32 %23, -44
  %25 = inttoptr i32 %tmp2_v.i39.i to i32*
  store i32 %21, i32* %25, align 4
  %tmp2_v4.i44.i = add i32 %20, 4
  %26 = inttoptr i32 %tmp2_v4.i44.i to i32*
  store i32 %21, i32* %26, align 4
  %tmp2_v5.i46.i = add i32 %24, -8184
  %27 = inttoptr i32 %20 to i32*
  store i32 %tmp2_v5.i46.i, i32* %27, align 4
  %tmp2_v7.i47.i = add i32 %20, -4
  %28 = inttoptr i32 %tmp2_v7.i47.i to i32*
  store i32 134517330, i32* %28, align 4
  %29 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %22, i32 noundef %20, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  ...
  %30 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_count_char(i32 %tmp2_v7.i47.i, i32 %23, i32 %24)
  ...
  %tmp2_v.i28.i = add i32 %34, -40
  %36 = inttoptr i32 %tmp2_v.i28.i to i32*
  store i32 %32, i32* %36, align 4
  %tmp2_v4.i32.i = add i32 %31, 4
  %37 = inttoptr i32 %tmp2_v4.i32.i to i32*
  store i32 %32, i32* %37, align 4
  %tmp2_v5.i34.i = add i32 %35, -8171
  %38 = inttoptr i32 %31 to i32*
  store i32 %tmp2_v5.i34.i, i32* %38, align 4
  %tmp2_v7.i35.i = add i32 %31, -4
  %39 = inttoptr i32 %tmp2_v7.i35.i to i32*
  store i32 134517371, i32* %39, align 4
  %40 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %33, i32 noundef %31, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  ret void
}
...
!14 = !{!"printf"}
  ...
  tail call fastcc void @count_charm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
