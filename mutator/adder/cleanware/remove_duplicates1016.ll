...
define internal fastcc void @remove_duplicates1016(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v8.i44.i = add i32 %tmp0_v.i36.i, -84
...
BB_804934C.i.lr.ph.i:                             ; preds = %0
  %tmp2_v.i50.i.i = add i32 %tmp0_v.i36.i, -129
  %38 = inttoptr i32 %tmp2_v.i50.i.i to i8*
  %tmp2_v1.i51.i.i = add i32 %tmp0_v.i36.i, -116
  %39 = inttoptr i32 %tmp2_v1.i51.i.i to i32*
  br label %BB_804934C.i.i

BB_8049389.i.i:                                   ; preds = %BB_8049359.i.i
  store i32 %tmp0_v1.i99.i.i, i32* %39, align 4
  %40 = load i32, i32* %34, align 4
  %41 = icmp slt i32 %tmp0_v1.i99.i.i, %40
  br i1 %41, label %BB_8049359.i.i, label %BB_8049391.i.i

BB_8049391.i.i:                                   ; preds = %BB_804934C.i.i, %BB_8049389.i.i
  %42 = phi i32 [ %54, %BB_804934C.i.i ], [ %40, %BB_8049389.i.i ]
  %r_ecx.0.lcssa.i = phi i32 [ %r_ecx.341.i, %BB_804934C.i.i ], [ %tmp4_v7.i.i.i, %BB_8049389.i.i ]
  %.pr.i = load i8, i8* %38, align 1
  %43 = icmp eq i8 %.pr.i, 0
  br i1 %43, label %BB_80493BD.i.i, label %BB_8049397.i.i

BB_8049359.i.i:                                   ; preds = %BB_804934C.i.i, %BB_8049389.i.i
  %storemerge3140.i = phi i32 [ %tmp0_v1.i99.i.i, %BB_8049389.i.i ], [ 0, %BB_804934C.i.i ]
  %tmp4_v.i25.i.i = shl i32 %storemerge3140.i, 2
  %44 = load i32, i32* %33, align 16
  %tmp0_v3.i.i.i = add i32 %44, %tmp4_v.i25.i.i
  %45 = inttoptr i32 %tmp0_v3.i.i.i to i32*
  %46 = load i32, i32* %45, align 4
  %47 = load i32, i32* %35, align 8
  %tmp4_v7.i.i.i = shl i32 %47, 2
  %48 = load i32, i32* %24, align 16
  %tmp0_v10.i32.i.i = add i32 %48, %tmp4_v7.i.i.i
  %49 = inttoptr i32 %tmp0_v10.i32.i.i to i32*
  %50 = load i32, i32* %49, align 4
  %.not.i.i.i = icmp eq i32 %46, %50
  %tmp0_v1.i99.i.i = add nuw nsw i32 %storemerge3140.i, 1
  br i1 %.not.i.i.i, label %BB_8049391.i.thread.i, label %BB_8049389.i.i

BB_80493BD.i.i:                                   ; preds = %BB_8049397.i.i, %BB_8049391.i.thread.i, %BB_8049391.i.i
  %r_ecx.2.i = phi i32 [ %r_ecx.0.lcssa.i, %BB_8049391.i.i ], [ %tmp4_v6.i.i.i, %BB_8049397.i.i ], [ %tmp4_v7.i.i.i, %BB_8049391.i.thread.i ]
  ...
  br i1 %53, label %BB_804934C.i.i, label %Func_remove_duplicates.exit

BB_804934C.i.i:                                   ; preds = %BB_80493BD.i.i, %BB_804934C.i.lr.ph.i
  %r_ecx.341.i = phi i32 [ %tmp2_v.i35.i, %BB_804934C.i.lr.ph.i ], [ %r_ecx.2.i, %BB_80493BD.i.i ]
  store i8 1, i8* %38, align 1
  store i32 0, i32* %39, align 4
  %54 = load i32, i32* %34, align 4
  %55 = icmp sgt i32 %54, 0
  br i1 %55, label %BB_8049359.i.i, label %BB_8049391.i.i
...
BB_8049397.i.i:                                   ; preds = %BB_8049391.i.i
  ...
  %tmp4_v.i57.i.i = shl i32 %56, 2
  %57 = load i32, i32* %24, align 16
  %tmp0_v3.i60.i.i = add i32 %57, %tmp4_v.i57.i.i
  %tmp4_v6.i.i.i = shl i32 %42, 2
  %58 = load i32, i32* %33, align 16
  %tmp0_v9.i64.i.i = add i32 %58, %tmp4_v6.i.i.i
  %59 = inttoptr i32 %tmp0_v3.i60.i.i to i32*
  %60 = load i32, i32* %59, align 4
  %61 = inttoptr i32 %tmp0_v9.i64.i.i to i32*
  store i32 %60, i32* %61, align 4
  %62 = load i32, i32* %34, align 4
  %tmp0_v13.i.i.i = add i32 %62, 1
  store i32 %tmp0_v13.i.i.i, i32* %34, align 4
  br label %BB_80493BD.i.i

Func_remove_duplicates.exit:                      ; preds = %BB_80493BD.i.i, %0
  %r_ecx.3.lcssa.i = phi i32 [ %tmp2_v.i35.i, %0 ], [ %r_ecx.2.i, %BB_80493BD.i.i ]
  %63 = load i32, i32* %34, align 4
  %tmp0_v1.i82.i.i = shl i32 %63, 2
  %tmp2_v3.i85.i.i = add i32 %tmp0_v.i36.i, -156
  %64 = inttoptr i32 %tmp2_v3.i85.i.i to i32*
  store i32 %tmp0_v1.i82.i.i, i32* %64, align 4
  ...
  %tmp2_v.i32.i = add i32 %72, -56
  %73 = inttoptr i32 %tmp2_v.i32.i to i32*
  store i32 %70, i32* %73, align 4
  %tmp2_v1.i33.i = add i32 %72, -60
  %74 = inttoptr i32 %tmp2_v1.i33.i to i32*
  %tmp2_v.i24.i = add i32 %72, -64
  %75 = inttoptr i32 %tmp2_v.i24.i to i32*
...
Func_remove_duplicates.exit.BB_80492E3.i_crit_edge: ; preds = %Func_remove_duplicates.exit
  %.pre = add i32 %tmp0_v.i36.i, -100
  %.pre6 = inttoptr i32 %.pre to i32*
  br label %BB_80492E3.i

BB_80492B0.i.lr.ph:                               ; preds = %Func_remove_duplicates.exit
  %tmp2_v6.i62.i = add i32 %tmp0_v.i36.i, -88
  %78 = inttoptr i32 %tmp2_v6.i62.i to i32*
  %tmp2_v9.i64.i = add i32 %tmp0_v.i36.i, -92
  %79 = inttoptr i32 %tmp2_v9.i64.i to i32*
  %tmp2_v10.i66.i = add i32 %71, -8184
  %tmp2_v12.i68.i = add i32 %tmp0_v.i36.i, -100
  %80 = inttoptr i32 %tmp2_v12.i68.i to i32*
  br label %BB_80492B0.i

BB_80492E3.i:                                     ; preds = %BB_80492B0.i, %Func_remove_duplicates.exit.BB_80492E3.i_crit_edge
  %.pre-phi = phi i32* [ %.pre6, %Func_remove_duplicates.exit.BB_80492E3.i_crit_edge ], [ %80, %BB_80492B0.i ]
  %81 = load i32, i32* %73, align 4
  store i32 %81, i32* %24, align 16
...
BB_80492B0.i:                                     ; preds = %BB_80492B0.i, %BB_80492B0.i.lr.ph
  %storemerge4 = phi i32 [ 0, %BB_80492B0.i.lr.ph ], [ %tmp0_v2.i.i, %BB_80492B0.i ]
  %tmp4_v.i55.i = shl i32 %storemerge4, 2
  %82 = load i32, i32* %73, align 4
  %tmp0_v3.i58.i = add i32 %82, %tmp4_v.i55.i
  %83 = inttoptr i32 %tmp0_v3.i58.i to i32*
  %84 = load i32, i32* %83, align 4
  store i32 %84, i32* %78, align 8
  %85 = load i32, i32* %74, align 4
  store i32 %85, i32* %79, align 4
  store i32 %tmp2_v10.i66.i, i32* %24, align 16
  store i32 134517460, i32* %80, align 4
  %86 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %r_ecx.3.lcssa.i, i32 inreg noundef %tmp4_v.i55.i, i32 noundef %tmp2_v19.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %87 = load i32, i32* %74, align 4
  %tmp0_v2.i.i = add i32 %87, 1
  store i32 %tmp0_v2.i.i, i32* %74, align 4
  %88 = load i32, i32* %75, align 4
  %89 = icmp slt i32 %tmp0_v2.i.i, %88
  br i1 %89, label %BB_80492B0.i, label %BB_80492E3.i
}
