...
@str.605 = constant [4 x i8] c"%f\0a\00"
...
define internal fastcc void @volume_of_a_sphere606(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !18 {
  ...
  %tmp2_v4.i4.i = add i32 %tmp0_v.i.i, -36
  %10 = inttoptr i32 %tmp2_v4.i4.i to i32*
  store i32 134517193, i32* %10, align 4
  %tmp2_v.i.i.i = add i32 %tmp0_v.i.i, -40
  %11 = inttoptr i32 %tmp2_v.i.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %11, align 8
  ...
  %tmp5_v.i16.i = tail call fastcc i64 @helper_fstl_ST0()
  %23 = inttoptr i32 %tmp2_v3.i.i.i to i64*
  store i64 %tmp5_v.i16.i, i64* %23, align 4
  tail call fastcc void @helper_fpop()
  %spi605 = ptrtoint[4 x i8]* @str.605 to i32
  store i32 %spi605, i32* %13, align 16
  store i32 134517218, i32* %10, align 4
  %24 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %17, i32 noundef %tmp2_v1.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  ret void
}
...
!19 = !{!"printf"}
  ...
  tail call fastcc void @volume_of_a_sphere606(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
