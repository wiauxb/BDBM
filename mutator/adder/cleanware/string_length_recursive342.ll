...
@str.341 = constant [12 x i8] c"length: %d\0a\00"
...
BB_804925B.i:                                     ; preds = %Func_8049245.exit.i
  ...
  %8 = tail call fastcc { i32, i32, i32 } @Func_string_length(i32 %tmp2_v4.i.i, i32 %tmp2_v.i6.i)
  %9 = extractvalue { i32, i32, i32 } %8, 1
  %10 = extractvalue { i32, i32, i32 } %8, 2
  %tmp0_v.i.i = add i32 %9, 1
...
.exit:                                            ; preds = %BB_804925B.i, %Func_8049245.exit.i
  ...
  %r_ebp.0 = phi i32 [ %tmp2_v.i6.i, %Func_8049245.exit.i ], [ %10, %BB_804925B.i ]
  %r_eax.0 = phi i32 [ 0, %Func_8049245.exit.i ], [ %tmp0_v.i.i, %BB_804925B.i ]
...
define internal fastcc void @string_length_recursive342(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !13 {
.exit:
  ...
  %tmp2_v4.i5.i = add i32 %15, 4
  %19 = inttoptr i32 %tmp2_v4.i5.i to i32*
  store i32 %16, i32* %19, align 4
  %20 = inttoptr i32 %15 to i32*
  %spi341 = ptrtoint[12 x i8]* @str.341 to i32
  store i32 %spi341, i32* %20, align 4
  %tmp2_v7.i.i = add i32 %15, -4
  %21 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 134517267, i32* %21, align 4
  %22 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef 0, i32 noundef %15, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  ret void
}
...
!14 = !{!"printf"}
  ...
  tail call fastcc void @string_length_recursive342(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
