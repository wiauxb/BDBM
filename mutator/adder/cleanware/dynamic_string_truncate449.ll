...
@str.448 = constant [19 x i8] c"before string: %s\0a\00"
...
define internal fastcc void @dynamic_string_truncate449(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v.i46.i = add i32 %tmp0_v.i.i, -48
  %8 = inttoptr i32 %tmp2_v.i46.i to i32*
  store i32 25, i32* %8, align 16
  %tmp2_v2.i47.i = add i32 %tmp0_v.i.i, -52
  ...
  %tmp2_v.i26.i = add i32 %tmp0_v.i.i, -20
  %11 = inttoptr i32 %tmp2_v.i26.i to i32*
  store i32 %10, i32* %11, align 4
  %12 = inttoptr i32 %10 to i32*
  store i32 1998615625, i32* %12, align 4
  %tmp2_v3.i29.i = add i32 %10, 4
  %13 = inttoptr i32 %tmp2_v3.i29.i to i32*
  store i32 1936421487, i32* %13, align 4
  %tmp2_v4.i30.i = add i32 %10, 8
  %14 = inttoptr i32 %tmp2_v4.i30.i to i32*
  store i32 544108320, i32* %14, align 4
  %tmp2_v5.i31.i = add i32 %10, 12
  %15 = inttoptr i32 %tmp2_v5.i31.i to i32*
  store i32 1830844781, i32* %15, align 4
  %tmp2_v6.i32.i = add i32 %10, 16
  %16 = inttoptr i32 %tmp2_v6.i32.i to i32*
  store i32 1768448865, i32* %16, align 4
  %tmp2_v7.i33.i = add i32 %10, 20
  %17 = inttoptr i32 %tmp2_v7.i33.i to i32*
  store i32 3040622, i32* %17, align 4
  %18 = load i32, i32* %11, align 4
  %tmp2_v11.i.i = add i32 %tmp0_v.i.i, -44
  %19 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 %18, i32* %19, align 4
  %spi448 = ptrtoint[19 x i8]* @str.448 to i32
  store i32 %spi448, i32* %8, align 16
  store i32 134517349, i32* %9, align 4
  %20 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef 0, i32 noundef %tmp2_v.i46.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ...
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i.i, -60
  ...
  %tmp2_v.i9.i = add i32 %35, -12
  %36 = inttoptr i32 %tmp2_v.i9.i to i32*
  store i32 %33, i32* %36, align 4
  store i32 %33, i32* %19, align 4
  %tmp2_v5.i15.i = add i32 %34, -8165
  store i32 %tmp2_v5.i15.i, i32* %8, align 16
  store i32 134517389, i32* %9, align 4
  %37 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %25, i32 inreg noundef %tmp0_v7.i.i.i, i32 noundef %tmp2_v.i46.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @dynamic_string_truncate449(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
