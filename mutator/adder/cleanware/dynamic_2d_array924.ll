...
define internal fastcc void @dynamic_2d_array924(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
  ...
  %tmp2_v7.i26.i = add i32 %tmp0_v.i18.i, -20
  %7 = inttoptr i32 %tmp2_v7.i26.i to i32*
  ...
  %tmp2_v.i3.i = add i32 %tmp0_v.i18.i, -44
  %9 = inttoptr i32 %tmp2_v.i3.i to i32*
  store i32 3, i32* %9, align 4
  %tmp2_v1.i.i = add i32 %tmp0_v.i18.i, -40
  %10 = inttoptr i32 %tmp2_v1.i.i to i32*
  store i32 3, i32* %10, align 8
  %11 = load i32, i32* %9, align 4
  %tmp0_v4.i4.i = shl i32 %11, 2
  %tmp2_v6.i.i = add i32 %tmp0_v.i18.i, -80
  %12 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 %tmp0_v4.i4.i, i32* %12, align 16
  ...
  %mrv.i = insertvalue { i32, i32 } undef, i32 %tmp2_v6.i.i, 0
  %tmp2_v.i38.i = add i32 %tmp0_v.i18.i, -36
  %15 = inttoptr i32 %tmp2_v.i38.i to i32*
  store i32 %14, i32* %15, align 4
  %tmp2_v1.i40.i = add i32 %tmp0_v.i18.i, -52
  %16 = inttoptr i32 %tmp2_v1.i40.i to i32*
...
BB_8049234.i:                                     ; preds = %BB_8049204.i, %0
  ...
  %tmp2_v.i15.i = add i32 %tmp0_v.i18.i, -48
  %19 = inttoptr i32 %tmp2_v.i15.i to i32*
  store i32 0, i32* %19, align 16
  %20 = load i32, i32* %9, align 4
  %21 = icmp sgt i32 %20, 0
  %22 = inttoptr i32 %r_esp.1.in.le to i32*
  %tmp2_v7.i90.i = add i32 %r_esp.1.in.le, -4
  %23 = inttoptr i32 %tmp2_v7.i90.i to i32*
  br i1 %21, label %BB_804923D.i, label %.exit

BB_8049204.i:                                     ; preds = %BB_8049204.i, %0
  %r_esp.1.in11 = phi i32 [ %r_esp.1.in, %BB_8049204.i ], [ %tmp2_v6.i.i, %0 ]
  %.pn710 = phi i32 [ %28, %BB_8049204.i ], [ %14, %0 ]
  %mrv.i.pn9 = phi { i32, i32 } [ %.pn, %BB_8049204.i ], [ %mrv.i, %0 ]
  %storemerge8 = phi i32 [ %tmp0_v2.i.i, %BB_8049204.i ], [ 0, %0 ]
  %.pn = insertvalue { i32, i32 } %mrv.i.pn9, i32 %.pn710, 1
  %24 = load i32, i32* %10, align 8
  %tmp0_v1.i70.i = shl i32 %24, 2
  %tmp4_v.i73.i = shl i32 %storemerge8, 2
  %25 = load i32, i32* %15, align 4
  %tmp2_v6.i76.i = add i32 %25, %tmp4_v.i73.i
  %26 = inttoptr i32 %r_esp.1.in11 to i32*
  store i32 %tmp0_v1.i70.i, i32* %26, align 4
  %tmp2_v9.i78.i = add i32 %r_esp.1.in11, -4
  %27 = inttoptr i32 %tmp2_v9.i78.i to i32*
  store i32 134517283, i32* %27, align 4
  %arg.i.i3 = load i32, i32* %26, align 4
  %28 = tail call i32 @malloc(i32 %arg.i.i3)
  %29 = inttoptr i32 %tmp2_v6.i76.i to i32*
  store i32 %28, i32* %29, align 4
  %30 = load i32, i32* %16, align 4
  %tmp0_v2.i.i = add i32 %30, 1
  %r_esp.1.in = extractvalue { i32, i32 } %mrv.i.pn9, 0
  store i32 %tmp0_v2.i.i, i32* %16, align 4
  %31 = load i32, i32* %9, align 4
  %32 = icmp slt i32 %tmp0_v2.i.i, %31
  br i1 %32, label %BB_8049204.i, label %BB_8049234.i

BB_804923D.i:                                     ; preds = %BB_804923D.i, %BB_8049234.i
  %storemerge112 = phi i32 [ %tmp0_v2.i53.i, %BB_804923D.i ], [ 0, %BB_8049234.i ]
  %tmp4_v.i82.i = shl i32 %storemerge112, 2
  %33 = load i32, i32* %15, align 4
  %tmp0_v3.i85.i = add i32 %33, %tmp4_v.i82.i
  %34 = inttoptr i32 %tmp0_v3.i85.i to i32*
  ...
  %36 = load i32, i32* %19, align 16
  %tmp0_v2.i53.i = add i32 %36, 1
  store i32 %tmp0_v2.i53.i, i32* %19, align 16
  %37 = load i32, i32* %9, align 4
  %38 = icmp slt i32 %tmp0_v2.i53.i, %37
  br i1 %38, label %BB_804923D.i, label %.exit

.exit:                                            ; preds = %BB_804923D.i, %BB_8049234.i
  %39 = load i32, i32* %15, align 4
  store i32 %39, i32* %22, align 4
  store i32 134517361, i32* %23, align 4
  %arg.i.i6 = load i32, i32* %22, align 4
