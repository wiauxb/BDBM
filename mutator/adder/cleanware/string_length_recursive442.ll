...
@str.bis.440 = constant [12 x i8] c"\6c\65\6e\67\74\68\3a\20\25\64\0a\00"
...
.exit:
  ...
  %spi.bis.440 = ptrtoint[12 x i8]* @str.bis.440 to i32
  ...
  %22 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i16.i, i32 inreg noundef 0, i32 noundef %15, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
