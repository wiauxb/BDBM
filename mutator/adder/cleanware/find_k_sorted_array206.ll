...
@str.205 = constant [12 x i8] c"index1: %d\0a\00"
...
define internal fastcc void @find_k_sorted_array206(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v3.i21.i = add i32 %tmp0_v.i3.i, -44
  %10 = inttoptr i32 %tmp2_v3.i21.i to i32*
  store i32 1, i32* %10, align 4
  %tmp2_v4.i22.i = add i32 %tmp0_v.i3.i, -40
  %11 = inttoptr i32 %tmp2_v4.i22.i to i32*
  store i32 4, i32* %11, align 8
  %tmp2_v5.i23.i = add i32 %tmp0_v.i3.i, -36
  %12 = inttoptr i32 %tmp2_v5.i23.i to i32*
  store i32 5, i32* %12, align 4
  %tmp2_v6.i24.i = add i32 %tmp0_v.i3.i, -32
  %13 = inttoptr i32 %tmp2_v6.i24.i to i32*
  store i32 7, i32* %13, align 16
  %tmp2_v7.i25.i = add i32 %tmp0_v.i3.i, -28
  %14 = inttoptr i32 %tmp2_v7.i25.i to i32*
  store i32 8, i32* %14, align 4
  %tmp2_v8.i26.i = add i32 %tmp0_v.i3.i, -24
  %15 = inttoptr i32 %tmp2_v8.i26.i to i32*
  store i32 9, i32* %15, align 8
  %tmp2_v9.i.i = add i32 %tmp0_v.i3.i, -56
  %16 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 6, i32* %16, align 8
  %tmp2_v10.i.i = add i32 %tmp0_v.i3.i, -52
...
Func_find_index.exit:                             ; preds = %BB_80492A3.i.i
  ...
  %32 = inttoptr i32 %tmp2_v.i.i to i32*
  store i32 %storemerge.i, i32* %32, align 4
  store i32 %storemerge.i, i32* %20, align 4
  %spi205 = ptrtoint[12 x i8]* @str.205 to i32
  store i32 %spi205, i32* %21, align 16
  store i32 134517316, i32* %22, align 4
  %33 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %tmp4_v.i6.i.i, i32 noundef %tmp2_v19.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @find_k_sorted_array206(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
