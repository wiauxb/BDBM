...
@str.32 = constant [5 x i8] c"the \00"
@str.33 = constant [12 x i8] c"Before: %s\0a\00"
...
define internal fastcc void @delete_substring34(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v8.i23.i = add i32 %tmp0_v.i2.i, -30
  %15 = inttoptr i32 %tmp2_v8.i23.i to i32*
  ...
  %tmp2_v13.i.i = add i32 %tmp0_v.i2.i, -76
  %18 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 %tmp2_v3.i19.i, i32* %18, align 4
  %tmp2_v15.i.i = add i32 %tmp0_v.i2.i, -80
  %19 = inttoptr i32 %tmp2_v15.i.i to i32*
  %spi33 = ptrtoint[12 x i8]* @str.33 to i32
  store i32 %spi33, i32* %19, align 16
  %tmp2_v16.i.i = add i32 %tmp0_v.i2.i, -84
  %20 = inttoptr i32 %tmp2_v16.i.i to i32*
  store i32 134517356, i32* %20, align 4
  %21 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i1.i, i32 inreg noundef 0, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %spi32 = ptrtoint[5 x i8]* @str.32 to i32
  store i32 %spi32, i32* %18, align 4
  store i32 %tmp2_v3.i19.i, i32* %19, align 16
  store i32 134517378, i32* %20, align 4
  %tmp2_v.i69.i.i = add i32 %tmp0_v.i2.i, -88
  %22 = inttoptr i32 %tmp2_v.i69.i.i to i32*
  store i32 %tmp2_v4.i3.i, i32* %22, align 8
  %tmp2_v1.i71.i.i = add i32 %tmp0_v.i2.i, -92
  %23 = inttoptr i32 %tmp2_v1.i71.i.i to i32*
  store i32 134529024, i32* %23, align 4
  %tmp2_v2.i74.i.i = add i32 %tmp0_v.i2.i, -116
  ...
  %tmp2_v4.i46.i.i = add i32 %tmp0_v.i2.i, -128
  %27 = inttoptr i32 %tmp2_v4.i46.i.i to i32*
  store i32 %26, i32* %27, align 16
  %tmp2_v5.i47.i.i = add i32 %tmp0_v.i2.i, -132
  %28 = inttoptr i32 %tmp2_v5.i47.i.i to i32*
  store i32 134517475, i32* %28, align 4
  %arg.i.i.i = load i32, i32* %27, align 16
  %29 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i62.i.i = add i32 %tmp0_v.i2.i, -108
  %30 = inttoptr i32 %tmp2_v.i62.i.i to i32*
  ...
  %tmp2_v.i23.i.i = add i32 %tmp0_v.i2.i, -100
  %33 = inttoptr i32 %tmp2_v.i23.i.i to i32*
...
BB_80492FC.i.lr.ph.i:                             ; preds = %.exit
  %mrv.i31.i = insertvalue { i32, i32 } undef, i32 %tmp2_v4.i46.i.i, 0
  %tmp2_v6.i.i.i = add i32 %tmp0_v.i2.i, -104
...
BB_80492FC.i.i:                                   ; preds = %BB_804935B.i.backedge.i, %BB_80492FC.i.lr.ph.i
  %38 = phi i32 [ %34, %BB_80492FC.i.lr.ph.i ], [ %48, %BB_804935B.i.backedge.i ]
  %r_esp.0.in41.i = phi i32 [ %tmp2_v4.i46.i.i, %BB_80492FC.i.lr.ph.i ], [ %r_esp.0.in.i, %BB_804935B.i.backedge.i ]
  %mrv.i31.pn.i = phi { i32, i32 } [ %mrv.i31.i, %BB_80492FC.i.lr.ph.i ], [ %.pn40.i, %BB_804935B.i.backedge.i ]
  %.pn44.i = phi i32 [ %32, %BB_80492FC.i.lr.ph.i ], [ %44, %BB_804935B.i.backedge.i ]
  %.pn40.i = insertvalue { i32, i32 } %mrv.i31.pn.i, i32 %.pn44.i, 1
  %39 = load i32, i32* %19, align 16
  %tmp0_v3.i6.i.i = add i32 %39, %38
  %40 = load i32, i32* %18, align 4
  %tmp2_v7.i.i.i = add i32 %r_esp.0.in41.i, 4
  %41 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  store i32 %40, i32* %41, align 4
  %42 = inttoptr i32 %r_esp.0.in41.i to i32*
  store i32 %tmp0_v3.i6.i.i, i32* %42, align 4
  %tmp2_v9.i.i.i = add i32 %r_esp.0.in41.i, -4
  %43 = inttoptr i32 %tmp2_v9.i.i.i to i32*
  store i32 134517520, i32* %43, align 4
  %arg.i.i35.i = load i32, i32* %42, align 4
  %arg2.i.i.i = load i32, i32* %41, align 4
  %44 = tail call i32 @strstr(i32 %arg.i.i35.i, i32 %arg2.i.i.i)
  %45 = load i32, i32* %25, align 16
  %46 = load i32, i32* %19, align 16
  %tmp0_v4.i55.i.i = add i32 %46, %45
  %.not.i.i.i = icmp eq i32 %44, %tmp0_v4.i55.i.i
...
BB_804935B.i.backedge.i:                          ; preds = %BB_804932D.i.i, %BB_804931F.i.i, %BB_8049357.i.i
  %47 = phi i32 [ %.pre.i, %BB_8049357.i.i ], [ %53, %BB_804931F.i.i ], [ %61, %BB_804932D.i.i ]
  %r_ecx.1.be.i = phi i32 [ %45, %BB_8049357.i.i ], [ %45, %BB_804931F.i.i ], [ %storemerge38.i, %BB_804932D.i.i ]
  %r_esp.0.in.i = extractvalue { i32, i32 } %mrv.i31.pn.i, 0
  %48 = load i32, i32* %25, align 16
  %49 = icmp slt i32 %48, %47
  br i1 %49, label %BB_80492FC.i.i, label %Func_delete.exit

BB_804931F.i.i:                                   ; preds = %BB_80492FC.i.i
  %50 = load i32, i32* %33, align 4
  %51 = load i32, i32* %30, align 4
  %tmp0_v3.i36.i.i = sub i32 %51, %50
  store i32 %tmp0_v3.i36.i.i, i32* %30, align 4
  %52 = load i32, i32* %25, align 16
  store i32 %52, i32* %37, align 8
  %53 = load i32, i32* %30, align 4
  %54 = icmp slt i32 %52, %53
  br i1 %54, label %BB_804932D.i.i, label %BB_804935B.i.backedge.i

BB_804932D.i.i:                                   ; preds = %BB_804932D.i.i, %BB_804931F.i.i
  %storemerge38.i = phi i32 [ %tmp0_v15.i.i.i, %BB_804932D.i.i ], [ %52, %BB_804931F.i.i ]
...
Func_delete.exit:                                 ; preds = %BB_804935B.i.backedge.i, %.exit
  %r_ecx.1.lcssa.i = phi i32 [ %tmp2_v.i1.i, %.exit ], [ %r_ecx.1.be.i, %BB_804935B.i.backedge.i ]
  %.lcssa.i = phi i32 [ %34, %.exit ], [ %48, %BB_804935B.i.backedge.i ]
  ...
  %tmp2_v.i38.i = add i32 %66, -42
  store i32 %tmp2_v.i38.i, i32* %18, align 4
  %tmp2_v3.i41.i = add i32 %65, -8167
  store i32 %tmp2_v3.i41.i, i32* %19, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @delete_substring34(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
