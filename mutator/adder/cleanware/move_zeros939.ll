...
define internal fastcc void @move_zeros939(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %tmp2_v.i17.i.i = add i32 %tmp0_v.i43.i, -104
  %25 = inttoptr i32 %tmp2_v.i17.i.i to i32*
  store i32 %tmp2_v4.i46.i, i32* %25, align 8
  %tmp2_v1.i20.i.i = add i32 %tmp0_v.i43.i, -124
  %26 = inttoptr i32 %tmp2_v1.i20.i.i to i32*
  store i32 134517452, i32* %26, align 4
  %tmp2_v.i59.i.i = add i32 %tmp0_v.i43.i, -116
  %27 = inttoptr i32 %tmp2_v.i59.i.i to i32*
  store i32 0, i32* %27, align 4
  %tmp2_v1.i60.i.i = add i32 %tmp0_v.i43.i, -112
...
BB_8049328.i.i:                                   ; preds = %BB_804931C.i.i, %0
  %r_edx.0.lcssa.i = phi i32 [ 0, %0 ], [ %r_edx.1.i, %BB_804931C.i.i ]
  %r_ecx.0.lcssa.i = phi i32 [ %tmp2_v.i42.i, %0 ], [ %r_ecx.1.i, %BB_804931C.i.i ]
  %31 = load i32, i32* %27, align 4
  %tmp2_v1.i4.i.i = add i32 %tmp0_v.i43.i, -108
...
BB_80492E1.i.i:                                   ; preds = %BB_804931C.i.i, %0
  %r_ecx.05.i = phi i32 [ %r_ecx.1.i, %BB_804931C.i.i ], [ %tmp2_v.i42.i, %0 ]
  ...
  %38 = icmp eq i32 %37, 0
  br i1 %38, label %BB_804931C.i.i, label %BB_80492F6.i.i

BB_804931C.i.i:                                   ; preds = %BB_80492F6.i.i, %BB_80492E1.i.i
  %39 = phi i32 [ %storemerge4.i, %BB_80492E1.i.i ], [ %.pre.i, %BB_80492F6.i.i ]
  %r_edx.1.i = phi i32 [ %tmp4_v.i.i.i1, %BB_80492E1.i.i ], [ %tmp0_v9.i.i.i, %BB_80492F6.i.i ]
  ...
  br i1 %41, label %BB_80492E1.i.i, label %BB_8049328.i.i

BB_80492F6.i.i:                                   ; preds = %BB_80492E1.i.i
  %42 = load i32, i32* %27, align 4
  %tmp4_v6.i.i.i = shl i32 %42, 2
  %tmp0_v9.i.i.i = add i32 %tmp4_v6.i.i.i, %35
...
Func_shift_zeros.exit:                            ; preds = %BB_8049330.i.i, %BB_8049328.i.i
  %r_edx.2.lcssa.i = phi i32 [ %r_edx.0.lcssa.i, %BB_8049328.i.i ], [ %tmp4_v.i39.i.i, %BB_8049330.i.i ]
  %50 = load i32, i32* %25, align 8
  %tmp2_v.i16.i = add i32 %50, -60
  %51 = inttoptr i32 %tmp2_v.i16.i to i32*
...
BB_804926A.i:                                     ; preds = %BB_804926A.i, %BB_804926A.i.lr.ph
  ...
  %tmp4_v.i31.i = shl i32 %storemerge6, 2
  %tmp2_v2.i32.i = add i32 %tmp2_v1.i30.i, %tmp4_v.i31.i
  %55 = inttoptr i32 %tmp2_v2.i32.i to i32*
  %56 = load i32, i32* %55, align 4
  store i32 %56, i32* %22, align 4
  %spi936 = ptrtoint[4 x i8]* @str.936 to i32
  store i32 %spi936, i32* %23, align 16
