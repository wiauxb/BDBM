...
define internal fastcc void @ifdef_ifndefm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %7 = select i1 %tmp4_v.i12.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i16.i = add i32 %tmp0_v.i22.i, -20
  ...
  store i32 134520858, i32* %10, align 16
  ...
  %tmp2_v.i.i = add i32 %tmp0_v.i22.i, -332
  %16 = inttoptr i32 %tmp2_v.i.i to i32*
  store i32 300, i32* %16, align 4
  store i32 134520874, i32* %10, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @ifdef_ifndefm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
