...
@str.777 = constant [14 x i8] c"Hello, World!\00"
...
define internal fastcc void @hello_world779(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
  ...
  %spi777 = ptrtoint[14 x i8]* @str.777 to i32
  store i32 %spi777, i32* %8, align 16
  %tmp2_v3.i11.i = add i32 %tmp0_v.i3.i, -36
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @hello_world779(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
