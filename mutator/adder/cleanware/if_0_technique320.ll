...
@stack319 = internal global [8092 x i32] zeroinitializer, align 16
@onUnfallback = common local_unnamed_addr global i1 false
@str.bis.317 = constant [7 x i8] c"\77\6f\72\6b\20\31\00"
@str.bis.318 = constant [4 x i8] c"\05\52\2e\00"
...
define internal fastcc void @if_0_technique320(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
  ...
  %spi.bis.318 = ptrtoint[4 x i8]* @str.bis.318 to i32
  store i32 %spi.bis.318, i32* %7, align 4
  %tmp2_v2.i.i = add i32 %tmp0_v.i3.i, -32
  %8 = inttoptr i32 %tmp2_v2.i.i to i32*
  %spi.bis.317 = ptrtoint[7 x i8]* @str.bis.317 to i32
  store i32 %spi.bis.317, i32* %8, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @if_0_technique320 (i32 ptrtoint (i32* getelementptr inbounds ([8092 x i32], [8092 x i32]* @stack319, i32 0, i32 8092) to i32)) nounwind
