...
define internal fastcc void @strcspnm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v8.i26.i = add i32 %tmp0_v.i.i, -49
  %15 = inttoptr i32 %tmp2_v8.i26.i to i32*
  store i32 858927408, i32* %15, align 4
  %tmp2_v9.i27.i = add i32 %tmp0_v.i.i, -45
  %16 = inttoptr i32 %tmp2_v9.i27.i to i32*
  store i32 892614968, i32* %16, align 4
  %tmp2_v10.i.i = add i32 %tmp0_v.i.i, -41
  %17 = inttoptr i32 %tmp2_v10.i.i to i16*
  store i16 14134, i16* %17, align 2
  %tmp2_v11.i.i = add i32 %tmp0_v.i.i, -39
  ...
  store i32 %tmp2_v3.i22.i, i32* %20, align 16
  ...
  %tmp2_v.i40.i = add i32 %tmp0_v.i.i, -60
  %23 = inttoptr i32 %tmp2_v.i40.i to i32*
  store i32 %22, i32* %23, align 4
  store i32 %22, i32* %19, align 4
  store i32 134520840, i32* %20, align 16
  store i32 134517380, i32* %21, align 4
  %24 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef 0, i32 noundef %tmp2_v16.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %25 = load i32, i32* %23, align 4
  %tmp0_v3.i11.i = add i32 %25, %tmp2_v3.i22.i
  %tmp2_v4.i12.i = add i32 %tmp0_v.i.i, -56
  %26 = inttoptr i32 %tmp2_v4.i12.i to i32*
  store i32 %tmp0_v3.i11.i, i32* %26, align 8
  store i32 %tmp0_v3.i11.i, i32* %20, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @strcspnm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
