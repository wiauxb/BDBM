...
@str.64 = constant [13 x i8] c"Before:\0a\0a %s\00"
...
define internal fastcc void @trim_trailing_whitespace66(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v8.i17.i = add i32 %tmp0_v.i10.i, -52
  ...
  %spi64 = ptrtoint[13 x i8]* @str.64 to i32
  store i32 %spi64, i32* %17, align 16
  %tmp2_v14.i.i = add i32 %tmp0_v.i10.i, -68
  %18 = inttoptr i32 %tmp2_v14.i.i to i32*
  store i32 134517342, i32* %18, align 4
  %19 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i9.i, i32 inreg noundef 0, i32 noundef %tmp2_v13.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  store i32 %tmp2_v3.i.i, i32* %17, align 16
  store i32 134517357, i32* %18, align 4
  %tmp2_v.i1.i.i = add i32 %tmp0_v.i10.i, -72
  %20 = inttoptr i32 %tmp2_v.i1.i.i to i32*
  store i32 %tmp2_v4.i12.i, i32* %20, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i10.i, -76
  %21 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 134529024, i32* %21, align 4
  %tmp2_v2.i4.i.i = add i32 %tmp0_v.i10.i, -100
  %22 = inttoptr i32 %tmp2_v2.i4.i.i to i32*
  store i32 134517441, i32* %22, align 4
  %23 = load i32, i32* %17, align 16
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i10.i, -112
  %24 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  store i32 %23, i32* %24, align 16
  %tmp2_v4.i.i.i = add i32 %tmp0_v.i10.i, -116
  ...
  %tmp2_v.i47.i.i = add i32 %tmp0_v.i10.i, -84
  %27 = inttoptr i32 %tmp2_v.i47.i.i to i32*
...
BB_804930F.i.i:                                   ; preds = %BB_804930F.i.i.backedge, %.exit
  ...
  %tmp0_v3.i28.i.i = add i32 %28, %storemerge.i
  %29 = inttoptr i32 %tmp0_v3.i28.i.i to i8*
...
Func_trim.exit:                                   ; preds = %BB_804930F.i.i
  %tmp0_v4.i21.i.i = add i32 %28, %storemerge.in.i
  %31 = inttoptr i32 %tmp0_v4.i21.i.i to i8*
  store i8 0, i8* %31, align 1
  %32 = load i32, i32* %21, align 4
  %33 = load i32, i32* %20, align 8
  %tmp2_v.i29.i = add i32 %32, -8171
  store i32 %tmp2_v.i29.i, i32* %17, align 16
