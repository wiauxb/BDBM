...
@str.bis.798 = constant [13 x i8] c"\44\69\63\65\20\25\64\3a\20\25\64\0a\00"
...
BB_8049247.i:                                     ; preds = %BB_8049247.i, %BB_8049247.i.lr.ph
  ...
  %spi.bis.798 = ptrtoint[13 x i8]* @str.bis.798 to i32
  store i32 %spi.bis.798, i32* %8, align 16
  store i32 134517381, i32* %9, align 4
  %20 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v7.i22.i, i32 inreg noundef %tmp0_v7.i22.i, i32 noundef %tmp2_v.i14.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
