...
@str.71 = constant [24 x i8] c"info.buffer.x[%d] = %c\0a\00"
@str.72 = constant [13 x i8] c"ptr->z = %s\0a\00"
@str.73 = constant [18 x i8] c"mydata2 size: %d\0a\00"
@str.74 = constant [15 x i8] c"char size: %d\0a\00"
@str.75 = constant [17 x i8] c"mydata size: %d\0a\00"
@str.76 = constant [15 x i8] c"mydata.z = %s\0a\00"
@str.77 = constant [15 x i8] c"mydata.y = %f\0a\00"
@str.78 = constant [15 x i8] c"mydata.x = %d\0a\00"
@str.79 = constant [15 x i8] c"mydata.z = %s\0a\00"
@str.80 = constant [15 x i8] c"mydata.y = %f\0a\00"
@str.81 = constant [15 x i8] c"mydata.x = %d\0a\00"
...
define internal fastcc void @unions82(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !18 {
Func_8049396.exit.i:
  %tmp2_v.i101.i = add i32 %arg_esp, 4
  %tmp0_v.i102.i = and i32 %arg_esp, -16
  %0 = inttoptr i32 %arg_esp to i32*
  %1 = load i32, i32* %0, align 4
  %tmp2_v3.i104.i = add i32 %tmp0_v.i102.i, -4
  %2 = inttoptr i32 %tmp2_v3.i104.i to i32*
  store i32 %1, i32* %2, align 4
  %tmp2_v4.i105.i = add i32 %tmp0_v.i102.i, -8
  %3 = inttoptr i32 %tmp2_v4.i105.i to i32*
  store i32 0, i32* %3, align 8
  %tmp2_v5.i107.i = add i32 %tmp0_v.i102.i, -12
  %4 = inttoptr i32 %tmp2_v5.i107.i to i32*
  store i32 0, i32* %4, align 4
  %tmp2_v6.i109.i = add i32 %tmp0_v.i102.i, -16
  %5 = inttoptr i32 %tmp2_v6.i109.i to i32*
  store i32 %tmp2_v.i101.i, i32* %5, align 16
  %tmp2_v12.i112.i = add i32 %tmp0_v.i102.i, -8260
  %6 = inttoptr i32 %tmp2_v12.i112.i to i32*
  store i32 134517253, i32* %6, align 4
  %tmp4_v.i.i.b = load i1, i1* @segs.0, align 1
  %7 = inttoptr i32 %arg_esp to i32*
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i27.i = add i32 %tmp0_v.i102.i, -20
  %9 = inttoptr i32 %tmp2_v2.i27.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i28.i = add i32 %tmp0_v.i102.i, -8248
  ...
  %tmp5_v2.i86.i = tail call fastcc i64 @helper_fstl_ST0()
  %12 = inttoptr i32 %tmp2_v3.i28.i to i64*
  store i64 %tmp5_v2.i86.i, i64* %12, align 8
  tail call fastcc void @helper_fpop()
  store i32 1953719668, i32* %10, align 8
  %tmp2_v5.i89.i = add i32 %tmp0_v.i102.i, -8244
  %13 = inttoptr i32 %tmp2_v5.i89.i to i32*
  store i32 858927392, i32* %13, align 4
  %tmp2_v6.i90.i = add i32 %tmp0_v.i102.i, -8240
  %14 = inttoptr i32 %tmp2_v6.i90.i to i8*
  store i8 0, i8* %14, align 16
  %15 = load i32, i32* %10, align 8
  %tmp2_v9.i95.i = add i32 %tmp0_v.i102.i, -8268
  %16 = inttoptr i32 %tmp2_v9.i95.i to i32*
  store i32 %15, i32* %16, align 4
  %tmp2_v12.i98.i = add i32 %tmp0_v.i102.i, -8272
  %17 = inttoptr i32 %tmp2_v12.i98.i to i32*
  %spi81 = ptrtoint[15 x i8]* @str.81 to i32
  store i32 %spi81, i32* %17, align 16
  %tmp2_v13.i99.i = add i32 %tmp0_v.i102.i, -8276
  %18 = inttoptr i32 %tmp2_v13.i99.i to i32*
  store i32 134517337, i32* %18, align 4
  %19 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i101.i, i32 inreg noundef 0, i32 noundef %tmp2_v12.i98.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %20 = lshr i64 %19, 32
  %21 = trunc i64 %20 to i32
  %22 = load i64, i64* %12, align 8
  tail call fastcc void @helper_fldl_ST0(i64 %22)
  %tmp5_v4.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %23 = inttoptr i32 %tmp2_v9.i95.i to i64*
  store i64 %tmp5_v4.i.i, i64* %23, align 4
  tail call fastcc void @helper_fpop()
  %spi80 = ptrtoint[15 x i8]* @str.80 to i32
  store i32 %spi80, i32* %17, align 16
  store i32 134517368, i32* %18, align 4
  %24 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i101.i, i32 inreg noundef %21, i32 noundef %tmp2_v12.i98.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %25 = lshr i64 %24, 32
  %26 = trunc i64 %25 to i32
  store i32 %tmp2_v3.i28.i, i32* %16, align 4
  %spi79 = ptrtoint[15 x i8]* @str.79 to i32
  store i32 %spi79, i32* %17, align 16
  store i32 134517393, i32* %18, align 4
  %27 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i101.i, i32 inreg noundef %26, i32 noundef %tmp2_v12.i98.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %28 = lshr i64 %27, 32
  %29 = trunc i64 %28 to i32
  store i32 10, i32* %10, align 8
  store i32 10, i32* %16, align 4
  %spi78 = ptrtoint[15 x i8]* @str.78 to i32
  store i32 %spi78, i32* %17, align 16
  store i32 134517428, i32* %18, align 4
  %30 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i101.i, i32 inreg noundef %29, i32 noundef %tmp2_v12.i98.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %31 = lshr i64 %30, 32
  ...
  tail call fastcc void @helper_fpop()
  %spi77 = ptrtoint[15 x i8]* @str.77 to i32
  store i32 %spi77, i32* %17, align 16
  store i32 134517471, i32* %18, align 4
  %35 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i101.i, i32 inreg noundef %32, i32 noundef %tmp2_v12.i98.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %36 = lshr i64 %35, 32
  ...
  store i8 0, i8* %14, align 16
  store i32 %tmp2_v3.i28.i, i32* %16, align 4
  %spi76 = ptrtoint[15 x i8]* @str.76 to i32
  store i32 %spi76, i32* %17, align 16
  store i32 134517519, i32* %18, align 4
  %38 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i101.i, i32 inreg noundef %37, i32 noundef %tmp2_v12.i98.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %39 = lshr i64 %38, 32
  %40 = trunc i64 %39 to i32
  store i32 32, i32* %16, align 4
  %spi75 = ptrtoint[17 x i8]* @str.75 to i32
  store i32 %spi75, i32* %17, align 16
  store i32 134517539, i32* %18, align 4
  %41 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i101.i, i32 inreg noundef %40, i32 noundef %tmp2_v12.i98.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %42 = lshr i64 %41, 32
  %43 = trunc i64 %42 to i32
  store i32 1, i32* %16, align 4
  %spi74 = ptrtoint[15 x i8]* @str.74 to i32
  store i32 %spi74, i32* %17, align 16
  store i32 134517559, i32* %18, align 4
  %44 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i101.i, i32 inreg noundef %43, i32 noundef %tmp2_v12.i98.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %45 = lshr i64 %44, 32
  %46 = trunc i64 %45 to i32
  store i32 44, i32* %16, align 4
  %spi73 = ptrtoint[18 x i8]* @str.73 to i32
  store i32 %spi73, i32* %17, align 16
  store i32 134517579, i32* %18, align 4
  %47 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i101.i, i32 inreg noundef %46, i32 noundef %tmp2_v12.i98.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %48 = lshr i64 %47, 32
  %49 = trunc i64 %48 to i32
  %tmp2_v1.i166.i = add i32 %tmp0_v.i102.i, -8252
  %50 = inttoptr i32 %tmp2_v1.i166.i to i32*
  store i32 %tmp2_v3.i28.i, i32* %50, align 4
  store i32 %tmp2_v3.i28.i, i32* %16, align 4
  %spi72 = ptrtoint[13 x i8]* @str.72 to i32
  store i32 %spi72, i32* %17, align 16
  store i32 134517616, i32* %18, align 4
  %51 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i101.i, i32 inreg noundef %49, i32 noundef %tmp2_v12.i98.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %tmp2_v.i143.i = add i32 %tmp0_v.i102.i, -8216
  %52 = inttoptr i32 %tmp2_v.i143.i to i32*
  store i32 0, i32* %52, align 8
  %tmp2_v2.i145.i = add i32 %tmp0_v.i102.i, -8264
  %53 = inttoptr i32 %tmp2_v2.i145.i to i32*
  store i32 1024, i32* %53, align 8
  store i32 116, i32* %16, align 4
  %tmp0_v5.i148.i = add i32 %tmp0_v.i102.i, -8212
  store i32 %tmp0_v5.i148.i, i32* %17, align 16
  ...
  %tmp2_v.i7.i = add i32 %tmp0_v.i102.i, -8256
...
BB_80493AF.i:                                     ; preds = %BB_80493AF.i, %Func_8049396.exit.i
  %storemerge14 = phi i32 [ 0, %Func_8049396.exit.i ], [ %tmp0_v2.i65.i, %BB_80493AF.i ]
  %tmp0_v2.i.i = add i32 %storemerge14, %tmp0_v5.i148.i
  %57 = inttoptr i32 %tmp0_v2.i.i to i8*
  %58 = load i8, i8* %57, align 1
  %tmp0_v4.i.i = sext i8 %58 to i32
  store i32 %tmp0_v4.i.i, i32* %53, align 8
  %59 = load i32, i32* %56, align 16
  store i32 %59, i32* %16, align 4
  %spi71 = ptrtoint[24 x i8]* @str.71 to i32
  store i32 %spi71, i32* %17, align 16
  store i32 134517721, i32* %18, align 4
  %60 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i101.i, i32 inreg noundef %tmp0_v5.i148.i, i32 noundef %tmp2_v12.i98.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %61 = load i32, i32* %56, align 16
  %tmp0_v2.i65.i = add i32 %61, 1
  store i32 %tmp0_v2.i65.i, i32* %56, align 16
  %62 = icmp slt i32 %tmp0_v2.i65.i, 1024
...
!19 = !{!"printf"}
  ...
  tail call fastcc void @unions82(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
