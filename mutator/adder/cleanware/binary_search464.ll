...
@str.463 = constant [17 x i8] c"index of 14: %d\0a\00"
...
define internal fastcc void @binary_search464(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v4.i6.i = add i32 %tmp0_v.i20.i, -120
  ...
  %spi463 = ptrtoint[17 x i8]* @str.463 to i32
  store i32 %spi463, i32* %47, align 4
...
Func_80492F1.exit.i:
  ...
  %tmp2_v1.i36.i = add i32 %arg_esp, -32
  %1 = inttoptr i32 %tmp2_v1.i36.i to i32*
  ...
  %tmp4_v.i8.i = shl i32 %tmp0_v9.i.i, 2
  %tmp2_v1.i9.i = add i32 %arg_esp, 4
  %7 = inttoptr i32 %tmp2_v1.i9.i to i32*
  %8 = load i32, i32* %7, align 4
  %tmp0_v3.i11.i = add i32 %tmp4_v.i8.i, %8
  %9 = inttoptr i32 %tmp0_v3.i11.i to i32*
  %10 = load i32, i32* %9, align 4
  %tmp2_v5.i13.i = add i32 %arg_esp, 8
  %11 = inttoptr i32 %tmp2_v5.i13.i to i32*
  %12 = load i32, i32* %11, align 4
  %.not.i16.i = icmp eq i32 %12, %10
  br i1 %.not.i16.i, label %.exit, label %Func_8049339.exit.i

Func_8049339.exit.i:                              ; preds = %Func_80492F1.exit.i
  %tmp0_v1.i28.i = add i32 %tmp0_v9.i.i, 1
  %13 = load i32, i32* %2, align 4
  store i32 %13, i32* %1, align 4
  %tmp2_v5.i31.i = add i32 %arg_esp, -36
  %14 = inttoptr i32 %tmp2_v5.i31.i to i32*
  store i32 %tmp0_v1.i28.i, i32* %14, align 4
  ...
  %20 = tail call fastcc { i32, i32, i32, i32 } @Func_binary_search(i32 %tmp2_v12.i.i, i32 %tmp2_v.i33.i)
...
.exit:                                            ; preds = %Func_8049339.exit.i, %Func_80492F1.exit.i
  ...
  %r_ebp.0 = phi i32 [ %tmp2_v.i33.i, %Func_80492F1.exit.i ], [ %23, %Func_8049339.exit.i ]
  %r_eax.0 = phi i32 [ %tmp0_v9.i.i, %Func_80492F1.exit.i ], [ %21, %Func_8049339.exit.i ]
  %r_edx.0 = phi i32 [ %tmp4_v.i8.i, %Func_80492F1.exit.i ], [ %22, %Func_8049339.exit.i ]
...
!14 = !{i32 0, i32 3}
  ...
  tail call fastcc void @binary_search464(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
