...
define internal fastcc void @count_lettersm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v.i28.i.i = add i32 %tmp0_v.i10.i, -116
  %31 = inttoptr i32 %tmp2_v.i28.i.i to i32*
  store i32 %30, i32* %31, align 4
  %tmp2_v1.i29.i.i = add i32 %tmp0_v.i10.i, -124
  %32 = inttoptr i32 %tmp2_v1.i29.i.i to i32*
  store i32 0, i32* %32, align 4
  %tmp2_v2.i30.i.i = add i32 %tmp0_v.i10.i, -120
  %33 = inttoptr i32 %tmp2_v2.i30.i.i to i32*
...
BB_804931B.i.i:                                   ; preds = %BB_80492F3.i.i
  ...
  %tmp0_v1.i4.i.i = add i32 %36, 1
  store i32 %tmp0_v1.i4.i.i, i32* %32, align 4
...
BB_80492F3.i.i:                                   ; preds = %BB_804931F.i.i, %.exit
  ...
  %tmp0_v4.i40.i.i = add i32 %41, %40
  %42 = inttoptr i32 %tmp0_v4.i40.i.i to i8*
  %43 = load i8, i8* %42, align 1
  %tmp0_v6.i41.i.i = sext i8 %43 to i32
  %tmp0_v7.i.i.i = shl nsw i32 %tmp0_v6.i41.i.i, 1
...
BB_804931F.i.i:                                   ; preds = %BB_80492F3.i.i, %BB_804931B.i.i
  ...
  %tmp0_v1.i46.i.i = add i32 %48, 1
  store i32 %tmp0_v1.i46.i.i, i32* %33, align 8
  %49 = load i32, i32* %31, align 4
  %50 = icmp slt i32 %tmp0_v1.i46.i.i, %49
  br i1 %50, label %BB_80492F3.i.i, label %Func_count_letters.exit

Func_count_letters.exit:                          ; preds = %BB_804931F.i.i, %.exit
  %r_ecx.0.lcssa.i = phi i32 [ %tmp2_v.i9.i, %.exit ], [ %40, %BB_804931F.i.i ]
  ...
  %tmp2_v.i21.i = add i32 %53, -64
  %54 = inttoptr i32 %tmp2_v.i21.i to i32*
  store i32 %51, i32* %54, align 4
  %tmp2_v4.i25.i = add i32 %tmp0_v.i10.i, -92
  %55 = inttoptr i32 %tmp2_v4.i25.i to i32*
  store i32 %51, i32* %55, align 4
  %tmp2_v5.i27.i = add i32 %52, -8184
  store i32 %tmp2_v5.i27.i, i32* %22, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @count_lettersm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
