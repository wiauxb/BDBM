...
.exit:
  ...
  %tmp2_v.i28.i.i = add i32 %tmp0_v.i10.i, -88
  %23 = inttoptr i32 %tmp2_v.i28.i.i to i32*
  store i32 %tmp2_v4.i12.i, i32* %23, align 8
  %tmp2_v1.i31.i.i = add i32 %tmp0_v.i10.i, -108
  %24 = inttoptr i32 %tmp2_v1.i31.i.i to i32*
  store i32 134517376, i32* %24, align 4
  %25 = load i32, i32* %21, align 16
  %26 = inttoptr i32 %25 to i32*
  %27 = load i32, i32* %26, align 4
  %tmp2_v1.i13.i.i = add i32 %25, 4
  %28 = inttoptr i32 %tmp2_v1.i13.i.i to i32*
  %29 = load i32, i32* %28, align 4
  %tmp2_v3.i15.i.i = add i32 %tmp0_v.i10.i, -100
  %30 = inttoptr i32 %tmp2_v3.i15.i.i to i32*
  store i32 %29, i32* %30, align 4
  %31 = load i32, i32* %21, align 16
  %32 = inttoptr i32 %31 to i32*
  %33 = load i32, i32* %32, align 4
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i10.i, -96
  %34 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  store i32 %33, i32* %34, align 16
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i10.i, -92
...
Func_80492C3.exit.i.i:                            ; preds = %Func_80492C3.exit.i.i, %.exit
  ...
  %tmp4_v.i23.i.i = shl i32 %39, 2
  %40 = load i32, i32* %21, align 16
  %tmp0_v6.i26.i.i = add i32 %40, %tmp4_v.i23.i.i
  %41 = inttoptr i32 %tmp0_v6.i26.i.i to i32*
  %42 = load i32, i32* %41, align 4
  store i32 %42, i32* %30, align 4
  %43 = load i32, i32* %35, align 4
  %tmp0_v1.i35.i.i = add i32 %43, 1
  store i32 %tmp0_v1.i35.i.i, i32* %35, align 4
  %44 = load i32, i32* %20, align 4
  %45 = icmp slt i32 %tmp0_v1.i35.i.i, %44
...
Func_second_highest.exit:                         ; preds = %Func_80492C3.exit.i.i, %.exit
  %r_edx.0.lcssa.i = phi i32 [ %27, %.exit ], [ %tmp4_v.i23.i.i, %Func_80492C3.exit.i.i ]
  %46 = load i32, i32* %34, align 16
  %47 = load i32, i32* %23, align 8
  %tmp2_v.i28.i = add i32 %47, -56
  %48 = inttoptr i32 %tmp2_v.i28.i to i32*
  store i32 %46, i32* %48, align 4
  store i32 %46, i32* %20, align 4
  %spi142 = ptrtoint[20 x i8]* @str.142 to i32
  store i32 %spi142, i32* %21, align 16
  store i32 134517326, i32* %22, align 4
  %49 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i9.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v16.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
