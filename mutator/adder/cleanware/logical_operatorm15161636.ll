...
define internal fastcc void @logical_operatorm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_80491B1.exit.i:
  ...
  %tmp2_v.i18.i = add i32 %tmp0_v.i2.i, -24
  %7 = inttoptr i32 %tmp2_v.i18.i to i32*
  store i32 2020, i32* %7, align 8
  %tmp2_v1.i19.i = add i32 %tmp0_v.i2.i, -20
  %8 = inttoptr i32 %tmp2_v1.i19.i to i32*
  store i32 19000, i32* %8, align 4
  %tmp2_v1.i13.i = add i32 %tmp0_v.i2.i, -48
  %9 = inttoptr i32 %tmp2_v1.i13.i to i32*
  store i32 134520840, i32* %9, align 16
  %tmp2_v2.i14.i = add i32 %tmp0_v.i2.i, -52
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @logical_operatorm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
