...
define internal fastcc void @matrix_subtraction926(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %tmp2_v8.i13.i = add i32 %tmp0_v.i6.i, -180
...
BB_8049394.i.i:                                   ; preds = %BB_804938B.i.i, %BB_8049394.i.i
  ...
  %tmp0_v1.i11.i.i = shl i32 %46, 4
  %47 = load i32, i32* %37, align 16
  %tmp4_v.i15.i.i = shl i32 %storemerge1315.i, 2
  %tmp0_v4.i14.i.i = add i32 %tmp0_v1.i11.i.i, %tmp4_v.i15.i.i
  %tmp2_v7.i.i.i = add i32 %tmp0_v4.i14.i.i, %47
  %48 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  %49 = load i32, i32* %48, align 4
  %50 = load i32, i32* %36, align 4
  %tmp2_v19.i.i.i = add i32 %50, %tmp0_v4.i14.i.i
  %51 = inttoptr i32 %tmp2_v19.i.i.i to i32*
  %52 = load i32, i32* %51, align 4
  %53 = load i32, i32* %35, align 8
  %tmp0_v28.i.i.i = sub i32 %49, %52
  %tmp2_v32.i.i.i = add i32 %53, %tmp0_v4.i14.i.i
...
Func_matrix_subtraction.exit:                     ; preds = %BB_80493D9.i.i
  ...
  %tmp2_v.i75.i = add i32 %58, -164
  %59 = inttoptr i32 %tmp2_v.i75.i to i32*
  %tmp2_v.i15.i = add i32 %58, -160
  %60 = inttoptr i32 %tmp2_v.i15.i to i32*
  %tmp2_v4.i52.i = add i32 %58, -60
  %tmp2_v10.i58.i = add i32 %57, -8184
...
BB_80492F4.i:                                     ; preds = %BB_80492F4.i, %BB_80492E8.i
  %storemerge15 = phi i32 [ 0, %BB_80492E8.i ], [ %tmp0_v2.i30.i, %BB_80492F4.i ]
  %61 = load i32, i32* %59, align 4
  %tmp4_v.i49.i = shl i32 %61, 2
  %tmp0_v3.i51.i = add i32 %tmp4_v.i49.i, %storemerge15
  %tmp4_v5.i.i = shl i32 %tmp0_v3.i51.i, 2
  %tmp2_v6.i53.i = add i32 %tmp2_v4.i52.i, %tmp4_v5.i.i
  %62 = inttoptr i32 %tmp2_v6.i53.i to i32*
  %63 = load i32, i32* %62, align 4
  store i32 %63, i32* %36, align 4
  store i32 %tmp2_v10.i58.i, i32* %37, align 16
  store i32 134517533, i32* %38, align 4
  %64 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v28.i.i.i, i32 inreg noundef %tmp4_v.i49.i, i32 noundef %tmp2_v33.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %65 = load i32, i32* %60, align 4
  %tmp0_v2.i30.i = add i32 %65, 1
  store i32 %tmp0_v2.i30.i, i32* %60, align 4
  %66 = icmp slt i32 %tmp0_v2.i30.i, 4
...
BB_8049330.i:                                     ; preds = %BB_80492F4.i
  ...
  %tmp0_v2.i21.i = add i32 %68, 1
  store i32 %tmp0_v2.i21.i, i32* %59, align 4
  %69 = icmp slt i32 %tmp0_v2.i21.i, 3
