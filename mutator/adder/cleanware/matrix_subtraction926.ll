...
BB_80492F4.i:                                     ; preds = %BB_80492F4.i, %BB_80492E8.i
  ...
  %67 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v28.i.i.i, i32 inreg noundef %tmp4_v.i38.i, i32 noundef %tmp2_v33.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
