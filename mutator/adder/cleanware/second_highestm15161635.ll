...
define internal fastcc void @second_highestm15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v1.i19.i.i = add i32 %25, 4
  %28 = inttoptr i32 %tmp2_v1.i19.i.i to i32*
  %29 = load i32, i32* %28, align 4
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i3.i, -100
  %30 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  store i32 %29, i32* %30, align 4
  %31 = load i32, i32* %21, align 16
  %32 = inttoptr i32 %31 to i32*
  %33 = load i32, i32* %32, align 4
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i3.i, -96
  %34 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  store i32 %33, i32* %34, align 16
  %tmp2_v8.i24.i.i = add i32 %tmp0_v.i3.i, -92
  %35 = inttoptr i32 %tmp2_v8.i24.i.i to i32*
...
Func_80492C3.exit.i.i:                            ; preds = %Func_80492C3.exit.i.i, %.exit
  ...
  %tmp4_v.i.i.i1 = shl i32 %39, 2
  %40 = load i32, i32* %21, align 16
  %tmp0_v6.i.i.i = add i32 %40, %tmp4_v.i.i.i1
  %41 = inttoptr i32 %tmp0_v6.i.i.i to i32*
...
Func_second_highest.exit:                         ; preds = %Func_80492C3.exit.i.i, %.exit
  %r_edx.0.lcssa.i = phi i32 [ %27, %.exit ], [ %tmp4_v.i.i.i1, %Func_80492C3.exit.i.i ]
  %46 = load i32, i32* %34, align 16
  %47 = load i32, i32* %23, align 8
  %tmp2_v.i15.i = add i32 %47, -56
  %48 = inttoptr i32 %tmp2_v.i15.i to i32*
  store i32 %46, i32* %48, align 4
  store i32 %46, i32* %20, align 4
  store i32 134520840, i32* %21, align 16
  store i32 134517326, i32* %22, align 4
  %49 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v16.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @second_highestm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
