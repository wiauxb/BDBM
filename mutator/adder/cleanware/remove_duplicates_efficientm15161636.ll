...
define internal fastcc void @remove_duplicates_efficientm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
.exit:
  ...
  %tmp2_v2.i.i = add i32 %tmp0_v.i22.i, -68
  ...
  %tmp2_v.i.i.i = add i32 %tmp0_v.i22.i, -104
  %24 = inttoptr i32 %tmp2_v.i.i.i to i32*
  store i32 %tmp2_v4.i24.i, i32* %24, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i22.i, -108
  ...
  %tmp2_v2.i49.i.i = add i32 %tmp0_v.i22.i, -388
  %29 = inttoptr i32 %tmp2_v2.i49.i.i to i32*
  ...
  %tmp2_v10.i56.i.i = add i32 %tmp0_v.i22.i, -420
  %34 = inttoptr i32 %tmp2_v10.i56.i.i to i32*
  store i32 134517445, i32* %34, align 4
  %arg.i.i.i = load i32, i32* %33, align 16
  %35 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i60.i.i = add i32 %tmp0_v.i22.i, -376
  %36 = inttoptr i32 %tmp2_v.i60.i.i to i32*
  store i32 %35, i32* %36, align 8
  %tmp2_v1.i62.i.i = add i32 %tmp0_v.i22.i, -372
  br label %Func_80492E0.exit.i.i

BB_80492E2.i.i:                                   ; preds = %Func_80492E0.exit.i.i
  %tmp2_v.i6.i.i = add i32 %tmp0_v.i22.i, -384
  %37 = inttoptr i32 %tmp2_v.i6.i.i to i32*
  store i32 0, i32* %37, align 16
  %tmp2_v1.i7.i.i = add i32 %tmp0_v.i22.i, -380
  %38 = inttoptr i32 %tmp2_v1.i7.i.i to i32*
...
BB_804931B.i.i:                                   ; preds = %BB_80492F8.i.i
  ...
  %tmp0_v12.i.i.i = add i32 %42, %41
  %43 = load i32, i32* %37, align 16
  %tmp0_v17.i.i.i = add i32 %43, %42
  %44 = inttoptr i32 %tmp0_v12.i.i.i to i8*
  %45 = load i8, i8* %44, align 1
  %46 = inttoptr i32 %tmp0_v17.i.i.i to i8*
  store i8 %45, i8* %46, align 1
  %47 = load i32, i32* %37, align 16
  %tmp0_v21.i.i.i = add i32 %47, 1
...
Func_80492E0.exit.i.i:                            ; preds = %Func_80492E0.exit.i.i, %.exit
  %r_edi.09.i = phi i32 [ %tmp2_v1.i62.i.i, %.exit ], [ %tmp4_v.i20.i.i, %Func_80492E0.exit.i.i ]
  %r_ecx.08.i = phi i32 [ 64, %.exit ], [ %tmp4_v3.i.i.i, %Func_80492E0.exit.i.i ]
  %48 = inttoptr i32 %r_edi.09.i to i32*
  store i32 0, i32* %48, align 4
  %tmp0_v.i19.i.i = load i32, i32* @df, align 4
  %tmp0_v1.i.i.i = shl i32 %tmp0_v.i19.i.i, 2
  %tmp4_v.i20.i.i = add i32 %tmp0_v1.i.i.i, %r_edi.09.i
...
BB_804935F.i.i:                                   ; preds = %BB_80492F8.i.i, %BB_804931B.i.i
  %49 = phi i32 [ %storemerge10.i, %BB_80492F8.i.i ], [ %.pre.i, %BB_804931B.i.i ]
  %tmp0_v1.i25.i.i = add i32 %49, 1
  store i32 %tmp0_v1.i25.i.i, i32* %38, align 4
  %50 = load i32, i32* %36, align 8
  %51 = icmp slt i32 %tmp0_v1.i25.i.i, %50
  br i1 %51, label %BB_80492F8.i.i, label %Func_remove_duplicates.exit

BB_80492F8.i.i:                                   ; preds = %BB_804935F.i.i, %BB_80492E2.i.i
  %storemerge10.i = phi i32 [ %tmp0_v1.i25.i.i, %BB_804935F.i.i ], [ 0, %BB_80492E2.i.i ]
  %52 = load i32, i32* %29, align 4
  %tmp0_v3.i37.i.i = add i32 %52, %storemerge10.i
  %53 = inttoptr i32 %tmp0_v3.i37.i.i to i8*
  %54 = load i8, i8* %53, align 1
  %tmp0_v5.i39.i.i = sext i8 %54 to i32
  %tmp2_v7.i41.i.i = add i32 %tmp2_v1.i62.i.i, %tmp0_v5.i39.i.i
  %55 = inttoptr i32 %tmp2_v7.i41.i.i to i8*
...
Func_remove_duplicates.exit:                      ; preds = %BB_804935F.i.i, %BB_80492E2.i.i
  ...
  %tmp2_v.i18.i = add i32 %61, -48
  store i32 %tmp2_v.i18.i, i32* %22, align 16
...
!10 = !{i32 0, i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @remove_duplicates_efficientm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
