...
@str.42 = constant [22 x i8] c"Row %d Average = %f\0a\0a\00"
@str.43 = constant [17 x i8] c"Row %d Sum = %f\0a\00"
...
define internal fastcc void @row_sum_avg_2darray44(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !28 {
Func_80491F9.exit.i:
  ...
  %2 = inttoptr i32 %tmp2_v3.i69.i to i32*
  store i32 %1, i32* %2, align 4
  %tmp2_v4.i70.i = add i32 %tmp0_v.i67.i, -8
  %3 = inttoptr i32 %tmp2_v4.i70.i to i32*
  store i32 0, i32* %3, align 8
  %tmp2_v5.i72.i = add i32 %tmp0_v.i67.i, -12
  %4 = inttoptr i32 %tmp2_v5.i72.i to i32*
  store i32 0, i32* %4, align 4
  %tmp2_v6.i74.i = add i32 %tmp0_v.i67.i, -16
  %5 = inttoptr i32 %tmp2_v6.i74.i to i32*
  store i32 0, i32* %5, align 16
  %tmp2_v7.i76.i = add i32 %tmp0_v.i67.i, -20
  %6 = inttoptr i32 %tmp2_v7.i76.i to i32*
  store i32 0, i32* %6, align 4
  %tmp2_v8.i78.i = add i32 %tmp0_v.i67.i, -24
  %7 = inttoptr i32 %tmp2_v8.i78.i to i32*
  store i32 %tmp2_v.i66.i, i32* %7, align 8
  %tmp2_v10.i80.i = add i32 %tmp0_v.i67.i, -164
  %8 = inttoptr i32 %tmp2_v10.i80.i to i32*
  store i32 134517206, i32* %8, align 4
  %tmp4_v.i30.i.b = load i1, i1* @segs.0, align 1
  %9 = inttoptr i32 %arg_esp to i32*
  %10 = load i32, i32* %9, align 4
  %tmp2_v2.i34.i = add i32 %tmp0_v.i67.i, -36
  %11 = inttoptr i32 %tmp2_v2.i34.i to i32*
  store i32 %10, i32* %11, align 4
  %tmp2_v3.i35.i = add i32 %tmp0_v.i67.i, -136
  %12 = load i32, i32* inttoptr (i32 134520928 to i32*), align 32
  %13 = inttoptr i32 %tmp2_v3.i35.i to i32*
  store i32 %12, i32* %13, align 8
  %tmp0_v1.i.i = load i32, i32* @df, align 4
  %tmp0_v2.i.i = shl i32 %tmp0_v1.i.i, 2
  %tmp4_v.i.i = add i32 %tmp0_v2.i.i, 134520928
  %tmp4_v3.i.i = add i32 %tmp0_v2.i.i, %tmp2_v3.i35.i
  ...
  %tmp2_v.i59.i = add i32 %tmp0_v.i67.i, -152
  %tmp6_v.i60.i = tail call fastcc i32 @helper_fsts_ST0()
  %86 = inttoptr i32 %tmp2_v.i59.i to i32*
  store i32 %tmp6_v.i60.i, i32* %86, align 8
  tail call fastcc void @helper_fpop()
  tail call fastcc void @helper_fpush()
  tail call fastcc void @helper_fldz_ST0()
  %tmp2_v2.i62.i = add i32 %tmp0_v.i67.i, -140
  %tmp6_v3.i.i = tail call fastcc i32 @helper_fsts_ST0()
  %87 = inttoptr i32 %tmp2_v2.i62.i to i32*
  store i32 %tmp6_v3.i.i, i32* %87, align 4
  tail call fastcc void @helper_fpop()
  %tmp2_v5.i64.i = add i32 %tmp0_v.i67.i, -148
  %88 = inttoptr i32 %tmp2_v5.i64.i to i32*
  %tmp2_v2.i.i = add i32 %tmp0_v.i67.i, -144
  %89 = inttoptr i32 %tmp2_v2.i.i to i32*
  %tmp2_v1.i85.i = add i32 %tmp0_v.i67.i, -168
  %90 = inttoptr i32 %tmp2_v1.i85.i to i64*
  %tmp2_v6.i89.i = add i32 %tmp0_v.i67.i, -172
  %91 = inttoptr i32 %tmp2_v6.i89.i to i32*
  %tmp2_v8.i92.i = add i32 %tmp0_v.i67.i, -176
  %92 = inttoptr i32 %tmp2_v8.i92.i to i32*
  %tmp2_v9.i.i = add i32 %tmp0_v.i67.i, -180
...
BB_804922E.i:                                     ; preds = %BB_804921A.i, %BB_804922E.i
  ...
  %tmp0_v2.i3.i = mul i32 %94, 5
  %tmp0_v5.i.i = add i32 %tmp0_v2.i3.i, %storemerge116
  %tmp4_v.i4.i = shl i32 %tmp0_v5.i.i, 2
  %tmp2_v7.i.i = add i32 %tmp4_v.i4.i, %tmp2_v3.i35.i
...
BB_804921A.i:                                     ; preds = %BB_8049265.i, %Func_80491F9.exit.i
  tail call fastcc void @helper_fpush()
  tail call fastcc void @helper_fldz_ST0()
  %tmp6_v.i8.i = tail call fastcc i32 @helper_fsts_ST0()
  store i32 %tmp6_v.i8.i, i32* %86, align 8
  tail call fastcc void @helper_fpop()
...
BB_8049265.i:                                     ; preds = %BB_804922E.i
  ...
  store i64 %tmp5_v.i86.i, i64* %90, align 8
  tail call fastcc void @helper_fpop()
  %101 = load i32, i32* %88, align 4
  store i32 %101, i32* %91, align 4
  %spi43 = ptrtoint[17 x i8]* @str.43 to i32
  store i32 %spi43, i32* %92, align 16
  store i32 134517380, i32* %93, align 4
  %102 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef 0, i32 inreg noundef %storemerge116, i32 noundef %tmp2_v8.i92.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !29
  %103 = lshr i64 %102, 32
  ...
  tail call fastcc void @helper_fpop()
  %tmp6_v.i46.i = tail call fastcc i32 @helper_fsts_ST0()
  store i32 %tmp6_v.i46.i, i32* %87, align 4
  tail call fastcc void @helper_fpop()
  ...
  %spi42 = ptrtoint[22 x i8]* @str.42 to i32
  store i32 %spi42, i32* %92, align 16
  store i32 134517434, i32* %93, align 4
  %109 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef 0, i32 inreg noundef %104, i32 noundef %tmp2_v8.i92.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !29
  %110 = load i32, i32* %88, align 4
  %tmp0_v2.i24.i = add i32 %110, 1
  store i32 %tmp0_v2.i24.i, i32* %88, align 4
  %111 = icmp slt i32 %tmp0_v2.i24.i, 5
...
!29 = !{!"printf"}
  ...
  tail call fastcc void @row_sum_avg_2darray44(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
