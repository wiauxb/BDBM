...
@str.211 = constant [20 x i8] c"%c is alphanumeric\0a\00"
...
define internal fastcc void @isalnum212(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v.i14.i = add i32 %tmp0_v.i.i, -17
  %7 = inttoptr i32 %tmp2_v.i14.i to i8*
  ...
  store i32 %spi211, i32* %11, align 16
  %tmp2_v5.i10.i = add i32 %tmp0_v.i.i, -52
  %12 = inttoptr i32 %tmp2_v5.i10.i to i32*
  store i32 134517259, i32* %12, align 4
  %13 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %tmp0_v2.i25.i, i32 noundef %tmp2_v4.i9.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @isalnum212(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
