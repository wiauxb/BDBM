...
@str.382 = constant [7 x i8] c"e: %s\0a\00"
@str.383 = constant [7 x i8] c"d: %s\0a\00"
...
define internal fastcc void @memcpy384(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v.i4.i = add i32 %tmp0_v.i9.i, -75
  %43 = inttoptr i32 %tmp2_v.i4.i to i8*
  store i8 0, i8* %43, align 1
  store i32 %tmp2_v5.i23.i, i32* %34, align 4
  %spi382 = ptrtoint[7 x i8]* @str.382 to i32
  store i32 %spi382, i32* %35, align 16
  store i32 134517422, i32* %36, align 4
  %44 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %39, i32 noundef %tmp2_v39.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @memcpy384(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
