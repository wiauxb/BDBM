...
label_1.i128.i:
  ...
  %4 = inttoptr i32 %tmp2_v5.i43.i to i32*
  store i32 0, i32* %4, align 4
  %tmp2_v6.i45.i = add i32 %tmp0_v.i38.i, -16
  %5 = inttoptr i32 %tmp2_v6.i45.i to i32*
  store i32 %tmp2_v.i37.i, i32* %5, align 16
  %tmp2_v8.i47.i = add i32 %tmp0_v.i38.i, -68
  %6 = inttoptr i32 %tmp2_v8.i47.i to i32*
  store i32 134517297, i32* %6, align 4
  %tmp4_v.i119.i.b = load i1, i1* @segs.0, align 1
  %7 = inttoptr i32 %arg_esp to i32*
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i123.i = add i32 %tmp0_v.i38.i, -20
  %9 = inttoptr i32 %tmp2_v2.i123.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i124.i = add i32 %tmp0_v.i38.i, -52
  %10 = inttoptr i32 %tmp2_v3.i124.i to i32*
  store i32 1, i32* %10, align 4
  %tmp2_v1.i9.i = add i32 %tmp0_v.i38.i, -80
  %11 = inttoptr i32 %tmp2_v1.i9.i to i32*
  %spi878 = ptrtoint[8 x i8]* @str.878 to i32
  store i32 %spi878, i32* %11, align 16
  %tmp2_v2.i10.i = add i32 %tmp0_v.i38.i, -84
  %12 = inttoptr i32 %tmp2_v2.i10.i to i32*
  ...
  %spi877 = ptrtoint[4 x i8]* @str.877 to i32
  store i32 %spi877, i32* %11, align 16
  ...
  %spi876 = ptrtoint[24 x i8]* @str.876 to i32
  store i32 %spi876, i32* %11, align 16
  ...
  %tmp2_v.i3.i = add i32 %tmp0_v.i38.i, -43
  %19 = inttoptr i32 %tmp2_v.i3.i to i32*
  store i32 1096966497, i32* %19, align 4
  %tmp2_v1.i.i = add i32 %tmp0_v.i38.i, -39
  %20 = inttoptr i32 %tmp2_v1.i.i to i32*
  store i32 1734763876, i32* %20, align 4
  %tmp2_v2.i.i = add i32 %tmp0_v.i38.i, -35
  %21 = inttoptr i32 %tmp2_v2.i.i to i32*
  store i32 1265256808, i32* %21, align 4
  %tmp2_v3.i4.i = add i32 %tmp0_v.i38.i, -31
  %22 = inttoptr i32 %tmp2_v3.i4.i to i32*
  store i32 1867402604, i32* %22, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i38.i, -27
  %23 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 1934782800, i32* %23, align 4
  %tmp2_v5.i.i = add i32 %tmp0_v.i38.i, -23
  %24 = inttoptr i32 %tmp2_v5.i.i to i16*
  store i16 21844, i16* %24, align 2
  %tmp2_v6.i.i = add i32 %tmp0_v.i38.i, -21
  %25 = inttoptr i32 %tmp2_v6.i.i to i8*
  store i8 0, i8* %25, align 1
  store i32 %tmp2_v.i3.i, i32* %11, align 16
  store i32 134517486, i32* %12, align 4
  %arg.i.i3 = load i32, i32* %11, align 16
  %26 = tail call i32 @strlen(i32 %arg.i.i3)
  %mrv.i4 = insertvalue { i32, i32 } undef, i32 %tmp2_v1.i9.i, 0
  %tmp2_v.i91.i = add i32 %tmp0_v.i38.i, -48
  %27 = inttoptr i32 %tmp2_v.i91.i to i32*
  store i32 %26, i32* %27, align 16
  %tmp2_v1.i93.i = add i32 %tmp0_v.i38.i, -64
  %28 = inttoptr i32 %tmp2_v1.i93.i to i32*
  store i32 0, i32* %28, align 16
  %tmp2_v2.i94.i = add i32 %tmp0_v.i38.i, -60
  %29 = inttoptr i32 %tmp2_v2.i94.i to i32*
  store i32 0, i32* %29, align 4
  %tmp2_v3.i95.i = add i32 %tmp0_v.i38.i, -56
  %30 = inttoptr i32 %tmp2_v3.i95.i to i32*
...
BB_8049340.i:                                     ; preds = %BB_804930B.i, %BB_804933C.i
  ...
  %tmp0_v1.i51.i = add i32 %33, 1
  store i32 %tmp0_v1.i51.i, i32* %29, align 4
  br label %BB_8049344.i

BB_8049344.i:                                     ; preds = %BB_804930B.i, %BB_8049340.i
  %34 = load i32, i32* %30, align 8
  %tmp0_v1.i68.i = add i32 %34, 1
  store i32 %tmp0_v1.i68.i, i32* %30, align 8
  %r_esp.0.in = extractvalue { i32, i32 } %.pn13.pn, 0
  %35 = load i32, i32* %27, align 16
  %36 = icmp slt i32 %tmp0_v1.i68.i, %35
  br i1 %36, label %BB_804930B.i, label %BB_8049350.i

BB_8049350.i:                                     ; preds = %BB_8049344.i, %label_1.i128.i
  %.pn.pn.lcssa = phi { i32, i32 } [ %mrv.i4, %label_1.i128.i ], [ %.pn13, %BB_8049344.i ]
  %r_edx.0.lcssa = phi i32 [ 0, %label_1.i128.i ], [ %tmp2_v.i3.i, %BB_8049344.i ]
  %r_esp.0.in.le = extractvalue { i32, i32 } %.pn.pn.lcssa, 0
  %37 = load i32, i32* %29, align 4
  %tmp2_v2.i80.i = add i32 %r_esp.0.in.le, 8
  %38 = inttoptr i32 %tmp2_v2.i80.i to i32*
  store i32 %37, i32* %38, align 4
  %39 = load i32, i32* %28, align 16
  %tmp2_v5.i83.i = add i32 %r_esp.0.in.le, 4
  %40 = inttoptr i32 %tmp2_v5.i83.i to i32*
  store i32 %39, i32* %40, align 4
  %41 = inttoptr i32 %r_esp.0.in.le to i32*
  %spi875 = ptrtoint[18 x i8]* @str.875 to i32
  store i32 %spi875, i32* %41, align 4
  %tmp2_v8.i87.i = add i32 %r_esp.0.in.le, -4
  %42 = inttoptr i32 %tmp2_v8.i87.i to i32*
  store i32 134517605, i32* %42, align 4
  %43 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i37.i, i32 inreg noundef %r_edx.0.lcssa, i32 noundef %r_esp.0.in.le, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void

BB_804933C.i:                                     ; preds = %BB_804930B.i
  %44 = load i32, i32* %28, align 16
  %tmp0_v1.i105.i = add i32 %44, 1
  store i32 %tmp0_v1.i105.i, i32* %28, align 16
  br label %BB_8049340.i

BB_804930B.i:                                     ; preds = %BB_8049344.i, %label_1.i128.i
  %r_esp.0.in14 = phi i32 [ %r_esp.0.in, %BB_8049344.i ], [ %tmp2_v1.i9.i, %label_1.i128.i ]
  %.pn13.pn = phi { i32, i32 } [ %.pn13, %BB_8049344.i ], [ %mrv.i4, %label_1.i128.i ]
  %.pn16 = phi i32 [ %49, %BB_8049344.i ], [ %26, %label_1.i128.i ]
  %storemerge12 = phi i32 [ %tmp0_v1.i68.i, %BB_8049344.i ], [ 0, %label_1.i128.i ]
  %.pn13 = insertvalue { i32, i32 } %.pn13.pn, i32 %.pn16, 1
  %tmp0_v2.i133.i = add i32 %storemerge12, %tmp2_v.i3.i
  ...
  %tmp2_v7.i139.i = add i32 %r_esp.0.in14, -4
  ...
  %tmp0_v1.i26.i = shl i32 %49, 2
  %tmp2_v1.i14.i = add i32 %tmp0_v1.i26.i, 134520656
  %50 = inttoptr i32 %tmp2_v1.i14.i to i32*
