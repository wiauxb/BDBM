...
define internal fastcc void @postal_codem15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
Func_804926D.exit.i:
  ...
  %tmp2_v8.i89.i = add i32 %tmp0_v.i82.i, -68
  %6 = inttoptr i32 %tmp2_v8.i89.i to i32*
  store i32 134517265, i32* %6, align 4
  %tmp4_v.i53.i.b = load i1, i1* @segs.0, align 1
  %7 = select i1 %tmp4_v.i53.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i57.i = add i32 %tmp0_v.i82.i, -20
  %9 = inttoptr i32 %tmp2_v2.i57.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i58.i = add i32 %tmp0_v.i82.i, -45
  %10 = inttoptr i32 %tmp2_v3.i58.i to i32*
  store i32 541800524, i32* %10, align 4
  %tmp2_v4.i59.i = add i32 %tmp0_v.i82.i, -41
  %11 = inttoptr i32 %tmp2_v4.i59.i to i32*
  store i32 3555892, i32* %11, align 4
  %tmp2_v5.i.i = add i32 %tmp0_v.i82.i, -29
  %12 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 540424268, i32* %12, align 4
  %tmp2_v6.i.i = add i32 %tmp0_v.i82.i, -25
  %13 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 892748340, i32* %13, align 4
  %tmp2_v7.i.i = add i32 %tmp0_v.i82.i, -21
  %14 = inttoptr i32 %tmp2_v7.i.i to i8*
  store i8 0, i8* %14, align 1
  %tmp2_v8.i.i = add i32 %tmp0_v.i82.i, -52
  %15 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 875968588, i32* %15, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i82.i, -48
  %16 = inttoptr i32 %tmp2_v9.i.i to i16*
  store i16 13890, i16* %16, align 16
  %tmp2_v10.i.i = add i32 %tmp0_v.i82.i, -46
  %17 = inttoptr i32 %tmp2_v10.i.i to i8*
  store i8 0, i8* %17, align 2
  %tmp2_v11.i.i = add i32 %tmp0_v.i82.i, -37
  %18 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 541538380, i32* %18, align 4
  %tmp2_v12.i.i = add i32 %tmp0_v.i82.i, -33
  %19 = inttoptr i32 %tmp2_v12.i.i to i32*
  store i32 4670004, i32* %19, align 4
  %tmp2_v15.i.i = add i32 %tmp0_v.i82.i, -80
  %20 = inttoptr i32 %tmp2_v15.i.i to i32*
  store i32 %tmp2_v3.i58.i, i32* %20, align 16
  %tmp2_v16.i.i = add i32 %tmp0_v.i82.i, -84
  %21 = inttoptr i32 %tmp2_v16.i.i to i32*
  store i32 134517357, i32* %21, align 4
  %22 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_is_postal_code(i32 %tmp2_v16.i.i, i32 0, i32 %tmp2_v4.i84.i, i32 134529024)
  ...
  %tmp2_v.i93.i = add i32 %25, -37
  %tmp2_v1.i94.i = add i32 %23, 4
  %27 = inttoptr i32 %tmp2_v1.i94.i to i32*
  store i32 %tmp2_v.i93.i, i32* %27, align 4
  %tmp2_v2.i96.i = add i32 %26, -8184
  %28 = inttoptr i32 %23 to i32*
  store i32 %tmp2_v2.i96.i, i32* %28, align 4
  %tmp2_v4.i98.i = add i32 %23, -4
  %29 = inttoptr i32 %tmp2_v4.i98.i to i32*
  store i32 134517383, i32* %29, align 4
  %30 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i81.i, i32 inreg noundef %24, i32 noundef %23, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %31 = lshr i64 %30, 32
  %32 = trunc i64 %31 to i32
  %tmp2_v.i64.i = add i32 %25, -21
  store i32 %tmp2_v.i64.i, i32* %28, align 4
  store i32 134517422, i32* %29, align 4
  %33 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_is_postal_code(i32 %tmp2_v4.i98.i, i32 %32, i32 %25, i32 %26)
  ...
  %tmp2_v.i4.i = add i32 %36, -21
  %tmp2_v1.i5.i = add i32 %34, 4
  %38 = inttoptr i32 %tmp2_v1.i5.i to i32*
  store i32 %tmp2_v.i4.i, i32* %38, align 4
  %tmp2_v2.i7.i = add i32 %37, -8163
  %39 = inttoptr i32 %34 to i32*
  store i32 %tmp2_v2.i7.i, i32* %39, align 4
  %tmp2_v4.i9.i = add i32 %34, -4
  %40 = inttoptr i32 %tmp2_v4.i9.i to i32*
  store i32 134517472, i32* %40, align 4
  %41 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i81.i, i32 inreg noundef %35, i32 noundef %34, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %42 = lshr i64 %41, 32
  %43 = trunc i64 %42 to i32
  %tmp2_v.i71.i = add i32 %36, -44
  store i32 %tmp2_v.i71.i, i32* %39, align 4
  store i32 134517487, i32* %40, align 4
  %44 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_is_postal_code(i32 %tmp2_v4.i9.i, i32 %43, i32 %36, i32 %37)
  ...
  %tmp2_v.i.i = add i32 %47, -44
  %tmp2_v1.i.i = add i32 %45, 4
  %49 = inttoptr i32 %tmp2_v1.i.i to i32*
  store i32 %tmp2_v.i.i, i32* %49, align 4
  %tmp2_v2.i.i = add i32 %48, -8163
  %50 = inttoptr i32 %45 to i32*
  store i32 %tmp2_v2.i.i, i32* %50, align 4
  %tmp2_v4.i.i = add i32 %45, -4
  %51 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 134517537, i32* %51, align 4
  %52 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i81.i, i32 inreg noundef %46, i32 noundef %45, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %53 = lshr i64 %52, 32
  %54 = trunc i64 %53 to i32
  %tmp2_v.i25.i = add i32 %47, -29
  store i32 %tmp2_v.i25.i, i32* %50, align 4
  store i32 134517552, i32* %51, align 4
  %55 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_is_postal_code(i32 %tmp2_v4.i.i, i32 %54, i32 %47, i32 %48)
  ...
  %tmp2_v.i35.i = add i32 %58, -29
  %tmp2_v1.i36.i = add i32 %56, 4
  %60 = inttoptr i32 %tmp2_v1.i36.i to i32*
  store i32 %tmp2_v.i35.i, i32* %60, align 4
  %tmp2_v2.i38.i = add i32 %59, -8163
  %61 = inttoptr i32 %56 to i32*
  store i32 %tmp2_v2.i38.i, i32* %61, align 4
  %tmp2_v4.i40.i = add i32 %56, -4
  %62 = inttoptr i32 %tmp2_v4.i40.i to i32*
  store i32 134517602, i32* %62, align 4
  %63 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i81.i, i32 inreg noundef %57, i32 noundef %56, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
BB_80493B8.i:                                     ; preds = %Func_80493A6.exit.i
  ...
  %tmp0_v2.i100.i = add i32 %17, 6
  %18 = inttoptr i32 %tmp0_v2.i100.i to i8*
  %19 = load i8, i8* %18, align 1
  %tmp0_v4.i102.i = sext i8 %19 to i32
  %tmp0_v5.i103.i = shl nsw i32 %tmp0_v4.i102.i, 1
  %tmp0_v6.i104.i = add i32 %tmp0_v5.i103.i, %16
  %20 = inttoptr i32 %tmp0_v6.i104.i to i16*
...
.exit:                                            ; preds = %BB_80493B8.i, %Func_80493A6.exit.i
  %r_edx.0 = phi i32 [ %arg_edx, %Func_80493A6.exit.i ], [ %tmp0_v5.i103.i, %BB_80493B8.i ]
  %r_eax.0 = phi i32 [ 0, %Func_80493A6.exit.i ], [ %23, %BB_80493B8.i ]
  %24 = load i32, i32* %1, align 4
  %25 = load i32, i32* %0, align 4
  %mrv = insertvalue { i32, i32, i32, i32, i32 } undef, i32 %tmp2_v.i48.i, 0
...
!14 = !{i32 0, i32 2, i32 3, i32 4}
  ...
  tail call fastcc void @postal_codem15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
