...
@str.525 = constant [15 x i8] c"result[%d]=%f\0a\00"
...
define internal fastcc void @vector_add527(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !24 {
  ...
  %tmp2_v1.i20.i = add i32 %tmp0_v.i6.i, -56
  %tmp6_v.i.i = tail call fastcc i32 @helper_fsts_ST0()
  %12 = inttoptr i32 %tmp2_v1.i20.i to i32*
  ...
  %tmp2_v6.i23.i = add i32 %tmp0_v.i6.i, -52
  ...
  %tmp2_v12.i25.i = add i32 %tmp0_v.i6.i, -48
  %tmp6_v13.i.i = tail call fastcc i32 @helper_fsts_ST0()
  %16 = inttoptr i32 %tmp2_v12.i25.i to i32*
  ...
  %tmp2_v18.i.i = add i32 %tmp0_v.i6.i, -44
  ...
  %tmp2_v24.i.i = add i32 %tmp0_v.i6.i, -40
  ...
  %tmp2_v27.i.i = add i32 %tmp0_v.i6.i, -36
  ...
  %tmp2_v30.i.i = add i32 %tmp0_v.i6.i, -32
  ...
  tail call fastcc void @helper_fpush()
  tail call fastcc void @helper_fldz_ST0()
  %tmp2_v33.i.i = add i32 %tmp0_v.i6.i, -28
  ...
  tail call fastcc void @helper_fpush()
  tail call fastcc void @helper_fldz_ST0()
  %tmp2_v36.i.i = add i32 %tmp0_v.i6.i, -24
...
BB_80492A9.i.i:                                   ; preds = %BB_80492A9.i.i, %0
  ...
  %tmp4_v.i13.i.i = shl i32 %storemerge1.i, 2
  %34 = load i32, i32* %27, align 16
  %tmp0_v3.i.i.i = add i32 %34, %tmp4_v.i13.i.i
...
BB_8049242.i:                                     ; preds = %BB_8049242.i, %Func_vector_add.exit
  ...
  %storemerge5 = phi i32 [ 0, %Func_vector_add.exit ], [ %tmp0_v2.i65.i, %BB_8049242.i ]
  ...
  %spi525 = ptrtoint[15 x i8]* @str.525 to i32
  store i32 %spi525, i32* %27, align 16
  store i32 134517343, i32* %28, align 4
  %53 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i5.i, i32 inreg noundef %r_edx.06, i32 noundef %tmp2_v45.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %54 = lshr i64 %53, 32
...
!25 = !{!"printf"}
  ...
  tail call fastcc void @vector_add527(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
