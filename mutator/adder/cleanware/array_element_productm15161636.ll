...
define internal fastcc void @array_element_productm15161636(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v4.i6.i = add i32 %tmp0_v.i28.i, -36
  %11 = inttoptr i32 %tmp2_v4.i6.i to i32*
  store i32 5, i32* %11, align 4
  %tmp2_v5.i.i = add i32 %tmp0_v.i28.i, -32
  %12 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 3, i32* %12, align 16
  %tmp2_v6.i.i = add i32 %tmp0_v.i28.i, -28
  %13 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 4, i32* %13, align 4
  %tmp2_v7.i.i = add i32 %tmp0_v.i28.i, -24
  %14 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 2, i32* %14, align 8
  %tmp2_v9.i.i = add i32 %tmp0_v.i28.i, -60
  %15 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 5, i32* %15, align 4
  %tmp2_v11.i.i = add i32 %tmp0_v.i28.i, -64
  %16 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 %tmp2_v3.i.i, i32* %16, align 16
  %tmp2_v12.i.i = add i32 %tmp0_v.i28.i, -68
  %17 = inttoptr i32 %tmp2_v12.i.i to i32*
  store i32 134517267, i32* %17, align 4
  %tmp2_v.i6.i.i = add i32 %tmp0_v.i28.i, -72
  %18 = inttoptr i32 %tmp2_v.i6.i.i to i32*
  store i32 %tmp2_v4.i30.i, i32* %18, align 8
  %tmp2_v1.i9.i.i = add i32 %tmp0_v.i28.i, -92
  %19 = inttoptr i32 %tmp2_v1.i9.i.i to i32*
  store i32 134517341, i32* %19, align 4
  %tmp2_v.i12.i.i = add i32 %tmp0_v.i28.i, -80
  %20 = inttoptr i32 %tmp2_v.i12.i.i to i32*
  store i32 1, i32* %20, align 16
  %tmp2_v1.i13.i.i = add i32 %tmp0_v.i28.i, -76
...
BB_8049272.i.i:                                   ; preds = %BB_8049272.i.i, %.exit
  ...
  %tmp0_v3.i.i.i = add i32 %24, %tmp4_v.i.i.i1
...
Func_element_product.exit:                        ; preds = %BB_8049272.i.i, %.exit
  ...
  store i32 134520840, i32* %16, align 16
  store i32 134517291, i32* %17, align 4
  %34 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i27.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v11.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @array_element_productm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
