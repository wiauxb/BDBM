...
@str.163 = constant [9 x i8] c"max: %d\0a\00"
...
BB_80492A6.i:                                     ; preds = %Func_8049283.exit.i
  %tmp0_v1.i37.i = add i32 %3, -1
  %tmp2_v3.i.i = add i32 %arg_esp, -40
  %7 = inttoptr i32 %tmp2_v3.i.i to i32*
  store i32 %tmp0_v1.i37.i, i32* %7, align 4
  %tmp2_v4.i40.i = add i32 %arg_esp, 4
  %8 = inttoptr i32 %tmp2_v4.i40.i to i32*
  ...
  %12 = tail call fastcc { i32, i32, i32, i32 } @Func_max(i32 %tmp2_v7.i.i, i32 %tmp2_v.i10.i)
  %13 = extractvalue { i32, i32, i32, i32 } %12, 1
  %14 = extractvalue { i32, i32, i32, i32 } %12, 3
  %tmp2_v.i24.i = add i32 %14, -12
  %15 = inttoptr i32 %tmp2_v.i24.i to i32*
  store i32 %13, i32* %15, align 4
  %tmp2_v1.i26.i = add i32 %14, 12
  %16 = inttoptr i32 %tmp2_v1.i26.i to i32*
  %17 = load i32, i32* %16, align 4
  %tmp0_v3.i27.i = shl i32 %17, 2
  %tmp4_v.i28.i = add i32 %tmp0_v3.i27.i, -4
  %tmp2_v4.i.i = add i32 %14, 8
  %18 = inttoptr i32 %tmp2_v4.i.i to i32*
  %19 = load i32, i32* %18, align 4
  %tmp0_v6.i30.i = add i32 %tmp4_v.i28.i, %19
  %20 = inttoptr i32 %tmp0_v6.i30.i to i32*
  %21 = load i32, i32* %20, align 4
  %.not.i32.i = icmp sgt i32 %13, %21
  %spec.select = select i1 %.not.i32.i, i32* %15, i32* %20
...
.exit:                                            ; preds = %BB_80492A6.i, %BB_804928E.i
  ...
  %r_edx.0 = phi i32 [ %tmp4_v.i28.i, %BB_80492A6.i ], [ 0, %BB_804928E.i ]
...
define internal fastcc void @find_array_max_recursive164(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !13 {
.exit:
  ...
  %24 = tail call fastcc { i32, i32, i32, i32 } @Func_max(i32 %tmp2_v20.i.i, i32 %tmp2_v4.i.i)
  ...
  %spi163 = ptrtoint[9 x i8]* @str.163 to i32
  store i32 %spi163, i32* %29, align 4
  %tmp2_v4.i5.i = add i32 %25, -4
  %30 = inttoptr i32 %tmp2_v4.i5.i to i32*
  store i32 134517329, i32* %30, align 4
  %31 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %27, i32 noundef %25, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  ret void
}
...
!14 = !{!"printf"}
  ...
  tail call fastcc void @find_array_max_recursive164(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
