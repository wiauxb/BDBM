...
define internal fastcc void @string_lengthm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v5.i.i = add i32 %tmp0_v.i16.i, -48
  %9 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 134520840, i32* %9, align 16
  %tmp2_v6.i.i = add i32 %tmp0_v.i16.i, -52
  ...
  %tmp2_v.i35.i = add i32 %tmp0_v.i16.i, -24
  %12 = inttoptr i32 %tmp2_v.i35.i to i32*
  store i32 %11, i32* %12, align 8
  %tmp2_v4.i40.i = add i32 %tmp0_v.i16.i, -44
  %13 = inttoptr i32 %tmp2_v4.i40.i to i32*
  store i32 %11, i32* %13, align 4
  store i32 134520857, i32* %9, align 16
  store i32 134517251, i32* %10, align 4
  %14 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i15.i, i32 inreg noundef 0, i32 noundef %tmp2_v5.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %15 = load i32, i32* %8, align 4
  store i32 %15, i32* %9, align 16
  store i32 134517265, i32* %10, align 4
  %tmp2_v.i9.i.i = add i32 %tmp0_v.i16.i, -56
  %16 = inttoptr i32 %tmp2_v.i9.i.i to i32*
  store i32 %tmp2_v4.i19.i, i32* %16, align 8
  %tmp2_v1.i12.i.i = add i32 %tmp0_v.i16.i, -76
  %17 = inttoptr i32 %tmp2_v1.i12.i.i to i32*
  store i32 134517322, i32* %17, align 4
  %tmp2_v.i3.i.i = add i32 %tmp0_v.i16.i, -60
...
BB_804925C.i.i:                                   ; preds = %BB_804925C.i.i, %0
  ...
  %tmp0_v3.i8.i.i = add i32 %19, %storemerge.i
  %20 = inttoptr i32 %tmp0_v3.i8.i.i to i8*
...
Func_string_length.exit:                          ; preds = %BB_804925C.i.i
  ...
  %tmp2_v.i27.i = add i32 %22, -12
  %23 = inttoptr i32 %tmp2_v.i27.i to i32*
  store i32 %tmp0_v1.i16.i.i, i32* %23, align 4
  store i32 %tmp0_v1.i16.i.i, i32* %13, align 4
  store i32 134520869, i32* %9, align 16
  store i32 134517289, i32* %10, align 4
  %24 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i15.i, i32 inreg noundef %storemerge.i, i32 noundef %tmp2_v5.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @string_lengthm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
