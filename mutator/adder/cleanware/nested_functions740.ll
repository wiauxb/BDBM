...
@str.bis.734 = constant [14 x i8] c"\76\61\72\69\61\62\6c\65\3a\20\25\64\0a\00"
@str.bis.735 = constant [4 x i8] c"\05\3e\2e\00"
@str.bis.736 = constant [14 x i8] c"\76\61\72\69\61\62\6c\65\3a\20\25\64\0a\00"
@str.bis.737 = constant [4 x i8] c"\05\3e\2e\00"
@str.bis.738 = constant [4 x i8] c"\05\08\2e\00"
...
define internal fastcc void @nested_functions740(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %tmp2_v.i4.i.i = add i32 %tmp0_v.i3.i, -24
  %8 = inttoptr i32 %tmp2_v.i4.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %8, align 8
  %tmp2_v1.i7.i.i = add i32 %tmp0_v.i3.i, -52
  %9 = inttoptr i32 %tmp2_v1.i7.i.i to i32*
  %spi.bis.738 = ptrtoint[4 x i8]* @str.bis.738 to i32
  store i32 %spi.bis.738, i32* %9, align 4
  %tmp4_v.i13.i.b.i = load i1, i1* @segs.0, align 1
  %10 = inttoptr i32 %arg_esp to i32*
  %11 = load i32, i32* %10, align 4
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i3.i, -36
  %12 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  store i32 %11, i32* %12, align 4
  %tmp2_v4.i.i.i = add i32 %tmp0_v.i3.i, -40
  %13 = inttoptr i32 %tmp2_v4.i.i.i to i32*
  store i32 %tmp2_v6.i.i, i32* %13, align 8
  %tmp2_v5.i.i.i = add i32 %tmp0_v.i3.i, -44
  %14 = inttoptr i32 %tmp2_v5.i.i.i to i32*
  store i32 5, i32* %14, align 4
  store i32 134517280, i32* %9, align 4
  %tmp2_v.i.i.i.i = add i32 %tmp0_v.i3.i, -56
  %15 = inttoptr i32 %tmp2_v.i.i.i.i to i32*
  store i32 %tmp2_v.i4.i.i, i32* %15, align 8
  %tmp2_v1.i.i.i.i = add i32 %tmp0_v.i3.i, -60
  %16 = inttoptr i32 %tmp2_v1.i.i.i.i to i32*
  store i32 134529024, i32* %16, align 4
  %tmp2_v2.i.i.i.i = add i32 %tmp0_v.i3.i, -84
  %17 = inttoptr i32 %tmp2_v2.i.i.i.i to i32*
  %spi.bis.737 = ptrtoint[4 x i8]* @str.bis.737 to i32
  store i32 %spi.bis.737, i32* %17, align 4
  %tmp2_v.i3.i.i.i = add i32 %tmp0_v.i3.i, -68
  %18 = inttoptr i32 %tmp2_v.i3.i.i.i to i32*
  store i32 %tmp2_v5.i.i.i, i32* %18, align 4
  %19 = load i32, i32* %14, align 4
  %tmp2_v3.i.i.i.i = add i32 %tmp0_v.i3.i, -92
  %20 = inttoptr i32 %tmp2_v3.i.i.i.i to i32*
  store i32 %19, i32* %20, align 4
  %tmp2_v5.i.i.i.i = add i32 %tmp0_v.i3.i, -96
  %21 = inttoptr i32 %tmp2_v5.i.i.i.i to i32*
  %spi.bis.736 = ptrtoint[14 x i8]* @str.bis.736 to i32
  store i32 %spi.bis.736, i32* %21, align 16
  %tmp2_v6.i.i.i.i = add i32 %tmp0_v.i3.i, -100
  ...
  %tmp2_v.i9.i.i = add i32 %25, -20
  store i32 134517290, i32* %9, align 4
  store i32 %25, i32* %15, align 8
  store i32 %24, i32* %16, align 4
  %spi.bis.735 = ptrtoint[4 x i8]* @str.bis.735 to i32
  store i32 %spi.bis.735, i32* %17, align 4
  store i32 %tmp2_v.i9.i.i, i32* %18, align 4
  %26 = inttoptr i32 %tmp2_v.i9.i.i to i32*
  %27 = load i32, i32* %26, align 4
  store i32 %27, i32* %20, align 4
  %spi.bis.734 = ptrtoint[14 x i8]* @str.bis.734 to i32
  store i32 %spi.bis.734, i32* %21, align 16
  store i32 134517216, i32* %22, align 4
  %28 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i9.i.i, i32 inreg noundef 134520840, i32 noundef %tmp2_v5.i.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %29 = load i32, i32* %16, align 4
  %30 = load i32, i32* %15, align 8
  %31 = inttoptr i32 %30 to i32*
  %32 = load i32, i32* %31, align 4
  %tmp2_v.i18.i = add i32 %30, 4
  %33 = inttoptr i32 %tmp2_v.i18.i to i32*
  ...
  %tmp2_v3.i20.i = add i32 %30, -8
  %35 = inttoptr i32 %tmp2_v3.i20.i to i32*
  store i32 4, i32* %35, align 4
  %tmp2_v4.i21.i = add i32 %30, -12
  %36 = inttoptr i32 %tmp2_v4.i21.i to i32*
  store i32 134517502, i32* %36, align 4
  %tmp2_v.i2.i.i = add i32 %30, -16
  %37 = inttoptr i32 %tmp2_v.i2.i.i to i32*
  store i32 %32, i32* %37, align 4
  %tmp2_v1.i5.i.i = add i32 %30, -44
  %38 = inttoptr i32 %tmp2_v1.i5.i.i to i32*
  store i32 134517353, i32* %38, align 4
  %tmp4_v.i.i.b.i = load i1, i1* @segs.0, align 1
  %39 = inttoptr i32 %arg_esp to i32*
  %40 = load i32, i32* %39, align 4
  %tmp2_v2.i16.i.i = add i32 %30, -28
  %41 = inttoptr i32 %tmp2_v2.i16.i.i to i32*
  store i32 %40, i32* %41, align 4
  %tmp2_v4.i18.i.i = add i32 %30, -40
  %42 = inttoptr i32 %tmp2_v4.i18.i.i to i32*
  store i32 %tmp2_v3.i20.i, i32* %42, align 4
  ...
  %tmp2_v.i.i.i.i3 = add i32 %30, -56
  %47 = inttoptr i32 %tmp2_v.i.i.i.i3 to i32*
  store i32 %tmp2_v.i2.i.i, i32* %47, align 4
  %tmp2_v1.i.i.i.i4 = add i32 %30, -64
  %48 = inttoptr i32 %tmp2_v1.i.i.i.i4 to i32*
  store i32 134517321, i32* %48, align 4
  %tmp2_v.i3.i.i.i5 = add i32 %30, -60
  %49 = inttoptr i32 %tmp2_v.i3.i.i.i5 to i32*
  store i32 %tmp2_v4.i18.i.i, i32* %49, align 4
  %50 = load i32, i32* %45, align 4
  %51 = load i32, i32* %38, align 4
  %tmp15_v5.i.i.i.i = mul i32 %51, %50
  %52 = load i32, i32* %47, align 4
  %tmp2_v.i.i.i = add i32 %52, -20
  %53 = inttoptr i32 %tmp2_v.i.i.i to i32*
  store i32 %tmp15_v5.i.i.i.i, i32* %53, align 4
  %tmp2_v1.i.i.i = add i32 %52, -24
  %tmp2_v2.i.i.i6 = add i32 %52, 20
  %54 = inttoptr i32 %tmp2_v2.i.i.i6 to i32*
  %55 = load i32, i32* %54, align 4
  store i32 %55, i32* %38, align 4
  %tmp2_v5.i.i.i7 = add i32 %52, 16
  %56 = inttoptr i32 %tmp2_v5.i.i.i7 to i32*
  %57 = load i32, i32* %56, align 4
  store i32 %57, i32* %45, align 4
  store i32 134517413, i32* %46, align 4
  store i32 %52, i32* %47, align 4
  store i32 134517321, i32* %48, align 4
  store i32 %tmp2_v1.i.i.i, i32* %49, align 4
  %58 = load i32, i32* %45, align 4
  %59 = load i32, i32* %38, align 4
  %tmp15_v5.i.i.i27.i = mul i32 %59, %58
  %60 = load i32, i32* %47, align 4
  %tmp2_v.i9.i.i8 = add i32 %60, -16
  %61 = inttoptr i32 %tmp2_v.i9.i.i8 to i32*
  store i32 %tmp15_v5.i.i.i27.i, i32* %61, align 4
  %tmp2_v1.i25.i.i = add i32 %60, -12
  %62 = inttoptr i32 %tmp2_v1.i25.i.i to i32*
  %63 = load i32, i32* %62, align 4
  %64 = load i32, i32* %39, align 4
  %tmp0_v4.i.i.i = xor i32 %64, %63
  %tmp4_v2.i.i.i9 = add i32 %60, 8
  %tmp2_v.i10.i = add i32 %60, 12
  %65 = inttoptr i32 %tmp2_v.i10.i to i32*
  store i32 %tmp15_v5.i.i.i27.i, i32* %65, align 4
  %tmp2_v2.i.i = add i32 %29, -8170
  %66 = inttoptr i32 %tmp4_v2.i.i.i9 to i32*
  store i32 %tmp2_v2.i.i, i32* %66, align 4
  %tmp2_v4.i12.i = add i32 %60, 4
  %67 = inttoptr i32 %tmp2_v4.i12.i to i32*
  store i32 134517521, i32* %67, align 4
  %68 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v1.i.i.i, i32 inreg noundef %tmp0_v4.i.i.i, i32 noundef %tmp4_v2.i.i.i9, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
