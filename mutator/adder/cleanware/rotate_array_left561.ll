...
@str.558 = constant [4 x i8] c"%d \00"
@str.560 = constant [4 x i8] c"%d \00"
...
define internal fastcc void @rotate_array_left561(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %7 = inttoptr i32 %tmp2_v8.i31.i to i32*
  store i32 134517233, i32* %7, align 4
  %tmp4_v.i2.i.b = load i1, i1* @segs.0, align 1
  %8 = inttoptr i32 %arg_esp to i32*
  %9 = load i32, i32* %8, align 4
  %tmp2_v2.i6.i = add i32 %tmp0_v.i24.i, -20
  %10 = inttoptr i32 %tmp2_v2.i6.i to i32*
  store i32 %9, i32* %10, align 4
  %tmp2_v3.i.i = add i32 %tmp0_v.i24.i, -44
  %11 = inttoptr i32 %tmp2_v3.i.i to i32*
  store i32 1, i32* %11, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i24.i, -40
  %12 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 2, i32* %12, align 8
  %tmp2_v5.i.i = add i32 %tmp0_v.i24.i, -36
  %13 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 3, i32* %13, align 4
  %tmp2_v6.i.i = add i32 %tmp0_v.i24.i, -32
  %14 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 4, i32* %14, align 16
  %tmp2_v7.i.i = add i32 %tmp0_v.i24.i, -28
  %15 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 5, i32* %15, align 4
  %tmp2_v8.i.i = add i32 %tmp0_v.i24.i, -24
  %16 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 6, i32* %16, align 8
  %tmp2_v9.i.i = add i32 %tmp0_v.i24.i, -52
  %17 = inttoptr i32 %tmp2_v9.i.i to i32*
  %tmp2_v5.i61.i = add i32 %tmp0_v.i24.i, -76
  %18 = inttoptr i32 %tmp2_v5.i61.i to i32*
  %tmp2_v7.i64.i = add i32 %tmp0_v.i24.i, -80
  %19 = inttoptr i32 %tmp2_v7.i64.i to i32*
  %tmp2_v8.i65.i = add i32 %tmp0_v.i24.i, -84
  %20 = inttoptr i32 %tmp2_v8.i65.i to i32*
...
BB_8049235.i:                                     ; preds = %BB_8049235.i, %0
  ...
  %storemerge11 = phi i32 [ 0, %0 ], [ %tmp0_v2.i71.i, %BB_8049235.i ]
  %tmp4_v.i56.i = shl i32 %storemerge11, 2
  %tmp2_v2.i57.i = add i32 %tmp4_v.i56.i, %tmp2_v3.i.i
  %22 = inttoptr i32 %tmp2_v2.i57.i to i32*
  %23 = load i32, i32* %22, align 4
  store i32 %23, i32* %18, align 4
  %spi560 = ptrtoint[4 x i8]* @str.560 to i32
  store i32 %spi560, i32* %19, align 16
  store i32 134517324, i32* %20, align 4
  %24 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i23.i, i32 inreg noundef %r_edx.112, i32 noundef %tmp2_v7.i64.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %25 = lshr i64 %24, 32
  %26 = trunc i64 %25 to i32
  %27 = load i32, i32* %17, align 4
  %tmp0_v2.i71.i = add i32 %27, 1
  store i32 %tmp0_v2.i71.i, i32* %17, align 4
  %28 = icmp slt i32 %tmp0_v2.i71.i, 6
...
BB_8049259.i:                                     ; preds = %BB_8049235.i
  ...
  %tmp2_v.i17.i = add i32 %tmp0_v.i24.i, -72
  %31 = inttoptr i32 %tmp2_v.i17.i to i32*
  store i32 6, i32* %31, align 8
  store i32 6, i32* %18, align 4
  store i32 %tmp2_v3.i.i, i32* %19, align 16
  store i32 134517366, i32* %20, align 4
  %tmp2_v.i2.i.i = add i32 %tmp0_v.i24.i, -88
  %32 = inttoptr i32 %tmp2_v.i2.i.i to i32*
  store i32 %tmp2_v4.i26.i, i32* %32, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i24.i, -116
  %33 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 134517474, i32* %33, align 4
  %tmp2_v.i25.i.i = add i32 %tmp0_v.i24.i, -100
  %34 = inttoptr i32 %tmp2_v.i25.i.i to i32*
...
BB_80492F0.i.lr.ph.i:                             ; preds = %BB_8049259.i
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i24.i, -124
  %37 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  %tmp2_v5.i.i.i = add i32 %tmp0_v.i24.i, -128
  %38 = inttoptr i32 %tmp2_v5.i.i.i to i32*
  %tmp2_v6.i.i.i = add i32 %tmp0_v.i24.i, -132
  %39 = inttoptr i32 %tmp2_v6.i.i.i to i32*
  %tmp2_v.i1.i.i.i = add i32 %tmp0_v.i24.i, -136
  %40 = inttoptr i32 %tmp2_v.i1.i.i.i to i32*
  %tmp2_v1.i.i.i.i = add i32 %tmp0_v.i24.i, -156
  %41 = inttoptr i32 %tmp2_v1.i.i.i.i to i32*
  %tmp2_v3.i.i.i.i = add i32 %tmp0_v.i24.i, -140
  %42 = inttoptr i32 %tmp2_v3.i.i.i.i to i32*
  %tmp2_v4.i.i.i.i = add i32 %tmp0_v.i24.i, -144
...
BB_80492F0.i.i:                                   ; preds = %Func_rotate_left_once.exit.i, %BB_80492F0.i.lr.ph.i
  ...
  %r_ecx.017.i = phi i32 [ %tmp2_v.i23.i, %BB_80492F0.i.lr.ph.i ], [ %r_ecx.0.lcssa.i.i, %Func_rotate_left_once.exit.i ]
  ...
  %tmp0_v1.i.i8.i.i = add i32 %51, -1
  %52 = icmp sgt i32 %tmp0_v1.i.i8.i.i, 0
...
BB_8049336.i.i.i:                                 ; preds = %BB_8049336.i.i.i, %BB_80492F0.i.i
  ...
  %tmp0_v1.i.i.i.i = add i32 %58, -1
  %59 = icmp slt i32 %tmp0_v14.i.i.i.i, %tmp0_v1.i.i.i.i
...
Func_rotate_left_once.exit.i:                     ; preds = %BB_8049336.i.i.i, %BB_80492F0.i.i
  ...
  %tmp4_v.i.i.i14.i = add i32 %tmp0_v1.i11.i.i.i, -4
...
Func_rotate_left.exit:                            ; preds = %.exit.loopexit.i, %BB_8049259.i
  ...
  %r_ecx.0.lcssa.i = phi i32 [ %r_ecx.0.lcssa.i.i, %.exit.loopexit.i ], [ %tmp2_v.i23.i, %BB_8049259.i ]
  ...
  %tmp2_v.i42.i = add i32 %69, -40
  %70 = inttoptr i32 %tmp2_v.i42.i to i32*
  %tmp2_v1.i88.i = add i32 %69, -36
  %tmp2_v5.i94.i = add i32 %r_ebp.0.lcssa.i, 12
  %71 = inttoptr i32 %tmp2_v5.i94.i to i32*
  %72 = inttoptr i32 %tmp4_v2.i.i.i to i32*
  %tmp2_v8.i98.i = add i32 %r_ebp.0.lcssa.i, 4
  %73 = inttoptr i32 %tmp2_v8.i98.i to i32*
...
BB_8049282.i:                                     ; preds = %BB_8049282.i, %Func_rotate_left.exit
  ...
  %storemerge114 = phi i32 [ 0, %Func_rotate_left.exit ], [ %tmp0_v2.i48.i, %BB_8049282.i ]
  %tmp4_v.i89.i = shl i32 %storemerge114, 2
  %tmp2_v2.i90.i = add i32 %tmp2_v1.i88.i, %tmp4_v.i89.i
  %74 = inttoptr i32 %tmp2_v2.i90.i to i32*
  %75 = load i32, i32* %74, align 4
  store i32 %75, i32* %71, align 4
  %spi558 = ptrtoint[4 x i8]* @str.558 to i32
  store i32 %spi558, i32* %72, align 4
  ...
  %tmp0_v2.i48.i = add i32 %79, 1
  store i32 %tmp0_v2.i48.i, i32* %70, align 4
  %80 = icmp slt i32 %tmp0_v2.i48.i, 6
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @rotate_array_left561(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
