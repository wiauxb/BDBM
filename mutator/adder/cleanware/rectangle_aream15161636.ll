...
define internal fastcc void @rectangle_aream15161636(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !18 {
  ...
  %tmp2_v1.i9.i = add i32 %tmp0_v.i33.i, -40
  %tmp5_v2.i10.i = tail call fastcc i64 @helper_fstl_ST0()
  %9 = inttoptr i32 %tmp2_v1.i9.i to i64*
  store i64 %tmp5_v2.i10.i, i64* %9, align 8
  ...
  %tmp2_v7.i15.i = add i32 %tmp0_v.i33.i, -32
  %tmp5_v8.i16.i = tail call fastcc i64 @helper_fstl_ST0()
  %11 = inttoptr i32 %tmp2_v7.i15.i to i64*
  store i64 %tmp5_v8.i16.i, i64* %11, align 16
  tail call fastcc void @helper_fpop()
  ...
  %tmp2_v16.i24.i = add i32 %tmp0_v.i33.i, -24
  %tmp5_v17.i25.i = tail call fastcc i64 @helper_fstl_ST0()
  %14 = inttoptr i32 %tmp2_v16.i24.i to i64*
  store i64 %tmp5_v17.i25.i, i64* %14, align 8
  tail call fastcc void @helper_fpop()
  %tmp2_v19.i.i = add i32 %tmp0_v.i33.i, -20
  %15 = inttoptr i32 %tmp2_v19.i.i to i32*
  %16 = load i32, i32* %15, align 4
  %tmp2_v21.i.i = add i32 %tmp0_v.i33.i, -56
  %17 = inttoptr i32 %tmp2_v21.i.i to i32*
  store i32 %16, i32* %17, align 8
  %18 = inttoptr i32 %tmp2_v16.i24.i to i32*
  %19 = load i32, i32* %18, align 8
  %tmp2_v24.i.i = add i32 %tmp0_v.i33.i, -60
  %20 = inttoptr i32 %tmp2_v24.i.i to i32*
  store i32 %19, i32* %20, align 4
  %tmp2_v27.i29.i = add i32 %tmp0_v.i33.i, -64
  %21 = inttoptr i32 %tmp2_v27.i29.i to i32*
  store i32 134520840, i32* %21, align 16
  %tmp2_v28.i30.i = add i32 %tmp0_v.i33.i, -68
  %22 = inttoptr i32 %tmp2_v28.i30.i to i32*
  store i32 134517224, i32* %22, align 4
  %23 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i32.i, i32 inreg noundef 134520840, i32 noundef %tmp2_v27.i29.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  ret void
}
...
!19 = !{!"printf"}
  ...
  tail call fastcc void @rectangle_aream15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
