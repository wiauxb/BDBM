...
define internal fastcc void @isdigitm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v.i.i = add i32 %tmp0_v.i14.i, -17
  ...
  %tmp0_v1.i9.i = sext i8 %9 to i32
  %tmp0_v2.i.i = shl nsw i32 %tmp0_v1.i9.i, 1
  %tmp2_v2.i.i = add i32 %tmp0_v.i14.i, -44
  %10 = inttoptr i32 %tmp2_v2.i.i to i32*
  store i32 %tmp0_v1.i9.i, i32* %10, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i14.i, -48
  ...
  %13 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i13.i, i32 inreg noundef %tmp0_v2.i.i, i32 noundef %tmp2_v4.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @isdigitm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
