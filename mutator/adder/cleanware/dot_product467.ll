...
.exit:
  ...
  %tmp2_v2.i36.i = add i32 %tmp0_v.i.i, -20
  ...
  %tmp2_v6.i6.i = add i32 %tmp0_v.i.i, -40
  ...
  %tmp2_v18.i.i = add i32 %tmp0_v.i.i, -32
  ...
  %tmp2_v24.i.i = add i32 %tmp0_v.i.i, -28
  ...
  %tmp2_v27.i.i = add i32 %tmp0_v.i.i, -24
  ...
  %tmp2_v.i3.i.i = add i32 %tmp0_v.i.i, -80
  %tmp6_v.i4.i.i = tail call fastcc i32 @helper_fsts_ST0()  nounwind 
  %27 = inttoptr i32 %tmp2_v.i3.i.i to i32*
  store i32 %tmp6_v.i4.i.i, i32* %27, align 16
  tail call fastcc void @helper_fpop()  nounwind 
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i.i, -76
...
Func_dot_product.exit:                            ; preds = %BB_804928A.i.i, %.exit
  ...
  tail call fastcc void @helper_fpop()
  %spi465 = ptrtoint[12 x i8]* @str.465 to i32
  store i32 %spi465, i32* %23, align 16
  store i32 134517317, i32* %24, align 4
  %47 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v35.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  ret void
}
