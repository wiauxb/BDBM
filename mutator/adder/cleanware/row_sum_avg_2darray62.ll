...
Func_80491F9.exit.i:
  ...
  %tmp2_v5.i.i = add i32 %tmp0_v.i40.i, -12
  %4 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 0, i32* %4, align 4
  %tmp2_v6.i45.i = add i32 %tmp0_v.i40.i, -16
  %5 = inttoptr i32 %tmp2_v6.i45.i to i32*
  store i32 0, i32* %5, align 16
  %tmp2_v7.i47.i = add i32 %tmp0_v.i40.i, -20
  %6 = inttoptr i32 %tmp2_v7.i47.i to i32*
  store i32 0, i32* %6, align 4
  %tmp2_v8.i49.i = add i32 %tmp0_v.i40.i, -24
  %7 = inttoptr i32 %tmp2_v8.i49.i to i32*
  store i32 %tmp2_v.i39.i, i32* %7, align 8
  %tmp2_v10.i50.i = add i32 %tmp0_v.i40.i, -164
  %8 = inttoptr i32 %tmp2_v10.i50.i to i32*
  store i32 134517206, i32* %8, align 4
  %tmp4_v.i53.i.b = load i1, i1* @segs.0, align 1
  %9 = inttoptr i32 %arg_esp to i32*
  %10 = load i32, i32* %9, align 4
  %tmp2_v2.i57.i = add i32 %tmp0_v.i40.i, -36
  %11 = inttoptr i32 %tmp2_v2.i57.i to i32*
  store i32 %10, i32* %11, align 4
  %tmp2_v3.i58.i = add i32 %tmp0_v.i40.i, -136
  %12 = load i32, i32* inttoptr (i32 134520928 to i32*), align 32
  %13 = inttoptr i32 %tmp2_v3.i58.i to i32*
  store i32 %12, i32* %13, align 8
  %tmp0_v1.i.i = load i32, i32* @df, align 4
  %tmp0_v2.i.i = shl i32 %tmp0_v1.i.i, 2
  %tmp4_v.i.i = add i32 %tmp0_v2.i.i, 134520928
  %tmp4_v3.i.i = add i32 %tmp0_v2.i.i, %tmp2_v3.i58.i
  ...
  %tmp2_v.i92.i = add i32 %tmp0_v.i40.i, -152
  %tmp6_v.i93.i = tail call fastcc i32 @helper_fsts_ST0()
  %86 = inttoptr i32 %tmp2_v.i92.i to i32*
  store i32 %tmp6_v.i93.i, i32* %86, align 8
  tail call fastcc void @helper_fpop()
  tail call fastcc void @helper_fpush()
  tail call fastcc void @helper_fldz_ST0()
  %tmp2_v2.i95.i = add i32 %tmp0_v.i40.i, -140
  %tmp6_v3.i.i = tail call fastcc i32 @helper_fsts_ST0()
  %87 = inttoptr i32 %tmp2_v2.i95.i to i32*
  store i32 %tmp6_v3.i.i, i32* %87, align 4
  tail call fastcc void @helper_fpop()
  %tmp2_v5.i97.i = add i32 %tmp0_v.i40.i, -148
  %88 = inttoptr i32 %tmp2_v5.i97.i to i32*
  %tmp2_v2.i.i = add i32 %tmp0_v.i40.i, -144
  %89 = inttoptr i32 %tmp2_v2.i.i to i32*
  %tmp2_v1.i33.i = add i32 %tmp0_v.i40.i, -168
  %90 = inttoptr i32 %tmp2_v1.i33.i to i64*
  %tmp2_v6.i36.i = add i32 %tmp0_v.i40.i, -172
  %91 = inttoptr i32 %tmp2_v6.i36.i to i32*
  %tmp2_v8.i.i = add i32 %tmp0_v.i40.i, -176
  %92 = inttoptr i32 %tmp2_v8.i.i to i32*
  %tmp2_v9.i.i = add i32 %tmp0_v.i40.i, -180
...
BB_804922E.i:                                     ; preds = %BB_804921A.i, %BB_804922E.i
  ...
  %tmp0_v2.i20.i = mul i32 %94, 5
  %tmp0_v5.i.i = add i32 %tmp0_v2.i20.i, %storemerge116
  %tmp4_v.i23.i = shl i32 %tmp0_v5.i.i, 2
  %tmp2_v7.i.i = add i32 %tmp4_v.i23.i, %tmp2_v3.i58.i
...
BB_804921A.i:                                     ; preds = %BB_8049265.i, %Func_80491F9.exit.i
  tail call fastcc void @helper_fpush()
  tail call fastcc void @helper_fldz_ST0()
  %tmp6_v.i28.i = tail call fastcc i32 @helper_fsts_ST0()
  store i32 %tmp6_v.i28.i, i32* %86, align 8
  tail call fastcc void @helper_fpop()
...
BB_8049265.i:                                     ; preds = %BB_804922E.i
  ...
  %spi60 = ptrtoint[17 x i8]* @str.60 to i32
  store i32 %spi60, i32* %92, align 16
  ...
  tail call fastcc void @helper_fpop()
  %tmp6_v.i69.i = tail call fastcc i32 @helper_fsts_ST0()
  store i32 %tmp6_v.i69.i, i32* %87, align 4
  tail call fastcc void @helper_fpop()
  %107 = load i32, i32* %87, align 4
  tail call fastcc void @helper_flds_ST0(i32 %107)
  %tmp5_v.i73.i = tail call fastcc i64 @helper_fstl_ST0()
  store i64 %tmp5_v.i73.i, i64* %90, align 8
  tail call fastcc void @helper_fpop()
  %108 = load i32, i32* %88, align 4
  store i32 %108, i32* %91, align 4
  %spi59 = ptrtoint[22 x i8]* @str.59 to i32
  store i32 %spi59, i32* %92, align 16
  ...
  %tmp0_v2.i9.i = add i32 %110, 1
  store i32 %tmp0_v2.i9.i, i32* %88, align 4
  %111 = icmp slt i32 %tmp0_v2.i9.i, 5
