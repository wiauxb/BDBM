...
@str.235 = constant [12 x i8] c"r[%d] = %d\0a\00"
...
define internal fastcc void @merge_sorted_arrays237(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %tmp2_v8.i25.i = add i32 %tmp0_v.i.i, -80
  ...
  %tmp2_v14.i.i = add i32 %tmp0_v.i.i, -60
  %tmp2_v15.i.i = add i32 %tmp0_v.i.i, -128
  %21 = inttoptr i32 %tmp2_v15.i.i to i32*
  store i32 %tmp2_v14.i.i, i32* %21, align 16
  %tmp2_v16.i.i = add i32 %tmp0_v.i.i, -132
  %22 = inttoptr i32 %tmp2_v16.i.i to i32*
  store i32 5, i32* %22, align 4
  %tmp2_v18.i.i = add i32 %tmp0_v.i.i, -136
  %23 = inttoptr i32 %tmp2_v18.i.i to i32*
  store i32 %tmp2_v8.i25.i, i32* %23, align 8
  %tmp2_v19.i.i = add i32 %tmp0_v.i.i, -140
  %24 = inttoptr i32 %tmp2_v19.i.i to i32*
  store i32 5, i32* %24, align 4
  %tmp2_v21.i.i = add i32 %tmp0_v.i.i, -144
  %25 = inttoptr i32 %tmp2_v21.i.i to i32*
  store i32 %tmp2_v3.i21.i, i32* %25, align 16
  %tmp2_v22.i.i = add i32 %tmp0_v.i.i, -148
  %26 = inttoptr i32 %tmp2_v22.i.i to i32*
  store i32 134517312, i32* %26, align 4
  %tmp2_v.i14.i.i = add i32 %tmp0_v.i.i, -152
  %27 = inttoptr i32 %tmp2_v.i14.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %27, align 8
  %tmp2_v1.i17.i.i = add i32 %tmp0_v.i.i, -172
  %28 = inttoptr i32 %tmp2_v1.i17.i.i to i32*
  store i32 134517410, i32* %28, align 4
  %tmp2_v.i70.i.i = add i32 %tmp0_v.i.i, -164
  %29 = inttoptr i32 %tmp2_v.i70.i.i to i32*
  store i32 0, i32* %29, align 4
  %tmp2_v1.i71.i.i = add i32 %tmp0_v.i.i, -160
  %30 = inttoptr i32 %tmp2_v1.i71.i.i to i32*
  store i32 0, i32* %30, align 16
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i.i, -156
...
BB_80492BE.i.i:                                   ; preds = %BB_804933A.i.backedge.i.BB_80492BE.i.i_crit_edge, %0
  ...
  %tmp4_v6.i57.i.i = shl i32 %35, 2
  %44 = load i32, i32* %21, align 16
  %tmp0_v9.i60.i.i = add i32 %44, %tmp4_v6.i57.i.i
  %45 = inttoptr i32 %tmp0_v9.i60.i.i to i32*
  br i1 %.not.i.i.i, label %BB_80492E4.i.i, label %BB_8049310.i.i

BB_804937A.i.preheader.i:                         ; preds = %BB_804933A.i.backedge.i, %0
  %r_ecx.1.lcssa.i = phi i32 [ %tmp2_v.i.i, %0 ], [ %tmp4_v6.i57.i.i, %BB_804933A.i.backedge.i ]
  %r_edx.1.lcssa.i = phi i32 [ 0, %0 ], [ %tmp0_v9.i60.i.i, %BB_804933A.i.backedge.i ]
  %46 = load i32, i32* %29, align 4
  %47 = load i32, i32* %24, align 4
  %48 = icmp slt i32 %46, %47
  br i1 %48, label %BB_8049350.i.i, label %Func_merge.exit

BB_8049350.i.i:                                   ; preds = %BB_8049350.i.i, %BB_804937A.i.preheader.i
  %49 = phi i32 [ %tmp0_v16.i.i.i, %BB_8049350.i.i ], [ %46, %BB_804937A.i.preheader.i ]
  %tmp4_v.i32.i.i = shl i32 %49, 2
  %50 = load i32, i32* %25, align 16
  %tmp0_v3.i35.i.i = add i32 %50, %tmp4_v.i32.i.i
  %51 = load i32, i32* %31, align 4
  %tmp4_v6.i.i.i = shl i32 %51, 2
  %52 = load i32, i32* %21, align 16
  %tmp0_v9.i36.i.i = add i32 %52, %tmp4_v6.i.i.i
  %53 = inttoptr i32 %tmp0_v3.i35.i.i to i32*
  %54 = load i32, i32* %53, align 4
  %55 = inttoptr i32 %tmp0_v9.i36.i.i to i32*
...
BB_804933A.i.backedge.i:                          ; preds = %BB_8049310.i.i, %BB_80492E4.i.i
  %62 = phi i32 [ %tmp0_v16.i91.i.i, %BB_8049310.i.i ], [ %.pre.i, %BB_80492E4.i.i ]
...
BB_8049310.i.i:                                   ; preds = %BB_80492BE.i.i
  ...
  %tmp0_v13.i88.i.i = add i32 %65, 1
  store i32 %tmp0_v13.i88.i.i, i32* %31, align 4
  %66 = load i32, i32* %30, align 16
  %tmp0_v16.i91.i.i = add i32 %66, 1
  store i32 %tmp0_v16.i91.i.i, i32* %30, align 16
  br label %BB_804933A.i.backedge.i
...
Func_merge.exit:                                  ; preds = %BB_8049350.i.i, %BB_804937A.i.preheader.i
  ...
  %r_edx.0.lcssa.i = phi i32 [ %r_edx.1.lcssa.i, %BB_804937A.i.preheader.i ], [ %tmp0_v9.i36.i.i, %BB_8049350.i.i ]
  %67 = load i32, i32* %27, align 8
  %tmp2_v.i7.i = add i32 %67, -96
  %68 = inttoptr i32 %tmp2_v.i7.i to i32*
  %tmp2_v1.i36.i = add i32 %67, -52
  %tmp2_v5.i41.i = add i32 %tmp0_v.i.i, -120
  %69 = inttoptr i32 %tmp2_v5.i41.i to i32*
  %tmp2_v8.i44.i = add i32 %tmp0_v.i.i, -124
  %70 = inttoptr i32 %tmp2_v8.i44.i to i32*
...
BB_804924C.i:                                     ; preds = %BB_804924C.i, %Func_merge.exit
  ...
  %storemerge6 = phi i32 [ 0, %Func_merge.exit ], [ %tmp0_v2.i12.i, %BB_804924C.i ]
  %tmp4_v.i37.i = shl i32 %storemerge6, 2
  %tmp2_v2.i38.i = add i32 %tmp2_v1.i36.i, %tmp4_v.i37.i
  %71 = inttoptr i32 %tmp2_v2.i38.i to i32*
  %72 = load i32, i32* %71, align 4
  store i32 %72, i32* %69, align 8
  %73 = load i32, i32* %68, align 4
  store i32 %73, i32* %70, align 4
  %spi235 = ptrtoint[12 x i8]* @str.235 to i32
  store i32 %spi235, i32* %21, align 16
  ...
  %tmp0_v2.i12.i = add i32 %77, 1
  store i32 %tmp0_v2.i12.i, i32* %68, align 4
  %78 = icmp slt i32 %tmp0_v2.i12.i, 10
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @merge_sorted_arrays237(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
