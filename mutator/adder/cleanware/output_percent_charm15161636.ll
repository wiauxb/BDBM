...
define internal fastcc void @output_percent_charm15161636(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %tmp2_v3.i10.i = add i32 %tmp0_v.i13.i, -36
  %9 = inttoptr i32 %tmp2_v3.i10.i to i32*
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @output_percent_charm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
