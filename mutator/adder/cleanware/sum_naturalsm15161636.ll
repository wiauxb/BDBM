...
define internal fastcc void @sum_naturalsm15161636(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %tmp2_v.i17.i = add i32 %tmp0_v.i7.i, -32
  %8 = inttoptr i32 %tmp2_v.i17.i to i32*
  store i32 5, i32* %8, align 16
  %tmp2_v2.i18.i = add i32 %tmp0_v.i7.i, -36
  %9 = inttoptr i32 %tmp2_v2.i18.i to i32*
  store i32 134517182, i32* %9, align 4
  %10 = tail call fastcc { i32, i32, i32, i32 } @Func_sum(i32 %tmp2_v2.i18.i, i32 %tmp2_v4.i9.i)
  ...
  %17 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i6.i, i32 inreg noundef %13, i32 noundef %11, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
.exit:                                            ; preds = %BB_80491FD.i, %Func_80491F2.exit.i..exit_crit_edge
  %tmp4_v2.i.i.pre-phi = phi i32 [ %.pre1, %Func_80491F2.exit.i..exit_crit_edge ], [ %tmp2_v.i6.i, %BB_80491FD.i ]
...
!14 = !{i32 0, i32 2, i32 3}
  ...
  tail call fastcc void @sum_naturalsm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
