...
define internal fastcc void @fill_randomm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v8.i51.i = add i32 %tmp0_v.i42.i, -436
  ...
  %tmp2_v2.i19.i = add i32 %tmp0_v.i42.i, -20
  %10 = inttoptr i32 %tmp2_v2.i19.i to i32*
  store i32 %9, i32* %10, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i42.i, -448
  %11 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 0, i32* %11, align 16
  %tmp2_v5.i22.i = add i32 %tmp0_v.i42.i, -452
  ...
  %tmp2_v.i35.i = add i32 %tmp0_v.i42.i, -440
  %14 = inttoptr i32 %tmp2_v.i35.i to i32*
  store i32 200, i32* %14, align 8
  %tmp2_v2.i36.i = add i32 %tmp0_v.i42.i, -444
  %15 = inttoptr i32 %tmp2_v2.i36.i to i32*
  store i32 100, i32* %15, align 4
  %tmp2_v3.i38.i = add i32 %tmp0_v.i42.i, -420
  store i32 %tmp2_v3.i38.i, i32* %11, align 16
  store i32 134517364, i32* %12, align 4
  %tmp2_v.i8.i.i = add i32 %tmp0_v.i42.i, -456
  %16 = inttoptr i32 %tmp2_v.i8.i.i to i32*
  store i32 %tmp2_v4.i45.i, i32* %16, align 8
  %tmp2_v1.i10.i.i = add i32 %tmp0_v.i42.i, -460
  %17 = inttoptr i32 %tmp2_v1.i10.i.i to i32*
  store i32 134529024, i32* %17, align 4
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i42.i, -484
  %18 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  store i32 134517481, i32* %18, align 4
  %tmp4_v.i.i.i.i = add i32 %tmp0_v.i42.i, -480
  %mrv.i.i = insertvalue { i32, i32 } undef, i32 %tmp4_v.i.i.i.i, 0
  %tmp2_v.i.i.i = add i32 %tmp0_v.i42.i, -468
...
BB_80492F8.i.i:                                   ; preds = %BB_80492F8.i.i, %0
  ...
  %tmp2_v.i3.i.i = add i32 %r_esp.05.i, -4
  %22 = inttoptr i32 %tmp2_v.i3.i.i to i32*
...
Func_fill_random.exit:                            ; preds = %Func_fill_random.exit.loopexit, %0
  ...
  %r_ecx.0.lcssa.i = phi i32 [ %tmp2_v.i41.i, %0 ], [ %42, %Func_fill_random.exit.loopexit ]
  ...
  %tmp0_v.i1.i.i = add i32 %r_esp.0.le.i, 20
  %43 = inttoptr i32 %tmp0_v.i1.i.i to i32*
  %44 = load i32, i32* %43, align 4
  %tmp4_v.i.i.i4 = add i32 %r_esp.0.le.i, 24
  %45 = inttoptr i32 %tmp4_v.i.i.i4 to i32*
  %46 = load i32, i32* %45, align 4
  %tmp4_v5.i.i.i = add i32 %r_esp.0.le.i, 32
  %tmp2_v.i55.i = add i32 %46, -416
  %47 = inttoptr i32 %tmp2_v.i55.i to i32*
  %tmp2_v1.i9.i = add i32 %46, -412
  %tmp2_v5.i.i = add i32 %r_esp.0.le.i, 40
...
BB_8049283.i:                                     ; preds = %BB_8049283.i, %Func_fill_random.exit
  ...
  %tmp4_v.i10.i = shl i32 %storemerge10, 2
  %tmp2_v2.i11.i = add i32 %tmp2_v1.i9.i, %tmp4_v.i10.i
  %52 = inttoptr i32 %tmp2_v2.i11.i to i32*
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @fill_randomm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
