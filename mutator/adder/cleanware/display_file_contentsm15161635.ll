...
define internal fastcc void @display_file_contentsm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
.exit:
  ...
  %tmp2_v2.i9.i = add i32 %tmp0_v.i19.i, -44
  %7 = inttoptr i32 %tmp2_v2.i9.i to i32*
  store i32 134520840, i32* %7, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i19.i, -48
  %8 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 134520842, i32* %8, align 16
  %tmp2_v5.i10.i = add i32 %tmp0_v.i19.i, -52
  %9 = inttoptr i32 %tmp2_v5.i10.i to i32*
  ...
  %tmp2_v.i14.i = add i32 %tmp0_v.i19.i, -20
  %11 = inttoptr i32 %tmp2_v.i14.i to i32*
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @display_file_contentsm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
