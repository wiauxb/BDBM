...
define internal fastcc void @verify_password254(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_8049243.exit.i:
  ...
  %tmp2_v8.i9.i = add i32 %tmp0_v.i3.i, -52
  ...
  %tmp2_v4.i.i = add i32 %tmp0_v.i3.i, -28
  %11 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 1684234849, i32* %11, align 4
  %tmp2_v5.i.i = add i32 %tmp0_v.i3.i, -24
  %12 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 6776421, i32* %12, align 8
  %tmp2_v8.i.i = add i32 %tmp0_v.i3.i, -64
  %13 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 %tmp2_v3.i.i, i32* %13, align 16
  %tmp2_v9.i.i = add i32 %tmp0_v.i3.i, -68
  %14 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 134517315, i32* %14, align 4
  %tmp2_v.i68.i.i = add i32 %tmp0_v.i3.i, -72
  %15 = inttoptr i32 %tmp2_v.i68.i.i to i32*
  store i32 %tmp2_v4.i5.i, i32* %15, align 8
  %tmp2_v1.i70.i.i = add i32 %tmp0_v.i3.i, -76
  %16 = inttoptr i32 %tmp2_v1.i70.i.i to i32*
  store i32 134529024, i32* %16, align 4
  %tmp2_v2.i73.i.i = add i32 %tmp0_v.i3.i, -100
  %17 = inttoptr i32 %tmp2_v2.i73.i.i to i32*
  ...
  %tmp2_v.i2.i.i = add i32 %tmp0_v.i3.i, -84
  %22 = inttoptr i32 %tmp2_v.i2.i.i to i32*
  store i32 %21, i32* %22, align 4
  %tmp2_v.i82.i.i = add i32 %tmp0_v.i3.i, -92
  %23 = inttoptr i32 %tmp2_v.i82.i.i to i8*
  store i8 0, i8* %23, align 4
  %tmp2_v1.i83.i.i = add i32 %tmp0_v.i3.i, -91
  %24 = inttoptr i32 %tmp2_v1.i83.i.i to i8*
  store i8 0, i8* %24, align 1
  %tmp2_v2.i84.i.i = add i32 %tmp0_v.i3.i, -90
  %25 = inttoptr i32 %tmp2_v2.i84.i.i to i8*
  store i8 0, i8* %25, align 2
  %tmp2_v3.i85.i.i = add i32 %tmp0_v.i3.i, -89
  %26 = inttoptr i32 %tmp2_v3.i85.i.i to i8*
  store i8 0, i8* %26, align 1
  %tmp2_v4.i86.i.i = add i32 %tmp0_v.i3.i, -88
  %27 = inttoptr i32 %tmp2_v4.i86.i.i to i32*
...
BB_8049314.i.i:                                   ; preds = %BB_8049310.i.i, %BB_80492E8.i.i
  ...
  %tmp0_v4.i94.i.i = add i32 %34, %33
  %35 = inttoptr i32 %tmp0_v4.i94.i.i to i8*
  %36 = load i8, i8* %35, align 1
  %tmp0_v6.i96.i.i = sext i8 %36 to i32
  %tmp0_v7.i97.i.i = shl nsw i32 %tmp0_v6.i96.i.i, 1
  %tmp0_v8.i98.i.i = add i32 %tmp0_v7.i97.i.i, %32
  %37 = inttoptr i32 %tmp0_v8.i98.i.i to i16*
...
BB_804936C.i.i:                                   ; preds = %BB_8049340.i.i, %BB_8049368.i.i
  ...
  %tmp0_v4.i133.i.i = add i32 %45, %44
  %46 = inttoptr i32 %tmp0_v4.i133.i.i to i8*
  %47 = load i8, i8* %46, align 1
  %tmp0_v6.i135.i.i = sext i8 %47 to i32
  %tmp0_v7.i136.i.i = shl nsw i32 %tmp0_v6.i135.i.i, 1
  %tmp0_v8.i137.i.i = add i32 %tmp0_v7.i136.i.i, %43
  %48 = inttoptr i32 %tmp0_v8.i137.i.i to i16*
  %49 = load i16, i16* %48, align 2
  %50 = and i16 %49, 4
  %51 = icmp eq i16 %50, 0
  br i1 %51, label %BB_8049396.i.i, label %BB_8049392.i.i
...
BB_8049340.i.i:                                   ; preds = %BB_804933C.i.i, %BB_8049314.i.i
  ...
  %tmp0_v4.i42.i.i = add i32 %56, %55
  %57 = inttoptr i32 %tmp0_v4.i42.i.i to i8*
  %58 = load i8, i8* %57, align 1
  %tmp0_v6.i44.i.i = sext i8 %58 to i32
  %tmp0_v7.i45.i.i = shl nsw i32 %tmp0_v6.i44.i.i, 1
  %tmp0_v8.i46.i.i = add i32 %tmp0_v7.i45.i.i, %54
  %59 = inttoptr i32 %tmp0_v8.i46.i.i to i16*
...
BB_80492E8.i.i:                                   ; preds = %BB_8049396.i.i, %Func_8049243.exit.i
  ...
  %63 = tail call i32 @__ctype_b_loc()
  %64 = inttoptr i32 %63 to i32*
  %65 = load i32, i32* %64, align 4
  %66 = load i32, i32* %27, align 8
  %67 = load i32, i32* %13, align 16
  %tmp0_v4.i.i.i = add i32 %67, %66
  %68 = inttoptr i32 %tmp0_v4.i.i.i to i8*
  %69 = load i8, i8* %68, align 1
  %tmp0_v6.i.i.i = sext i8 %69 to i32
  %tmp0_v7.i.i.i = shl nsw i32 %tmp0_v6.i.i.i, 1
  %tmp0_v8.i.i.i = add i32 %tmp0_v7.i.i.i, %65
  %70 = inttoptr i32 %tmp0_v8.i.i.i to i16*
  %71 = load i16, i16* %70, align 2
  %72 = and i16 %71, 256
  %73 = icmp eq i16 %72, 0
  br i1 %73, label %BB_8049314.i.i, label %BB_8049310.i.i

BB_8049396.i.i:                                   ; preds = %BB_8049392.i.i, %BB_804936C.i.i
  %74 = phi i32 [ %44, %BB_804936C.i.i ], [ %.pre.i, %BB_8049392.i.i ]
  %tmp0_v1.i105.i.i = add i32 %74, 1
  store i32 %tmp0_v1.i105.i.i, i32* %27, align 8
  %75 = load i32, i32* %22, align 4
  %76 = icmp slt i32 %tmp0_v1.i105.i.i, %75
  br i1 %76, label %BB_80492E8.i.i, label %Func_verify_password.exit
...
Func_verify_password.exit:                        ; preds = %BB_8049396.i.i, %Func_8049243.exit.i
  ...
  %tmp2_v.i18.i = add i32 %78, -25
  %79 = inttoptr i32 %tmp2_v.i18.i to i8*
  store i8 1, i8* %79, align 1
  %tmp2_v.i13.i = add i32 %77, -8184
  store i32 %tmp2_v.i13.i, i32* %13, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @verify_password254(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
