...
define internal fastcc void @iscntrlm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
.exit:
  ...
  %tmp2_v.i3.i = add i32 %tmp0_v.i13.i, -17
  %7 = inttoptr i32 %tmp2_v.i3.i to i8*
  store i8 10, i8* %7, align 1
  store i32 134517216, i32* %6, align 4
  %8 = tail call i32 @__ctype_b_loc()
  %tmp2_v1.i10.i = add i32 %tmp0_v.i13.i, -48
  %9 = inttoptr i32 %tmp2_v1.i10.i to i32*
  store i32 134520840, i32* %9, align 16
  %tmp2_v2.i.i = add i32 %tmp0_v.i13.i, -52
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @iscntrlm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
