...
define internal fastcc void @binary_to_decimalm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v3.i29.i = add i32 %tmp0_v.i9.i, -41
  %10 = inttoptr i32 %tmp2_v3.i29.i to i32*
  store i32 808529969, i32* %10, align 4
  %tmp2_v4.i30.i = add i32 %tmp0_v.i9.i, -37
  %11 = inttoptr i32 %tmp2_v4.i30.i to i16*
  store i16 49, i16* %11, align 2
  %tmp2_v7.i34.i = add i32 %tmp0_v.i9.i, -80
  %12 = inttoptr i32 %tmp2_v7.i34.i to i32*
  store i32 %tmp2_v3.i29.i, i32* %12, align 16
  %tmp2_v8.i35.i = add i32 %tmp0_v.i9.i, -84
  %13 = inttoptr i32 %tmp2_v8.i35.i to i32*
  store i32 134517275, i32* %13, align 4
  %tmp2_v.i13.i.i = add i32 %tmp0_v.i9.i, -88
  %14 = inttoptr i32 %tmp2_v.i13.i.i to i32*
  store i32 %tmp2_v4.i10.i, i32* %14, align 8
  %tmp2_v1.i15.i.i = add i32 %tmp0_v.i9.i, -92
  %15 = inttoptr i32 %tmp2_v1.i15.i.i to i32*
  store i32 134529024, i32* %15, align 4
  %tmp2_v2.i17.i.i = add i32 %tmp0_v.i9.i, -116
  %16 = inttoptr i32 %tmp2_v2.i17.i.i to i32*
  ...
  %tmp2_v.i33.i.i = add i32 %tmp0_v.i9.i, -100
  %21 = inttoptr i32 %tmp2_v.i33.i.i to i32*
  store i32 %20, i32* %21, align 4
  %tmp2_v1.i35.i.i = add i32 %tmp0_v.i9.i, -112
  %22 = inttoptr i32 %tmp2_v1.i35.i.i to i32*
  store i32 0, i32* %22, align 16
  %tmp2_v2.i36.i.i = add i32 %tmp0_v.i9.i, -108
  %23 = inttoptr i32 %tmp2_v2.i36.i.i to i32*
  store i32 1, i32* %23, align 4
  %tmp2_v6.i.i.i = add i32 %tmp0_v.i9.i, -104
...
BB_8049304.i.i:                                   ; preds = %BB_8049319.i.i, %.exit
  ...
  %tmp0_v3.i4.i.i = add i32 %28, %storemerge22.i
  %29 = inttoptr i32 %tmp0_v3.i4.i.i to i8*
...
Func_convert.exit:                                ; preds = %BB_8049319.i.i, %.exit
  ...
  %37 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 %33, i32* %37, align 4
  %tmp2_v5.i.i = add i32 %34, -8184
  store i32 %tmp2_v5.i.i, i32* %12, align 16
  store i32 134517299, i32* %13, align 4
  %38 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v7.i34.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %39 = lshr i64 %38, 32
  %40 = trunc i64 %39 to i32
  %tmp2_v.i59.i = add i32 %35, -27
  %41 = inttoptr i32 %tmp2_v.i59.i to i32*
  store i32 825307441, i32* %41, align 4
  %tmp2_v1.i60.i = add i32 %35, -23
  %42 = inttoptr i32 %tmp2_v1.i60.i to i16*
  store i16 49, i16* %42, align 2
  store i32 %tmp2_v.i59.i, i32* %12, align 16
...
BB_8049304.i.i24:                                 ; preds = %BB_8049319.i.i20, %Func_convert.exit
  ...
  %tmp0_v3.i4.i.i22 = add i32 %48, %storemerge22.i21
  %49 = inttoptr i32 %tmp0_v3.i4.i.i22 to i8*
...
Func_convert.exit33:                              ; preds = %BB_8049319.i.i20, %Func_convert.exit
  ...
  %tmp2_v.i67.i = add i32 %55, -44
  %56 = inttoptr i32 %tmp2_v.i67.i to i32*
  store i32 %53, i32* %56, align 4
  store i32 %53, i32* %37, align 4
  %tmp2_v5.i74.i = add i32 %54, -8169
  store i32 %tmp2_v5.i74.i, i32* %12, align 16
  store i32 134517351, i32* %13, align 4
  %57 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %r_edx.0.lcssa.i27, i32 noundef %tmp2_v7.i34.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %58 = lshr i64 %57, 32
  %59 = trunc i64 %58 to i32
  %tmp2_v.i39.i = add i32 %55, -21
  %60 = inttoptr i32 %tmp2_v.i39.i to i32*
  ...
  %tmp2_v2.i40.i = add i32 %55, -13
  %62 = inttoptr i32 %tmp2_v2.i40.i to i8*
  store i8 0, i8* %62, align 1
  store i32 %tmp2_v.i39.i, i32* %12, align 16
...
BB_8049304.i.i55:                                 ; preds = %BB_8049319.i.i51, %Func_convert.exit33
  ...
  %tmp0_v3.i4.i.i53 = add i32 %68, %storemerge22.i52
  %69 = inttoptr i32 %tmp0_v3.i4.i.i53 to i8*
...
Func_convert.exit64:                              ; preds = %BB_8049319.i.i51, %Func_convert.exit33
  ...
  %tmp2_v.i47.i = add i32 %75, -40
  %76 = inttoptr i32 %tmp2_v.i47.i to i32*
  store i32 %73, i32* %76, align 4
  store i32 %73, i32* %37, align 4
  %tmp2_v5.i54.i = add i32 %74, -8154
  store i32 %tmp2_v5.i54.i, i32* %12, align 16
  store i32 134517408, i32* %13, align 4
  %77 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %r_edx.0.lcssa.i58, i32 noundef %tmp2_v7.i34.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @binary_to_decimalm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
