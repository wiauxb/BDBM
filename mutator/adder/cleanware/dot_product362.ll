...
@str.361 = constant [12 x i8] c"Result: %f\0a\00"
...
define internal fastcc void @dot_product362(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !24 {
.exit:
  ...
  %tmp2_v.i19.i.i = add i32 %tmp0_v.i.i, -72
  %25 = inttoptr i32 %tmp2_v.i19.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %25, align 8
  %tmp2_v1.i22.i.i = add i32 %tmp0_v.i.i, -92
  ...
  %tmp2_v.i.i.i = add i32 %tmp0_v.i.i, -80
...
Func_dot_product.exit:                            ; preds = %BB_804928A.i.i, %.exit
  ...
  %tmp2_v.i25.i = add i32 %43, -40
  %tmp6_v.i26.i = tail call fastcc i32 @helper_fsts_ST0()
  %44 = inttoptr i32 %tmp2_v.i25.i to i32*
  store i32 %tmp6_v.i26.i, i32* %44, align 4
  tail call fastcc void @helper_fpop()
  ...
  tail call fastcc void @helper_fpop()
  %spi361 = ptrtoint[12 x i8]* @str.361 to i32
  store i32 %spi361, i32* %23, align 16
...
!25 = !{!"printf"}
  ...
  tail call fastcc void @dot_product362(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
