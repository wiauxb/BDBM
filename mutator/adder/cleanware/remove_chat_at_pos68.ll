...
define internal fastcc void @remove_chat_at_pos68(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_8049225.exit.i:
  ...
  store i32 %tmp2_v3.i16.i, i32* %14, align 16
  ...
  %tmp2_v3.i23.i.i = add i32 %tmp0_v.i.i, -112
  ...
  %tmp2_v.i8.i.i = add i32 %tmp0_v.i.i, -84
  %23 = inttoptr i32 %tmp2_v.i8.i.i to i32*
...
BB_80492FD.i.i:                                   ; preds = %Func_8049225.exit.i
  %tmp2_v1.i16.i.i = add i32 %tmp0_v.i.i, -88
  %26 = inttoptr i32 %tmp2_v1.i16.i.i to i32*
...
BB_8049305.i.i:                                   ; preds = %BB_8049305.i.i, %BB_80492FD.i.i
  ...
  %tmp2_v1.i39.i.i = add i32 %29, %storemerge19.i
  %tmp0_v4.i.i.i = add i32 %tmp2_v1.i39.i.i, 1
  %30 = inttoptr i32 %tmp0_v4.i.i.i to i8*
  %31 = load i8, i8* %30, align 1
  %32 = inttoptr i32 %tmp2_v1.i39.i.i to i8*
...
Func_remove_char.exit:                            ; preds = %BB_8049305.i.i, %BB_80492FD.i.i, %Func_8049225.exit.i
  ...
  %tmp2_v.i32.i = add i32 %37, -26
  %38 = inttoptr i32 %tmp2_v.i32.i to i8*
...
BB_80492FD.i.i14:                                 ; preds = %Func_remove_char.exit
  %tmp2_v1.i16.i.i13 = add i32 %tmp0_v.i.i, -88
  %45 = inttoptr i32 %tmp2_v1.i16.i.i13 to i32*
...
BB_8049305.i.i19:                                 ; preds = %BB_8049305.i.i19, %BB_80492FD.i.i14
  ...
  %tmp2_v1.i39.i.i16 = add i32 %48, %storemerge19.i15
  %tmp0_v4.i.i.i17 = add i32 %tmp2_v1.i39.i.i16, 1
  %49 = inttoptr i32 %tmp0_v4.i.i.i17 to i8*
  %50 = load i8, i8* %49, align 1
  %51 = inttoptr i32 %tmp2_v1.i39.i.i16 to i8*
...
Func_remove_char.exit24:                          ; preds = %BB_8049305.i.i19, %BB_80492FD.i.i14, %Func_remove_char.exit
  ...
  %tmp2_v.i8.i = add i32 %56, -25
  %57 = inttoptr i32 %tmp2_v.i8.i to i8*
  store i8 %r_eax.0.i20, i8* %57, align 1
  %tmp2_v.i47.i = add i32 %55, -8184
  store i32 %tmp2_v.i47.i, i32* %14, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @remove_chat_at_pos68(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
