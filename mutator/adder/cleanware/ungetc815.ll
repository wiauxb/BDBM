...
@str.812 = constant [20 x i8] c"Error opening file.\00"
@str.813 = constant [9 x i8] c"file.txt\00"
@str.814 = constant [2 x i8] c"r\00"
...
define internal fastcc void @ungetc815(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_80492FB.exit.i:
  ...
  %tmp2_v8.i34.i = add i32 %tmp0_v.i27.i, -548
  ...
  %tmp2_v5.i.i = add i32 %tmp0_v.i27.i, -556
  %10 = inttoptr i32 %tmp2_v5.i.i to i32*
  %spi814 = ptrtoint[2 x i8]* @str.814 to i32
  store i32 %spi814, i32* %10, align 4
  %tmp2_v7.i.i = add i32 %tmp0_v.i27.i, -560
  %11 = inttoptr i32 %tmp2_v7.i.i to i32*
  %spi813 = ptrtoint[9 x i8]* @str.813 to i32
  store i32 %spi813, i32* %11, align 16
  %tmp2_v8.i.i = add i32 %tmp0_v.i27.i, -564
  ...
  %tmp2_v.i15.i = add i32 %tmp0_v.i27.i, -540
  %14 = inttoptr i32 %tmp2_v.i15.i to i32*
  store i32 %13, i32* %14, align 4
  %spi812 = ptrtoint[20 x i8]* @str.812 to i32
  store i32 %spi812, i32* %11, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @ungetc815(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
