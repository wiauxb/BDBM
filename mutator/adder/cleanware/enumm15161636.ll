...
define internal fastcc void @enumm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v8.i89.i = add i32 %tmp0_v.i81.i, -36
  %7 = inttoptr i32 %tmp2_v8.i89.i to i32*
  store i32 134517201, i32* %7, align 4
  %tmp2_v.i66.i = add i32 %tmp0_v.i81.i, -32
  %8 = inttoptr i32 %tmp2_v.i66.i to i32*
  store i32 9, i32* %8, align 16
  %tmp2_v1.i.i = add i32 %tmp0_v.i81.i, -28
  %9 = inttoptr i32 %tmp2_v1.i.i to i32*
  store i32 0, i32* %9, align 4
  %tmp2_v2.i67.i = add i32 %tmp0_v.i81.i, -24
  %10 = inttoptr i32 %tmp2_v2.i67.i to i32*
  store i32 10, i32* %10, align 8
  %11 = load i32, i32* %9, align 4
  %tmp2_v6.i71.i = add i32 %tmp0_v.i81.i, -44
  %12 = inttoptr i32 %tmp2_v6.i71.i to i32*
  store i32 %11, i32* %12, align 4
  %tmp2_v8.i.i = add i32 %tmp0_v.i81.i, -48
  %13 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 134520840, i32* %13, align 16
  %tmp2_v9.i.i = add i32 %tmp0_v.i81.i, -52
  %14 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 134517246, i32* %14, align 4
  %15 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i80.i, i32 inreg noundef 0, i32 noundef %tmp2_v8.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %16 = lshr i64 %15, 32
  ...
  %19 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i80.i, i32 inreg noundef %17, i32 noundef %tmp2_v8.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %20 = lshr i64 %19, 32
  ...
  %23 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i80.i, i32 inreg noundef %21, i32 noundef %tmp2_v8.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %24 = lshr i64 %23, 32
  %25 = trunc i64 %24 to i32
  store i32 20, i32* %12, align 4
  store i32 134520880, i32* %13, align 16
  store i32 134517308, i32* %14, align 4
  %26 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i80.i, i32 inreg noundef %25, i32 noundef %tmp2_v8.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %tmp2_v.i44.i = add i32 %tmp0_v.i81.i, -20
  %27 = inttoptr i32 %tmp2_v.i44.i to i32*
  store i32 0, i32* %27, align 4
  store i32 0, i32* %13, align 16
  store i32 134517329, i32* %14, align 4
  %tmp2_v.i29.i.i = add i32 %tmp0_v.i81.i, -56
  %28 = inttoptr i32 %tmp2_v.i29.i.i to i32*
  store i32 %tmp2_v4.i84.i, i32* %28, align 8
  %tmp2_v1.i31.i.i = add i32 %tmp0_v.i81.i, -60
  %29 = inttoptr i32 %tmp2_v1.i31.i.i to i32*
  store i32 134529024, i32* %29, align 4
  %tmp2_v2.i33.i.i = add i32 %tmp0_v.i81.i, -68
  %30 = inttoptr i32 %tmp2_v2.i33.i.i to i32*
  store i32 134517479, i32* %30, align 4
  %31 = load i32, i32* %13, align 16
  %.not.i26.i.i = icmp eq i32 %31, 0
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i81.i, -80
  %32 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  %..i = select i1 %.not.i26.i.i, i32 134520892, i32 134520895
  %.19.i = select i1 %.not.i26.i.i, i32 134517507, i32 134517535
  store i32 %..i, i32* %32, align 16
  %tmp2_v2.i20.i.i = add i32 %tmp0_v.i81.i, -84
  %33 = inttoptr i32 %tmp2_v2.i20.i.i to i32*
  ...
  %spec.select.i = zext i1 %.not.i.i.i to i32
  %41 = load i32, i32* %28, align 8
  %tmp2_v.i3.i = add i32 %41, -12
  %42 = inttoptr i32 %tmp2_v.i3.i to i32*
  ...
  %.not.i26.i.i14 = icmp eq i32 %43, 0
  %..i16 = select i1 %.not.i26.i.i14, i32 134520892, i32 134520895
  %.19.i17 = select i1 %.not.i26.i.i14, i32 134517507, i32 134517535
  ...
  %tmp2_v.i60.i = add i32 %47, -12
  %48 = inttoptr i32 %tmp2_v.i60.i to i32*
  ...
  %tmp2_v.i25.i = add i32 %51, -12
  %52 = inttoptr i32 %tmp2_v.i25.i to i32*
  ...
  %tmp2_v.i9.i = add i32 %54, -12
  %55 = inttoptr i32 %tmp2_v.i9.i to i32*
  ...
  %.not.i26.i.i37 = icmp eq i32 %56, 0
  %..i39 = select i1 %.not.i26.i.i37, i32 134520892, i32 134520895
  %.19.i40 = select i1 %.not.i26.i.i37, i32 134517507, i32 134517535
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @enumm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
