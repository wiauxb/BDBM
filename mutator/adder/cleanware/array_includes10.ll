...
@str.bis.7 = constant [29 x i8] c"\43\6f\75\6c\64\20\6e\6f\74\20\66\69\6e\64\20\31\31\20\69\6e\20\61\72\72\61\79\20\61\00"
@str.bis.8 = constant [4 x i8] c"\05\64\2d\00"
...
label_1.i33.i:
  ...
  %tmp2_v8.i29.i = add i32 %tmp0_v.i22.i, -68
  ...
  %tmp2_v3.i.i = add i32 %tmp0_v.i22.i, -60
  %10 = inttoptr i32 %tmp2_v3.i.i to i32*
  store i32 1, i32* %10, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i22.i, -56
  %11 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 2, i32* %11, align 8
  %tmp2_v5.i.i = add i32 %tmp0_v.i22.i, -52
  %12 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 3, i32* %12, align 4
  %tmp2_v6.i.i = add i32 %tmp0_v.i22.i, -48
  %13 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 4, i32* %13, align 16
  %tmp2_v7.i.i = add i32 %tmp0_v.i22.i, -44
  %14 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 5, i32* %14, align 4
  %tmp2_v8.i.i = add i32 %tmp0_v.i22.i, -40
  %15 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 6, i32* %15, align 8
  %tmp2_v9.i.i = add i32 %tmp0_v.i22.i, -36
  %16 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 7, i32* %16, align 4
  %tmp2_v10.i.i = add i32 %tmp0_v.i22.i, -32
  %17 = inttoptr i32 %tmp2_v10.i.i to i32*
  store i32 8, i32* %17, align 16
  %tmp2_v11.i.i = add i32 %tmp0_v.i22.i, -28
  %18 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 9, i32* %18, align 4
  %tmp2_v12.i.i = add i32 %tmp0_v.i22.i, -24
  ...
  %tmp2_v18.i.i = add i32 %tmp0_v.i22.i, -76
  %23 = inttoptr i32 %tmp2_v18.i.i to i32*
  store i32 %22, i32* %23, align 4
  %tmp2_v20.i.i = add i32 %tmp0_v.i22.i, -80
  %24 = inttoptr i32 %tmp2_v20.i.i to i32*
  store i32 %tmp2_v3.i.i, i32* %24, align 16
  %tmp2_v21.i.i = add i32 %tmp0_v.i22.i, -84
  %25 = inttoptr i32 %tmp2_v21.i.i to i32*
  store i32 134517312, i32* %25, align 4
  %tmp2_v.i10.i.i = add i32 %tmp0_v.i22.i, -88
  %26 = inttoptr i32 %tmp2_v.i10.i.i to i32*
  store i32 %tmp2_v4.i24.i, i32* %26, align 8
  %tmp2_v1.i13.i.i = add i32 %tmp0_v.i22.i, -108
  %27 = inttoptr i32 %tmp2_v1.i13.i.i to i32*
  %spi.bis.8 = ptrtoint[4 x i8]* @str.bis.8 to i32
  store i32 %spi.bis.8, i32* %27, align 4
  %tmp2_v.i3.i.i = add i32 %tmp0_v.i22.i, -92
  %28 = inttoptr i32 %tmp2_v.i3.i.i to i32*
  br label %BB_80492CB.i.i

BB_80492CB.i.i:                                   ; preds = %BB_80492CB.i.i, %label_1.i33.i
  %storemerge.i = phi i32 [ 0, %label_1.i33.i ], [ %tmp0_v1.i.i.i, %BB_80492CB.i.i ]
...
Func_includes.exit:                               ; preds = %BB_80492CB.i.i
  %spi.bis.7 = ptrtoint[29 x i8]* @str.bis.7 to i32
