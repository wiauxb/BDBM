...
define internal fastcc void @absolute_valuem15161636(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !18 {
  ...
  %tmp2_v.i3.i = add i32 %tmp0_v.i20.i, -40
  ...
  store i32 134520852, i32* %11, align 16
...
!19 = !{!"printf"}
  ...
  tail call fastcc void @absolute_valuem15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
