...
define internal fastcc void @find_first_char_occurrence253(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
Func_804924F.exit.i:
  ...
  %tmp2_v8.i23.i = add i32 %tmp0_v.i.i, -32
  ...
  %tmp2_v2.i10.i.i = add i32 %tmp0_v.i.i, -116
  %26 = trunc i32 %25 to i8
  %27 = inttoptr i32 %tmp2_v2.i10.i.i to i8*
  ...
  %tmp2_v.i4.i.i = add i32 %tmp0_v.i.i, -100
  %32 = inttoptr i32 %tmp2_v.i4.i.i to i32*
  store i32 %31, i32* %32, align 4
  %tmp2_v1.i5.i.i = add i32 %tmp0_v.i.i, -104
  %33 = inttoptr i32 %tmp2_v1.i5.i.i to i32*
  br label %BB_80492FE.i.i

BB_80492FE.i.i:                                   ; preds = %BB_80492FE.i.i, %Func_804924F.exit.i
  %storemerge.i = phi i32 [ 0, %Func_804924F.exit.i ], [ %tmp0_v1.i26.i.i, %BB_80492FE.i.i ]
  store i32 %storemerge.i, i32* %33, align 8
  %34 = load i32, i32* %20, align 16
  %tmp0_v3.i16.i.i = add i32 %34, %storemerge.i
  %35 = inttoptr i32 %tmp0_v3.i16.i.i to i8*
  ...
  %tmp0_v1.i26.i.i = add i32 %storemerge.i, 1
...
Func_first_occurrence.exit:                       ; preds = %BB_80492FE.i.i
  ...
  %tmp2_v.i28.i = add i32 %39, -48
  %40 = inttoptr i32 %tmp2_v.i28.i to i32*
  store i32 %storemerge.i, i32* %40, align 4
  %tmp2_v.i32.i = add i32 %39, -49
  %41 = inttoptr i32 %tmp2_v.i32.i to i8*
  %42 = load i8, i8* %41, align 1
  %tmp0_v.i33.i = sext i8 %42 to i32
  %tmp2_v4.i38.i = add i32 %tmp0_v.i.i, -72
  %43 = inttoptr i32 %tmp2_v4.i38.i to i32*
  store i32 %storemerge.i, i32* %43, align 8
  store i32 %tmp0_v.i33.i, i32* %19, align 4
  %tmp2_v6.i41.i = add i32 %38, -8159
  store i32 %tmp2_v6.i41.i, i32* %20, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @find_first_char_occurrence253(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
