...
@str.655 = constant [4 x i8] c"%d \00"
...
define internal fastcc void @replace_occurrences657(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %tmp2_v8.i.i = add i32 %tmp0_v.i10.i, -84
  ...
  %tmp2_v3.i22.i = add i32 %tmp0_v.i10.i, -60
  %11 = inttoptr i32 %tmp2_v3.i22.i to i32*
  store i32 1, i32* %11, align 4
  %tmp2_v4.i23.i = add i32 %tmp0_v.i10.i, -56
  %12 = inttoptr i32 %tmp2_v4.i23.i to i32*
  store i32 2, i32* %12, align 8
  %tmp2_v5.i24.i = add i32 %tmp0_v.i10.i, -52
  %13 = inttoptr i32 %tmp2_v5.i24.i to i32*
  store i32 1, i32* %13, align 4
  %tmp2_v6.i25.i = add i32 %tmp0_v.i10.i, -48
  ...
  %tmp2_v8.i26.i = add i32 %tmp0_v.i10.i, -40
  ...
  %tmp2_v15.i.i = add i32 %tmp0_v.i10.i, -88
  %22 = inttoptr i32 %tmp2_v15.i.i to i32*
  store i32 2, i32* %22, align 8
  %23 = load i32, i32* %21, align 16
  %tmp2_v18.i.i = add i32 %tmp0_v.i10.i, -92
  %24 = inttoptr i32 %tmp2_v18.i.i to i32*
  store i32 %23, i32* %24, align 4
  %tmp2_v20.i.i = add i32 %tmp0_v.i10.i, -96
  %25 = inttoptr i32 %tmp2_v20.i.i to i32*
  store i32 %tmp2_v3.i22.i, i32* %25, align 16
  %tmp2_v21.i.i = add i32 %tmp0_v.i10.i, -100
  ...
  store i32 %tmp2_v4.i13.i, i32* %27, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i10.i, -124
  %28 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 134517453, i32* %28, align 4
  %tmp2_v.i35.i.i = add i32 %tmp0_v.i10.i, -108
...
BB_80492DB.i.i:                                   ; preds = %BB_8049305.i.i, %0
  %storemerge2.i = phi i32 [ %tmp0_v1.i27.i.i, %BB_8049305.i.i ], [ 0, %0 ]
...
Func_replace.exit:                                ; preds = %BB_8049305.i.i, %0
  ...
  %tmp2_v.i62.i = add i32 %40, -60
  %41 = inttoptr i32 %tmp2_v.i62.i to i32*
  %tmp2_v1.i55.i = add i32 %40, -56
...
BB_804926B.i:                                     ; preds = %BB_804926B.i, %BB_804926B.i.lr.ph
  ...
  %tmp4_v.i32.i = shl i32 %storemerge5, 2
  %tmp2_v2.i33.i = add i32 %tmp2_v1.i31.i, %tmp4_v.i32.i
  %46 = inttoptr i32 %tmp2_v2.i33.i to i32*
  %47 = load i32, i32* %46, align 4
  store i32 %47, i32* %24, align 4
  %spi655 = ptrtoint[4 x i8]* @str.655 to i32
  store i32 %spi655, i32* %25, align 16
  store i32 134517378, i32* %26, align 4
  %48 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i9.i, i32 inreg noundef %r_edx.06, i32 noundef %tmp2_v20.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %49 = lshr i64 %48, 32
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @replace_occurrences657(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
