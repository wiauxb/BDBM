...
define internal fastcc void @absolute_value1004(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !18 {
  ...
  %tmp2_v.i4.i = add i32 %tmp0_v.i.i, -40
  ...
  %spi1002 = ptrtoint[12 x i8]* @str.1002 to i32
  store i32 %spi1002, i32* %11, align 16
  ...
  %spi1001 = ptrtoint[13 x i8]* @str.1001 to i32
  store i32 %spi1001, i32* %11, align 16
