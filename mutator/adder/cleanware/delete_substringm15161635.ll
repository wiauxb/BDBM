...
define internal fastcc void @delete_substringm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v8.i42.i = add i32 %tmp0_v.i35.i, -68
  ...
  %tmp2_v3.i.i = add i32 %tmp0_v.i35.i, -50
  %10 = inttoptr i32 %tmp2_v3.i.i to i32*
  store i32 1702125896, i32* %10, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i35.i, -46
  %11 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 1701344288, i32* %11, align 4
  %tmp2_v5.i.i = add i32 %tmp0_v.i35.i, -42
  %12 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 1852404512, i32* %12, align 4
  %tmp2_v6.i.i = add i32 %tmp0_v.i35.i, -38
  %13 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 1869357100, i32* %13, align 4
  %tmp2_v7.i.i = add i32 %tmp0_v.i35.i, -34
  %14 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 1948280182, i32* %14, align 4
  %tmp2_v8.i.i = add i32 %tmp0_v.i35.i, -30
  %15 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 1931502952, i32* %15, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i35.i, -26
  %16 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 1701736041, i32* %16, align 4
  %tmp2_v10.i.i = add i32 %tmp0_v.i35.i, -22
  %17 = inttoptr i32 %tmp2_v10.i.i to i16*
  store i16 114, i16* %17, align 2
  %tmp2_v13.i.i = add i32 %tmp0_v.i35.i, -76
  %18 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 %tmp2_v3.i.i, i32* %18, align 4
  %tmp2_v15.i.i = add i32 %tmp0_v.i35.i, -80
  %19 = inttoptr i32 %tmp2_v15.i.i to i32*
  store i32 134520840, i32* %19, align 16
  %tmp2_v16.i.i = add i32 %tmp0_v.i35.i, -84
  %20 = inttoptr i32 %tmp2_v16.i.i to i32*
  store i32 134517356, i32* %20, align 4
  %21 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i34.i, i32 inreg noundef 0, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  store i32 134520852, i32* %18, align 4
  store i32 %tmp2_v3.i.i, i32* %19, align 16
  store i32 134517378, i32* %20, align 4
  %tmp2_v.i74.i.i = add i32 %tmp0_v.i35.i, -88
  %22 = inttoptr i32 %tmp2_v.i74.i.i to i32*
  store i32 %tmp2_v4.i37.i, i32* %22, align 8
  %tmp2_v1.i76.i.i = add i32 %tmp0_v.i35.i, -92
  %23 = inttoptr i32 %tmp2_v1.i76.i.i to i32*
  store i32 134529024, i32* %23, align 4
  %tmp2_v2.i78.i.i = add i32 %tmp0_v.i35.i, -116
  %24 = inttoptr i32 %tmp2_v2.i78.i.i to i32*
  store i32 134517451, i32* %24, align 4
  %tmp2_v.i82.i.i = add i32 %tmp0_v.i35.i, -112
  %25 = inttoptr i32 %tmp2_v.i82.i.i to i32*
  store i32 0, i32* %25, align 16
  %26 = load i32, i32* %19, align 16
  %tmp2_v4.i87.i.i = add i32 %tmp0_v.i35.i, -128
  %27 = inttoptr i32 %tmp2_v4.i87.i.i to i32*
  store i32 %26, i32* %27, align 16
  %tmp2_v5.i88.i.i = add i32 %tmp0_v.i35.i, -132
  %28 = inttoptr i32 %tmp2_v5.i88.i.i to i32*
  store i32 134517475, i32* %28, align 4
  %arg.i.i.i = load i32, i32* %27, align 16
  %29 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i.i.i = add i32 %tmp0_v.i35.i, -108
  ...
  %tmp2_v.i32.i.i = add i32 %tmp0_v.i35.i, -100
  %33 = inttoptr i32 %tmp2_v.i32.i.i to i32*
...
BB_80492FC.i.lr.ph.i:                             ; preds = %.exit
  %mrv.i31.i = insertvalue { i32, i32 } undef, i32 %tmp2_v4.i87.i.i, 0
  %tmp2_v6.i.i.i = add i32 %tmp0_v.i35.i, -104
...
BB_804931F.i.i:                                   ; preds = %BB_80492FC.i.i
  ...
  %tmp0_v3.i8.i.i = sub i32 %39, %38
  store i32 %tmp0_v3.i8.i.i, i32* %30, align 4
...
BB_804932D.i.i:                                   ; preds = %BB_804932D.i.i, %BB_804931F.i.i
  ...
  %tmp0_v3.i14.i.i = add i32 %44, %storemerge38.i
  %tmp0_v6.i.i.i = add i32 %tmp0_v3.i14.i.i, %43
  %45 = inttoptr i32 %tmp0_v6.i.i.i to i8*
  %46 = load i8, i8* %45, align 1
  %47 = inttoptr i32 %tmp0_v3.i14.i.i to i8*
...
BB_8049357.i.i:                                   ; preds = %BB_80492FC.i.i
  %tmp0_v1.i37.i.i = add i32 %61, 1
  store i32 %tmp0_v1.i37.i.i, i32* %25, align 16
...
BB_804935B.i.backedge.i:                          ; preds = %BB_8049357.i.i, %BB_804932D.i.i, %BB_804931F.i.i
  %51 = phi i32 [ %.pre.i, %BB_8049357.i.i ], [ %41, %BB_804931F.i.i ], [ %49, %BB_804932D.i.i ]
  ...
  br i1 %53, label %BB_80492FC.i.i, label %Func_delete.exit

BB_80492FC.i.i:                                   ; preds = %BB_804935B.i.backedge.i, %BB_80492FC.i.lr.ph.i
  %54 = phi i32 [ %34, %BB_80492FC.i.lr.ph.i ], [ %52, %BB_804935B.i.backedge.i ]
  %r_esp.0.in41.i = phi i32 [ %tmp2_v4.i87.i.i, %BB_80492FC.i.lr.ph.i ], [ %r_esp.0.in.i, %BB_804935B.i.backedge.i ]
  ...
  %tmp0_v3.i49.i.i = add i32 %55, %54
  %56 = load i32, i32* %18, align 4
  %tmp2_v7.i53.i.i = add i32 %r_esp.0.in41.i, 4
  %57 = inttoptr i32 %tmp2_v7.i53.i.i to i32*
  store i32 %56, i32* %57, align 4
  %58 = inttoptr i32 %r_esp.0.in41.i to i32*
  store i32 %tmp0_v3.i49.i.i, i32* %58, align 4
  %tmp2_v9.i54.i.i = add i32 %r_esp.0.in41.i, -4
  %59 = inttoptr i32 %tmp2_v9.i54.i.i to i32*
  ...
  %tmp0_v4.i62.i.i = add i32 %62, %61
  %.not.i.i.i = icmp eq i32 %60, %tmp0_v4.i62.i.i
  br i1 %.not.i.i.i, label %BB_804931F.i.i, label %BB_8049357.i.i

Func_delete.exit:                                 ; preds = %BB_804935B.i.backedge.i, %.exit
  %r_ecx.1.lcssa.i = phi i32 [ %tmp2_v.i34.i, %.exit ], [ %r_ecx.1.be.i, %BB_804935B.i.backedge.i ]
  %.lcssa.i = phi i32 [ %34, %.exit ], [ %52, %BB_804935B.i.backedge.i ]
  %63 = load i32, i32* %19, align 16
  %tmp0_v3.i25.i.i = add i32 %63, %.lcssa.i
  %64 = inttoptr i32 %tmp0_v3.i25.i.i to i8*
  store i8 0, i8* %64, align 1
  %65 = load i32, i32* %23, align 4
  %66 = load i32, i32* %22, align 8
  %tmp2_v.i12.i = add i32 %66, -42
  store i32 %tmp2_v.i12.i, i32* %18, align 4
  %tmp2_v3.i15.i = add i32 %65, -8167
  store i32 %tmp2_v3.i15.i, i32* %19, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @delete_substringm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
