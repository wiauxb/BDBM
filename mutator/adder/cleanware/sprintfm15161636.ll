...
define internal fastcc void @sprintfm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !18 {
  ...
  %tmp2_v8.i10.i = add i32 %tmp0_v.i3.i, -164
  ...
  %tmp2_v2.i30.i = add i32 %tmp0_v.i3.i, -20
  %10 = inttoptr i32 %tmp2_v2.i30.i to i32*
  store i32 %9, i32* %10, align 4
  %11 = load i64, i64* inttoptr (i32 134520880 to i64*), align 16
  tail call fastcc void @helper_fldl_ST0(i64 %11)
  %tmp2_v1.i54.i = add i32 %tmp0_v.i3.i, -180
  %tmp5_v2.i55.i = tail call fastcc i64 @helper_fstl_ST0()
  %12 = inttoptr i32 %tmp2_v1.i54.i to i64*
  store i64 %tmp5_v2.i55.i, i64* %12, align 4
  tail call fastcc void @helper_fpop()
  %tmp2_v4.i56.i = add i32 %tmp0_v.i3.i, -184
  %13 = inttoptr i32 %tmp2_v4.i56.i to i32*
  store i32 2, i32* %13, align 8
  %tmp2_v7.i.i = add i32 %tmp0_v.i3.i, -188
  %14 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 134520840, i32* %14, align 4
  %tmp2_v8.i59.i = add i32 %tmp0_v.i3.i, -120
  %tmp2_v9.i60.i = add i32 %tmp0_v.i3.i, -192
  %15 = inttoptr i32 %tmp2_v9.i60.i to i32*
  store i32 %tmp2_v8.i59.i, i32* %15, align 16
  %tmp2_v10.i61.i = add i32 %tmp0_v.i3.i, -196
  %16 = inttoptr i32 %tmp2_v10.i61.i to i32*
  store i32 134517383, i32* %16, align 4
  %17 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef 0, i32 noundef %tmp2_v9.i60.i, i32 noundef ptrtoint (i32 ()* @sprintf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %18 = lshr i64 %17, 32
  %19 = trunc i64 %18 to i32
  %tmp2_v2.i67.i = add i32 %tmp0_v.i3.i, -172
  %20 = inttoptr i32 %tmp2_v2.i67.i to i32*
  store i32 %tmp2_v8.i59.i, i32* %20, align 4
  %tmp2_v4.i70.i = add i32 %tmp0_v.i3.i, -176
  %21 = inttoptr i32 %tmp2_v4.i70.i to i32*
  store i32 134520852, i32* %21, align 16
  %22 = inttoptr i32 %tmp2_v1.i54.i to i32*
  store i32 134517405, i32* %22, align 4
  %23 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %19, i32 noundef %tmp2_v4.i70.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !20
  %24 = lshr i64 %23, 32
  %25 = trunc i64 %24 to i32
  %mrv.i5 = insertvalue { i32, i32 } undef, i32 %tmp2_v4.i70.i, 0
  ...
  %27 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %25, i32 noundef %tmp2_v4.i70.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !20
  %28 = lshr i64 %27, 32
  ...
  store i32 %tmp2_v8.i59.i, i32* %21, align 16
  ...
  %tmp2_v.i48.i = add i32 %tmp0_v.i3.i, -148
  %32 = inttoptr i32 %tmp2_v.i48.i to i32*
  store i32 %31, i32* %32, align 4
  %tmp2_v1.i49.i = add i32 %tmp0_v.i3.i, -152
  %33 = inttoptr i32 %tmp2_v1.i49.i to i32*
...
BB_8049330.i:                                     ; preds = %BB_80492F1.i, %0
  ...
  store i32 134520872, i32* %44, align 4
  %tmp2_v12.i.i = add i32 %tmp0_v.i3.i, -130
  ...
  %47 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %r_edx.0, i32 noundef %r_esp.0.in.le, i32 noundef ptrtoint (i32 ()* @sprintf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  store i32 %tmp2_v12.i.i, i32* %45, align 4
...
BB_80492F1.i:                                     ; preds = %BB_80492F1.i, %0
  %r_esp.0.in17 = phi i32 [ %r_esp.0.in, %BB_80492F1.i ], [ %tmp2_v4.i70.i, %0 ]
  %.pn216 = phi { i32, i32 } [ %mrv1.i13, %BB_80492F1.i ], [ %mrv1.i10, %0 ]
  %storemerge15 = phi i32 [ %tmp0_v2.i100.i, %BB_80492F1.i ], [ 0, %0 ]
  %tmp0_v2.i114.i = add i32 %storemerge15, %tmp2_v8.i59.i
  %50 = inttoptr i32 %tmp0_v2.i114.i to i8*
  %51 = load i8, i8* %50, align 1
  %tmp0_v4.i116.i = sext i8 %51 to i32
  %tmp2_v6.i119.i = add i32 %r_esp.0.in17, 8
  %52 = inttoptr i32 %tmp2_v6.i119.i to i32*
  store i32 %tmp0_v4.i116.i, i32* %52, align 4
  %53 = load i32, i32* %33, align 8
  %tmp2_v9.i121.i = add i32 %r_esp.0.in17, 4
  %54 = inttoptr i32 %tmp2_v9.i121.i to i32*
  store i32 %53, i32* %54, align 4
  %55 = inttoptr i32 %r_esp.0.in17 to i32*
  store i32 134520855, i32* %55, align 4
  %tmp2_v12.i125.i = add i32 %r_esp.0.in17, -4
  %56 = inttoptr i32 %tmp2_v12.i125.i to i32*
  store i32 134517528, i32* %56, align 4
  %57 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %tmp2_v8.i59.i, i32 noundef %r_esp.0.in17, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !20
  %58 = lshr i64 %57, 32
  %59 = trunc i64 %58 to i32
  %mrv1.i13 = insertvalue { i32, i32 } %.pn216, i32 %59, 1
  %60 = load i32, i32* %33, align 8
  %tmp0_v2.i100.i = add i32 %60, 1
  store i32 %tmp0_v2.i100.i, i32* %33, align 8
  %r_esp.0.in = extractvalue { i32, i32 } %.pn216, 0
  %61 = load i32, i32* %32, align 4
  %62 = icmp slt i32 %tmp0_v2.i100.i, %61
...
!20 = !{!"printf"}
  ...
  tail call fastcc void @sprintfm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
