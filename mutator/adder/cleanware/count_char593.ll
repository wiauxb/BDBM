...
define internal fastcc void @count_char593(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v6.i.i = add i32 %tmp0_v.i24.i, -16
  %5 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 %tmp2_v.i23.i, i32* %5, align 16
  %tmp2_v8.i.i = add i32 %tmp0_v.i24.i, -68
  %6 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 134517233, i32* %6, align 4
  %tmp4_v.i31.i.b = load i1, i1* @segs.0, align 1
  %7 = inttoptr i32 %arg_esp to i32*
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i35.i = add i32 %tmp0_v.i24.i, -20
  %9 = inttoptr i32 %tmp2_v2.i35.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i36.i = add i32 %tmp0_v.i24.i, -44
  %10 = inttoptr i32 %tmp2_v3.i36.i to i32*
  store i32 1936287828, i32* %10, align 4
  %tmp2_v4.i37.i = add i32 %tmp0_v.i24.i, -40
  %11 = inttoptr i32 %tmp2_v4.i37.i to i32*
  store i32 544434464, i32* %11, align 8
  %tmp2_v5.i38.i = add i32 %tmp0_v.i24.i, -36
  %12 = inttoptr i32 %tmp2_v5.i38.i to i32*
  store i32 1948285293, i32* %12, align 4
  %tmp2_v6.i39.i = add i32 %tmp0_v.i24.i, -32
  %13 = inttoptr i32 %tmp2_v6.i39.i to i32*
  store i32 544502629, i32* %13, align 16
  %tmp2_v7.i40.i = add i32 %tmp0_v.i24.i, -28
  %14 = inttoptr i32 %tmp2_v7.i40.i to i32*
  store i32 1769108595, i32* %14, align 4
  %tmp2_v8.i41.i = add i32 %tmp0_v.i24.i, -24
  %15 = inttoptr i32 %tmp2_v8.i41.i to i32*
  store i32 3041134, i32* %15, align 8
  %tmp2_v10.i.i = add i32 %tmp0_v.i24.i, -76
  %16 = inttoptr i32 %tmp2_v10.i.i to i32*
  store i32 115, i32* %16, align 4
  %tmp2_v12.i.i = add i32 %tmp0_v.i24.i, -80
  %17 = inttoptr i32 %tmp2_v12.i.i to i32*
  store i32 %tmp2_v3.i36.i, i32* %17, align 16
  %tmp2_v13.i.i = add i32 %tmp0_v.i24.i, -84
  %18 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 134517306, i32* %18, align 4
  %19 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_count_char(i32 %tmp2_v13.i.i, i32 %tmp2_v4.i25.i, i32 134529024)
  ...
  %29 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i23.i, i32 inreg noundef %22, i32 noundef %20, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  store i32 46, i32* %26, align 4
  %tmp2_v2.i20.i = add i32 %23, -36
  store i32 %tmp2_v2.i20.i, i32* %27, align 4
  ...
  %tmp2_v.i3.i = add i32 %34, -40
  %36 = inttoptr i32 %tmp2_v.i3.i to i32*
  store i32 %32, i32* %36, align 4
  %tmp2_v4.i6.i = add i32 %31, 4
  %37 = inttoptr i32 %tmp2_v4.i6.i to i32*
  ...
  %40 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i23.i, i32 inreg noundef %33, i32 noundef %31, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
define internal fastcc { i32, i32, i32, i32, i32 } @Func_count_char(i32 %arg_esp, i32 %arg_ebp, i32 %arg_ebx) unnamed_addr  norecurse  !retregs !14 {
  ...
  %3 = inttoptr i32 %tmp2_v2.i5.i to i32*
  store i32 134517422, i32* %3, align 4
  %tmp2_v.i.i = add i32 %arg_esp, 8
  %4 = inttoptr i32 %tmp2_v.i.i to i32*
  ...
  %tmp2_v.i41.i = add i32 %arg_esp, -16
  %13 = inttoptr i32 %tmp2_v.i41.i to i32*
  store i32 %12, i32* %13, align 4
  %tmp2_v1.i43.i = add i32 %arg_esp, -24
  %14 = inttoptr i32 %tmp2_v1.i43.i to i32*
  store i32 0, i32* %14, align 4
  %tmp2_v2.i44.i = add i32 %arg_esp, -20
  %15 = inttoptr i32 %tmp2_v2.i44.i to i32*
...
BB_80492EC.i:                                     ; preds = %BB_80492DC.i
  ...
  %tmp0_v1.i18.i = add i32 %18, 1
  store i32 %tmp0_v1.i18.i, i32* %14, align 4
  %.pre = load i32, i32* %15, align 4
  br label %BB_80492F0.i

BB_80492DC.i:                                     ; preds = %BB_80492F0.i, %0
  %storemerge20 = phi i32 [ %tmp0_v1.i48.i, %BB_80492F0.i ], [ 0, %0 ]
  %19 = load i32, i32* %8, align 4
  %tmp0_v3.i31.i = add i32 %19, %storemerge20
  %20 = inttoptr i32 %tmp0_v3.i31.i to i8*
  %21 = load i8, i8* %20, align 1
  %tmp0_v4.i32.i = zext i8 %21 to i32
  %22 = load i8, i8* %7, align 1
  %tmp0_v6.i34.i = zext i8 %22 to i32
  %cc_dst_v.i35.i = sub nsw i32 %tmp0_v6.i34.i, %tmp0_v4.i32.i
  %tmp4_v.i36.i = and i32 %cc_dst_v.i35.i, 255
  %.not.i.i = icmp eq i32 %tmp4_v.i36.i, 0
...
BB_80492F0.i:                                     ; preds = %BB_80492DC.i, %BB_80492EC.i
  ...
  %tmp0_v1.i48.i = add i32 %23, 1
  store i32 %tmp0_v1.i48.i, i32* %15, align 4
  %24 = load i32, i32* %13, align 4
  %25 = icmp slt i32 %tmp0_v1.i48.i, %24
