...
define internal fastcc void @dot_productm15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !24 {
.exit:
  ...
  %tmp2_v8.i46.i = add i32 %tmp0_v.i40.i, -52
  ...
  %tmp2_v2.i28.i = add i32 %tmp0_v.i40.i, -20
  ...
  %tmp6_v.i18.i = tail call fastcc i32 @helper_fsts_ST0()
  %11 = inttoptr i32 %tmp2_v1.i.i to i32*
  store i32 %tmp6_v.i18.i, i32* %11, align 4
  ...
  %tmp2_v6.i19.i = add i32 %tmp0_v.i40.i, -40
  %tmp6_v7.i.i = tail call fastcc i32 @helper_fsts_ST0()
  %13 = inttoptr i32 %tmp2_v6.i19.i to i32*
  ...
  %tmp2_v12.i.i = add i32 %tmp0_v.i40.i, -36
  ...
  %tmp2_v18.i.i = add i32 %tmp0_v.i40.i, -32
  ...
  %tmp2_v24.i.i = add i32 %tmp0_v.i40.i, -28
  ...
  %tmp2_v27.i.i = add i32 %tmp0_v.i40.i, -24
  ...
  %tmp2_v.i20.i.i = add i32 %tmp0_v.i40.i, -80
  %tmp6_v.i21.i.i = tail call fastcc i32 @helper_fsts_ST0()  nounwind 
  %27 = inttoptr i32 %tmp2_v.i20.i.i to i32*
  store i32 %tmp6_v.i21.i.i, i32* %27, align 16
  tail call fastcc void @helper_fpop()  nounwind 
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i40.i, -76
...
Func_dot_product.exit:                            ; preds = %BB_804928A.i.i, %.exit
  ...
  %tmp2_v.i10.i = add i32 %43, -40
  %tmp6_v.i.i = tail call fastcc i32 @helper_fsts_ST0()
  %44 = inttoptr i32 %tmp2_v.i10.i to i32*
  store i32 %tmp6_v.i.i, i32* %44, align 4
  tail call fastcc void @helper_fpop()
  ...
  %47 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i39.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v35.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  ret void
}
...
!25 = !{!"printf"}
  ...
  tail call fastcc void @dot_productm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
