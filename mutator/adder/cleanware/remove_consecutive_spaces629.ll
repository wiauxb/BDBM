...
@str.628 = constant [14 x i8] c"Before: '%s'\0a\00"
...
define internal fastcc void @remove_consecutive_spaces629(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  store i32 %tmp2_v3.i26.i, i32* %20, align 4
  %tmp2_v17.i.i = add i32 %tmp0_v.i32.i, -80
  %21 = inttoptr i32 %tmp2_v17.i.i to i32*
  %spi628 = ptrtoint[14 x i8]* @str.628 to i32
  store i32 %spi628, i32* %21, align 16
  ...
  store i32 %tmp2_v3.i26.i, i32* %21, align 16
  store i32 134517351, i32* %22, align 4
  %tmp2_v.i67.i.i = add i32 %tmp0_v.i32.i, -88
  %24 = inttoptr i32 %tmp2_v.i67.i.i to i32*
  store i32 %tmp2_v4.i34.i, i32* %24, align 8
  %tmp2_v1.i69.i.i = add i32 %tmp0_v.i32.i, -92
  %25 = inttoptr i32 %tmp2_v1.i69.i.i to i32*
  store i32 134529024, i32* %25, align 4
  %tmp2_v2.i71.i.i = add i32 %tmp0_v.i32.i, -116
  %26 = inttoptr i32 %tmp2_v2.i71.i.i to i32*
  store i32 134517424, i32* %26, align 4
  %27 = load i32, i32* %21, align 16
  %tmp2_v3.i41.i.i = add i32 %tmp0_v.i32.i, -128
  %28 = inttoptr i32 %tmp2_v3.i41.i.i to i32*
  store i32 %27, i32* %28, align 16
  %tmp2_v4.i42.i.i = add i32 %tmp0_v.i32.i, -132
  %29 = inttoptr i32 %tmp2_v4.i42.i.i to i32*
...
BB_804930A.i.i:                                   ; preds = %BB_80492EB.i.i, %BB_80492F1.i.i
  %37 = phi i8 [ 32, %BB_80492EB.i.i ], [ %.pre, %BB_80492F1.i.i ]
  %r_ecx.0.i = phi i32 [ %r_ecx.129.i, %BB_80492EB.i.i ], [ %41, %BB_80492F1.i.i ]
  %.not.i.i.i = icmp ne i8 %37, 32
  %spec.select.i = zext i1 %.not.i.i.i to i8
  store i8 %spec.select.i, i8* %33, align 1
  %38 = load i32, i32* %34, align 8
  %tmp0_v1.i75.i.i = add i32 %38, 1
  store i32 %tmp0_v1.i75.i.i, i32* %34, align 8
  %39 = load i32, i32* %31, align 4
  %40 = icmp slt i32 %tmp0_v1.i75.i.i, %39
  br i1 %40, label %BB_80492DC.i.i, label %Func_remove_consecutive_spaces.exit

BB_80492F1.i.i:                                   ; preds = %BB_80492DC.i.i, %BB_80492EB.i.i
  %41 = load i32, i32* %32, align 4
  %tmp0_v8.i.i.i = add i32 %41, %46
...
BB_80492EB.i.i:                                   ; preds = %BB_80492DC.i.i
  ...
  %45 = icmp eq i8 %44, 0
  br i1 %45, label %BB_804930A.i.i, label %BB_80492F1.i.i

BB_80492DC.i.i:                                   ; preds = %BB_804930A.i.i, %.exit
  %r_ecx.129.i = phi i32 [ %r_ecx.0.i, %BB_804930A.i.i ], [ %tmp2_v.i31.i, %.exit ]
  %storemerge28.i = phi i32 [ %tmp0_v1.i75.i.i, %BB_804930A.i.i ], [ 0, %.exit ]
  %46 = load i32, i32* %21, align 16
  %tmp0_v3.i48.i.i = add i32 %46, %storemerge28.i
  %47 = inttoptr i32 %tmp0_v3.i48.i.i to i8*
  %48 = load i8, i8* %47, align 1
  %.not.i52.i.i = icmp eq i8 %48, 32
  br i1 %.not.i52.i.i, label %BB_80492EB.i.i, label %BB_80492F1.i.i

Func_remove_consecutive_spaces.exit:              ; preds = %BB_804930A.i.i, %.exit
  %r_ecx.1.lcssa.i = phi i32 [ %tmp2_v.i31.i, %.exit ], [ %r_ecx.0.i, %BB_804930A.i.i ]
  %49 = load i32, i32* %32, align 4
  %50 = load i32, i32* %21, align 16
  %tmp0_v3.i10.i.i = add i32 %50, %49
  %51 = inttoptr i32 %tmp0_v3.i10.i.i to i8*
  store i8 0, i8* %51, align 1
  %52 = load i32, i32* %25, align 4
  %53 = load i32, i32* %24, align 8
  %tmp2_v.i.i = add i32 %53, -49
  store i32 %tmp2_v.i.i, i32* %20, align 4
  %tmp2_v3.i.i = add i32 %52, -8170
  store i32 %tmp2_v3.i.i, i32* %21, align 16
  store i32 134517373, i32* %22, align 4
  %54 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %r_ecx.1.lcssa.i, i32 inreg noundef %49, i32 noundef %tmp2_v17.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @remove_consecutive_spaces629(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
