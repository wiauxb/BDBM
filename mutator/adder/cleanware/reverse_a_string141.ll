...
define internal fastcc void @reverse_a_string141(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
.exit:
  ...
  %tmp2_v3.i18.i = add i32 %tmp0_v.i.i, -48
  ...
  %tmp2_v1.i30.i.i = add i32 %tmp0_v.i.i, -76
  ...
  %tmp2_v.i20.i.i = add i32 %tmp0_v.i.i, -88
  %26 = inttoptr i32 %tmp2_v.i20.i.i to i32*
  store i32 %25, i32* %26, align 8
  %tmp0_v3.i24.i.i = lshr i32 %25, 31
  %tmp0_v4.i25.i.i = add i32 %tmp0_v3.i24.i.i, %25
  %tmp0_v5.i.i.i = ashr i32 %tmp0_v4.i25.i.i, 1
  %tmp2_v6.i26.i.i = add i32 %tmp0_v.i.i, -84
  %27 = inttoptr i32 %tmp2_v6.i26.i.i to i32*
  store i32 %tmp0_v5.i.i.i, i32* %27, align 4
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i.i, -92
...
BB_80492B1.i.lr.ph.i:                             ; preds = %.exit
  %tmp2_v5.i.i.i = add i32 %tmp0_v.i.i, -93
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @reverse_a_string141(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
