...
@str.305 = constant [4 x i8] c"%c\0a\00"
...
.exit:
  ...
  %tmp2_v.i71.i.i = add i32 %tmp0_v.i.i, -72
  %18 = inttoptr i32 %tmp2_v.i71.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %18, align 8
  %tmp2_v1.i73.i.i = add i32 %tmp0_v.i.i, -76
  %19 = inttoptr i32 %tmp2_v1.i73.i.i to i32*
  store i32 0, i32* %19, align 4
  %tmp2_v2.i76.i.i = add i32 %tmp0_v.i.i, -100
  ...
  %tmp2_v4.i33.i.i = add i32 %tmp0_v.i.i, -116
  %23 = inttoptr i32 %tmp2_v4.i33.i.i to i32*
  store i32 134517406, i32* %23, align 4
  %arg.i.i.i = load i32, i32* %22, align 16
  %24 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i99.i.i = add i32 %tmp0_v.i.i, -84
  %25 = inttoptr i32 %tmp2_v.i99.i.i to i32*
  store i32 %24, i32* %25, align 4
  %tmp2_v1.i100.i.i = add i32 %tmp0_v.i.i, -94
  %26 = inttoptr i32 %tmp2_v1.i100.i.i to i8*
  %tmp2_v2.i101.i.i = add i32 %tmp0_v.i.i, -93
  %27 = inttoptr i32 %tmp2_v2.i101.i.i to i8*
  store i8 0, i8* %27, align 1
  %tmp2_v3.i102.i.i = add i32 %tmp0_v.i.i, -92
  %28 = inttoptr i32 %tmp2_v3.i102.i.i to i32*
  %tmp2_v1.i69.i.i = add i32 %tmp0_v.i.i, -88
  %29 = inttoptr i32 %tmp2_v1.i69.i.i to i32*
...
BB_80492E8.i.i:                                   ; preds = %BB_80492C2.i.i, %BB_80492E4.i.i
  ...
  %tmp0_v1.i7.i.i = add i32 %30, 1
  store i32 %tmp0_v1.i7.i.i, i32* %29, align 8
  %31 = load i32, i32* %25, align 4
  %32 = icmp slt i32 %tmp0_v1.i7.i.i, %31
  br i1 %32, label %BB_80492C2.i.i, label %BB_80492F4.i.i

BB_804932A.i.i:                                   ; preds = %BB_8049326.i.i, %.exit
  %storemerge.i = phi i32 [ 0, %.exit ], [ %tmp0_v1.i47.i.i, %BB_8049326.i.i ]
  ...
  br i1 %34, label %BB_80492C2.i.i, label %BB_80492F4.i.i
...
BB_8049326.i.i:                                   ; preds = %BB_80492F4.i.i
  %tmp0_v1.i47.i.i = add i32 %44, 1
  br label %BB_804932A.i.i

BB_80492C2.i.i:                                   ; preds = %BB_804932A.i.i, %BB_80492E8.i.i
  %storemerge17.i = phi i32 [ %tmp0_v1.i7.i.i, %BB_80492E8.i.i ], [ 0, %BB_804932A.i.i ]
  %35 = load i32, i32* %28, align 4
  %36 = load i32, i32* %16, align 16
  %tmp0_v3.i59.i.i = add i32 %36, %35
  %37 = inttoptr i32 %tmp0_v3.i59.i.i to i8*
  %38 = load i8, i8* %37, align 1
  %tmp0_v4.i60.i.i = zext i8 %38 to i32
  %tmp0_v9.i.i.i = add i32 %36, %storemerge17.i
  %39 = inttoptr i32 %tmp0_v9.i.i.i to i8*
  %40 = load i8, i8* %39, align 1
  %tmp0_v10.i.i.i = zext i8 %40 to i32
  %cc_dst_v.i64.i.i = sub nsw i32 %tmp0_v4.i60.i.i, %tmp0_v10.i.i.i
  %tmp4_v.i65.i.i = and i32 %cc_dst_v.i64.i.i, 255
  %.not.i.i.i = icmp ne i32 %tmp4_v.i65.i.i, 0
  %41 = icmp eq i32 %35, %storemerge17.i
...
BB_80492F4.i.i:                                   ; preds = %BB_804932A.i.i, %BB_80492E8.i.i
  ...
  %42 = load i8, i8* %26, align 2
  %43 = icmp eq i8 %42, 1
  %44 = load i32, i32* %28, align 4
  br i1 %43, label %BB_8049326.i.i, label %Func_print_first_unique.exit

Func_print_first_unique.exit:                     ; preds = %BB_80492F4.i.i
  %45 = load i32, i32* %16, align 16
  %tmp0_v3.i12.i.i = add i32 %45, %44
  %46 = inttoptr i32 %tmp0_v3.i12.i.i to i8*
  ...
  %spi305 = ptrtoint[4 x i8]* @str.305 to i32
  store i32 %spi305, i32* %22, align 16
  store i32 134517533, i32* %23, align 4
  %49 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %r_ecx.1.lcssa.i, i32 inreg noundef %44, i32 noundef %tmp2_v3.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
