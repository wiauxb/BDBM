...
@str.bis.705 = constant [4 x i8] c"\25\64\20\00"
@str.bis.706 = constant [4 x i8] c"\05\1e\2d\00"
@str.bis.707 = constant [4 x i8] c"\25\64\20\00"
...
define internal fastcc void @rotate_array_left709(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %tmp2_v4.i.i = add i32 %tmp0_v.i34.i, -8
...
BB_8049235.i:                                     ; preds = %BB_8049235.i, %0
  ...
  %spi.bis.707 = ptrtoint[4 x i8]* @str.bis.707 to i32
  store i32 %spi.bis.707, i32* %19, align 16
  store i32 134517324, i32* %20, align 4
  %23 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i33.i, i32 inreg noundef %r_edx.112, i32 noundef %tmp2_v7.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %24 = lshr i64 %23, 32
  %25 = trunc i64 %24 to i32
  %26 = load i32, i32* %17, align 4
  %tmp0_v2.i69.i = add i32 %26, 1
  store i32 %tmp0_v2.i69.i, i32* %17, align 4
  %27 = icmp slt i32 %tmp0_v2.i69.i, 6
...
BB_8049259.i:                                     ; preds = %BB_8049235.i
  ...
  %tmp2_v.i45.i = add i32 %tmp0_v.i34.i, -72
  %31 = inttoptr i32 %tmp2_v.i45.i to i32*
  store i32 6, i32* %31, align 8
  store i32 6, i32* %18, align 4
  store i32 %tmp2_v3.i93.i, i32* %19, align 16
  store i32 134517366, i32* %20, align 4
  %tmp2_v.i5.i.i = add i32 %tmp0_v.i34.i, -88
  %32 = inttoptr i32 %tmp2_v.i5.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %32, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i34.i, -116
  %33 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  %spi.bis.706 = ptrtoint[4 x i8]* @str.bis.706 to i32
  store i32 %spi.bis.706, i32* %33, align 4
  %tmp2_v.i3.i.i = add i32 %tmp0_v.i34.i, -100
...
BB_80492F0.i.lr.ph.i:                             ; preds = %BB_8049259.i
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i34.i, -124
  %37 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  %tmp2_v5.i15.i.i = add i32 %tmp0_v.i34.i, -128
  %38 = inttoptr i32 %tmp2_v5.i15.i.i to i32*
  %tmp2_v6.i.i.i = add i32 %tmp0_v.i34.i, -132
  %39 = inttoptr i32 %tmp2_v6.i.i.i to i32*
  %tmp2_v.i1.i.i.i = add i32 %tmp0_v.i34.i, -136
  %40 = inttoptr i32 %tmp2_v.i1.i.i.i to i32*
  %tmp2_v1.i.i.i.i = add i32 %tmp0_v.i34.i, -156
  %41 = inttoptr i32 %tmp2_v1.i.i.i.i to i32*
  %tmp2_v3.i.i.i.i = add i32 %tmp0_v.i34.i, -140
  %42 = inttoptr i32 %tmp2_v3.i.i.i.i to i32*
  %tmp2_v4.i.i.i.i = add i32 %tmp0_v.i34.i, -144
...
BB_80492F0.i.i:                                   ; preds = %Func_rotate_left_once.exit.i, %BB_80492F0.i.lr.ph.i
  %r_ecx.018.i = phi i32 [ %tmp2_v.i33.i, %BB_80492F0.i.lr.ph.i ], [ %r_ecx.0.lcssa.i.i, %Func_rotate_left_once.exit.i ]
  %r_ebp.017.i = phi i32 [ %tmp2_v.i5.i.i, %BB_80492F0.i.lr.ph.i ], [ %63, %Func_rotate_left_once.exit.i ]
  %tmp2_v.i11.i.i = add i32 %r_ebp.017.i, 12
  %44 = inttoptr i32 %tmp2_v.i11.i.i to i32*
  %45 = load i32, i32* %44, align 4
  store i32 %45, i32* %37, align 4
  %tmp2_v3.i13.i.i = add i32 %r_ebp.017.i, 8
  %46 = inttoptr i32 %tmp2_v3.i13.i.i to i32*
  %47 = load i32, i32* %46, align 4
  store i32 %47, i32* %38, align 16
  store i32 134517502, i32* %39, align 4
  store i32 %r_ebp.017.i, i32* %40, align 8
  ...
  %tmp0_v1.i22.i8.i.i = add i32 %51, -1
  %52 = icmp sgt i32 %tmp0_v1.i22.i8.i.i, 0
...
BB_8049336.i.i.i:                                 ; preds = %BB_8049336.i.i.i, %BB_80492F0.i.i
  ...
  %tmp0_v1.i11.i.i.i = shl i32 %storemerge9.i.i, 2
  %53 = load i32, i32* %38, align 16
  %tmp4_v.i12.i.i.i = add i32 %53, %tmp0_v1.i11.i.i.i
  %tmp0_v4.i15.i.i.i = add i32 %tmp4_v.i12.i.i.i, 4
  %54 = inttoptr i32 %tmp0_v4.i15.i.i.i to i32*
  %55 = load i32, i32* %54, align 4
  %56 = inttoptr i32 %tmp4_v.i12.i.i.i to i32*
  ...
  %tmp0_v1.i22.i.i.i = add i32 %58, -1
  %59 = icmp slt i32 %tmp0_v14.i.i.i.i, %tmp0_v1.i22.i.i.i
...
Func_rotate_left_once.exit.i:                     ; preds = %BB_8049336.i.i.i, %BB_80492F0.i.i
  %r_ecx.0.lcssa.i.i = phi i32 [ %r_ecx.018.i, %BB_80492F0.i.i ], [ %tmp0_v1.i11.i.i.i, %BB_8049336.i.i.i ]
  %.lcssa.i.i = phi i32 [ %51, %BB_80492F0.i.i ], [ %58, %BB_8049336.i.i.i ]
  %tmp0_v1.i7.i.i.i = shl i32 %.lcssa.i.i, 2
  %tmp4_v.i.i.i14.i = add i32 %tmp0_v1.i7.i.i.i, -4
  ...
  %tmp2_v.i.i.i = add i32 %63, -12
  %64 = inttoptr i32 %tmp2_v.i.i.i to i32*
  %65 = load i32, i32* %64, align 4
  %tmp0_v2.i.i.i = add i32 %65, 1
  store i32 %tmp0_v2.i.i.i, i32* %64, align 4
  %tmp2_v1.i22.i.i = add i32 %63, 16
  %66 = inttoptr i32 %tmp2_v1.i22.i.i to i32*
...
Func_rotate_left.exit:                            ; preds = %.exit.loopexit.i, %BB_8049259.i
  ...
  %r_ebp.0.lcssa.i = phi i32 [ %63, %.exit.loopexit.i ], [ %tmp2_v.i5.i.i, %BB_8049259.i ]
  %r_ecx.0.lcssa.i = phi i32 [ %r_ecx.0.lcssa.i.i, %.exit.loopexit.i ], [ %tmp2_v.i33.i, %BB_8049259.i ]
  ...
  %tmp2_v1.i53.i = add i32 %69, -36
  %tmp2_v5.i59.i = add i32 %r_ebp.0.lcssa.i, 12
  %71 = inttoptr i32 %tmp2_v5.i59.i to i32*
  %72 = inttoptr i32 %tmp4_v2.i.i.i to i32*
  %tmp2_v8.i63.i = add i32 %r_ebp.0.lcssa.i, 4
  %73 = inttoptr i32 %tmp2_v8.i63.i to i32*
...
BB_8049282.i:                                     ; preds = %BB_8049282.i, %Func_rotate_left.exit
  ...
  %tmp4_v.i54.i = shl i32 %storemerge114, 2
  %tmp2_v2.i55.i = add i32 %tmp2_v1.i53.i, %tmp4_v.i54.i
  %74 = inttoptr i32 %tmp2_v2.i55.i to i32*
  %75 = load i32, i32* %74, align 4
  store i32 %75, i32* %71, align 4
  %spi.bis.705 = ptrtoint[4 x i8]* @str.bis.705 to i32
  store i32 %spi.bis.705, i32* %72, align 4
  ...
  store i32 %tmp0_v2.i.i, i32* %70, align 4
