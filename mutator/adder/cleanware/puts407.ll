...
Func_804925F.exit.i:
  ...
  %tmp2_v2.i29.i = add i32 %tmp0_v.i46.i, -20
  %9 = inttoptr i32 %tmp2_v2.i29.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v5.i33.i = add i32 %tmp0_v.i46.i, -64
  %10 = inttoptr i32 %tmp2_v5.i33.i to i32*
  %spi.bis.405 = ptrtoint[21 x i8]* @str.405 to i32
  store i32 %spi.bis.405, i32* %10, align 16
  %tmp2_v6.i34.i = add i32 %tmp0_v.i46.i, -68
  %11 = inttoptr i32 %tmp2_v6.i34.i to i32*
  ...
  %spi.bis.404 = ptrtoint[21 x i8]* @str.404 to i32
  ...
  %spi.bis.403 = ptrtoint[21 x i8]* @str.403 to i32
  store i32 %spi.bis.403, i32* %16, align 16
  %spi.bis.402 = ptrtoint[21 x i8]* @str.402 to i32
  ...
  %tmp2_v.i3.i = add i32 %tmp0_v.i46.i, -41
  %19 = inttoptr i32 %tmp2_v.i3.i to i32*
  store i32 1769108563, i32* %19, align 4
  %tmp2_v1.i4.i = add i32 %tmp0_v.i46.i, -37
  %20 = inttoptr i32 %tmp2_v1.i4.i to i32*
  ...
  %tmp2_v3.i.i = add i32 %tmp0_v.i46.i, -29
