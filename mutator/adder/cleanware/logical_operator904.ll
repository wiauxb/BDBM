...
Func_80491B1.exit.i:
  ...
  %tmp2_v.i28.i = add i32 %tmp0_v.i15.i, -24
  %7 = inttoptr i32 %tmp2_v.i28.i to i32*
  store i32 2020, i32* %7, align 8
  %tmp2_v1.i29.i = add i32 %tmp0_v.i15.i, -20
  %8 = inttoptr i32 %tmp2_v1.i29.i to i32*
  store i32 19000, i32* %8, align 4
  %tmp2_v1.i47.i = add i32 %tmp0_v.i15.i, -48
  %9 = inttoptr i32 %tmp2_v1.i47.i to i32*
  %spi902 = ptrtoint[4 x i8]* @str.902 to i32
  store i32 %spi902, i32* %9, align 16
  %tmp2_v2.i48.i = add i32 %tmp0_v.i15.i, -52
  ...
  %spi901 = ptrtoint[4 x i8]* @str.901 to i32
  store i32 %spi901, i32* %9, align 16
  ...
  %spi900 = ptrtoint[4 x i8]* @str.900 to i32
  store i32 %spi900, i32* %9, align 16
