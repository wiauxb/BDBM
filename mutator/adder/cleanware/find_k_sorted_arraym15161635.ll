...
define internal fastcc void @find_k_sorted_arraym15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %23 = inttoptr i32 %tmp2_v.i24.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %23, align 8
  %tmp2_v1.i27.i.i = add i32 %tmp0_v.i.i, -108
  %24 = inttoptr i32 %tmp2_v1.i27.i.i to i32*
  store i32 134517366, i32* %24, align 4
  %tmp2_v.i12.i.i = add i32 %tmp0_v.i.i, -92
  %25 = inttoptr i32 %tmp2_v.i12.i.i to i32*
  br label %BB_80492A3.i.i

BB_80492A3.i.i:                                   ; preds = %BB_80492A3.i.i, %.exit
  %storemerge.i = phi i32 [ 0, %.exit ], [ %tmp0_v1.i16.i.i, %BB_80492A3.i.i ]
...
Func_find_index.exit:                             ; preds = %BB_80492A3.i.i
  ...
  %33 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %tmp4_v.i6.i.i, i32 noundef %tmp2_v19.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @find_k_sorted_arraym15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
