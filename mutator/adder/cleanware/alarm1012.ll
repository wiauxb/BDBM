...
define internal fastcc void @alarm1012(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v.i19.i = add i32 %tmp0_v.i3.i, -48
  %8 = inttoptr i32 %tmp2_v.i19.i to i32*
  store i32 1, i32* %8, align 16
  %tmp2_v2.i20.i = add i32 %tmp0_v.i3.i, -52
  ...
  %11 = inttoptr i32 %tmp2_v.i10.i to i32*
  store i32 %10, i32* %11, align 4
  %tmp2_v4.i12.i = add i32 %tmp0_v.i3.i, -44
  %12 = inttoptr i32 %tmp2_v4.i12.i to i32*
  store i32 %10, i32* %12, align 4
  %spi1010 = ptrtoint[3 x i8]* @str.1010 to i32
  store i32 %spi1010, i32* %8, align 16
  store i32 134517241, i32* %9, align 4
  %13 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef 0, i32 noundef %tmp2_v.i19.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
