...
@str.725 = constant [14 x i8] c"integral: %f\0a\00"
@str.726 = constant [10 x i8] c"frac: %f\0a\00"
...
define internal fastcc void @modf727(i32 %arg_esp) unnamed_addr  norecurse  !retregs !18 {
.exit:
  ...
  %spi726 = ptrtoint[10 x i8]* @str.726 to i32
  store i32 %spi726, i32* %20, align 16
  ...
  tail call fastcc void @helper_fpop()
  %spi725 = ptrtoint[14 x i8]* @str.725 to i32
  store i32 %spi725, i32* %20, align 16
...
!19 = !{!"printf"}
  ...
  tail call fastcc void @modf727(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
