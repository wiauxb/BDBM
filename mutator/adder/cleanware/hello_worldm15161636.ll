...
define internal fastcc void @hello_worldm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
  ...
  %tmp2_v3.i11.i = add i32 %tmp0_v.i.i, -36
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @hello_worldm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
