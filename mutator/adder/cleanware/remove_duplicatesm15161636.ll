...
define internal fastcc void @remove_duplicatesm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %8 = select i1 %tmp4_v.i20.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %9 = load i32, i32* %8, align 4
  %tmp2_v2.i24.i = add i32 %tmp0_v.i2.i, -20
  %10 = inttoptr i32 %tmp2_v2.i24.i to i32*
  store i32 %9, i32* %10, align 4
  %tmp2_v3.i25.i = add i32 %tmp0_v.i2.i, -60
  %11 = inttoptr i32 %tmp2_v3.i25.i to i32*
  store i32 1, i32* %11, align 4
  %tmp2_v4.i26.i = add i32 %tmp0_v.i2.i, -56
  %12 = inttoptr i32 %tmp2_v4.i26.i to i32*
  store i32 2, i32* %12, align 8
  %tmp2_v5.i27.i = add i32 %tmp0_v.i2.i, -52
  %13 = inttoptr i32 %tmp2_v5.i27.i to i32*
  store i32 3, i32* %13, align 4
  %tmp2_v6.i28.i = add i32 %tmp0_v.i2.i, -48
  %14 = inttoptr i32 %tmp2_v6.i28.i to i32*
  store i32 4, i32* %14, align 16
  %tmp2_v7.i29.i = add i32 %tmp0_v.i2.i, -44
  %15 = inttoptr i32 %tmp2_v7.i29.i to i32*
  store i32 1, i32* %15, align 4
  %tmp2_v8.i30.i = add i32 %tmp0_v.i2.i, -40
  %16 = inttoptr i32 %tmp2_v8.i30.i to i32*
  store i32 2, i32* %16, align 8
  %tmp2_v9.i31.i = add i32 %tmp0_v.i2.i, -36
  %17 = inttoptr i32 %tmp2_v9.i31.i to i32*
  store i32 5, i32* %17, align 4
  %tmp2_v10.i32.i = add i32 %tmp0_v.i2.i, -32
  %18 = inttoptr i32 %tmp2_v10.i32.i to i32*
  store i32 6, i32* %18, align 16
  %tmp2_v11.i33.i = add i32 %tmp0_v.i2.i, -28
  %19 = inttoptr i32 %tmp2_v11.i33.i to i32*
  store i32 7, i32* %19, align 4
  %tmp2_v12.i34.i = add i32 %tmp0_v.i2.i, -24
  %20 = inttoptr i32 %tmp2_v12.i34.i to i32*
  store i32 8, i32* %20, align 8
  %tmp2_v13.i.i = add i32 %tmp0_v.i2.i, -72
  %21 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 0, i32* %21, align 8
  %tmp2_v16.i.i = add i32 %tmp0_v.i2.i, -88
  %22 = inttoptr i32 %tmp2_v16.i.i to i32*
  store i32 %tmp2_v13.i.i, i32* %22, align 8
  %tmp2_v17.i.i = add i32 %tmp0_v.i2.i, -92
  %23 = inttoptr i32 %tmp2_v17.i.i to i32*
  store i32 10, i32* %23, align 4
  %tmp2_v19.i.i = add i32 %tmp0_v.i2.i, -96
  %24 = inttoptr i32 %tmp2_v19.i.i to i32*
  store i32 %tmp2_v3.i25.i, i32* %24, align 16
  %tmp2_v20.i.i = add i32 %tmp0_v.i2.i, -100
  %25 = inttoptr i32 %tmp2_v20.i.i to i32*
  store i32 134517409, i32* %25, align 4
  %tmp2_v.i51.i.i = add i32 %tmp0_v.i2.i, -104
  %26 = inttoptr i32 %tmp2_v.i51.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %26, align 8
  %tmp2_v1.i53.i.i = add i32 %tmp0_v.i2.i, -108
  %27 = inttoptr i32 %tmp2_v1.i53.i.i to i32*
  store i32 134529024, i32* %27, align 4
  %tmp2_v2.i56.i.i = add i32 %tmp0_v.i2.i, -148
  %28 = inttoptr i32 %tmp2_v2.i56.i.i to i32*
  store i32 134517537, i32* %28, align 4
  %29 = load i32, i32* %23, align 4
  %tmp0_v2.i24.i.i = shl i32 %29, 2
  %tmp2_v4.i27.i.i = add i32 %tmp0_v.i2.i, -160
  %30 = inttoptr i32 %tmp2_v4.i27.i.i to i32*
  store i32 %tmp0_v2.i24.i.i, i32* %30, align 16
  %tmp2_v5.i28.i.i = add i32 %tmp0_v.i2.i, -164
  %31 = inttoptr i32 %tmp2_v5.i28.i.i to i32*
  store i32 134517558, i32* %31, align 4
  %arg.i.i.i = load i32, i32* %30, align 16
  %32 = tail call i32 @malloc(i32 %arg.i.i.i)
  %tmp2_v.i92.i.i = add i32 %tmp0_v.i2.i, -128
  %33 = inttoptr i32 %tmp2_v.i92.i.i to i32*
  store i32 %32, i32* %33, align 16
  %tmp2_v1.i94.i.i = add i32 %tmp0_v.i2.i, -124
  %34 = inttoptr i32 %tmp2_v1.i94.i.i to i32*
  store i32 0, i32* %34, align 4
  %tmp2_v2.i95.i.i = add i32 %tmp0_v.i2.i, -120
  %35 = inttoptr i32 %tmp2_v2.i95.i.i to i32*
...
BB_804934C.i.lr.ph.i:                             ; preds = %0
  %tmp2_v.i19.i.i = add i32 %tmp0_v.i2.i, -129
  %38 = inttoptr i32 %tmp2_v.i19.i.i to i8*
  %tmp2_v1.i20.i.i = add i32 %tmp0_v.i2.i, -116
  %39 = inttoptr i32 %tmp2_v1.i20.i.i to i32*
...
BB_804934C.i.i:                                   ; preds = %BB_80493BD.i.i, %BB_804934C.i.lr.ph.i
  %r_ecx.241.i = phi i32 [ %tmp2_v.i1.i, %BB_804934C.i.lr.ph.i ], [ %r_ecx.0.i, %BB_80493BD.i.i ]
...
BB_80493BD.i.i:                                   ; preds = %BB_8049391.i.i, %BB_8049391.i.thread.i, %BB_8049397.i.i
  %r_ecx.0.i = phi i32 [ %r_ecx.3.lcssa.i, %BB_8049391.i.i ], [ %tmp4_v6.i.i.i, %BB_8049397.i.i ], [ %tmp4_v7.i.i.i, %BB_8049391.i.thread.i ]
  %49 = load i32, i32* %35, align 8
  %tmp0_v1.i32.i.i = add i32 %49, 1
  store i32 %tmp0_v1.i32.i.i, i32* %35, align 8
  %50 = load i32, i32* %23, align 4
  %51 = icmp slt i32 %tmp0_v1.i32.i.i, %50
...
BB_8049391.i.i:                                   ; preds = %BB_8049389.i.i, %BB_804934C.i.i
  %52 = phi i32 [ %47, %BB_804934C.i.i ], [ %61, %BB_8049389.i.i ]
  %r_ecx.3.lcssa.i = phi i32 [ %r_ecx.241.i, %BB_804934C.i.i ], [ %tmp4_v7.i.i.i, %BB_8049389.i.i ]
  %.pr.i = load i8, i8* %38, align 1
  %53 = icmp eq i8 %.pr.i, 0
  br i1 %53, label %BB_80493BD.i.i, label %BB_8049397.i.i

BB_8049359.i.i:                                   ; preds = %BB_8049389.i.i, %BB_804934C.i.i
  %storemerge3140.i = phi i32 [ %tmp0_v1.i43.i.i, %BB_8049389.i.i ], [ 0, %BB_804934C.i.i ]
  %tmp4_v.i71.i.i = shl i32 %storemerge3140.i, 2
  %54 = load i32, i32* %33, align 16
  %tmp0_v3.i74.i.i = add i32 %54, %tmp4_v.i71.i.i
  %55 = inttoptr i32 %tmp0_v3.i74.i.i to i32*
  %56 = load i32, i32* %55, align 4
  %57 = load i32, i32* %35, align 8
  %tmp4_v7.i.i.i = shl i32 %57, 2
  %58 = load i32, i32* %24, align 16
  %tmp0_v10.i79.i.i = add i32 %58, %tmp4_v7.i.i.i
  %59 = inttoptr i32 %tmp0_v10.i79.i.i to i32*
  %60 = load i32, i32* %59, align 4
  %.not.i.i.i = icmp eq i32 %56, %60
  %tmp0_v1.i43.i.i = add nuw nsw i32 %storemerge3140.i, 1
  br i1 %.not.i.i.i, label %BB_8049391.i.thread.i, label %BB_8049389.i.i

BB_8049389.i.i:                                   ; preds = %BB_8049359.i.i
  store i32 %tmp0_v1.i43.i.i, i32* %39, align 4
  %61 = load i32, i32* %34, align 4
  %62 = icmp slt i32 %tmp0_v1.i43.i.i, %61
  br i1 %62, label %BB_8049359.i.i, label %BB_8049391.i.i

Func_remove_duplicates.exit:                      ; preds = %BB_80493BD.i.i, %0
  %r_ecx.2.lcssa.i = phi i32 [ %tmp2_v.i1.i, %0 ], [ %r_ecx.0.i, %BB_80493BD.i.i ]
  %63 = load i32, i32* %34, align 4
  %tmp0_v1.i99.i.i = shl i32 %63, 2
  %tmp2_v3.i102.i.i = add i32 %tmp0_v.i2.i, -156
  %64 = inttoptr i32 %tmp2_v3.i102.i.i to i32*
  store i32 %tmp0_v1.i99.i.i, i32* %64, align 4
...
BB_80492B0.i:                                     ; preds = %BB_80492B0.i, %BB_80492B0.i.lr.ph
  ...
  %85 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %r_ecx.2.lcssa.i, i32 inreg noundef %tmp4_v.i.i, i32 noundef %tmp2_v19.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %86 = load i32, i32* %74, align 4
  %tmp0_v2.i55.i = add i32 %86, 1
  store i32 %tmp0_v2.i55.i, i32* %74, align 4
  %87 = load i32, i32* %75, align 4
  %88 = icmp slt i32 %tmp0_v2.i55.i, %87
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @remove_duplicatesm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
