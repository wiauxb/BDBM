...
@str.181 = constant [6 x i8] c"%02d \00"
...
define internal fastcc void @print_0_99_grid182(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
...
BB_80491E0.i:                                     ; preds = %BB_804922D.ithread-pre-split, %0
  %r_ecx.04 = phi i32 [ %tmp2_v.i11.i, %0 ], [ %tmp0_v13.i.i, %BB_804922D.ithread-pre-split ]
  %r_edx.03 = phi i32 [ 0, %0 ], [ %tmp0_v13.i.i, %BB_804922D.ithread-pre-split ]
  %12 = phi i32 [ 0, %0 ], [ %.pr, %BB_804922D.ithread-pre-split ]
  store i32 %12, i32* %9, align 4
  %spi181 = ptrtoint[6 x i8]* @str.181 to i32
  store i32 %spi181, i32* %10, align 16
  ...
  %tmp0_v2.i33.i = add i32 %14, 1
  store i32 %tmp0_v2.i33.i, i32* %8, align 4
  %tmp16_v.i.i = sext i32 %tmp0_v2.i33.i to i64
  %tmp15_v.i.i = mul nsw i64 %tmp16_v.i.i, 1717986919
  %tmp15_v5.i.i = lshr i64 %tmp15_v.i.i, 32
  %15 = trunc i64 %tmp15_v5.i.i to i32
  %tmp0_v7.i35.i = ashr i32 %15, 2
  %tmp0_v8.i.i.neg = lshr i32 %tmp0_v2.i33.i, 31
  %tmp0_v9.i.i = add nsw i32 %tmp0_v7.i35.i, %tmp0_v8.i.i.neg
  %tmp0_v12.i.i.neg = mul i32 %tmp0_v9.i.i, -10
  %tmp0_v13.i.i = add i32 %tmp0_v12.i.i.neg, %tmp0_v2.i33.i
...
BB_804922D.ithread-pre-split:                     ; preds = %BB_8049220.i, %BB_80491E0.i
  %.pr = phi i32 [ %.pr.pre, %BB_8049220.i ], [ %tmp0_v2.i33.i, %BB_80491E0.i ]
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @print_0_99_grid182(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
