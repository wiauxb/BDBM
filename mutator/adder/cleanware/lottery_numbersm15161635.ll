...
define internal fastcc void @lottery_numbersm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v4.i.i = add i32 %tmp0_v.i9.i, -80
  %11 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 0, i32* %11, align 16
  %tmp2_v5.i.i = add i32 %tmp0_v.i9.i, -84
  ...
  %tmp2_v.i41.i = add i32 %tmp0_v.i9.i, -56
  %14 = inttoptr i32 %tmp2_v.i41.i to i32*
  store i32 0, i32* %14, align 8
  %tmp2_v.i88.i = add i32 %tmp0_v.i9.i, -48
  %15 = inttoptr i32 %tmp2_v.i88.i to i32*
  %tmp2_v9.i89.i = add i32 %tmp0_v.i9.i, -57
  %16 = inttoptr i32 %tmp2_v9.i89.i to i8*
  %tmp2_v10.i.i = add i32 %tmp0_v.i9.i, -52
  %17 = inttoptr i32 %tmp2_v10.i.i to i32*
  %tmp2_v3.i74.i = add i32 %tmp0_v.i9.i, -44
  %tmp2_v11.i.i = add i32 %tmp0_v.i9.i, -72
  %18 = inttoptr i32 %tmp2_v11.i.i to i32*
  %tmp2_v12.i.i = add i32 %tmp0_v.i9.i, -76
...
BB_8049267.i:                                     ; preds = %Func_80492B9.exit.i, %0
  ...
  %tmp16_v.i.i = sext i32 %20 to i64
  %tmp15_v.i.i = mul nsw i64 %tmp16_v.i.i, 582368447
  %tmp15_v1.i.i = lshr i64 %tmp15_v.i.i, 32
  %21 = trunc i64 %tmp15_v1.i.i to i32
  %tmp0_v2.i82.i = ashr i32 %21, 3
  %tmp0_v3.i83.i.neg = lshr i32 %20, 31
  %tmp0_v4.i84.i = add nsw i32 %tmp0_v2.i82.i, %tmp0_v3.i83.i.neg
  %tmp17_v5.i.i.neg = mul i32 %tmp0_v4.i84.i, -59
  %tmp0_v7.i85.i = add i32 %tmp17_v5.i.i.neg, %20
  %tmp0_v8.i86.i = add i32 %tmp0_v7.i85.i, 1
  store i32 %tmp0_v8.i86.i, i32* %15, align 16
...
BB_80492B1.i:                                     ; preds = %BB_80492B1.i, %BB_8049267.i
  ...
  br i1 %23, label %BB_80492B1.i, label %Func_80492B9.exit.i

Func_80492B9.exit.i:                              ; preds = %BB_80492B1.i
  %24 = load i32, i32* %15, align 16
  %tmp4_v.i75.i = shl i32 %22, 2
  %tmp2_v4.i76.i = add i32 %tmp2_v3.i74.i, %tmp4_v.i75.i
  %25 = inttoptr i32 %tmp2_v4.i76.i to i32*
  store i32 %24, i32* %25, align 4
  %26 = load i32, i32* %14, align 8
  %tmp0_v7.i78.i = add i32 %26, 1
  ...
  %28 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v7.i85.i, i32 inreg noundef %24, i32 noundef %tmp2_v4.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %29 = load i32, i32* %14, align 8
  %tmp0_v2.i19.i = add i32 %29, 1
  store i32 %tmp0_v2.i19.i, i32* %14, align 8
  %30 = icmp slt i32 %tmp0_v2.i19.i, 6
  br i1 %30, label %BB_8049267.i, label %.exit
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @lottery_numbersm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
