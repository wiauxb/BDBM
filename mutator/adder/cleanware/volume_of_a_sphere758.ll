...
define internal fastcc void @volume_of_a_sphere758(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !18 {
  ...
  %tmp2_v1.i.i = add i32 %tmp0_v.i3.i, -32
  ...
  store i64 %tmp5_v.i11.i, i64* %23, align 4
  tail call fastcc void @helper_fpop()
  %spi756 = ptrtoint[4 x i8]* @str.756 to i32
  store i32 %spi756, i32* %13, align 16
