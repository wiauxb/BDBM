...
@str.46 = constant [13 x i8] c"Before:\0a\0a %s\00"
...
define internal fastcc void @trim_trailing_whitespace47(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v3.i23.i = add i32 %tmp0_v.i.i, -42
  %10 = inttoptr i32 %tmp2_v3.i23.i to i32*
  store i32 1936287828, i32* %10, align 4
  %tmp2_v4.i24.i = add i32 %tmp0_v.i.i, -38
  %11 = inttoptr i32 %tmp2_v4.i24.i to i32*
  store i32 544434464, i32* %11, align 4
  %tmp2_v5.i25.i = add i32 %tmp0_v.i.i, -34
  %12 = inttoptr i32 %tmp2_v5.i25.i to i32*
  store i32 543516788, i32* %12, align 4
  %tmp2_v6.i26.i = add i32 %tmp0_v.i.i, -30
  %13 = inttoptr i32 %tmp2_v6.i26.i to i32*
  store i32 779706743, i32* %13, align 4
  %tmp2_v7.i.i = add i32 %tmp0_v.i.i, -26
  %14 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 151652896, i32* %14, align 4
  %tmp2_v8.i27.i = add i32 %tmp0_v.i.i, -22
  %15 = inttoptr i32 %tmp2_v8.i27.i to i16*
  store i16 32, i16* %15, align 2
  %tmp2_v11.i.i = add i32 %tmp0_v.i.i, -60
  %16 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 %tmp2_v3.i23.i, i32* %16, align 4
  %tmp2_v13.i.i = add i32 %tmp0_v.i.i, -64
  %17 = inttoptr i32 %tmp2_v13.i.i to i32*
  %spi46 = ptrtoint[13 x i8]* @str.46 to i32
  store i32 %spi46, i32* %17, align 16
  %tmp2_v14.i.i = add i32 %tmp0_v.i.i, -68
  %18 = inttoptr i32 %tmp2_v14.i.i to i32*
  store i32 134517342, i32* %18, align 4
  %19 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef 0, i32 noundef %tmp2_v13.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  store i32 %tmp2_v3.i23.i, i32* %17, align 16
  ...
  %tmp2_v.i54.i.i = add i32 %tmp0_v.i.i, -84
  %27 = inttoptr i32 %tmp2_v.i54.i.i to i32*
...
BB_804930F.i.i:                                   ; preds = %BB_804930F.i.i.backedge, %.exit
  ...
  %tmp0_v3.i10.i.i = add i32 %28, %storemerge.i
  %29 = inttoptr i32 %tmp0_v3.i10.i.i to i8*
...
Func_trim.exit:                                   ; preds = %BB_804930F.i.i
  %tmp0_v4.i.i.i = add i32 %28, %storemerge.in.i
  %31 = inttoptr i32 %tmp0_v4.i.i.i to i8*
  store i8 0, i8* %31, align 1
  %32 = load i32, i32* %21, align 4
  %33 = load i32, i32* %20, align 8
  %tmp2_v.i41.i = add i32 %32, -8171
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @trim_trailing_whitespace47(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
