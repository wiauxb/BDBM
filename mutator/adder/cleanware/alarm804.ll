...
@str.803 = constant [3 x i8] c"%d\00"
...
define internal fastcc void @alarm804(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v.i.i = add i32 %tmp0_v.i9.i, -20
  %11 = inttoptr i32 %tmp2_v.i.i to i32*
  store i32 %10, i32* %11, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i9.i, -44
  %12 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 %10, i32* %12, align 4
  %spi803 = ptrtoint[3 x i8]* @str.803 to i32
  store i32 %spi803, i32* %8, align 16
  store i32 134517241, i32* %9, align 4
  %13 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef 0, i32 noundef %tmp2_v.i19.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @alarm804(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
