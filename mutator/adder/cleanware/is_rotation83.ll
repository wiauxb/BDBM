...
define internal fastcc void @is_rotation83(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
Func_80492CC.exit.i:
  ...
  %tmp2_v2.i32.i = add i32 %tmp0_v.i16.i, -20
  %9 = inttoptr i32 %tmp2_v2.i32.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i33.i = add i32 %tmp0_v.i16.i, -32
  %10 = inttoptr i32 %tmp2_v3.i33.i to i32*
  store i32 1330531660, i32* %10, align 16
  %tmp2_v4.i34.i = add i32 %tmp0_v.i16.i, -28
  %11 = inttoptr i32 %tmp2_v4.i34.i to i16*
  store i16 80, i16* %11, align 4
  %tmp2_v5.i35.i = add i32 %tmp0_v.i16.i, -26
  %12 = inttoptr i32 %tmp2_v5.i35.i to i32*
  store i32 1280331598, i32* %12, align 4
  %tmp2_v6.i36.i = add i32 %tmp0_v.i16.i, -22
  %13 = inttoptr i32 %tmp2_v6.i36.i to i16*
  store i16 77, i16* %13, align 2
  %tmp2_v9.i.i = add i32 %tmp0_v.i16.i, -44
  %14 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 %tmp2_v5.i35.i, i32* %14, align 4
  %tmp2_v11.i.i = add i32 %tmp0_v.i16.i, -48
  %15 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 %tmp2_v3.i33.i, i32* %15, align 16
  %tmp2_v12.i.i = add i32 %tmp0_v.i16.i, -52
  %16 = inttoptr i32 %tmp2_v12.i.i to i32*
  store i32 134517452, i32* %16, align 4
  %tmp2_v.i11.i.i = add i32 %tmp0_v.i16.i, -56
  %17 = inttoptr i32 %tmp2_v.i11.i.i to i32*
  store i32 %tmp2_v4.i19.i, i32* %17, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i16.i, -60
  %18 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 134529024, i32* %18, align 4
  %tmp2_v2.i14.i.i = add i32 %tmp0_v.i16.i, -100
  %19 = inttoptr i32 %tmp2_v2.i14.i.i to i32*
  store i32 134517561, i32* %19, align 4
  %20 = load i32, i32* %15, align 16
  %tmp2_v3.i78.i.i = add i32 %tmp0_v.i16.i, -112
  %21 = inttoptr i32 %tmp2_v3.i78.i.i to i32*
  store i32 %20, i32* %21, align 16
  %tmp2_v4.i79.i.i = add i32 %tmp0_v.i16.i, -116
  %22 = inttoptr i32 %tmp2_v4.i79.i.i to i32*
  store i32 134517578, i32* %22, align 4
  %arg.i.i.i = load i32, i32* %21, align 16
  %23 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i.i.i = add i32 %tmp0_v.i16.i, -84
  ...
  %tmp2_v.i33.i.i = add i32 %tmp0_v.i16.i, -80
  %27 = inttoptr i32 %tmp2_v.i33.i.i to i32*
  store i32 %26, i32* %27, align 16
  %28 = load i32, i32* %24, align 4
  %tmp0_v1.i51.i.i = shl i32 %28, 1
  %tmp0_v2.i52.i.i = or i32 %tmp0_v1.i51.i.i, 1
  %tmp2_v3.i53.i.i = add i32 %tmp0_v.i16.i, -76
  %29 = inttoptr i32 %tmp2_v3.i53.i.i to i32*
  store i32 %tmp0_v2.i52.i.i, i32* %29, align 4
  store i32 %tmp0_v2.i52.i.i, i32* %21, align 16
  store i32 134517639, i32* %22, align 4
  %arg.i.i11.i = load i32, i32* %21, align 16
  %30 = tail call i32 @malloc(i32 %arg.i.i11.i)
  %tmp2_v.i18.i.i = add i32 %tmp0_v.i16.i, -72
  %31 = inttoptr i32 %tmp2_v.i18.i.i to i32*
  store i32 %30, i32* %31, align 8
  %32 = load i32, i32* %15, align 16
  %tmp2_v4.i.i.i = add i32 %tmp0_v.i16.i, -108
  ...
  %tmp2_v.i4.i.i = add i32 %tmp0_v.i16.i, -68
  ...
  %tmp2_v.i11.i = add i32 %45, -18
  %tmp2_v1.i12.i = add i32 %tmp0_v.i16.i, -40
  %46 = inttoptr i32 %tmp2_v1.i12.i to i32*
  store i32 %tmp2_v.i11.i, i32* %46, align 8
  ...
  %47 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i15.i, i32 inreg noundef 0, i32 noundef %tmp2_v11.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @is_rotation83(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
