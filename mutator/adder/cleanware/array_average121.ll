...
@str.114 = constant [17 x i8] c"arr4 avg: %.2lf\0a\00"
@str.115 = constant [17 x i8] c"arr3 avg: %.2lf\0a\00"
@str.116 = constant [17 x i8] c"arr2 avg: %.2lf\0a\00"
@str.117 = constant [17 x i8] c"arr1 avg: %.2lf\0a\00"
...
define internal fastcc { i32, i32, i32 } @Func_avg(i32 %arg_esp, i32 %arg_edx, i32 %arg_ebp) unnamed_addr  nofree norecurse nosync nounwind  !retregs !22 {
  %tmp2_v.i12.i = add i32 %arg_esp, -4
  %1 = inttoptr i32 %tmp2_v.i12.i to i32*
  store i32 %arg_ebp, i32* %1, align 4
  %tmp2_v1.i15.i = add i32 %arg_esp, -24
  %2 = inttoptr i32 %tmp2_v1.i15.i to i32*
  store i32 134517559, i32* %2, align 4
  tail call fastcc void @helper_fpush()
  tail call fastcc void @helper_fldz_ST0()
  %tmp2_v.i10.i = add i32 %arg_esp, -12
  %tmp5_v.i11.i = tail call fastcc i64 @helper_fstl_ST0()
  %3 = inttoptr i32 %tmp2_v.i10.i to i64*
  store i64 %tmp5_v.i11.i, i64* %3, align 4
...
BB_804934A.i.lr.ph:                               ; preds = %0
  %8 = inttoptr i32 %tmp2_v1.i4.i to i32*
...
BB_804934A.i:                                     ; preds = %BB_804934A.i, %BB_804934A.i.lr.ph
  ...
  %tmp4_v.i.i = shl i32 %storemerge14, 3
  %9 = load i32, i32* %8, align 4
  %tmp0_v3.i.i = add i32 %9, %tmp4_v.i.i
...
.exit:                                            ; preds = %BB_804934A.i, %0
  %r_edx.0.lcssa = phi i32 [ %arg_edx, %0 ], [ %tmp4_v.i.i, %BB_804934A.i ]
  ...
  %mrv = insertvalue { i32, i32, i32 } undef, i32 %tmp2_v1.i4.i, 0
...
define internal fastcc void @array_average121(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !23 {
.exit:
  ...
  tail call fastcc void @helper_fldl_ST0(i64 %12)
  %tmp2_v7.i.i = add i32 %tmp0_v.i16.i, -104
  ...
  %tmp2_v13.i.i = add i32 %tmp0_v.i16.i, -96
  ...
  tail call fastcc void @helper_fldl_ST0(i64 %16)
  %tmp2_v19.i.i = add i32 %tmp0_v.i16.i, -88
  ...
  %tmp2_v25.i.i = add i32 %tmp0_v.i16.i, -80
  ...
  %tmp2_v31.i.i = add i32 %tmp0_v.i16.i, -136
  ...
  %tmp2_v37.i.i = add i32 %tmp0_v.i16.i, -128
  ...
  %tmp2_v43.i.i = add i32 %tmp0_v.i16.i, -120
  ...
  %tmp2_v49.i.i = add i32 %tmp0_v.i16.i, -72
  ...
  %tmp2_v55.i.i = add i32 %tmp0_v.i16.i, -64
  ...
  %tmp2_v61.i.i = add i32 %tmp0_v.i16.i, -56
  ...
  %tmp2_v67.i.i = add i32 %tmp0_v.i16.i, -48
  ...
  %tmp2_v73.i.i = add i32 %tmp0_v.i16.i, -40
  ...
  %tmp2_v79.i.i = add i32 %tmp0_v.i16.i, -32
  ...
  tail call fastcc void @helper_fpop()
  %tmp2_v81.i.i = add i32 %tmp0_v.i16.i, -156
  %38 = inttoptr i32 %tmp2_v81.i.i to i32*
  store i32 5, i32* %38, align 4
  %tmp2_v84.i.i = add i32 %tmp0_v.i16.i, -160
  %39 = inttoptr i32 %tmp2_v84.i.i to i32*
  store i32 %tmp2_v1.i.i, i32* %39, align 16
  %tmp2_v85.i.i = add i32 %tmp0_v.i16.i, -164
  %40 = inttoptr i32 %tmp2_v85.i.i to i32*
  store i32 134517358, i32* %40, align 4
  %41 = tail call fastcc { i32, i32, i32 } @Func_avg(i32 %tmp2_v85.i.i, i32 0, i32 %tmp2_v4.i17.i)
  %42 = extractvalue { i32, i32, i32 } %41, 0
  %43 = extractvalue { i32, i32, i32 } %41, 1
  %44 = extractvalue { i32, i32, i32 } %41, 2
  %tmp2_v.i69.i = add i32 %42, 4
  %tmp5_v.i70.i = tail call fastcc i64 @helper_fstl_ST0()
  %45 = inttoptr i32 %tmp2_v.i69.i to i64*
  store i64 %tmp5_v.i70.i, i64* %45, align 4
  tail call fastcc void @helper_fpop()
  %46 = inttoptr i32 %42 to i32*
  %spi117 = ptrtoint[17 x i8]* @str.117 to i32
  store i32 %spi117, i32* %46, align 4
  %tmp2_v5.i75.i = add i32 %42, -4
  %47 = inttoptr i32 %tmp2_v5.i75.i to i32*
  store i32 134517383, i32* %47, align 4
  %48 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i15.i, i32 inreg noundef %43, i32 noundef %42, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !24
  %49 = lshr i64 %48, 32
  %50 = trunc i64 %49 to i32
  %51 = inttoptr i32 %tmp2_v.i69.i to i32*
  store i32 1, i32* %51, align 4
  %tmp2_v2.i6.i = add i32 %44, -128
  store i32 %tmp2_v2.i6.i, i32* %46, align 4
  store i32 134517400, i32* %47, align 4
  %52 = tail call fastcc { i32, i32, i32 } @Func_avg(i32 %tmp2_v5.i75.i, i32 %50, i32 %44)
  ...
  %spi116 = ptrtoint[17 x i8]* @str.116 to i32
  store i32 %spi116, i32* %57, align 4
  %tmp2_v5.i65.i = add i32 %53, -4
  %58 = inttoptr i32 %tmp2_v5.i65.i to i32*
  store i32 134517425, i32* %58, align 4
  %59 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i15.i, i32 inreg noundef %54, i32 noundef %53, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !24
  %60 = lshr i64 %59, 32
  %61 = trunc i64 %60 to i32
  %62 = inttoptr i32 %tmp2_v.i59.i to i32*
  store i32 2, i32* %62, align 4
  %tmp2_v2.i37.i = add i32 %55, -120
  store i32 %tmp2_v2.i37.i, i32* %57, align 4
  ...
  %tmp2_v.i11.i = add i32 %64, 4
  %tmp5_v.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %67 = inttoptr i32 %tmp2_v.i11.i to i64*
  store i64 %tmp5_v.i.i, i64* %67, align 4
  tail call fastcc void @helper_fpop()
  %68 = inttoptr i32 %64 to i32*
  %spi115 = ptrtoint[17 x i8]* @str.115 to i32
  store i32 %spi115, i32* %68, align 4
  %tmp2_v5.i.i = add i32 %64, -4
  %69 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 134517467, i32* %69, align 4
  %70 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i15.i, i32 inreg noundef %65, i32 noundef %64, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !24
  %71 = lshr i64 %70, 32
  %72 = trunc i64 %71 to i32
  %73 = inttoptr i32 %tmp2_v.i11.i to i32*
  ...
  %74 = tail call fastcc { i32, i32, i32 } @Func_avg(i32 %tmp2_v5.i.i, i32 %72, i32 %66)
  %75 = extractvalue { i32, i32, i32 } %74, 0
  %76 = extractvalue { i32, i32, i32 } %74, 1
  %tmp2_v.i49.i = add i32 %75, 4
  %tmp5_v.i50.i = tail call fastcc i64 @helper_fstl_ST0()
  %77 = inttoptr i32 %tmp2_v.i49.i to i64*
  store i64 %tmp5_v.i50.i, i64* %77, align 4
  tail call fastcc void @helper_fpop()
  %78 = inttoptr i32 %75 to i32*
  %spi114 = ptrtoint[17 x i8]* @str.114 to i32
  store i32 %spi114, i32* %78, align 4
  %tmp2_v5.i55.i = add i32 %75, -4
  %79 = inttoptr i32 %tmp2_v5.i55.i to i32*
  store i32 134517509, i32* %79, align 4
  %80 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i15.i, i32 inreg noundef %76, i32 noundef %75, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !24
  ret void
}
...
!23 = !{i32 0, i32 0, i32 0, i32 0}
!24 = !{!"printf"}

  tail call fastcc void @array_average121(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
