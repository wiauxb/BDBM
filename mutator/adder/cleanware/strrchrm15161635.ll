...
define internal fastcc void @strrchrm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_8049255.exit.i:
  ...
  %5 = inttoptr i32 %tmp2_v6.i51.i to i32*
  store i32 %tmp2_v.i43.i, i32* %5, align 16
  %tmp2_v8.i.i = add i32 %tmp0_v.i44.i, -52
  ...
  %tmp2_v.i36.i = add i32 %tmp0_v.i44.i, -48
  %19 = inttoptr i32 %tmp2_v.i36.i to i32*
  ...
  %tmp2_v.i3.i = add i32 %tmp0_v.i44.i, -44
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @strrchrm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
