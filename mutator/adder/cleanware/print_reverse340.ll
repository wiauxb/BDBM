...
@str.337 = constant [4 x i8] c"%d \00"
@str.338 = constant [4 x i8] c"%d \00"
...
define internal fastcc void @print_reverse340(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v7.i.i = add i32 %tmp0_v.i3.i, -116
...
BB_80492E1.i.i:                                   ; preds = %BB_80492E1.i.i, %BB_80492E1.i.lr.ph.i
  ...
  %tmp4_v.i14.i.i = shl i32 %storemerge20.i, 2
  %30 = load i32, i32* %20, align 16
  %tmp0_v3.i17.i.i = add i32 %30, %tmp4_v.i14.i.i
  %31 = inttoptr i32 %tmp0_v3.i17.i.i to i32*
  %32 = load i32, i32* %31, align 4
  store i32 %32, i32* %27, align 4
  %spi338 = ptrtoint[4 x i8]* @str.338 to i32
  store i32 %spi338, i32* %28, align 16
  store i32 134517506, i32* %29, align 4
  %33 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %tmp4_v.i14.i.i, i32 noundef %tmp2_v8.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
...
Func_print_reverse.exit:                          ; preds = %BB_80492E1.i.i, %..exit_crit_edge.i
  ...
  %tmp2_v.i8.i = add i32 %37, -52
  %38 = inttoptr i32 %tmp2_v.i8.i to i32*
  store i32 0, i32* %38, align 4
  %tmp2_v1.i.i = add i32 %37, -48
  %39 = inttoptr i32 %tmp2_v1.i.i to i32*
  store i32 1, i32* %39, align 4
  %tmp2_v2.i9.i = add i32 %37, -44
  %40 = inttoptr i32 %tmp2_v2.i9.i to i32*
  store i32 2, i32* %40, align 4
  %tmp2_v3.i10.i = add i32 %37, -40
  %41 = inttoptr i32 %tmp2_v3.i10.i to i32*
  store i32 3, i32* %41, align 4
  %tmp2_v4.i11.i = add i32 %37, -36
  %42 = inttoptr i32 %tmp2_v4.i11.i to i32*
  store i32 4, i32* %42, align 4
  %tmp2_v5.i12.i = add i32 %37, -32
  %43 = inttoptr i32 %tmp2_v5.i12.i to i32*
  store i32 5, i32* %43, align 4
  %tmp2_v6.i.i = add i32 %37, -28
  %44 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 6, i32* %44, align 4
  %tmp2_v7.i13.i = add i32 %37, -24
  %45 = inttoptr i32 %tmp2_v7.i13.i to i32*
...
..exit_crit_edge.i12:                             ; preds = %Func_print_reverse.exit
  %.pre.i8 = add i32 %tmp0_v.i3.i, -176
  %.pre21.i9 = inttoptr i32 %.pre.i8 to i32*
  %.pre22.i10 = add i32 %tmp0_v.i3.i, -180
...
BB_80492E1.i.lr.ph.i16:                           ; preds = %Func_print_reverse.exit
  %tmp2_v6.i.i.i13 = add i32 %tmp0_v.i3.i, -172
  %55 = inttoptr i32 %tmp2_v6.i.i.i13 to i32*
  %tmp2_v8.i.i.i14 = add i32 %tmp0_v.i3.i, -176
  %56 = inttoptr i32 %tmp2_v8.i.i.i14 to i32*
  %tmp2_v9.i.i.i15 = add i32 %tmp0_v.i3.i, -180
...
BB_80492E1.i.i22:                                 ; preds = %BB_80492E1.i.i22, %BB_80492E1.i.lr.ph.i16
  ...
  %tmp4_v.i14.i.i18 = shl i32 %storemerge20.i17, 2
  %58 = load i32, i32* %20, align 16
  %tmp0_v3.i17.i.i19 = add i32 %58, %tmp4_v.i14.i.i18
  %59 = inttoptr i32 %tmp0_v3.i17.i.i19 to i32*
  %60 = load i32, i32* %59, align 4
  store i32 %60, i32* %55, align 4
  %spi337 = ptrtoint[4 x i8]* @str.337 to i32
  store i32 %spi337, i32* %56, align 16
  store i32 134517506, i32* %57, align 4
  %61 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %tmp4_v.i14.i.i18, i32 noundef %tmp2_v8.i.i.i14, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @print_reverse340(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
