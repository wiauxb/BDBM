...
.exit:
  ...
  %tmp2_v4.i38.i = add i32 %tmp0_v.i37.i, -8
  ...
  %tmp2_v8.i.i = add i32 %tmp0_v.i37.i, -100
  %6 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 134517201, i32* %6, align 4
  %tmp4_v.i59.i.b = load i1, i1* @segs.0, align 1
  %7 = inttoptr i32 %arg_esp to i32*
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i63.i = add i32 %tmp0_v.i37.i, -20
  %9 = inttoptr i32 %tmp2_v2.i63.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i64.i = add i32 %tmp0_v.i37.i, -52
  %10 = inttoptr i32 %tmp2_v3.i64.i to i32*
  store i32 1, i32* %10, align 4
  %tmp2_v4.i65.i = add i32 %tmp0_v.i37.i, -48
  %11 = inttoptr i32 %tmp2_v4.i65.i to i32*
  store i32 2, i32* %11, align 16
  %tmp2_v5.i66.i = add i32 %tmp0_v.i37.i, -44
  %12 = inttoptr i32 %tmp2_v5.i66.i to i32*
  store i32 6, i32* %12, align 4
  %tmp2_v6.i67.i = add i32 %tmp0_v.i37.i, -40
  %13 = inttoptr i32 %tmp2_v6.i67.i to i32*
  store i32 9, i32* %13, align 8
  %tmp2_v7.i.i = add i32 %tmp0_v.i37.i, -36
  %14 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 8, i32* %14, align 4
  %tmp2_v8.i68.i = add i32 %tmp0_v.i37.i, -32
  %15 = inttoptr i32 %tmp2_v8.i68.i to i32*
  store i32 7, i32* %15, align 16
  %tmp2_v9.i.i = add i32 %tmp0_v.i37.i, -28
  %16 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 6, i32* %16, align 4
  %tmp2_v10.i.i = add i32 %tmp0_v.i37.i, -24
  %17 = inttoptr i32 %tmp2_v10.i.i to i32*
  store i32 5, i32* %17, align 8
  %tmp2_v11.i.i = add i32 %tmp0_v.i37.i, -88
  %18 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 100, i32* %18, align 8
  %tmp2_v12.i.i = add i32 %tmp0_v.i37.i, -84
...
Func_sum.exit:                                    ; preds = %BB_804932D.i.i, %.exit
  ...
  %spi421 = ptrtoint[12 x i8]* @str.421 to i32
  store i32 %spi421, i32* %28, align 16
  store i32 134517370, i32* %29, align 4
  %45 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i36.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v23.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %46 = lshr i64 %45, 32
  %47 = trunc i64 %46 to i32
  store i32 1, i32* %27, align 4
  %tmp2_v2.i5.i = add i32 %44, -80
  store i32 %tmp2_v2.i5.i, i32* %28, align 16
...
Func_sum.exit23:                                  ; preds = %BB_804932D.i.i17, %Func_sum.exit
  ...
  %spi420 = ptrtoint[12 x i8]* @str.420 to i32
  store i32 %spi420, i32* %28, align 16
  store i32 134517406, i32* %29, align 4
  %59 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i36.i, i32 inreg noundef %r_edx.0.lcssa.i18, i32 noundef %tmp2_v23.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %60 = lshr i64 %59, 32
  %61 = trunc i64 %60 to i32
  store i32 2, i32* %27, align 4
  %tmp2_v2.i12.i = add i32 %58, -76
  store i32 %tmp2_v2.i12.i, i32* %28, align 16
...
Func_sum.exit43:                                  ; preds = %BB_804932D.i.i37, %Func_sum.exit23
  ...
  %spi419 = ptrtoint[12 x i8]* @str.419 to i32
  store i32 %spi419, i32* %28, align 16
  store i32 134517442, i32* %29, align 4
  %73 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i36.i, i32 inreg noundef %r_edx.0.lcssa.i38, i32 noundef %tmp2_v23.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %74 = lshr i64 %73, 32
...
Func_sum.exit63:                                  ; preds = %BB_804932D.i.i57, %Func_sum.exit43
  ...
  %spi418 = ptrtoint[12 x i8]* @str.418 to i32
  store i32 %spi418, i32* %28, align 16
  store i32 134517478, i32* %29, align 4
  %86 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i36.i, i32 inreg noundef %r_edx.0.lcssa.i58, i32 noundef %tmp2_v23.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
