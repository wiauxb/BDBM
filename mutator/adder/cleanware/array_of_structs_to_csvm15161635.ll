...
define internal fastcc void @array_of_structs_to_csvm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !18 {
Func_804929C.exit.i:
  %tmp2_v.i47.i = add i32 %arg_esp, 4
  %tmp0_v.i48.i = and i32 %arg_esp, -16
  %0 = inttoptr i32 %arg_esp to i32*
  %1 = load i32, i32* %0, align 4
  %tmp2_v3.i49.i = add i32 %tmp0_v.i48.i, -4
  ...
  %tmp2_v6.i53.i = add i32 %tmp0_v.i48.i, -16
  %5 = inttoptr i32 %tmp2_v6.i53.i to i32*
  store i32 0, i32* %5, align 16
  %tmp2_v7.i55.i = add i32 %tmp0_v.i48.i, -20
  %6 = inttoptr i32 %tmp2_v7.i55.i to i32*
  store i32 %tmp2_v.i47.i, i32* %6, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i48.i, -244
  %7 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 134517365, i32* %7, align 4
  %tmp4_v.i15.i.b = load i1, i1* @segs.0, align 1
  %8 = select i1 %tmp4_v.i15.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %9 = load i32, i32* %8, align 4
  %tmp2_v2.i19.i = add i32 %tmp0_v.i48.i, -36
  %10 = inttoptr i32 %tmp2_v2.i19.i to i32*
  store i32 %9, i32* %10, align 4
  %tmp2_v5.i.i = add i32 %tmp0_v.i48.i, -252
  %11 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 134520840, i32* %11, align 4
  %tmp2_v7.i.i = add i32 %tmp0_v.i48.i, -256
  %12 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 134520842, i32* %12, align 16
  %tmp2_v8.i.i = add i32 %tmp0_v.i48.i, -260
  ...
  %tmp2_v.i98.i = add i32 %tmp0_v.i48.i, -232
  %15 = inttoptr i32 %tmp2_v.i98.i to i32*
  store i32 %14, i32* %15, align 8
  %tmp2_v.i39.i = add i32 %tmp0_v.i48.i, -228
  %16 = inttoptr i32 %tmp2_v.i39.i to i8*
  store i8 85, i8* %16, align 4
  %tmp0_v.i40.i = add i32 %tmp0_v.i48.i, -227
  %17 = inttoptr i32 %tmp0_v.i40.i to i32*
  store i32 1701273934, i32* %17, align 4
  %tmp2_v2.i41.i = add i32 %tmp0_v.i48.i, -223
  %18 = inttoptr i32 %tmp2_v2.i41.i to i16*
  store i16 25189, i16* %18, align 2
  %tmp2_v3.i.i = add i32 %tmp0_v.i48.i, -221
  %19 = inttoptr i32 %tmp2_v3.i.i to i8*
  store i8 0, i8* %19, align 1
  %tmp2_v4.i42.i = add i32 %tmp0_v.i48.i, -176
  %20 = inttoptr i32 %tmp2_v4.i42.i to i32*
  ...
  %tmp2_v7.i45.i = add i32 %tmp0_v.i48.i, -172
  %tmp5_v8.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %22 = inttoptr i32 %tmp2_v7.i45.i to i64*
  store i64 %tmp5_v8.i.i, i64* %22, align 4
  tail call fastcc void @helper_fpop()
  %tmp2_v10.i.i = add i32 %tmp0_v.i48.i, -164
  %23 = inttoptr i32 %tmp2_v10.i.i to i8*
  store i8 85, i8* %23, align 4
  %tmp0_v12.i.i = add i32 %tmp0_v.i48.i, -163
  %24 = inttoptr i32 %tmp0_v12.i.i to i32*
  store i32 2037539149, i32* %24, align 4
  %tmp2_v13.i.i = add i32 %tmp0_v.i48.i, -159
  %25 = inttoptr i32 %tmp2_v13.i.i to i8*
  store i8 0, i8* %25, align 1
  %tmp2_v14.i.i = add i32 %tmp0_v.i48.i, -112
  %26 = inttoptr i32 %tmp2_v14.i.i to i32*
  ...
  %tmp2_v32.i.i = add i32 %tmp0_v.i48.i, -44
  %tmp5_v33.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %35 = inttoptr i32 %tmp2_v32.i.i to i64*
  store i64 %tmp5_v33.i.i, i64* %35, align 4
  tail call fastcc void @helper_fpop()
  %tmp2_v35.i.i = add i32 %tmp0_v.i48.i, -236
  %36 = inttoptr i32 %tmp2_v35.i.i to i32*
  %tmp2_v2.i75.i = add i32 %tmp0_v.i48.i, -32
...
BB_8049427.i:                                     ; preds = %BB_804936B.i
  ...
  %40 = inttoptr i32 %r_esp.0.in.le to i32*
  store i32 %39, i32* %40, align 4
  %tmp2_v3.i70.i = add i32 %r_esp.0.in.le, -4
  %41 = inttoptr i32 %tmp2_v3.i70.i to i32*
  store i32 134517813, i32* %41, align 4
  %arg.i.i3 = load i32, i32* %40, align 4
  %42 = tail call i32 @fclose(i32 %arg.i.i3)
  %tmp2_v.i34.i = add i32 %r_esp.0.in.le, 4
  %43 = inttoptr i32 %tmp2_v.i34.i to i32*
  store i32 3, i32* %43, align 4
  store i32 134520909, i32* %40, align 4
  store i32 134517833, i32* %41, align 4
  %44 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v19.i85.i, i32 inreg noundef %38, i32 noundef %r_esp.0.in.le, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  ret void

BB_804936B.i:                                     ; preds = %BB_804936B.i, %Func_804929C.exit.i
  %r_esp.0.in13 = phi i32 [ %tmp2_v7.i.i, %Func_804929C.exit.i ], [ %r_esp.0.in, %BB_804936B.i ]
  %.pn912 = phi i32 [ %14, %Func_804929C.exit.i ], [ %62, %BB_804936B.i ]
  %mrv.i1.pn11 = phi { i32, i32 } [ %mrv.i1, %Func_804929C.exit.i ], [ %.pn, %BB_804936B.i ]
  %storemerge10 = phi i32 [ 0, %Func_804929C.exit.i ], [ %tmp0_v1.i26.i, %BB_804936B.i ]
  %.pn = insertvalue { i32, i32 } %mrv.i1.pn11, i32 %.pn912, 1
  %tmp0_v1.i74.i = shl i32 %storemerge10, 6
  %tmp2_v5.i77.i = add i32 %tmp2_v7.i45.i, %tmp0_v1.i74.i
  %45 = inttoptr i32 %tmp2_v5.i77.i to i64*
  %46 = load i64, i64* %45, align 4
  tail call fastcc void @helper_fldl_ST0(i64 %46)
  %47 = load i32, i32* %36, align 4
  %tmp0_v9.i.i = shl i32 %47, 6
  %tmp0_v11.i.i = add i32 %tmp0_v9.i.i, %tmp2_v2.i75.i
  %tmp0_v12.i83.i = add i32 %tmp0_v11.i.i, -144
  %48 = inttoptr i32 %tmp0_v12.i83.i to i32*
  %49 = load i32, i32* %48, align 16
  %tmp0_v18.i.i = add i32 %tmp0_v9.i.i, %tmp2_v.i39.i
  %tmp2_v19.i85.i = or i32 %tmp0_v18.i.i, 1
  %tmp0_v25.i.i = add i32 %tmp0_v11.i.i, -196
  %50 = inttoptr i32 %tmp0_v25.i.i to i8*
  %51 = load i8, i8* %50, align 4
  %tmp0_v27.i.i = sext i8 %51 to i32
  %tmp2_v29.i89.i = add i32 %r_esp.0.in13, 4
  %tmp5_v30.i90.i = tail call fastcc i64 @helper_fstl_ST0()
  %52 = inttoptr i32 %tmp2_v29.i89.i to i64*
  store i64 %tmp5_v30.i90.i, i64* %52, align 4
  tail call fastcc void @helper_fpop()
  %53 = inttoptr i32 %r_esp.0.in13 to i32*
  store i32 %49, i32* %53, align 4
  %tmp2_v33.i.i = add i32 %r_esp.0.in13, -4
  %54 = inttoptr i32 %tmp2_v33.i.i to i32*
  store i32 %tmp2_v19.i85.i, i32* %54, align 4
  %tmp2_v34.i.i = add i32 %r_esp.0.in13, -8
  %55 = inttoptr i32 %tmp2_v34.i.i to i32*
  store i32 %tmp0_v27.i.i, i32* %55, align 4
  %tmp2_v36.i.i = add i32 %r_esp.0.in13, -12
  %56 = inttoptr i32 %tmp2_v36.i.i to i32*
  store i32 134520871, i32* %56, align 4
  %57 = load i32, i32* %15, align 8
  %tmp2_v40.i.i = add i32 %r_esp.0.in13, -16
  %58 = inttoptr i32 %tmp2_v40.i.i to i32*
  store i32 %57, i32* %58, align 4
  %tmp2_v41.i.i = add i32 %r_esp.0.in13, -20
  %59 = inttoptr i32 %tmp2_v41.i.i to i32*
  store i32 134517730, i32* %59, align 4
  %60 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v19.i85.i, i32 inreg noundef %49, i32 noundef %tmp2_v40.i.i, i32 noundef ptrtoint (i32 ()* @fprintf to i32))  nobuiltin nounwind "no-builtins" , !funcname !20
  %61 = load i32, i32* %15, align 8
  store i32 %61, i32* %53, align 4
  store i32 134517747, i32* %54, align 4
  %arg.i.i6 = load i32, i32* %53, align 4
  %62 = tail call i32 @ferror(i32 %arg.i.i6)
  %63 = load i32, i32* %36, align 4
  %tmp0_v1.i26.i = add i32 %63, 1
  %r_esp.0.in = extractvalue { i32, i32 } %mrv.i1.pn11, 0
  store i32 %tmp0_v1.i26.i, i32* %36, align 4
  %64 = icmp slt i32 %tmp0_v1.i26.i, 3
  br i1 %64, label %BB_804936B.i, label %BB_8049427.i
}
...
!20 = !{!"fprintf"}
  ...
  tail call fastcc void @array_of_structs_to_csvm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
