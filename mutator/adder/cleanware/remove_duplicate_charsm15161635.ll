...
define internal fastcc void @remove_duplicate_charsm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
.exit:
  ...
  %10 = select i1 %tmp4_v.i11.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %11 = load i32, i32* %10, align 4
  %tmp2_v5.i13.i = add i32 %tmp0_v.i.i, -20
  %12 = inttoptr i32 %tmp2_v5.i13.i to i32*
  store i32 %11, i32* %12, align 4
  %tmp2_v6.i14.i = add i32 %tmp0_v.i.i, -48
  ...
  %tmp2_v8.i15.i = add i32 %tmp0_v.i.i, -40
  ...
  %tmp2_v.i17.i.i = add i32 %tmp0_v.i.i, -88
  %22 = inttoptr i32 %tmp2_v.i17.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %22, align 8
  %tmp2_v1.i19.i.i = add i32 %tmp0_v.i.i, -92
  %23 = inttoptr i32 %tmp2_v1.i19.i.i to i32*
  store i32 134529024, i32* %23, align 4
  %tmp2_v2.i21.i.i = add i32 %tmp0_v.i.i, -116
  %24 = inttoptr i32 %tmp2_v2.i21.i.i to i32*
  ...
  %tmp2_v.i9.i.i = add i32 %tmp0_v.i.i, -112
...
BB_80492AA.i.lr.ph.i:                             ; preds = %.exit
  %tmp2_v2.i56.i.i = add i32 %tmp0_v.i.i, -104
  %33 = inttoptr i32 %tmp2_v2.i56.i.i to i32*
  %tmp2_v1.i67.i.i = add i32 %tmp0_v.i.i, -100
  %34 = inttoptr i32 %tmp2_v1.i67.i.i to i32*
  br label %BB_80492AA.i.i

BB_8049301.i.i:                                   ; preds = %BB_80492B5.i.i
  %tmp0_v1.i14.i.i = add nsw i32 %41, 1
  store i32 %tmp0_v1.i14.i.i, i32* %33, align 8
...
BB_8049305.i.backedge.i:                          ; preds = %BB_80492FB.i.i, %BB_8049301.i.i
  %35 = phi i32 [ %.pre32.i, %BB_8049301.i.i ], [ %tmp0_v1.i44.i.i, %BB_80492FB.i.i ]
  %36 = phi i32 [ %tmp0_v1.i14.i.i, %BB_8049301.i.i ], [ %.pre.i, %BB_80492FB.i.i ]
...
BB_804930D.i.i:                                   ; preds = %BB_80492AA.i.i, %BB_8049305.i.backedge.i
  ...
  %tmp0_v1.i25.i.i = add i32 %38, 1
  store i32 %tmp0_v1.i25.i.i, i32* %30, align 4
  %39 = load i32, i32* %29, align 16
  %40 = icmp slt i32 %tmp0_v1.i25.i.i, %39
  br i1 %40, label %BB_80492AA.i.i, label %Func_remove_duplicates.exit

BB_80492B5.i.i:                                   ; preds = %BB_80492AA.i.i, %BB_8049305.i.backedge.i
  %41 = phi i32 [ %36, %BB_8049305.i.backedge.i ], [ %tmp0_v1.i55.i.i, %BB_80492AA.i.i ]
  %42 = load i32, i32* %30, align 4
  %43 = load i32, i32* %20, align 16
  %tmp0_v3.i37.i.i = add i32 %43, %42
  %44 = inttoptr i32 %tmp0_v3.i37.i.i to i8*
  %45 = load i8, i8* %44, align 1
  %tmp0_v4.i.i.i = zext i8 %45 to i32
  %tmp0_v9.i.i.i = add i32 %43, %41
  %46 = inttoptr i32 %tmp0_v9.i.i.i to i8*
  %47 = load i8, i8* %46, align 1
  %tmp0_v10.i.i.i = zext i8 %47 to i32
  %cc_dst_v.i38.i.i = sub nsw i32 %tmp0_v4.i.i.i, %tmp0_v10.i.i.i
  %tmp4_v.i39.i.i = and i32 %cc_dst_v.i38.i.i, 255
  %.not.i.i.i = icmp eq i32 %tmp4_v.i39.i.i, 0
...
BB_80492FB.i.i:                                   ; preds = %BB_80492D7.i.i, %BB_80492CF.i.i
  ...
  %tmp0_v1.i44.i.i = add i32 %.lcssa.i, -1
  store i32 %tmp0_v1.i44.i.i, i32* %29, align 16
  %.pre.i = load i32, i32* %33, align 8
  br label %BB_8049305.i.backedge.i

BB_80492AA.i.i:                                   ; preds = %BB_804930D.i.i, %BB_80492AA.i.lr.ph.i
  %storemerge30.i = phi i32 [ 0, %BB_80492AA.i.lr.ph.i ], [ %tmp0_v1.i25.i.i, %BB_804930D.i.i ]
  %tmp0_v1.i55.i.i = add nsw i32 %storemerge30.i, 1
  store i32 %tmp0_v1.i55.i.i, i32* %33, align 8
  %48 = load i32, i32* %29, align 16
  %49 = icmp slt i32 %tmp0_v1.i55.i.i, %48
...
BB_80492D7.i.i:                                   ; preds = %BB_80492D7.i.i, %BB_80492CF.i.i
  %storemerge2529.i = phi i32 [ %tmp0_v13.i.i.i, %BB_80492D7.i.i ], [ %41, %BB_80492CF.i.i ]
  %52 = load i32, i32* %20, align 16
  %tmp2_v1.i78.i.i = add i32 %52, %storemerge2529.i
  %tmp0_v4.i81.i.i = add i32 %tmp2_v1.i78.i.i, 1
  %53 = inttoptr i32 %tmp0_v4.i81.i.i to i8*
  %54 = load i8, i8* %53, align 1
  %55 = inttoptr i32 %tmp2_v1.i78.i.i to i8*
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @remove_duplicate_charsm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
