...
@str.739 = constant [27 x i8] c"Total Unique Elements: %d\0a\00"
...
define internal fastcc void @count_unique741(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  store i32 %tmp2_v3.i21.i, i32* %24, align 16
  %tmp2_v20.i.i = add i32 %tmp0_v.i9.i, -100
  %25 = inttoptr i32 %tmp2_v20.i.i to i32*
  store i32 134517323, i32* %25, align 4
  %tmp2_v.i59.i.i = add i32 %tmp0_v.i9.i, -104
  %26 = inttoptr i32 %tmp2_v.i59.i.i to i32*
  store i32 %tmp2_v4.i10.i, i32* %26, align 8
  %tmp2_v1.i62.i.i = add i32 %tmp0_v.i9.i, -124
  %27 = inttoptr i32 %tmp2_v1.i62.i.i to i32*
  store i32 134517397, i32* %27, align 4
  %tmp2_v.i.i.i = add i32 %tmp0_v.i9.i, -116
  %28 = inttoptr i32 %tmp2_v.i.i.i to i32*
  store i32 0, i32* %28, align 4
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i9.i, -112
...
BB_80492AA.i.lr.ph.i:                             ; preds = %.exit
  %tmp2_v.i36.i.i = add i32 %tmp0_v.i9.i, -117
  %32 = inttoptr i32 %tmp2_v.i36.i.i to i8*
  %tmp2_v1.i37.i.i = add i32 %tmp0_v.i9.i, -108
  %33 = inttoptr i32 %tmp2_v1.i37.i.i to i32*
...
BB_80492B7.i.i:                                   ; preds = %BB_80492E9.i.i, %BB_80492AA.i.i
  ...
  %tmp4_v.i30.i.i = shl i32 %36, 2
  %37 = load i32, i32* %24, align 16
  %tmp0_v3.i.i.i = add i32 %37, %tmp4_v.i30.i.i
...
BB_80492AA.i.i:                                   ; preds = %BB_8049304.i.i, %BB_80492AA.i.lr.ph.i
  ...
  %r_ecx.18.i = phi i32 [ %tmp2_v.i8.i, %BB_80492AA.i.lr.ph.i ], [ %r_ecx.0.lcssa.i, %BB_8049304.i.i ]
...
BB_8049300.i.i:                                   ; preds = %BB_80492F5.i.i
  ...
  %tmp0_v1.i41.i.i = add i32 %45, 1
  store i32 %tmp0_v1.i41.i.i, i32* %28, align 4
...
Func_count_unique.exit:                           ; preds = %BB_8049304.i.i, %.exit
  %r_ecx.1.lcssa.i = phi i32 [ %tmp2_v.i8.i, %.exit ], [ %r_ecx.0.lcssa.i, %BB_8049304.i.i ]
  %r_edx.1.lcssa.i = phi i32 [ 0, %.exit ], [ %r_edx.0.lcssa.i, %BB_8049304.i.i ]
  %52 = load i32, i32* %28, align 4
  %53 = load i32, i32* %26, align 8
  %tmp2_v.i3.i = add i32 %53, -68
  %54 = inttoptr i32 %tmp2_v.i3.i to i32*
  store i32 %52, i32* %54, align 4
  %tmp2_v4.i6.i = add i32 %tmp0_v.i9.i, -92
  %55 = inttoptr i32 %tmp2_v4.i6.i to i32*
  store i32 %52, i32* %55, align 4
  %spi739 = ptrtoint[27 x i8]* @str.739 to i32
  store i32 %spi739, i32* %24, align 16
  %tmp2_v7.i.i = add i32 %tmp0_v.i9.i, -100
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @count_unique741(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
