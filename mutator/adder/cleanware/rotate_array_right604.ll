...
@str.602 = constant [4 x i8] c"%d \00"
...
define internal fastcc void @rotate_array_right604(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
...
BB_8049235.i:                                     ; preds = %BB_8049235.i, %0
  ...
  %storemerge11 = phi i32 [ 0, %0 ], [ %tmp0_v2.i.i, %BB_8049235.i ]
  ...
  store i32 %spi603, i32* %19, align 16
  store i32 134517324, i32* %20, align 4
  %23 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i53.i, i32 inreg noundef %r_edx.012, i32 noundef %tmp2_v7.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %24 = lshr i64 %23, 32
...
BB_8049282.i:                                     ; preds = %Func_rotate_right.exit, %BB_8049282.i
  %r_edx.115 = phi i32 [ %r_edx.0.lcssa.i, %Func_rotate_right.exit ], [ %33, %BB_8049282.i ]
  %storemerge114 = phi i32 [ 0, %Func_rotate_right.exit ], [ %tmp0_v2.i81.i, %BB_8049282.i ]
  %tmp4_v.i42.i = shl i32 %storemerge114, 2
  %tmp2_v2.i43.i = add i32 %tmp2_v1.i41.i, %tmp4_v.i42.i
  %29 = inttoptr i32 %tmp2_v2.i43.i to i32*
  %30 = load i32, i32* %29, align 4
  store i32 %30, i32* %78, align 4
  %spi602 = ptrtoint[4 x i8]* @str.602 to i32
  store i32 %spi602, i32* %79, align 4
  store i32 134517401, i32* %80, align 4
  %31 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %r_ecx.0.lcssa.i, i32 inreg noundef %r_edx.115, i32 noundef %tmp4_v2.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %32 = lshr i64 %31, 32
  %33 = trunc i64 %32 to i32
  %34 = load i32, i32* %77, align 4
  %tmp0_v2.i81.i = add i32 %34, 1
  store i32 %tmp0_v2.i81.i, i32* %77, align 4
  %35 = icmp slt i32 %tmp0_v2.i81.i, 6
...
BB_8049259.i:                                     ; preds = %BB_8049235.i
  ...
  %37 = tail call i32 @putchar(i32 %arg.i.i7)  nounwind 
  %tmp2_v.i23.i = add i32 %tmp0_v.i54.i, -72
  %38 = inttoptr i32 %tmp2_v.i23.i to i32*
  store i32 2, i32* %38, align 8
  store i32 6, i32* %18, align 4
  store i32 %tmp2_v3.i93.i, i32* %19, align 16
  store i32 134517366, i32* %20, align 4
  %tmp2_v.i19.i.i = add i32 %tmp0_v.i54.i, -88
  %39 = inttoptr i32 %tmp2_v.i19.i.i to i32*
  store i32 %tmp2_v4.i57.i, i32* %39, align 8
  %tmp2_v1.i22.i.i = add i32 %tmp0_v.i54.i, -116
  %40 = inttoptr i32 %tmp2_v1.i22.i.i to i32*
  store i32 134517474, i32* %40, align 4
  %tmp2_v.i.i.i = add i32 %tmp0_v.i54.i, -100
...
BB_80492F0.i.lr.ph.i:                             ; preds = %BB_8049259.i
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i54.i, -124
  %44 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  %tmp2_v5.i17.i.i = add i32 %tmp0_v.i54.i, -128
  %45 = inttoptr i32 %tmp2_v5.i17.i.i to i32*
  %tmp2_v6.i.i.i = add i32 %tmp0_v.i54.i, -132
  %46 = inttoptr i32 %tmp2_v6.i.i.i to i32*
  %tmp2_v.i15.i.i.i = add i32 %tmp0_v.i54.i, -136
  %47 = inttoptr i32 %tmp2_v.i15.i.i.i to i32*
  %tmp2_v1.i18.i.i.i = add i32 %tmp0_v.i54.i, -156
  %48 = inttoptr i32 %tmp2_v1.i18.i.i.i to i32*
  %tmp2_v7.i.i.i.i = add i32 %tmp0_v.i54.i, -140
  %49 = inttoptr i32 %tmp2_v7.i.i.i.i to i32*
  %tmp2_v11.i.i.i.i = add i32 %tmp0_v.i54.i, -144
...
BB_80492F0.i.i:                                   ; preds = %Func_rotate_once_right.exit.i, %BB_80492F0.i.lr.ph.i
  %r_ecx.018.i = phi i32 [ %tmp2_v.i53.i, %BB_80492F0.i.lr.ph.i ], [ %r_ecx.0.lcssa.i.i, %Func_rotate_once_right.exit.i ]
  %r_ebp.017.i = phi i32 [ %tmp2_v.i19.i.i, %BB_80492F0.i.lr.ph.i ], [ %70, %Func_rotate_once_right.exit.i ]
  %tmp2_v.i13.i.i = add i32 %r_ebp.017.i, 12
  %51 = inttoptr i32 %tmp2_v.i13.i.i to i32*
  %52 = load i32, i32* %51, align 4
  store i32 %52, i32* %44, align 4
  %tmp2_v3.i15.i.i = add i32 %r_ebp.017.i, 8
  %53 = inttoptr i32 %tmp2_v3.i15.i.i to i32*
  ...
  %tmp0_v2.i.i.i.i = shl i32 %55, 2
  %tmp4_v.i.i.i14.i = add i32 %tmp0_v2.i.i.i.i, -4
  %56 = load i32, i32* %45, align 16
  %tmp0_v5.i.i.i.i = add i32 %tmp4_v.i.i.i14.i, %56
  %57 = inttoptr i32 %tmp0_v5.i.i.i.i to i32*
  %58 = load i32, i32* %57, align 4
  store i32 %58, i32* %49, align 4
  %59 = load i32, i32* %44, align 4
  %tmp0_v10.i.i.i.i = add i32 %59, -2
  store i32 %tmp0_v10.i.i.i.i, i32* %50, align 16
  %60 = icmp sgt i32 %tmp0_v10.i.i.i.i, -1
...
BB_8049349.i.i.i:                                 ; preds = %BB_8049349.i.i.i, %BB_80492F0.i.i
  ...
  %tmp4_v.i7.i.i.i = shl i32 %storemerge8.i.i, 2
  %61 = load i32, i32* %45, align 16
  %tmp0_v3.i.i.i.i = add i32 %61, %tmp4_v.i7.i.i.i
  %tmp4_v7.i.i.i.i = add i32 %tmp4_v.i7.i.i.i, 4
  %tmp0_v10.i13.i.i.i = add i32 %tmp4_v7.i.i.i.i, %61
  %62 = inttoptr i32 %tmp0_v3.i.i.i.i to i32*
  %63 = load i32, i32* %62, align 4
  %64 = inttoptr i32 %tmp0_v10.i13.i.i.i to i32*
...
Func_rotate_once_right.exit.i:                    ; preds = %BB_8049349.i.i.i, %BB_80492F0.i.i
  ...
  %tmp2_v.i3.i.i = add i32 %70, -12
  %71 = inttoptr i32 %tmp2_v.i3.i.i to i32*
...
Func_rotate_right.exit:                           ; preds = %.exit.loopexit.i, %BB_8049259.i
  ...
  %r_ecx.0.lcssa.i = phi i32 [ %r_ecx.0.lcssa.i.i, %.exit.loopexit.i ], [ %tmp2_v.i53.i, %BB_8049259.i ]
  %76 = load i32, i32* %.pre-phi.i, align 4
  %tmp4_v2.i.i.i = add i32 %r_ebp.0.lcssa.i, 8
  %tmp2_v.i15.i = add i32 %76, -40
  %77 = inttoptr i32 %tmp2_v.i15.i to i32*
  %tmp2_v1.i41.i = add i32 %76, -36
  %tmp2_v5.i47.i = add i32 %r_ebp.0.lcssa.i, 12
  %78 = inttoptr i32 %tmp2_v5.i47.i to i32*
  %79 = inttoptr i32 %tmp4_v2.i.i.i to i32*
  %tmp2_v8.i51.i = add i32 %r_ebp.0.lcssa.i, 4
  %80 = inttoptr i32 %tmp2_v8.i51.i to i32*
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @rotate_array_right604(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
