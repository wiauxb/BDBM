...
define internal fastcc void @print_reverse_recursive718(i32 %arg_esp) unnamed_addr  nofree norecurse nounwind  !retregs !11 {
.exit:
  ...
  %tmp2_v2.i15.i = add i32 %18, -4
  %20 = inttoptr i32 %tmp2_v2.i15.i to i32*
...
!11 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @print_reverse_recursive718(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
