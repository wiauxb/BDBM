...
define internal fastcc void @palindrome304(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
Func_804926F.exit.i:
...
BB_80493A0.i.i:                                   ; preds = %BB_80493CB.i.i, %Func_804926F.exit.i
  %storemerge19.i = phi i32 [ %tmp0_v1.i20.i.i, %BB_80493CB.i.i ], [ 0, %Func_804926F.exit.i ]
  ...
  %tmp0_v1.i20.i.i = add nuw nsw i32 %storemerge19.i, 1
  br i1 %41, label %BB_80493CB.i.i, label %Func_is_palindrome.exit

BB_80493CB.i.i:                                   ; preds = %BB_80493A0.i.i
  store i32 %tmp0_v1.i20.i.i, i32* %31, align 4
  %42 = load i32, i32* %30, align 4
  %43 = icmp slt i32 %tmp0_v1.i20.i.i, %42
...
Func_is_palindrome.exit:                          ; preds = %BB_80493CB.i.i, %BB_80493A0.i.i, %Func_804926F.exit.i
  %r_ecx.1.i = phi i32 [ %tmp2_v.i55.i, %Func_804926F.exit.i ], [ %tmp2_v9.i.i.i, %BB_80493CB.i.i ], [ %tmp2_v9.i.i.i, %BB_80493A0.i.i ]
  %r_edx.1.i = phi i32 [ %tmp0_v3.i39.i.i, %Func_804926F.exit.i ], [ %tmp0_v4.i.i.i, %BB_80493CB.i.i ], [ %tmp0_v4.i.i.i, %BB_80493A0.i.i ]
  %44 = load i32, i32* %23, align 4
  %45 = load i32, i32* %22, align 8
  %tmp2_v.i68.i = add i32 %45, -30
  %tmp2_v1.i69.i = add i32 %tmp0_v.i56.i, -76
  %46 = inttoptr i32 %tmp2_v1.i69.i to i32*
  store i32 %tmp2_v.i68.i, i32* %46, align 4
  %tmp2_v2.i71.i = add i32 %44, -8162
  store i32 %tmp2_v2.i71.i, i32* %20, align 16
  ...
  %tmp2_v.i7.i = add i32 %45, -45
  store i32 %tmp2_v.i7.i, i32* %20, align 16
  ...
  %tmp0_v3.i39.i.i11 = lshr i32 %50, 31
  %tmp0_v4.i40.i.i12 = add i32 %tmp0_v3.i39.i.i11, %50
  %tmp0_v5.i.i.i13 = ashr i32 %tmp0_v4.i40.i.i12, 1
...
BB_80493A0.i.i25:                                 ; preds = %BB_80493CB.i.i26, %Func_is_palindrome.exit
  %storemerge19.i16 = phi i32 [ %tmp0_v1.i20.i.i24, %BB_80493CB.i.i26 ], [ 0, %Func_is_palindrome.exit ]
  ...
  %tmp0_v1.i20.i.i24 = add nuw nsw i32 %storemerge19.i16, 1
  br i1 %60, label %BB_80493CB.i.i26, label %Func_is_palindrome.exit35

BB_80493CB.i.i26:                                 ; preds = %BB_80493A0.i.i25
  store i32 %tmp0_v1.i20.i.i24, i32* %31, align 4
  %61 = load i32, i32* %30, align 4
  %62 = icmp slt i32 %tmp0_v1.i20.i.i24, %61
...
Func_is_palindrome.exit35:                        ; preds = %BB_80493CB.i.i26, %BB_80493A0.i.i25, %Func_is_palindrome.exit
  ...
  %r_edx.1.i28 = phi i32 [ %tmp0_v3.i39.i.i11, %Func_is_palindrome.exit ], [ %tmp0_v4.i.i.i18, %BB_80493CB.i.i26 ], [ %tmp0_v4.i.i.i18, %BB_80493A0.i.i25 ]
  %63 = load i32, i32* %23, align 4
  %64 = load i32, i32* %22, align 8
  %tmp2_v.i39.i = add i32 %64, -45
  store i32 %tmp2_v.i39.i, i32* %46, align 4
  %tmp2_v2.i42.i = add i32 %63, -8184
  ...
  %tmp2_v.i12.i = add i32 %64, -38
  store i32 %tmp2_v.i12.i, i32* %20, align 16
  ...
  %tmp0_v3.i39.i.i44 = lshr i32 %68, 31
  %tmp0_v4.i40.i.i45 = add i32 %tmp0_v3.i39.i.i44, %68
  %tmp0_v5.i.i.i46 = ashr i32 %tmp0_v4.i40.i.i45, 1
...
BB_80493A0.i.i58:                                 ; preds = %BB_80493CB.i.i59, %Func_is_palindrome.exit35
  %storemerge19.i49 = phi i32 [ %tmp0_v1.i20.i.i57, %BB_80493CB.i.i59 ], [ 0, %Func_is_palindrome.exit35 ]
  ...
  %tmp0_v1.i20.i.i57 = add nuw nsw i32 %storemerge19.i49, 1
  br i1 %78, label %BB_80493CB.i.i59, label %Func_is_palindrome.exit68

BB_80493CB.i.i59:                                 ; preds = %BB_80493A0.i.i58
  store i32 %tmp0_v1.i20.i.i57, i32* %31, align 4
  %79 = load i32, i32* %30, align 4
  %80 = icmp slt i32 %tmp0_v1.i20.i.i57, %79
...
Func_is_palindrome.exit68:                        ; preds = %BB_80493CB.i.i59, %BB_80493A0.i.i58, %Func_is_palindrome.exit35
  ...
  %r_edx.1.i61 = phi i32 [ %tmp0_v3.i39.i.i44, %Func_is_palindrome.exit35 ], [ %tmp0_v4.i.i.i51, %BB_80493CB.i.i59 ], [ %tmp0_v4.i.i.i51, %BB_80493A0.i.i58 ]
  %81 = load i32, i32* %23, align 4
  %82 = load i32, i32* %22, align 8
  %tmp2_v.i48.i = add i32 %82, -38
  store i32 %tmp2_v.i48.i, i32* %46, align 4
  %tmp2_v2.i51.i = add i32 %81, -8184
  store i32 %tmp2_v2.i51.i, i32* %20, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @palindrome304(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
