...
Func_8049373.exit.i:
  ...
  %1 = inttoptr i32 %tmp2_v1.i4.i to i32*
  ...
  %tmp2_v2.i11.i = add i32 %arg_esp, 8
...
BB_80493C0.i:                                     ; preds = %BB_8049391.i
  ...
  store i32 %tmp0_v1.i15.i, i32* %16, align 4
  %14 = load i32, i32* %12, align 4
  %15 = icmp sgt i32 %14, %tmp0_v1.i15.i
  br i1 %15, label %BB_8049391.i, label %.exit

BB_8049388.i:                                     ; preds = %Func_8049373.exit.i
  %tmp2_v.i41.i = add i32 %arg_esp, -24
  %16 = inttoptr i32 %tmp2_v.i41.i to i32*
...
BB_8049391.i:                                     ; preds = %BB_8049388.i, %BB_80493C0.i
  %19 = phi i32 [ %14, %BB_80493C0.i ], [ %17, %BB_8049388.i ]
  %storemerge.neg30 = phi i32 [ %storemerge.neg, %BB_80493C0.i ], [ 0, %BB_8049388.i ]
  %storemerge29 = phi i32 [ %tmp0_v1.i15.i, %BB_80493C0.i ], [ 0, %BB_8049388.i ]
  %20 = load i32, i32* %8, align 4
  %tmp0_v2.i47.i = add i32 %20, %storemerge.neg30
  %21 = load i32, i32* %3, align 4
  %tmp0_v5.i.i = add i32 %tmp0_v2.i47.i, %21
  ...
  %cc_dst_v.i49.i = sub nsw i32 %tmp0_v6.i.i, %tmp0_v15.i.i
  %tmp4_v.i50.i = and i32 %cc_dst_v.i49.i, 255
  %27 = icmp eq i32 %tmp4_v.i50.i, 0
  %tmp0_v1.i15.i = add nuw nsw i32 %storemerge29, 1
  br i1 %27, label %BB_80493C0.i, label %.exit

.exit:                                            ; preds = %BB_8049391.i, %BB_8049388.i, %BB_80493C0.i, %Func_8049373.exit.i
...
Func_8049234.exit.i:
  ...
  %tmp2_v5.i43.i = add i32 %tmp0_v.i39.i, -12
  ...
  %tmp2_v8.i46.i = add i32 %tmp0_v.i39.i, -84
  %6 = inttoptr i32 %tmp2_v8.i46.i to i32*
  ...
  %tmp2_v.i73.i = add i32 %20, -62
  %26 = inttoptr i32 %tmp2_v.i73.i to i32*
  store i32 1702194274, i32* %26, align 4
  %tmp2_v1.i74.i = add i32 %20, -58
  %27 = inttoptr i32 %tmp2_v1.i74.i to i8*
  store i8 0, i8* %27, align 1
  %tmp2_v3.i78.i = add i32 %19, 4
  %28 = inttoptr i32 %tmp2_v3.i78.i to i32*
  store i32 %tmp2_v.i73.i, i32* %28, align 4
  %tmp2_v4.i79.i = add i32 %20, -57
  store i32 %tmp2_v4.i79.i, i32* %22, align 4
  store i32 134517372, i32* %23, align 4
  %29 = tail call fastcc { i32, i32, i32, i32 } @Func_endswith(i32 %tmp2_v2.i30.i, i32 %20, i32 %21)
  %30 = extractvalue { i32, i32, i32, i32 } %29, 0
  %31 = extractvalue { i32, i32, i32, i32 } %29, 2
  %32 = extractvalue { i32, i32, i32, i32 } %29, 3
  %tmp2_v.i34.i = add i32 %32, -8096
  %33 = inttoptr i32 %30 to i32*
  store i32 %tmp2_v.i34.i, i32* %33, align 4
  %tmp2_v2.i36.i = add i32 %30, -4
  %34 = inttoptr i32 %tmp2_v2.i36.i to i32*
  ...
  %tmp2_v.i5.i = add i32 %31, -43
  %37 = inttoptr i32 %tmp2_v.i5.i to i32*
  ...
  %tmp2_v4.i6.i = add i32 %31, -27
  %41 = inttoptr i32 %tmp2_v4.i6.i to i32*
  ...
  store i32 %tmp2_v.i5.i, i32* %46, align 4
  %tmp2_v12.i.i = add i32 %31, -57
  store i32 %tmp2_v12.i.i, i32* %33, align 4
  store i32 134517492, i32* %34, align 4
  %47 = tail call fastcc { i32, i32, i32, i32 } @Func_endswith(i32 %tmp2_v2.i36.i, i32 %31, i32 %32)
  %48 = extractvalue { i32, i32, i32, i32 } %47, 0
  %49 = extractvalue { i32, i32, i32, i32 } %47, 3
  %tmp2_v.i55.i = add i32 %49, -8038
  %50 = inttoptr i32 %48 to i32*
  store i32 %tmp2_v.i55.i, i32* %50, align 4
  %tmp2_v2.i57.i = add i32 %48, -4
  %51 = inttoptr i32 %tmp2_v2.i57.i to i32*
