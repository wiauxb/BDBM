...
define internal fastcc void @count_char465(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %19 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_count_char(i32 %tmp2_v13.i.i, i32 %tmp2_v4.i18.i, i32 134529024)
  ...
  %29 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i15.i, i32 inreg noundef %22, i32 noundef %20, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  store i32 46, i32* %26, align 4
  %tmp2_v2.i12.i = add i32 %23, -36
  store i32 %tmp2_v2.i12.i, i32* %27, align 4
  ...
  %tmp2_v.i27.i = add i32 %34, -40
  %36 = inttoptr i32 %tmp2_v.i27.i to i32*
  store i32 %32, i32* %36, align 4
  %tmp2_v4.i31.i = add i32 %31, 4
  %37 = inttoptr i32 %tmp2_v4.i31.i to i32*
  store i32 %32, i32* %37, align 4
  %tmp2_v5.i33.i = add i32 %35, -8171
  %38 = inttoptr i32 %31 to i32*
  store i32 %tmp2_v5.i33.i, i32* %38, align 4
  %tmp2_v7.i34.i = add i32 %31, -4
  %39 = inttoptr i32 %tmp2_v7.i34.i to i32*
  store i32 134517371, i32* %39, align 4
  %40 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i15.i, i32 inreg noundef %33, i32 noundef %31, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}

; Function Attrs: norecurse
define internal fastcc { i32, i32, i32, i32, i32 } @Func_count_char(i32 %arg_esp, i32 %arg_ebp, i32 %arg_ebx) unnamed_addr  norecurse  !retregs !14 {
  %tmp2_v.i37.i = add i32 %arg_esp, -4
  %1 = inttoptr i32 %tmp2_v.i37.i to i32*
  store i32 %arg_ebp, i32* %1, align 4
  %tmp2_v1.i39.i = add i32 %arg_esp, -8
  %2 = inttoptr i32 %tmp2_v1.i39.i to i32*
  store i32 %arg_ebx, i32* %2, align 4
  %tmp2_v2.i41.i = add i32 %arg_esp, -48
  %3 = inttoptr i32 %tmp2_v2.i41.i to i32*
  store i32 134517422, i32* %3, align 4
  %tmp2_v.i11.i = add i32 %arg_esp, 8
  %4 = inttoptr i32 %tmp2_v.i11.i to i32*
  %5 = load i32, i32* %4, align 4
  %tmp2_v2.i.i = add i32 %arg_esp, -32
  %6 = trunc i32 %5 to i8
  %7 = inttoptr i32 %tmp2_v2.i.i to i8*
  ...
  %tmp2_v7.i.i = add i32 %arg_esp, -64
  ...
  %tmp2_v.i16.i = add i32 %arg_esp, -16
  %13 = inttoptr i32 %tmp2_v.i16.i to i32*
  store i32 %12, i32* %13, align 4
  %tmp2_v1.i18.i = add i32 %arg_esp, -24
  %14 = inttoptr i32 %tmp2_v1.i18.i to i32*
  store i32 0, i32* %14, align 4
  %tmp2_v2.i19.i = add i32 %arg_esp, -20
  %15 = inttoptr i32 %tmp2_v2.i19.i to i32*
...
BB_80492DC.i:                                     ; preds = %BB_80492F0.i, %0
  %storemerge20 = phi i32 [ %tmp0_v1.i23.i, %BB_80492F0.i ], [ 0, %0 ]
  %18 = load i32, i32* %8, align 4
  %tmp0_v3.i.i = add i32 %18, %storemerge20
  %19 = inttoptr i32 %tmp0_v3.i.i to i8*
  %20 = load i8, i8* %19, align 1
  %tmp0_v4.i.i = zext i8 %20 to i32
  %21 = load i8, i8* %7, align 1
  %tmp0_v6.i.i = zext i8 %21 to i32
  %cc_dst_v.i.i = sub nsw i32 %tmp0_v6.i.i, %tmp0_v4.i.i
...
BB_80492F0.i:                                     ; preds = %BB_80492EC.i, %BB_80492DC.i
  ...
  %tmp0_v1.i23.i = add i32 %22, 1
  store i32 %tmp0_v1.i23.i, i32* %15, align 4
  %23 = load i32, i32* %13, align 4
  %24 = icmp slt i32 %tmp0_v1.i23.i, %23
  br i1 %24, label %BB_80492DC.i, label %.exit

BB_80492EC.i:                                     ; preds = %BB_80492DC.i
  %25 = load i32, i32* %14, align 4
  %tmp0_v1.i45.i = add i32 %25, 1
  store i32 %tmp0_v1.i45.i, i32* %14, align 4
...
!14 = !{i32 0, i32 3, i32 4}
  ...
  tail call fastcc void @count_char465(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
