...
define internal fastcc void @second_lowestm15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v3.i11.i = add i32 %tmp0_v.i.i, -60
  %10 = inttoptr i32 %tmp2_v3.i11.i to i32*
  store i32 9, i32* %10, align 4
  %tmp2_v4.i12.i = add i32 %tmp0_v.i.i, -56
  %11 = inttoptr i32 %tmp2_v4.i12.i to i32*
  store i32 8, i32* %11, align 8
  %tmp2_v5.i13.i = add i32 %tmp0_v.i.i, -52
  ...
  %23 = inttoptr i32 %tmp2_v.i42.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %23, align 8
  %tmp2_v1.i45.i.i = add i32 %tmp0_v.i.i, -108
  %24 = inttoptr i32 %tmp2_v1.i45.i.i to i32*
  store i32 134517376, i32* %24, align 4
  %25 = load i32, i32* %21, align 16
  %26 = inttoptr i32 %25 to i32*
  %27 = load i32, i32* %26, align 4
  %tmp2_v1.i63.i.i = add i32 %25, 4
  %28 = inttoptr i32 %tmp2_v1.i63.i.i to i32*
  %29 = load i32, i32* %28, align 4
  %tmp2_v3.i65.i.i = add i32 %tmp0_v.i.i, -100
  %30 = inttoptr i32 %tmp2_v3.i65.i.i to i32*
  ...
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i.i, -92
...
BB_80492C3.i.i:                                   ; preds = %BB_8049335.i.i, %.exit
  %storemerge19.i = phi i32 [ %tmp0_v1.i49.i.i, %BB_8049335.i.i ], [ 2, %.exit ]
  %tmp4_v.i.i.i1 = shl i32 %storemerge19.i, 2
  %38 = load i32, i32* %21, align 16
  %tmp0_v3.i.i.i = add i32 %38, %tmp4_v.i.i.i1
  %39 = inttoptr i32 %tmp0_v3.i.i.i to i32*
  %40 = load i32, i32* %39, align 4
  %41 = load i32, i32* %30, align 4
  %.not.i14.i.i = icmp sgt i32 %41, %40
  br i1 %.not.i14.i.i, label %BB_80492D9.i.i, label %BB_80492F5.i.i
...
BB_80492F5.i.i:                                   ; preds = %BB_80492C3.i.i
  %42 = load i32, i32* %34, align 16
  %.not.i40.i.i = icmp sgt i32 %42, %40
  br i1 %.not.i40.i.i, label %Func_804930B.exit.i.i, label %BB_8049335.i.i

BB_8049335.i.i:                                   ; preds = %BB_80492D9.i.i, %BB_80492F5.i.i, %Func_804930B.exit.i.i
  %r_edx.1.i = phi i32 [ %tmp4_v.i.i.i1, %BB_80492F5.i.i ], [ %tmp4_v.i.i.i1, %Func_804930B.exit.i.i ], [ %tmp4_v.i87.i.i, %BB_80492D9.i.i ]
  %43 = load i32, i32* %35, align 4
  %tmp0_v1.i49.i.i = add i32 %43, 1
  store i32 %tmp0_v1.i49.i.i, i32* %35, align 4
  %44 = load i32, i32* %20, align 4
  %45 = icmp slt i32 %tmp0_v1.i49.i.i, %44
  br i1 %45, label %BB_80492C3.i.i, label %Func_second_lowest.exit

BB_80492D9.i.i:                                   ; preds = %BB_80492C3.i.i
  store i32 %41, i32* %34, align 16
  %46 = load i32, i32* %35, align 4
  %tmp4_v.i87.i.i = shl i32 %46, 2
  %47 = load i32, i32* %21, align 16
  %tmp0_v6.i90.i.i = add i32 %47, %tmp4_v.i87.i.i
  %48 = inttoptr i32 %tmp0_v6.i90.i.i to i32*
  %49 = load i32, i32* %48, align 4
  store i32 %49, i32* %30, align 4
  br label %BB_8049335.i.i

Func_second_lowest.exit:                          ; preds = %BB_8049335.i.i, %.exit
  %r_edx.0.lcssa.i = phi i32 [ %27, %.exit ], [ %r_edx.1.i, %BB_8049335.i.i ]
  %50 = load i32, i32* %34, align 16
  %51 = load i32, i32* %23, align 8
  %tmp2_v.i28.i = add i32 %51, -56
  %52 = inttoptr i32 %tmp2_v.i28.i to i32*
  store i32 %50, i32* %52, align 4
  store i32 %50, i32* %20, align 4
  store i32 134520840, i32* %21, align 16
  store i32 134517326, i32* %22, align 4
  %53 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v16.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @second_lowestm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
