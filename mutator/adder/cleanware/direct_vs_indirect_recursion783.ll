...
@str.782 = constant [9 x i8] c"sum: %d\0a\00"
...
define internal fastcc void @direct_vs_indirect_recursion783(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %spi782 = ptrtoint[9 x i8]* @str.782 to i32
  store i32 %spi782, i32* %17, align 4
  ...
  %25 = tail call fastcc i32 @Func_print_even(i32 %tmp2_v3.i.i.i, i32 %tmp2_v.i7.i.i, i32 134529024, i32 %tmp2_v.i2.i)  nounwind 
  ret void
}
...
BB_8049219.i:                                     ; preds = %Func_8049207.exit.i
  ...
  %tmp0_v2.i15.i = add i32 %7, %10
  %.pre = inttoptr i32 %8 to i32*
  br label %.exit

.exit:                                            ; preds = %BB_8049219.i, %Func_8049207.exit.i..exit_crit_edge
  %tmp4_v2.i.i.pre-phi = phi i32 [ %.pre1, %Func_8049207.exit.i..exit_crit_edge ], [ %tmp2_v.i12.i, %BB_8049219.i ]
  %.pre-phi = phi i32* [ %0, %Func_8049207.exit.i..exit_crit_edge ], [ %.pre, %BB_8049219.i ]
  %r_eax.0 = phi i32 [ 1, %Func_8049207.exit.i..exit_crit_edge ], [ %tmp0_v2.i15.i, %BB_8049219.i ]
...
BB_804928C.i:                                     ; preds = %Func_8049281.exit.i
  ...
  %tmp0_v2.i20.i = add i32 %10, -1
  store i32 %tmp0_v2.i20.i, i32* %7, align 4
  ...
  %tmp2_v2.i17.i.i = add i32 %arg_esp, -56
  %15 = inttoptr i32 %tmp2_v2.i17.i.i to i32*
  store i32 %14, i32* %15, align 4
  %tmp2_v4.i.i.i = add i32 %arg_esp, -60
  %16 = inttoptr i32 %tmp2_v4.i.i.i to i32*
  store i32 134520860, i32* %16, align 4
  %tmp2_v5.i18.i.i = add i32 %arg_esp, -64
  %17 = inttoptr i32 %tmp2_v5.i18.i.i to i32*
  ...
  %tmp0_v2.i10.i.i = add i32 %19, -1
  store i32 %tmp0_v2.i10.i.i, i32* %16, align 4
  store i32 134517500, i32* %17, align 4
  %20 = tail call fastcc i32 @Func_print_even(i32 %tmp2_v5.i18.i.i, i32 %tmp2_v.i2.i.i, i32 134529024, i32 %arg_ecx)
...
!15 = !{i32 0, i32 1, i32 0, i32 0}
  ...
  tail call fastcc void @direct_vs_indirect_recursion783(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
