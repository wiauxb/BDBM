...
define internal fastcc void @files_lines_to_dynamic_arraym15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
.exit:
  ...
  %tmp2_v9.i.i = add i32 %tmp0_v.i.i, -84
  %7 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 134517458, i32* %7, align 4
  %tmp2_v2.i.i = add i32 %tmp0_v.i.i, -92
  %8 = inttoptr i32 %tmp2_v2.i.i to i32*
  store i32 134520840, i32* %8, align 4
  %tmp2_v4.i6.i = add i32 %tmp0_v.i.i, -96
  %9 = inttoptr i32 %tmp2_v4.i6.i to i32*
  store i32 134520842, i32* %9, align 16
  %tmp2_v5.i7.i = add i32 %tmp0_v.i.i, -100
  ...
  %tmp2_v.i16.i = add i32 %tmp0_v.i.i, -44
  %12 = inttoptr i32 %tmp2_v.i16.i to i32*
...
!10 = !{i32 0, i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @files_lines_to_dynamic_arraym15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
