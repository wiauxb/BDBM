...
define internal fastcc void @if_elif_elsem15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v2.i10.i = add i32 %tmp0_v.i25.i, -32
  %8 = inttoptr i32 %tmp2_v2.i10.i to i32*
  store i32 134520840, i32* %8, align 16
  %tmp2_v3.i.i = add i32 %tmp0_v.i25.i, -36
  ...
  store i32 134520851, i32* %8, align 16
  ...
  store i32 134520862, i32* %8, align 16
  ...
  store i32 134520880, i32* %8, align 16
  ...
  %tmp2_v.i41.i = add i32 %tmp0_v.i25.i, -28
  %18 = inttoptr i32 %tmp2_v.i41.i to i32*
  store i32 100, i32* %18, align 4
  store i32 134520898, i32* %8, align 16
  store i32 134517293, i32* %9, align 4
  %19 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i24.i, i32 inreg noundef 0, i32 noundef %tmp2_v2.i10.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %20 = lshr i64 %19, 32
  %21 = trunc i64 %20 to i32
  store i32 134520902, i32* %8, align 16
  ...
  store i32 134520916, i32* %8, align 16
  store i32 134517334, i32* %9, align 4
  %24 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i24.i, i32 inreg noundef %21, i32 noundef %tmp2_v2.i10.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @if_elif_elsem15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
