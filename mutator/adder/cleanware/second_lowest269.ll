...
@str.268 = constant [19 x i8] c"second lowest: %d\0a\00"
...
define internal fastcc void @second_lowest269(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
...
BB_8049335.i.i:                                   ; preds = %BB_80492D9.i.i, %BB_80492F5.i.i, %Func_804930B.exit.i.i
  %r_edx.0.i = phi i32 [ %tmp4_v.i46.i.i, %BB_80492F5.i.i ], [ %tmp4_v.i46.i.i, %Func_804930B.exit.i.i ], [ %tmp4_v.i87.i.i, %BB_80492D9.i.i ]
  %38 = load i32, i32* %35, align 4
  %tmp0_v1.i4.i.i = add i32 %38, 1
  store i32 %tmp0_v1.i4.i.i, i32* %35, align 4
  %39 = load i32, i32* %20, align 4
  %40 = icmp slt i32 %tmp0_v1.i4.i.i, %39
  br i1 %40, label %BB_80492C3.i.i, label %Func_second_lowest.exit
...
BB_80492C3.i.i:                                   ; preds = %BB_8049335.i.i, %.exit
  %storemerge19.i = phi i32 [ %tmp0_v1.i4.i.i, %BB_8049335.i.i ], [ 2, %.exit ]
  %tmp4_v.i46.i.i = shl i32 %storemerge19.i, 2
  %41 = load i32, i32* %21, align 16
  %tmp0_v3.i49.i.i = add i32 %41, %tmp4_v.i46.i.i
  %42 = inttoptr i32 %tmp0_v3.i49.i.i to i32*
  %43 = load i32, i32* %42, align 4
  %44 = load i32, i32* %30, align 4
  %.not.i54.i.i = icmp sgt i32 %44, %43
  br i1 %.not.i54.i.i, label %BB_80492D9.i.i, label %BB_80492F5.i.i

BB_80492F5.i.i:                                   ; preds = %BB_80492C3.i.i
  %45 = load i32, i32* %34, align 16
  %.not.i79.i.i = icmp sgt i32 %45, %43
  br i1 %.not.i79.i.i, label %Func_804930B.exit.i.i, label %BB_8049335.i.i
...
Func_second_lowest.exit:                          ; preds = %BB_8049335.i.i, %.exit
  ...
  %spi268 = ptrtoint[19 x i8]* @str.268 to i32
  store i32 %spi268, i32* %21, align 16
  store i32 134517326, i32* %22, align 4
  %53 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %r_edx.1.lcssa.i, i32 noundef %tmp2_v16.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @second_lowest269(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
