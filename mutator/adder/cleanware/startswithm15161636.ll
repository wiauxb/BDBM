...
define internal fastcc void @startswithm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_804923A.exit.i:
  %tmp2_v.i39.i = add i32 %arg_esp, 4
  %tmp0_v.i40.i = and i32 %arg_esp, -16
  %0 = inttoptr i32 %arg_esp to i32*
  %1 = load i32, i32* %0, align 4
  %tmp2_v3.i41.i = add i32 %tmp0_v.i40.i, -4
  %2 = inttoptr i32 %tmp2_v3.i41.i to i32*
  store i32 %1, i32* %2, align 4
  %tmp2_v4.i42.i = add i32 %tmp0_v.i40.i, -8
  %3 = inttoptr i32 %tmp2_v4.i42.i to i32*
  store i32 0, i32* %3, align 8
  %tmp2_v5.i44.i = add i32 %tmp0_v.i40.i, -12
  %4 = inttoptr i32 %tmp2_v5.i44.i to i32*
  store i32 0, i32* %4, align 4
  %tmp2_v6.i46.i = add i32 %tmp0_v.i40.i, -16
  %5 = inttoptr i32 %tmp2_v6.i46.i to i32*
  store i32 %tmp2_v.i39.i, i32* %5, align 16
  %tmp2_v8.i47.i = add i32 %tmp0_v.i40.i, -84
  %6 = inttoptr i32 %tmp2_v8.i47.i to i32*
  ...
  %tmp2_v.i15.i = add i32 %21, -65
  %27 = inttoptr i32 %tmp2_v.i15.i to i32*
  store i32 1819240790, i32* %27, align 4
  %tmp2_v1.i16.i = add i32 %21, -61
  %28 = inttoptr i32 %tmp2_v1.i16.i to i32*
  store i32 7566437, i32* %28, align 4
  %tmp2_v3.i20.i = add i32 %20, 4
  %29 = inttoptr i32 %tmp2_v3.i20.i to i32*
  store i32 %tmp2_v.i15.i, i32* %29, align 4
  %tmp2_v4.i21.i = add i32 %21, -57
  store i32 %tmp2_v4.i21.i, i32* %23, align 4
  store i32 134517381, i32* %24, align 4
  %30 = tail call fastcc { i32, i32, i32, i32 } @Func_startswith(i32 %tmp2_v2.i8.i, i32 %21, i32 %22)
  %31 = extractvalue { i32, i32, i32, i32 } %30, 0
  %32 = extractvalue { i32, i32, i32, i32 } %30, 2
  %33 = extractvalue { i32, i32, i32, i32 } %30, 3
  %tmp2_v.i27.i = add i32 %33, -8076
  %34 = inttoptr i32 %31 to i32*
  store i32 %tmp2_v.i27.i, i32* %34, align 4
  %tmp2_v2.i29.i = add i32 %31, -4
  %35 = inttoptr i32 %tmp2_v2.i29.i to i32*
  ...
  %tmp2_v.i53.i = add i32 %32, -43
  %38 = inttoptr i32 %tmp2_v.i53.i to i32*
  store i32 1702063954, i32* %38, align 4
  %tmp2_v1.i54.i = add i32 %32, -39
  %39 = inttoptr i32 %tmp2_v1.i54.i to i32*
  store i32 1918967923, i32* %39, align 4
  %tmp2_v2.i55.i = add i32 %32, -35
  %40 = inttoptr i32 %tmp2_v2.i55.i to i32*
  store i32 1701978213, i32* %40, align 4
  %tmp2_v3.i56.i = add i32 %32, -31
  %41 = inttoptr i32 %tmp2_v3.i56.i to i32*
  store i32 1767252068, i32* %41, align 4
  %tmp2_v4.i57.i = add i32 %32, -27
  %42 = inttoptr i32 %tmp2_v4.i57.i to i32*
  store i32 1952803951, i32* %42, align 4
  %tmp2_v5.i58.i = add i32 %32, -23
  %43 = inttoptr i32 %tmp2_v5.i58.i to i32*
  store i32 1918967923, i32* %43, align 4
  %tmp2_v6.i59.i = add i32 %32, -19
  %44 = inttoptr i32 %tmp2_v6.i59.i to i32*
  store i32 1816272997, i32* %44, align 4
  %tmp2_v7.i60.i = add i32 %32, -15
  %45 = inttoptr i32 %tmp2_v7.i60.i to i16*
  store i16 25973, i16* %45, align 2
  %tmp2_v8.i61.i = add i32 %32, -13
  %46 = inttoptr i32 %tmp2_v8.i61.i to i8*
  store i8 0, i8* %46, align 1
  %tmp2_v11.i64.i = add i32 %31, 4
  %47 = inttoptr i32 %tmp2_v11.i64.i to i32*
  store i32 %tmp2_v.i53.i, i32* %47, align 4
  %tmp2_v12.i65.i = add i32 %32, -57
  store i32 %tmp2_v12.i65.i, i32* %34, align 4
  store i32 134517501, i32* %35, align 4
  %48 = tail call fastcc { i32, i32, i32, i32 } @Func_startswith(i32 %tmp2_v2.i29.i, i32 %32, i32 %33)
  %49 = extractvalue { i32, i32, i32, i32 } %48, 0
  %50 = extractvalue { i32, i32, i32, i32 } %48, 3
  %tmp2_v.i70.i = add i32 %50, -8015
  %51 = inttoptr i32 %49 to i32*
  store i32 %tmp2_v.i70.i, i32* %51, align 4
  %tmp2_v2.i72.i = add i32 %49, -4
  %52 = inttoptr i32 %tmp2_v2.i72.i to i32*
...
Func_804937C.exit.i:
  ...
  %tmp2_v1.i11.i = add i32 %arg_esp, -8
  %1 = inttoptr i32 %tmp2_v1.i11.i to i32*
  ...
  %3 = inttoptr i32 %tmp2_v.i26.i to i32*
  %4 = load i32, i32* %3, align 4
  %tmp2_v3.i28.i = add i32 %arg_esp, -44
  %5 = inttoptr i32 %tmp2_v3.i28.i to i32*
  ...
  %tmp2_v.i55.i = add i32 %arg_esp, -20
  %8 = inttoptr i32 %tmp2_v.i55.i to i32*
  store i32 %7, i32* %8, align 4
  %tmp2_v2.i58.i = add i32 %arg_esp, 8
  ...
  %12 = inttoptr i32 %tmp2_v.i3.i to i32*
...
BB_804939A.i:                                     ; preds = %BB_80493BF.i, %BB_8049391.i
  %storemerge29 = phi i32 [ %tmp0_v1.i38.i, %BB_80493BF.i ], [ 0, %BB_8049391.i ]
  %14 = load i32, i32* %3, align 4
  %tmp0_v3.i.i = add i32 %14, %storemerge29
  ...
  %tmp0_v1.i38.i = add nuw nsw i32 %storemerge29, 1
  br i1 %20, label %BB_80493BF.i, label %.exit

BB_8049391.i:                                     ; preds = %Func_804937C.exit.i
  %tmp2_v.i14.i = add i32 %arg_esp, -24
  %21 = inttoptr i32 %tmp2_v.i14.i to i32*
...
BB_80493BF.i:                                     ; preds = %BB_804939A.i
  store i32 %tmp0_v1.i38.i, i32* %21, align 4
  %24 = load i32, i32* %12, align 4
  %25 = icmp slt i32 %tmp0_v1.i38.i, %24
...
.exit:                                            ; preds = %BB_80493BF.i, %BB_8049391.i, %BB_804939A.i, %Func_804937C.exit.i
  ...
  %mrv = insertvalue { i32, i32, i32, i32 } undef, i32 %tmp2_v.i26.i, 0
...
!11 = !{i32 0, i32 2, i32 3}
  ...
  tail call fastcc void @startswithm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
