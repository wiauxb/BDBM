...
define internal fastcc void @truncatem15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v.i14.i = add i32 %tmp0_v.i26.i, -28
  %7 = inttoptr i32 %tmp2_v.i14.i to i32*
  store i32 10, i32* %7, align 4
  %tmp2_v3.i16.i = add i32 %tmp0_v.i26.i, -32
  %8 = inttoptr i32 %tmp2_v3.i16.i to i32*
  store i32 134520840, i32* %8, align 16
  %tmp2_v4.i17.i = add i32 %tmp0_v.i26.i, -36
  ...
  store i32 134520849, i32* %8, align 16
  store i32 134517316, i32* %9, align 4
  %14 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i25.i, i32 inreg noundef 0, i32 noundef %tmp2_v3.i16.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @truncatem15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
