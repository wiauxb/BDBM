...
define internal fastcc void @ungetcm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_80492FB.exit.i:
  ...
  %tmp2_v.i33.i = add i32 %tmp0_v.i.i, -540
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @ungetcm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
