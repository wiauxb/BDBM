...
Func_8049283.exit.i:
  ...
  %tmp2_v1.i34.i = add i32 %arg_esp, -32
  %1 = inttoptr i32 %tmp2_v1.i34.i to i32*
  store i32 134517379, i32* %1, align 4
  %tmp2_v.i21.i = add i32 %arg_esp, 8
  %2 = inttoptr i32 %tmp2_v.i21.i to i32*
  %3 = load i32, i32* %2, align 4
  %.not.i24.i = icmp eq i32 %3, 1
  br i1 %.not.i24.i, label %BB_804928E.i, label %BB_80492A6.i
...
BB_80492A6.i:                                     ; preds = %Func_8049283.exit.i
  ...
  %tmp2_v4.i6.i = add i32 %arg_esp, 4
  %5 = inttoptr i32 %tmp2_v4.i6.i to i32*
  ...
  %9 = tail call fastcc { i32, i32, i32, i32 } @Func_max(i32 %tmp2_v7.i.i, i32 %tmp2_v.i31.i)
...
define internal fastcc void @find_array_max_recursivem15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !13 {
.exit:
  ...
  %tmp2_v2.i17.i = add i32 %tmp0_v.i.i, -20
  %9 = inttoptr i32 %tmp2_v2.i17.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i18.i = add i32 %tmp0_v.i.i, -60
  %10 = inttoptr i32 %tmp2_v3.i18.i to i32*
  store i32 4, i32* %10, align 4
  %tmp2_v4.i19.i = add i32 %tmp0_v.i.i, -56
  %11 = inttoptr i32 %tmp2_v4.i19.i to i32*
  store i32 1, i32* %11, align 8
  %tmp2_v5.i20.i = add i32 %tmp0_v.i.i, -52
  ...
  %tmp2_v8.i22.i = add i32 %tmp0_v.i.i, -40
...
!14 = !{!"printf"}
  ...
  tail call fastcc void @find_array_max_recursivem15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
