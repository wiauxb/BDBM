...
@str.bis.188 = constant [12 x i8] c"\6c\6f\67\20\25\64\3a\20\25\73\0a\00"
@str.bis.189 = constant [8 x i8] c"\6c\6f\67\2e\74\78\74\00"
@str.bis.190 = constant [2 x i8] c"\61\00"
@str.bis.191 = constant [12 x i8] c"\6c\6f\67\20\25\64\3a\20\25\73\0a\00"
@str.bis.192 = constant [8 x i8] c"\6c\6f\67\2e\74\78\74\00"
@str.bis.193 = constant [2 x i8] c"\61\00"
@str.bis.194 = constant [12 x i8] c"\6c\6f\67\20\25\64\3a\20\25\73\0a\00"
@str.bis.195 = constant [8 x i8] c"\6c\6f\67\2e\74\78\74\00"
@str.bis.196 = constant [2 x i8] c"\61\00"
@str.bis.197 = constant [11 x i8] c"\63\61\6c\6c\73\3a\20\25\64\0a\00"
@str.bis.198 = constant [4 x i8] c"\05\11\2d\00"
@str.bis.199 = constant [11 x i8] c"\63\61\6c\6c\73\3a\20\25\64\0a\00"
@str.bis.200 = constant [4 x i8] c"\05\11\2d\00"
@str.bis.201 = constant [11 x i8] c"\63\61\6c\6c\73\3a\20\25\64\0a\00"
@str.bis.202 = constant [4 x i8] c"\05\11\2d\00"
...
define internal fastcc void @static_local_variables204(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %spi.bis.202 = ptrtoint[4 x i8]* @str.bis.202 to i32
  ...
  %spi.bis.201 = ptrtoint[11 x i8]* @str.bis.201 to i32
  ...
  %15 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i22.i, i32 inreg noundef 134520895, i32 noundef %tmp2_v9.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %16 = load i32, i32* %9, align 4
  %17 = load i32, i32* %8, align 8
  store i32 134517278, i32* %7, align 4
  store i32 %17, i32* %8, align 8
  store i32 %16, i32* %9, align 4
  %spi.bis.200 = ptrtoint[4 x i8]* @str.bis.200 to i32
  ...
  %spi.bis.199 = ptrtoint[11 x i8]* @str.bis.199 to i32
  store i32 %spi.bis.199, i32* %13, align 16
  store i32 134517531, i32* %14, align 4
  %19 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i22.i, i32 inreg noundef 134520895, i32 noundef %tmp2_v9.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %20 = load i32, i32* %9, align 4
  %21 = load i32, i32* %8, align 8
  store i32 134517283, i32* %7, align 4
  store i32 %21, i32* %8, align 8
  store i32 %20, i32* %9, align 4
  %spi.bis.198 = ptrtoint[4 x i8]* @str.bis.198 to i32
  ...
  %spi.bis.197 = ptrtoint[11 x i8]* @str.bis.197 to i32
  store i32 %spi.bis.197, i32* %13, align 16
  store i32 134517531, i32* %14, align 4
  %23 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i22.i, i32 inreg noundef 134520895, i32 noundef %tmp2_v9.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %24 = lshr i64 %23, 32
  ...
  %spi.bis.194 = ptrtoint[12 x i8]* @str.bis.194 to i32
  store i32 %spi.bis.194, i32* %32, align 4
  %39 = load i32, i32* %14, align 4
  store i32 %39, i32* %33, align 16
  store i32 134517448, i32* %34, align 4
  %40 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i22.i, i32 inreg noundef %25, i32 noundef %tmp2_v8.i.i.i, i32 noundef ptrtoint (i32 ()* @fprintf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  %41 = lshr i64 %40, 32
  ...
  %spi.bis.193 = ptrtoint[2 x i8]* @str.bis.193 to i32
  store i32 %spi.bis.193, i32* %32, align 4
  %spi.bis.192 = ptrtoint[8 x i8]* @str.bis.192 to i32
  ...
  %spi.bis.191 = ptrtoint[12 x i8]* @str.bis.191 to i32
  store i32 %spi.bis.191, i32* %32, align 4
  %51 = load i32, i32* %14, align 4
  store i32 %51, i32* %33, align 16
  store i32 134517448, i32* %34, align 4
  %52 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i22.i, i32 inreg noundef %42, i32 noundef %tmp2_v8.i.i.i, i32 noundef ptrtoint (i32 ()* @fprintf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  %53 = lshr i64 %52, 32
  ...
  %spi.bis.190 = ptrtoint[2 x i8]* @str.bis.190 to i32
  store i32 %spi.bis.190, i32* %32, align 4
  %spi.bis.189 = ptrtoint[8 x i8]* @str.bis.189 to i32
  ...
  %spi.bis.188 = ptrtoint[12 x i8]* @str.bis.188 to i32
  store i32 %spi.bis.188, i32* %32, align 4
  %63 = load i32, i32* %14, align 4
  store i32 %63, i32* %33, align 16
  store i32 134517448, i32* %34, align 4
  %64 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i22.i, i32 inreg noundef %54, i32 noundef %tmp2_v8.i.i.i, i32 noundef ptrtoint (i32 ()* @fprintf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
