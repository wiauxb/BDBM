...
define internal fastcc void @remove_chars_from_stringm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v14.i.i = add i32 %tmp0_v.i2.i, -76
  ...
  %tmp2_v17.i.i = add i32 %tmp0_v.i2.i, -84
  %21 = inttoptr i32 %tmp2_v17.i.i to i32*
  store i32 134517327, i32* %21, align 4
  %tmp2_v.i11.i.i = add i32 %tmp0_v.i2.i, -88
  %22 = inttoptr i32 %tmp2_v.i11.i.i to i32*
  store i32 %tmp2_v4.i3.i, i32* %22, align 8
  %tmp2_v1.i13.i.i = add i32 %tmp0_v.i2.i, -92
  %23 = inttoptr i32 %tmp2_v1.i13.i.i to i32*
  store i32 134529024, i32* %23, align 4
  %tmp2_v2.i15.i.i = add i32 %tmp0_v.i2.i, -132
  %24 = inttoptr i32 %tmp2_v2.i15.i.i to i32*
  store i32 134517424, i32* %24, align 4
  %25 = load i32, i32* %20, align 16
  %tmp2_v3.i112.i.i = add i32 %tmp0_v.i2.i, -144
  %26 = inttoptr i32 %tmp2_v3.i112.i.i to i32*
  store i32 %25, i32* %26, align 16
  %tmp2_v4.i113.i.i = add i32 %tmp0_v.i2.i, -148
  %27 = inttoptr i32 %tmp2_v4.i113.i.i to i32*
  store i32 134517441, i32* %27, align 4
  %arg.i.i.i = load i32, i32* %26, align 16
  %28 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i68.i.i = add i32 %tmp0_v.i2.i, -104
  %29 = inttoptr i32 %tmp2_v.i68.i.i to i32*
  ...
  %tmp2_v.i.i.i = add i32 %tmp0_v.i2.i, -100
  %32 = inttoptr i32 %tmp2_v.i.i.i to i32*
  store i32 %31, i32* %32, align 4
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i2.i, -120
  %33 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 0, i32* %33, align 8
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i2.i, -116
...
BB_80492EF.i.lr.ph.i:                             ; preds = %.exit
  %tmp2_v.i53.i.i = add i32 %tmp0_v.i2.i, -121
  %38 = inttoptr i32 %tmp2_v.i53.i.i to i8*
  %tmp2_v1.i54.i.i = add i32 %tmp0_v.i2.i, -108
  %39 = inttoptr i32 %tmp2_v1.i54.i.i to i32*
  br label %BB_80492EF.i.i

BB_8049331.i.i:                                   ; preds = %BB_8049326.i.i
  %40 = load i32, i32* %35, align 16
  %41 = load i32, i32* %20, align 16
  %tmp0_v3.i.i.i = add i32 %41, %40
  %42 = load i32, i32* %34, align 4
  %tmp0_v8.i.i.i = add i32 %42, %41
  %43 = inttoptr i32 %tmp0_v3.i.i.i to i8*
  %44 = load i8, i8* %43, align 1
  %45 = inttoptr i32 %tmp0_v8.i.i.i to i8*
  store i8 %44, i8* %45, align 1
  br label %BB_8049350.i.i

BB_804931A.i.i:                                   ; preds = %BB_8049316.i.i, %BB_80492FC.i.i
  %46 = phi i32 [ %storemerge3038.i, %BB_80492FC.i.i ], [ %.pre.i, %BB_8049316.i.i ]
  %tmp0_v1.i45.i.i = add i32 %46, 1
  store i32 %tmp0_v1.i45.i.i, i32* %39, align 4
  %47 = load i32, i32* %32, align 4
  %48 = icmp slt i32 %tmp0_v1.i45.i.i, %47
  br i1 %48, label %BB_80492FC.i.i, label %BB_8049326.i.i

BB_80492EF.i.i:                                   ; preds = %BB_8049350.i.i, %BB_80492EF.i.lr.ph.i
  %r_ecx.139.i = phi i32 [ %tmp2_v.i1.i, %BB_80492EF.i.lr.ph.i ], [ %r_ecx.2.i, %BB_8049350.i.i ]
  store i8 0, i8* %38, align 1
  store i32 0, i32* %39, align 4
  %49 = load i32, i32* %32, align 4
  %50 = icmp sgt i32 %49, 0
  br i1 %50, label %BB_80492FC.i.i, label %BB_8049326.i.i

BB_8049350.i.i:                                   ; preds = %BB_8049326.i.i, %BB_8049331.i.i
  %.sink42.i = phi i32* [ %34, %BB_8049331.i.i ], [ %33, %BB_8049326.i.i ]
  %r_ecx.2.i = phi i32 [ %42, %BB_8049331.i.i ], [ %r_ecx.0.lcssa.i, %BB_8049326.i.i ]
  %51 = load i32, i32* %.sink42.i, align 4
  %tmp0_v1.i.i.i = add i32 %51, 1
  store i32 %tmp0_v1.i.i.i, i32* %.sink42.i, align 4
  %52 = load i32, i32* %35, align 16
  %tmp0_v1.i58.i.i = add i32 %52, 1
  store i32 %tmp0_v1.i58.i.i, i32* %35, align 16
  %53 = load i32, i32* %29, align 8
  %54 = icmp slt i32 %tmp0_v1.i58.i.i, %53
  br i1 %54, label %BB_80492EF.i.i, label %Func_remove_chars.exit

BB_8049326.i.i:                                   ; preds = %BB_80492EF.i.i, %BB_804931A.i.i
  %r_ecx.0.lcssa.i = phi i32 [ %r_ecx.139.i, %BB_80492EF.i.i ], [ %storemerge3038.i, %BB_804931A.i.i ]
  %55 = load i8, i8* %38, align 1
  %56 = icmp eq i8 %55, 1
  br i1 %56, label %BB_8049350.i.i, label %BB_8049331.i.i

BB_80492FC.i.i:                                   ; preds = %BB_80492EF.i.i, %BB_804931A.i.i
  %storemerge3038.i = phi i32 [ %tmp0_v1.i45.i.i, %BB_804931A.i.i ], [ 0, %BB_80492EF.i.i ]
  %57 = load i32, i32* %35, align 16
  %58 = load i32, i32* %20, align 16
  %tmp0_v3.i84.i.i = add i32 %58, %57
  %59 = inttoptr i32 %tmp0_v3.i84.i.i to i8*
  %60 = load i8, i8* %59, align 1
  %tmp0_v4.i85.i.i = zext i8 %60 to i32
  %61 = load i32, i32* %19, align 4
  %tmp0_v9.i90.i.i = add i32 %61, %storemerge3038.i
  %62 = inttoptr i32 %tmp0_v9.i90.i.i to i8*
  %63 = load i8, i8* %62, align 1
  %tmp0_v10.i.i.i = zext i8 %63 to i32
  %cc_dst_v.i91.i.i = sub nsw i32 %tmp0_v4.i85.i.i, %tmp0_v10.i.i.i
  %tmp4_v.i92.i.i = and i32 %cc_dst_v.i91.i.i, 255
  %.not.i.i.i = icmp eq i32 %tmp4_v.i92.i.i, 0
...
Func_remove_chars.exit:                           ; preds = %BB_8049350.i.i, %.exit
  %r_ecx.1.lcssa.i = phi i32 [ %tmp2_v.i1.i, %.exit ], [ %r_ecx.2.i, %BB_8049350.i.i ]
  %64 = load i32, i32* %34, align 4
  %65 = load i32, i32* %20, align 16
  %tmp0_v3.i35.i.i = add i32 %65, %64
  %66 = inttoptr i32 %tmp0_v3.i35.i.i to i8*
  store i8 0, i8* %66, align 1
  %67 = load i32, i32* %33, align 8
  %68 = load i32, i32* %23, align 4
  %69 = load i32, i32* %22, align 8
  %tmp2_v.i15.i = add i32 %69, -48
  %70 = inttoptr i32 %tmp2_v.i15.i to i32*
  store i32 %67, i32* %70, align 4
  %tmp2_v2.i17.i = add i32 %69, -38
  store i32 %tmp2_v2.i17.i, i32* %19, align 4
  %tmp2_v4.i20.i = add i32 %68, -8184
  store i32 %tmp2_v4.i20.i, i32* %20, align 16
  ...
  %tmp2_v4.i43.i = add i32 %68, -8172
  store i32 %tmp2_v4.i43.i, i32* %20, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @remove_chars_from_stringm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
