...
.exit:
  ...
  store i32 %spi731, i32* %19, align 16
  store i32 134517439, i32* %20, align 4
  %22 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef 0, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %tmp2_v.i55.i = add i32 %tmp0_v.i9.i, -59
  %23 = inttoptr i32 %tmp2_v.i55.i to i32*
  store i32 6513249, i32* %23, align 4
  %tmp2_v1.i.i = add i32 %tmp0_v.i9.i, -55
  %24 = inttoptr i32 %tmp2_v1.i.i to i32*
  store i32 2054781047, i32* %24, align 4
  %tmp2_v2.i56.i = add i32 %tmp0_v.i9.i, -51
  %25 = inttoptr i32 %tmp2_v2.i56.i to i8*
  store i8 0, i8* %25, align 1
  store i32 %tmp2_v1.i.i, i32* %18, align 4
  store i32 %tmp2_v.i55.i, i32* %19, align 16
  store i32 134517476, i32* %20, align 4
  %tmp2_v.i42.i.i = add i32 %tmp0_v.i9.i, -88
  %26 = inttoptr i32 %tmp2_v.i42.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %26, align 8
  %tmp2_v1.i44.i.i = add i32 %tmp0_v.i9.i, -92
  %27 = inttoptr i32 %tmp2_v1.i44.i.i to i32*
  store i32 134529024, i32* %27, align 4
  %tmp2_v2.i46.i.i = add i32 %tmp0_v.i9.i, -132
  %28 = inttoptr i32 %tmp2_v2.i46.i.i to i32*
  store i32 134517565, i32* %28, align 4
  %29 = load i32, i32* %19, align 16
  %tmp2_v3.i69.i.i = add i32 %tmp0_v.i9.i, -144
  %30 = inttoptr i32 %tmp2_v3.i69.i.i to i32*
  store i32 %29, i32* %30, align 16
  %tmp2_v4.i70.i.i = add i32 %tmp0_v.i9.i, -148
  %31 = inttoptr i32 %tmp2_v4.i70.i.i to i32*
  store i32 134517582, i32* %31, align 4
  %arg.i.i.i = load i32, i32* %30, align 16
  %32 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i31.i.i = add i32 %tmp0_v.i9.i, -112
  %33 = inttoptr i32 %tmp2_v.i31.i.i to i32*
  ...
  %tmp2_v.i57.i.i = add i32 %tmp0_v.i9.i, -100
  %41 = inttoptr i32 %tmp2_v.i57.i.i to i32*
  store i32 %40, i32* %41, align 4
  %tmp2_v1.i59.i.i = add i32 %tmp0_v.i9.i, -120
  %42 = inttoptr i32 %tmp2_v1.i59.i.i to i32*
...
BB_80493BA.i.i:                                   ; preds = %BB_80493B1.i.i, %BB_80493BA.i.i
  ...
  %51 = load i32, i32* %62, align 4
  %tmp0_v15.i.i.i = add i32 %51, 1
  store i32 %tmp0_v15.i.i.i, i32* %62, align 4
...
BB_8049390.i.i:                                   ; preds = %BB_8049390.i.i, %.exit
  %storemerge34.i = phi i32 [ %tmp0_v12.i22.i.i, %BB_8049390.i.i ], [ 0, %.exit ]
  %54 = load i32, i32* %19, align 16
  %tmp0_v3.i14.i.i = add i32 %54, %storemerge34.i
  %55 = load i32, i32* %41, align 4
  %tmp0_v8.i19.i.i = add i32 %55, %storemerge34.i
  %56 = inttoptr i32 %tmp0_v3.i14.i.i to i8*
  %57 = load i8, i8* %56, align 1
  %58 = inttoptr i32 %tmp0_v8.i19.i.i to i8*
  store i8 %57, i8* %58, align 1
  %59 = load i32, i32* %42, align 8
  %tmp0_v12.i22.i.i = add i32 %59, 1
  store i32 %tmp0_v12.i22.i.i, i32* %42, align 8
  %60 = load i32, i32* %33, align 16
  %61 = icmp slt i32 %tmp0_v12.i22.i.i, %60
  br i1 %61, label %BB_8049390.i.i, label %BB_80493B1.i.i

BB_80493B1.i.i:                                   ; preds = %BB_8049390.i.i, %.exit
  %r_ecx.1.lcssa.i = phi i32 [ %tmp2_v.i8.i, %.exit ], [ %storemerge34.i, %BB_8049390.i.i ]
  %tmp2_v.i61.i.i = add i32 %tmp0_v.i9.i, -116
  %62 = inttoptr i32 %tmp2_v.i61.i.i to i32*
...
Func_string_append.exit:                          ; preds = %BB_80493B1.i.i, %BB_80493BA.i.i
  ...
  %tmp2_v.i30.i = add i32 %70, -56
  %71 = inttoptr i32 %tmp2_v.i30.i to i32*
  store i32 %68, i32* %71, align 4
  store i32 %68, i32* %18, align 4
  %tmp2_v5.i36.i = add i32 %69, -8173
  store i32 %tmp2_v5.i36.i, i32* %19, align 16
  store i32 134517500, i32* %20, align 4
  %72 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %r_ecx.0.lcssa.i, i32 inreg noundef %tmp2_v1.i74.i.i, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
