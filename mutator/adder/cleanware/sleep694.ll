...
@str.692 = constant [6 x i8] c"after\00"
@str.693 = constant [7 x i8] c"before\00"
...
define internal fastcc void @sleep694(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
  ...
  %tmp2_v2.i4.i = add i32 %tmp0_v.i17.i, -32
  %8 = inttoptr i32 %tmp2_v2.i4.i to i32*
  %spi693 = ptrtoint[7 x i8]* @str.693 to i32
  store i32 %spi693, i32* %8, align 16
  %tmp2_v3.i.i = add i32 %tmp0_v.i17.i, -36
  ...
  %spi692 = ptrtoint[6 x i8]* @str.692 to i32
  store i32 %spi692, i32* %8, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @sleep694(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
