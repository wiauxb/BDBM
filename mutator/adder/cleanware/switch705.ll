...
@str.701 = constant [18 x i8] c"a: %d, vowel: %d\0a\00"
@str.702 = constant [24 x i8] c"Below switch statement!\00"
@str.703 = constant [4 x i8] c"if!\00"
@str.704 = constant [8 x i8] c"Case 1!\00"
...
define internal fastcc void @switch705(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
label_1.i58.i:
  ...
  %spi704 = ptrtoint[8 x i8]* @str.704 to i32
  store i32 %spi704, i32* %11, align 16
  ...
  %spi703 = ptrtoint[4 x i8]* @str.703 to i32
  store i32 %spi703, i32* %11, align 16
  ...
  %spi702 = ptrtoint[24 x i8]* @str.702 to i32
  store i32 %spi702, i32* %11, align 16
...
BB_8049350.i:                                     ; preds = %BB_8049344.i, %label_1.i58.i
  ...
  %spi701 = ptrtoint[18 x i8]* @str.701 to i32
  store i32 %spi701, i32* %49, align 4
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @switch705(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
