...
@str.18 = constant [20 x i8] c"factorial(%d) = %d\0a\00"
...
define internal fastcc void @factorial_recursion19(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !13 {
...
BB_80491C0.i:                                     ; preds = %BB_80491C0.i, %BB_80491C0.i.preheader
  ...
  %spi18 = ptrtoint[20 x i8]* @str.18 to i32
  store i32 %spi18, i32* %19, align 4
...
!14 = !{!"printf"}
  ...
  tail call fastcc void @factorial_recursion19(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
