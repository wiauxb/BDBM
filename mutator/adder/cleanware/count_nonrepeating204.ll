...
@str.202 = constant [11 x i8] c"count: %d\0a\00"
...
define internal fastcc void @count_nonrepeating204(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v3.i.i = add i32 %tmp0_v.i28.i, -64
  %10 = inttoptr i32 %tmp2_v3.i.i to i32*
  store i32 1, i32* %10, align 16
  %tmp2_v4.i14.i = add i32 %tmp0_v.i28.i, -60
  %11 = inttoptr i32 %tmp2_v4.i14.i to i32*
  store i32 3, i32* %11, align 4
  %tmp2_v5.i15.i = add i32 %tmp0_v.i28.i, -56
  %12 = inttoptr i32 %tmp2_v5.i15.i to i32*
  store i32 5, i32* %12, align 8
  %tmp2_v6.i.i = add i32 %tmp0_v.i28.i, -52
  %13 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 7, i32* %13, align 4
  %tmp2_v7.i16.i = add i32 %tmp0_v.i28.i, -48
  %14 = inttoptr i32 %tmp2_v7.i16.i to i32*
  store i32 3, i32* %14, align 16
  %tmp2_v8.i.i = add i32 %tmp0_v.i28.i, -44
  %15 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 7, i32* %15, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i28.i, -40
  %16 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 6, i32* %16, align 8
  %tmp2_v10.i.i = add i32 %tmp0_v.i28.i, -36
  %17 = inttoptr i32 %tmp2_v10.i.i to i32*
  store i32 6, i32* %17, align 4
  %tmp2_v11.i.i = add i32 %tmp0_v.i28.i, -32
  %18 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 4, i32* %18, align 16
  %tmp2_v12.i.i = add i32 %tmp0_v.i28.i, -28
  %19 = inttoptr i32 %tmp2_v12.i.i to i32*
  store i32 2, i32* %19, align 4
  %tmp2_v13.i.i = add i32 %tmp0_v.i28.i, -24
  %20 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 9, i32* %20, align 8
  %tmp2_v15.i.i = add i32 %tmp0_v.i28.i, -92
  ...
  %tmp2_v.i9.i.i = add i32 %tmp0_v.i28.i, -104
  %24 = inttoptr i32 %tmp2_v.i9.i.i to i32*
  store i32 %tmp2_v4.i30.i, i32* %24, align 8
  %tmp2_v1.i12.i.i = add i32 %tmp0_v.i28.i, -124
  %25 = inttoptr i32 %tmp2_v1.i12.i.i to i32*
  store i32 134517383, i32* %25, align 4
  %tmp2_v.i23.i.i = add i32 %tmp0_v.i28.i, -116
  %26 = inttoptr i32 %tmp2_v.i23.i.i to i32*
  %tmp2_v1.i24.i.i = add i32 %tmp0_v.i28.i, -112
  %27 = inttoptr i32 %tmp2_v1.i24.i.i to i32*
  store i32 0, i32* %27, align 16
  %tmp2_v2.i25.i.i = add i32 %tmp0_v.i28.i, -108
...
BB_80492B3.i.i:                                   ; preds = %BB_80492E1.i.i.preheader, %BB_80492E1.i.i
  %34 = phi i32 [ %42, %BB_80492E1.i.i ], [ %52, %BB_80492E1.i.i.preheader ]
  %tmp0_v1.i56.i.i19 = phi i32 [ %tmp0_v1.i56.i.i, %BB_80492E1.i.i ], [ 1, %BB_80492E1.i.i.preheader ]
  %35 = load i32, i32* %26, align 4
  %tmp4_v.i.i.i1 = shl i32 %35, 2
  %36 = load i32, i32* %22, align 16
  %tmp0_v3.i6.i.i = add i32 %36, %tmp4_v.i.i.i1
  %37 = inttoptr i32 %tmp0_v3.i6.i.i to i32*
  %38 = load i32, i32* %37, align 4
  %tmp4_v7.i.i.i = shl i32 %tmp0_v1.i56.i.i19, 2
  %tmp0_v10.i.i.i = add i32 %36, %tmp4_v7.i.i.i
  %39 = inttoptr i32 %tmp0_v10.i.i.i to i32*
  %40 = load i32, i32* %39, align 4
  %.not.i.i.i = icmp ne i32 %38, %40
  %.not.i19.i.i = icmp eq i32 %35, %tmp0_v1.i56.i.i19
  %or.cond.i = select i1 %.not.i.i.i, i1 true, i1 %.not.i19.i.i
...
BB_80492F0.i.i:                                   ; preds = %BB_80492E1.i.i.preheader, %BB_80492B3.i.i.preheader, %BB_80492E5.i.preheader.i, %BB_80492E1.i.i, %BB_80492B3.i.i
  %storemerge1.lcssa.i = phi i32 [ 0, %BB_80492E5.i.preheader.i ], [ 0, %BB_80492B3.i.i.preheader ], [ 1, %BB_80492E1.i.i.preheader ], [ %tmp0_v1.i56.i.i19, %BB_80492B3.i.i ], [ %tmp0_v1.i56.i.i, %BB_80492E1.i.i ]
  %.lcssa.i = phi i32 [ %44, %BB_80492E5.i.preheader.i ], [ %44, %BB_80492B3.i.i.preheader ], [ %52, %BB_80492E1.i.i.preheader ], [ %34, %BB_80492B3.i.i ], [ %42, %BB_80492E1.i.i ]
  %r_edx.0.i = phi i32 [ %r_edx.214.i, %BB_80492E5.i.preheader.i ], [ %49, %BB_80492B3.i.i.preheader ], [ %49, %BB_80492E1.i.i.preheader ], [ %38, %BB_80492B3.i.i ], [ %38, %BB_80492E1.i.i ]
  %r_ecx.0.i = phi i32 [ %r_ecx.215.i, %BB_80492E5.i.preheader.i ], [ 0, %BB_80492B3.i.i.preheader ], [ 0, %BB_80492E1.i.i.preheader ], [ %tmp4_v7.i.i.i, %BB_80492B3.i.i ], [ %tmp4_v7.i.i.i, %BB_80492E1.i.i ]
  %.not.i32.i.i = icmp eq i32 %storemerge1.lcssa.i, %.lcssa.i
  br i1 %.not.i32.i.i, label %BB_80492F8.i.i, label %BB_80492FC.i.i

BB_80492F8.i.i:                                   ; preds = %BB_80492F0.i.i
  %41 = load i32, i32* %28, align 4
  %tmp0_v1.i37.i.i = add i32 %41, 1
  store i32 %tmp0_v1.i37.i.i, i32* %28, align 4
  br label %BB_80492FC.i.i

BB_80492E1.i.i:                                   ; preds = %BB_80492B3.i.i
  %tmp0_v1.i56.i.i = add nuw nsw i32 %tmp0_v1.i56.i.i19, 1
  store i32 %tmp0_v1.i56.i.i, i32* %27, align 16
  %42 = load i32, i32* %21, align 4
  %43 = icmp slt i32 %tmp0_v1.i56.i.i, %42
  br i1 %43, label %BB_80492B3.i.i, label %BB_80492F0.i.i

BB_80492E5.i.preheader.i:                         ; preds = %BB_80492FC.i.i, %.exit
  %r_ecx.215.i = phi i32 [ %r_ecx.0.i, %BB_80492FC.i.i ], [ %tmp2_v.i27.i, %.exit ]
  %r_edx.214.i = phi i32 [ %r_edx.0.i, %BB_80492FC.i.i ], [ 0, %.exit ]
  store i32 0, i32* %27, align 16
...
BB_80492B3.i.i.preheader:                         ; preds = %BB_80492E5.i.preheader.i
  ...
  %tmp0_v3.i6.i.i5 = add i32 %47, %tmp4_v.i.i.i14
  %48 = inttoptr i32 %tmp0_v3.i6.i.i5 to i32*
  %49 = load i32, i32* %48, align 4
  %50 = inttoptr i32 %47 to i32*
  %51 = load i32, i32* %50, align 4
  %.not.i.i.i7 = icmp ne i32 %49, %51
  %.not.i19.i.i8 = icmp eq i32 %46, 0
  %or.cond.i9 = select i1 %.not.i.i.i7, i1 true, i1 %.not.i19.i.i8
...
Func_non_repeating.exit:                          ; preds = %BB_80492FC.i.i, %.exit
  ...
  %r_ecx.2.lcssa.i = phi i32 [ %tmp2_v.i27.i, %.exit ], [ %r_ecx.0.i, %BB_80492FC.i.i ]
  %54 = load i32, i32* %28, align 4
  %55 = load i32, i32* %24, align 8
  %tmp2_v.i3.i = add i32 %55, -60
  %56 = inttoptr i32 %tmp2_v.i3.i to i32*
  store i32 %54, i32* %56, align 4
  store i32 %54, i32* %21, align 4
  %spi202 = ptrtoint[11 x i8]* @str.202 to i32
  store i32 %spi202, i32* %22, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @count_nonrepeating204(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
