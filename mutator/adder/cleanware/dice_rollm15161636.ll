...
define internal fastcc void @dice_rollm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v8.i40.i = add i32 %tmp0_v.i33.i, -36
  %7 = inttoptr i32 %tmp2_v8.i40.i to i32*
  store i32 134517265, i32* %7, align 4
  %tmp2_v.i2.i = add i32 %tmp0_v.i33.i, -48
  ...
  %tmp2_v.i12.i = add i32 %tmp0_v.i33.i, -24
  %11 = inttoptr i32 %tmp2_v.i12.i to i32*
  store i32 10, i32* %11, align 8
  %tmp2_v1.i13.i = add i32 %tmp0_v.i33.i, -20
  %12 = inttoptr i32 %tmp2_v1.i13.i to i32*
  store i32 0, i32* %12, align 4
  %tmp2_v2.i14.i = add i32 %tmp0_v.i33.i, -28
  %13 = inttoptr i32 %tmp2_v2.i14.i to i32*
...
BB_8049247.i.lr.ph:                               ; preds = %0
  %tmp2_v12.i.i = add i32 %tmp0_v.i33.i, -40
  %15 = inttoptr i32 %tmp2_v12.i.i to i32*
  %tmp2_v15.i.i = add i32 %tmp0_v.i33.i, -44
...
BB_8049247.i:                                     ; preds = %BB_8049247.i, %BB_8049247.i.lr.ph
  ...
  %tmp0_v2.i.i.neg = lshr i32 %17, 31
  %tmp0_v3.i.i = add i32 %tmp0_v2.i.i.neg, %18
  %tmp0_v6.i.i.neg = mul i32 %tmp0_v3.i.i, -6
  %tmp0_v7.i.i = add i32 %tmp0_v6.i.i.neg, %17
  %tmp2_v.i3.i = add i32 %tmp0_v7.i.i, 1
  store i32 %tmp2_v.i3.i, i32* %12, align 4
  store i32 %tmp2_v.i3.i, i32* %15, align 8
  %19 = load i32, i32* %13, align 4
  store i32 %19, i32* %16, align 4
  store i32 134520840, i32* %8, align 16
  store i32 134517381, i32* %9, align 4
  %20 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v7.i.i, i32 inreg noundef %tmp0_v7.i.i, i32 noundef %tmp2_v.i2.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %21 = load i32, i32* %13, align 4
  %tmp0_v2.i25.i = add i32 %21, 1
  store i32 %tmp0_v2.i25.i, i32* %13, align 4
  %22 = load i32, i32* %11, align 8
  %.not.i.i = icmp sgt i32 %tmp0_v2.i25.i, %22
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @dice_rollm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
