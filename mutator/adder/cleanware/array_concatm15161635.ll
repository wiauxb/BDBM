...
define internal fastcc void @array_concatm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %4 = inttoptr i32 %tmp2_v4.i24.i to i32*
  ...
  %tmp2_v.i54.i = add i32 %arg_esp, 8
  %8 = inttoptr i32 %tmp2_v.i54.i to i32*
  %9 = load i32, i32* %8, align 4
  %tmp2_v2.i57.i = add i32 %tmp0_v.i22.i, -84
  %10 = inttoptr i32 %tmp2_v2.i57.i to i32*
  store i32 %9, i32* %10, align 4
  %tmp4_v.i58.i.b = load i1, i1* @segs.0, align 1
  %11 = select i1 %tmp4_v.i58.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %12 = load i32, i32* %11, align 4
  %tmp2_v5.i61.i = add i32 %tmp0_v.i22.i, -20
  %13 = inttoptr i32 %tmp2_v5.i61.i to i32*
  store i32 %12, i32* %13, align 4
  %tmp2_v6.i62.i = add i32 %tmp0_v.i22.i, -60
  %14 = inttoptr i32 %tmp2_v6.i62.i to i32*
  store i32 0, i32* %14, align 4
  %tmp2_v7.i63.i = add i32 %tmp0_v.i22.i, -56
  %15 = inttoptr i32 %tmp2_v7.i63.i to i32*
  store i32 1, i32* %15, align 8
  %tmp2_v8.i64.i = add i32 %tmp0_v.i22.i, -52
  %16 = inttoptr i32 %tmp2_v8.i64.i to i32*
  store i32 2, i32* %16, align 4
  %tmp2_v9.i65.i = add i32 %tmp0_v.i22.i, -48
  %17 = inttoptr i32 %tmp2_v9.i65.i to i32*
  store i32 3, i32* %17, align 16
  %tmp2_v10.i66.i = add i32 %tmp0_v.i22.i, -44
  %18 = inttoptr i32 %tmp2_v10.i66.i to i32*
  store i32 4, i32* %18, align 4
  %tmp2_v11.i67.i = add i32 %tmp0_v.i22.i, -40
  %19 = inttoptr i32 %tmp2_v11.i67.i to i32*
  store i32 5, i32* %19, align 8
  %tmp2_v12.i68.i = add i32 %tmp0_v.i22.i, -36
  %20 = inttoptr i32 %tmp2_v12.i68.i to i32*
  store i32 6, i32* %20, align 4
  %tmp2_v13.i.i = add i32 %tmp0_v.i22.i, -32
  %21 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 7, i32* %21, align 16
  %tmp2_v14.i.i = add i32 %tmp0_v.i22.i, -28
  %22 = inttoptr i32 %tmp2_v14.i.i to i32*
  store i32 8, i32* %22, align 4
  %tmp2_v15.i.i = add i32 %tmp0_v.i22.i, -24
  %23 = inttoptr i32 %tmp2_v15.i.i to i32*
  store i32 9, i32* %23, align 8
  store i32 5, i32* %7, align 4
  %tmp2_v18.i.i = add i32 %tmp0_v.i22.i, -104
  %24 = inttoptr i32 %tmp2_v18.i.i to i32*
  store i32 %tmp2_v11.i67.i, i32* %24, align 8
  ...
  store i32 %tmp2_v6.i62.i, i32* %26, align 16
  ...
  %tmp0_v4.i32.i.i = add i32 %32, %31
  %tmp0_v5.i33.i.i = shl i32 %tmp0_v4.i32.i.i, 2
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i22.i, -160
  %33 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  store i32 %tmp0_v5.i33.i.i, i32* %33, align 16
  %tmp2_v8.i36.i.i = add i32 %tmp0_v.i22.i, -164
  %34 = inttoptr i32 %tmp2_v8.i36.i.i to i32*
  store i32 134517606, i32* %34, align 4
  %arg.i.i.i = load i32, i32* %33, align 16
  %35 = tail call i32 @malloc(i32 %arg.i.i.i)
  %tmp2_v.i4.i.i = add i32 %tmp0_v.i22.i, -132
  %36 = inttoptr i32 %tmp2_v.i4.i.i to i32*
  store i32 %35, i32* %36, align 4
  %37 = load i32, i32* %25, align 4
  %tmp0_v3.i.i.i = shl i32 %37, 2
  %tmp2_v5.i.i.i = add i32 %tmp0_v.i22.i, -152
  %38 = inttoptr i32 %tmp2_v5.i.i.i to i32*
  store i32 %tmp0_v3.i.i.i, i32* %38, align 8
  %39 = load i32, i32* %26, align 16
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i22.i, -156
  ...
  %tmp4_v.i18.i.i = shl i32 %44, 2
  %45 = load i32, i32* %25, align 4
  %tmp4_v4.i.i.i = shl i32 %45, 2
  %46 = load i32, i32* %36, align 4
  %tmp0_v7.i22.i.i = add i32 %46, %tmp4_v4.i.i.i
  store i32 %tmp4_v.i18.i.i, i32* %38, align 8
  %47 = load i32, i32* %24, align 8
  store i32 %47, i32* %40, align 4
  store i32 %tmp0_v7.i22.i.i, i32* %33, align 16
  ...
  %tmp2_v.i50.i = add i32 %52, -56
  %53 = inttoptr i32 %tmp2_v.i50.i to i32*
  store i32 %50, i32* %53, align 4
  %tmp2_v1.i51.i = add i32 %52, -60
  %54 = inttoptr i32 %tmp2_v1.i51.i to i32*
...
BB_80492D0.i:                                     ; preds = %BB_80492D0.i, %0
  %storemerge5 = phi i32 [ 0, %0 ], [ %tmp0_v2.i31.i, %BB_80492D0.i ]
  %tmp4_v.i38.i = shl i32 %storemerge5, 2
  %57 = load i32, i32* %53, align 4
  %tmp0_v3.i41.i = add i32 %57, %tmp4_v.i38.i
  %58 = inttoptr i32 %tmp0_v3.i41.i to i32*
  ...
  %61 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp4_v4.i.i.i, i32 inreg noundef %tmp4_v.i38.i, i32 noundef %tmp2_v21.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %62 = load i32, i32* %54, align 4
  %tmp0_v2.i31.i = add i32 %62, 1
  store i32 %tmp0_v2.i31.i, i32* %54, align 4
  %63 = icmp slt i32 %tmp0_v2.i31.i, 10
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @array_concatm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
