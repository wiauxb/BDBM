...
define internal fastcc void @convert_stringm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !18 {
  ...
  %tmp2_v3.i38.i = add i32 %tmp0_v.i.i, -40
  %9 = inttoptr i32 %tmp2_v3.i38.i to i32*
  store i32 134520846, i32* %9, align 8
  %tmp2_v5.i40.i = add i32 %tmp0_v.i.i, -36
  %10 = inttoptr i32 %tmp2_v5.i40.i to i32*
  store i32 134520849, i32* %10, align 4
  ...
  %tmp2_v.i23.i = add i32 %tmp0_v.i.i, -24
  %tmp5_v.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %16 = inttoptr i32 %tmp2_v.i23.i to i64*
  ...
  %tmp2_v.i60.i = add i32 %tmp0_v.i.i, -32
  ...
  %tmp2_v.i47.i = add i32 %tmp0_v.i.i, -28
  %22 = inttoptr i32 %tmp2_v.i47.i to i32*
  store i32 %21, i32* %22, align 4
  %tmp2_v2.i49.i = add i32 %tmp0_v.i.i, -20
  %23 = inttoptr i32 %tmp2_v2.i49.i to i32*
  %24 = load i32, i32* %23, align 4
  %tmp2_v4.i50.i = add i32 %tmp0_v.i.i, -56
  %25 = inttoptr i32 %tmp2_v4.i50.i to i32*
  store i32 %24, i32* %25, align 8
  %26 = inttoptr i32 %tmp2_v.i23.i to i32*
  %27 = load i32, i32* %26, align 8
  %tmp2_v7.i53.i = add i32 %tmp0_v.i.i, -60
  %28 = inttoptr i32 %tmp2_v7.i53.i to i32*
  store i32 %27, i32* %28, align 4
  store i32 134520866, i32* %12, align 16
  store i32 134517370, i32* %13, align 4
  %29 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef 0, i32 noundef %tmp2_v9.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %30 = lshr i64 %29, 32
  %31 = trunc i64 %30 to i32
  %32 = load i32, i32* %19, align 16
  store i32 %32, i32* %28, align 4
  store i32 134520878, i32* %12, align 16
  store i32 134517391, i32* %13, align 4
  %33 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %31, i32 noundef %tmp2_v9.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %34 = lshr i64 %33, 32
  %35 = trunc i64 %34 to i32
  %36 = load i32, i32* %22, align 4
  store i32 %36, i32* %28, align 4
  store i32 134520887, i32* %12, align 16
  store i32 134517412, i32* %13, align 4
  %37 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %35, i32 noundef %tmp2_v9.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  ret void
}
...
!19 = !{!"printf"}
  ...
  tail call fastcc void @convert_stringm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
