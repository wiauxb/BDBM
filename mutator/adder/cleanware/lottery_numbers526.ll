...
Func_80492B9.exit.i:                              ; preds = %BB_80492B1.i
  ...
  %24 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v7.i93.i, i32 inreg noundef %20, i32 noundef %tmp2_v4.i67.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
