...
@str.697 = constant [12 x i8] c"a[%d] = %d\0a\00"
...
define internal fastcc void @qsort698(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v8.i38.i = add i32 %tmp0_v.i30.i, -84
  ...
  %tmp2_v3.i11.i = add i32 %tmp0_v.i30.i, -60
  %11 = inttoptr i32 %tmp2_v3.i11.i to i32*
  store i32 8, i32* %11, align 4
  %tmp2_v4.i.i = add i32 %tmp0_v.i30.i, -56
  %12 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 7, i32* %12, align 8
  %tmp2_v5.i12.i = add i32 %tmp0_v.i30.i, -52
  %13 = inttoptr i32 %tmp2_v5.i12.i to i32*
  store i32 2, i32* %13, align 4
  %tmp2_v6.i.i = add i32 %tmp0_v.i30.i, -48
  ...
  %tmp2_v.i59.i = add i32 %tmp0_v.i30.i, -68
...
BB_804929D.i:                                     ; preds = %BB_804929D.i, %0
  ...
  %tmp4_v.i43.i = shl i32 %storemerge3, 2
  %tmp2_v2.i44.i = add i32 %tmp4_v.i43.i, %tmp2_v3.i11.i
  %29 = inttoptr i32 %tmp2_v2.i44.i to i32*
  %30 = load i32, i32* %29, align 4
  store i32 %30, i32* %22, align 8
  %31 = load i32, i32* %26, align 4
  store i32 %31, i32* %23, align 4
  %spi697 = ptrtoint[12 x i8]* @str.697 to i32
  store i32 %spi697, i32* %24, align 16
  store i32 134517431, i32* %25, align 4
  %32 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i29.i, i32 inreg noundef %r_edx.04, i32 noundef %tmp2_v21.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %33 = lshr i64 %32, 32
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @qsort698(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
