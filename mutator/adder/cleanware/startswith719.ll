...
define internal fastcc void @startswith719(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_804923A.exit.i:
  ...
  %tmp2_v8.i.i = add i32 %tmp0_v.i9.i, -84
  %6 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 134517233, i32* %6, align 4
  %tmp4_v.i63.i.b = load i1, i1* @segs.0, align 1
  %7 = inttoptr i32 %arg_esp to i32*
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i67.i = add i32 %tmp0_v.i9.i, -20
  %9 = inttoptr i32 %tmp2_v2.i67.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i68.i = add i32 %tmp0_v.i9.i, -65
  %10 = inttoptr i32 %tmp2_v3.i68.i to i32*
  store i32 1702063954, i32* %10, align 4
  %tmp2_v4.i69.i = add i32 %tmp0_v.i9.i, -61
  %11 = inttoptr i32 %tmp2_v4.i69.i to i32*
  store i32 1918967923, i32* %11, align 4
  %tmp2_v5.i70.i = add i32 %tmp0_v.i9.i, -57
  %12 = inttoptr i32 %tmp2_v5.i70.i to i32*
  store i32 1701978213, i32* %12, align 4
  %tmp2_v6.i71.i = add i32 %tmp0_v.i9.i, -53
  %13 = inttoptr i32 %tmp2_v6.i71.i to i16*
  store i16 100, i16* %13, align 2
  %tmp2_v7.i72.i = add i32 %tmp0_v.i9.i, -79
  %14 = inttoptr i32 %tmp2_v7.i72.i to i32*
  store i32 1702063954, i32* %14, align 4
  %tmp2_v8.i73.i = add i32 %tmp0_v.i9.i, -75
  %15 = inttoptr i32 %tmp2_v8.i73.i to i16*
  store i16 115, i16* %15, align 2
  %tmp2_v11.i77.i = add i32 %tmp0_v.i9.i, -92
  %16 = inttoptr i32 %tmp2_v11.i77.i to i32*
  store i32 %tmp2_v7.i72.i, i32* %16, align 4
  %tmp2_v13.i.i = add i32 %tmp0_v.i9.i, -96
  %17 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 %tmp2_v3.i68.i, i32* %17, align 16
  %tmp2_v14.i79.i = add i32 %tmp0_v.i9.i, -100
  %18 = inttoptr i32 %tmp2_v14.i79.i to i32*
  store i32 134517306, i32* %18, align 4
  %19 = tail call fastcc { i32, i32, i32, i32 } @Func_startswith(i32 %tmp2_v14.i79.i, i32 %tmp2_v4.i.i, i32 134529024)
  %20 = extractvalue { i32, i32, i32, i32 } %19, 0
  %21 = extractvalue { i32, i32, i32, i32 } %19, 2
  %22 = extractvalue { i32, i32, i32, i32 } %19, 3
  %tmp2_v.i53.i = add i32 %22, -8184
  %23 = inttoptr i32 %20 to i32*
  store i32 %tmp2_v.i53.i, i32* %23, align 4
  %tmp2_v2.i55.i = add i32 %20, -4
  %24 = inttoptr i32 %tmp2_v2.i55.i to i32*
  ...
  %tmp2_v.i34.i = add i32 %21, -65
  %27 = inttoptr i32 %tmp2_v.i34.i to i32*
  store i32 1819240790, i32* %27, align 4
  %tmp2_v1.i35.i = add i32 %21, -61
  %28 = inttoptr i32 %tmp2_v1.i35.i to i32*
  store i32 7566437, i32* %28, align 4
  %tmp2_v3.i39.i = add i32 %20, 4
  %29 = inttoptr i32 %tmp2_v3.i39.i to i32*
  store i32 %tmp2_v.i34.i, i32* %29, align 4
  %tmp2_v4.i40.i = add i32 %21, -57
  store i32 %tmp2_v4.i40.i, i32* %23, align 4
  store i32 134517381, i32* %24, align 4
  %30 = tail call fastcc { i32, i32, i32, i32 } @Func_startswith(i32 %tmp2_v2.i55.i, i32 %21, i32 %22)
  %31 = extractvalue { i32, i32, i32, i32 } %30, 0
  %32 = extractvalue { i32, i32, i32, i32 } %30, 2
  %33 = extractvalue { i32, i32, i32, i32 } %30, 3
  %tmp2_v.i4.i = add i32 %33, -8076
  %34 = inttoptr i32 %31 to i32*
  store i32 %tmp2_v.i4.i, i32* %34, align 4
  %tmp2_v2.i6.i = add i32 %31, -4
  %35 = inttoptr i32 %tmp2_v2.i6.i to i32*
  ...
  %tmp2_v.i23.i = add i32 %32, -43
  %38 = inttoptr i32 %tmp2_v.i23.i to i32*
  store i32 1702063954, i32* %38, align 4
  %tmp2_v1.i24.i = add i32 %32, -39
  %39 = inttoptr i32 %tmp2_v1.i24.i to i32*
  store i32 1918967923, i32* %39, align 4
  %tmp2_v2.i25.i = add i32 %32, -35
  %40 = inttoptr i32 %tmp2_v2.i25.i to i32*
  store i32 1701978213, i32* %40, align 4
  %tmp2_v3.i26.i = add i32 %32, -31
  %41 = inttoptr i32 %tmp2_v3.i26.i to i32*
  store i32 1767252068, i32* %41, align 4
  %tmp2_v4.i27.i = add i32 %32, -27
  %42 = inttoptr i32 %tmp2_v4.i27.i to i32*
  store i32 1952803951, i32* %42, align 4
  %tmp2_v5.i28.i = add i32 %32, -23
  %43 = inttoptr i32 %tmp2_v5.i28.i to i32*
  store i32 1918967923, i32* %43, align 4
  %tmp2_v6.i29.i = add i32 %32, -19
  %44 = inttoptr i32 %tmp2_v6.i29.i to i32*
  store i32 1816272997, i32* %44, align 4
  %tmp2_v7.i.i = add i32 %32, -15
  %45 = inttoptr i32 %tmp2_v7.i.i to i16*
  store i16 25973, i16* %45, align 2
  %tmp2_v8.i30.i = add i32 %32, -13
  %46 = inttoptr i32 %tmp2_v8.i30.i to i8*
  store i8 0, i8* %46, align 1
  %tmp2_v11.i.i = add i32 %31, 4
  %47 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 %tmp2_v.i23.i, i32* %47, align 4
  %tmp2_v12.i.i = add i32 %32, -57
  store i32 %tmp2_v12.i.i, i32* %34, align 4
  store i32 134517501, i32* %35, align 4
  %48 = tail call fastcc { i32, i32, i32, i32 } @Func_startswith(i32 %tmp2_v2.i6.i, i32 %32, i32 %33)
...
Func_804937C.exit.i:
  %tmp2_v.i8.i = add i32 %arg_esp, -4
  %0 = inttoptr i32 %tmp2_v.i8.i to i32*
  store i32 %arg_ebp, i32* %0, align 4
  %tmp2_v1.i10.i = add i32 %arg_esp, -8
  %1 = inttoptr i32 %tmp2_v1.i10.i to i32*
  ...
  %tmp2_v2.i49.i = add i32 %arg_esp, 8
  ...
  %12 = inttoptr i32 %tmp2_v.i4.i to i32*
  store i32 %11, i32* %12, align 4
  %13 = load i32, i32* %8, align 4
  %.not.i.i = icmp sgt i32 %11, %13
  br i1 %.not.i.i, label %.exit, label %BB_8049391.i

BB_804939A.i:                                     ; preds = %BB_8049391.i, %BB_80493BF.i
  %storemerge29 = phi i32 [ %tmp0_v1.i16.i, %BB_80493BF.i ], [ 0, %BB_8049391.i ]
  %14 = load i32, i32* %3, align 4
  %tmp0_v3.i27.i = add i32 %14, %storemerge29
  %15 = inttoptr i32 %tmp0_v3.i27.i to i8*
  ...
  %cc_dst_v.i28.i = sub nsw i32 %tmp0_v4.i.i, %tmp0_v10.i.i
  %tmp4_v.i.i = and i32 %cc_dst_v.i28.i, 255
  %20 = icmp eq i32 %tmp4_v.i.i, 0
  %tmp0_v1.i16.i = add nuw nsw i32 %storemerge29, 1
  br i1 %20, label %BB_80493BF.i, label %.exit

BB_80493BF.i:                                     ; preds = %BB_804939A.i
  store i32 %tmp0_v1.i16.i, i32* %23, align 4
  %21 = load i32, i32* %12, align 4
  %22 = icmp slt i32 %tmp0_v1.i16.i, %21
  br i1 %22, label %BB_804939A.i, label %.exit

BB_8049391.i:                                     ; preds = %Func_804937C.exit.i
  %tmp2_v.i60.i = add i32 %arg_esp, -24
  %23 = inttoptr i32 %tmp2_v.i60.i to i32*
  store i32 0, i32* %23, align 4
  %24 = load i32, i32* %12, align 4
  %25 = icmp sgt i32 %24, 0
  br i1 %25, label %BB_804939A.i, label %.exit

.exit:                                            ; preds = %BB_8049391.i, %BB_80493BF.i, %BB_804939A.i, %Func_804937C.exit.i
...
!11 = !{i32 0, i32 2, i32 3}
  ...
  tail call fastcc void @startswith719(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
