...
define internal fastcc void @strstrm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
Func_804928B.exit.i:
  ...
  %tmp2_v8.i48.i = add i32 %tmp0_v.i40.i, -68
  ...
  %tmp2_v.i23.i = add i32 %tmp0_v.i40.i, -56
  %20 = inttoptr i32 %tmp2_v.i23.i to i32*
  store i32 %19, i32* %20, align 8
  store i32 %19, i32* %16, align 4
  store i32 134520840, i32* %17, align 16
  store i32 134517361, i32* %18, align 4
  %21 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i39.i, i32 inreg noundef 0, i32 noundef %tmp2_v13.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %tmp2_v.i52.i = add i32 %tmp0_v.i40.i, -41
  %22 = inttoptr i32 %tmp2_v.i52.i to i32*
  store i32 7827310, i32* %22, align 4
  store i32 %tmp2_v.i52.i, i32* %16, align 4
  store i32 %tmp2_v3.i.i, i32* %17, align 16
  ...
  %tmp2_v.i34.i = add i32 %tmp0_v.i40.i, -52
  %24 = inttoptr i32 %tmp2_v.i34.i to i32*
  store i32 %23, i32* %24, align 4
  store i32 134520849, i32* %17, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @strstrm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
