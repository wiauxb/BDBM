...
@str.573 = constant [4 x i8] c"%d\0a\00"
...
define internal fastcc void @sum_naturals574(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %tmp2_v.i.i = add i32 %tmp0_v.i13.i, -32
  ...
  %spi573 = ptrtoint[4 x i8]* @str.573 to i32
  store i32 %spi573, i32* %15, align 4
  %tmp2_v4.i.i = add i32 %11, -4
  %16 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 134517201, i32* %16, align 4
  %17 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i12.i, i32 inreg noundef %13, i32 noundef %11, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
BB_80491FD.i:                                     ; preds = %Func_80491F2.exit.i
  %tmp0_v1.i11.i = add nsw i32 %3, -1
  %tmp2_v3.i.i = add i32 %arg_esp, -28
  %5 = inttoptr i32 %tmp2_v3.i.i to i32*
  store i32 %tmp0_v1.i11.i, i32* %5, align 4
  ...
  %tmp2_v.i16.i = add i32 %9, 8
  %10 = inttoptr i32 %tmp2_v.i16.i to i32*
...
.exit:                                            ; preds = %BB_80491FD.i, %Func_80491F2.exit.i..exit_crit_edge
  %tmp4_v2.i.i.pre-phi = phi i32 [ %.pre1, %Func_80491F2.exit.i..exit_crit_edge ], [ %tmp2_v.i16.i, %BB_80491FD.i ]
...
!14 = !{i32 0, i32 2, i32 3}
  ...
  tail call fastcc void @sum_naturals574(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
