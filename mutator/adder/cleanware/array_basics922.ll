...
BB_8049259.i:                                     ; preds = %BB_8049245.i
  ...
  %24 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %21, i32 inreg noundef %tmp0_v5.i.i, i32 noundef %tmp2_v10.i50.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
...
BB_804920E.i:                                     ; preds = %BB_804920E.i, %0
  ...
  %30 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef %r_edx.08, i32 noundef %tmp2_v10.i50.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %31 = lshr i64 %30, 32
