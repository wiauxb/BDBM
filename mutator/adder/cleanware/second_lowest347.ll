...
.exit:
  ...
  store i32 %tmp2_v3.i19.i, i32* %21, align 16
  %tmp2_v17.i.i = add i32 %tmp0_v.i2.i, -84
  %22 = inttoptr i32 %tmp2_v17.i.i to i32*
  store i32 134517302, i32* %22, align 4
  %tmp2_v.i66.i.i = add i32 %tmp0_v.i2.i, -88
  %23 = inttoptr i32 %tmp2_v.i66.i.i to i32*
  store i32 %tmp2_v4.i3.i, i32* %23, align 8
  %tmp2_v1.i69.i.i = add i32 %tmp0_v.i2.i, -108
  %24 = inttoptr i32 %tmp2_v1.i69.i.i to i32*
...
BB_80492C3.i.i:                                   ; preds = %BB_8049335.i.i, %.exit
  %storemerge19.i = phi i32 [ %tmp0_v1.i52.i.i, %BB_8049335.i.i ], [ 2, %.exit ]
  %tmp4_v.i4.i.i = shl i32 %storemerge19.i, 2
...
BB_80492D9.i.i:                                   ; preds = %BB_80492C3.i.i
  ...
  %tmp4_v.i21.i.i = shl i32 %42, 2
  %43 = load i32, i32* %21, align 16
  %tmp0_v6.i23.i.i = add i32 %43, %tmp4_v.i21.i.i
  %44 = inttoptr i32 %tmp0_v6.i23.i.i to i32*
...
BB_8049335.i.i:                                   ; preds = %BB_80492F5.i.i, %Func_804930B.exit.i.i, %BB_80492D9.i.i
  %r_edx.0.i = phi i32 [ %tmp4_v.i4.i.i, %BB_80492F5.i.i ], [ %tmp4_v.i4.i.i, %Func_804930B.exit.i.i ], [ %tmp4_v.i21.i.i, %BB_80492D9.i.i ]
  %46 = load i32, i32* %35, align 4
  %tmp0_v1.i52.i.i = add i32 %46, 1
  store i32 %tmp0_v1.i52.i.i, i32* %35, align 4
  %47 = load i32, i32* %20, align 4
  %48 = icmp slt i32 %tmp0_v1.i52.i.i, %47
...
BB_80492F5.i.i:                                   ; preds = %BB_80492C3.i.i
  ...
  %.not.i81.i.i = icmp sgt i32 %49, %40
...
Func_second_lowest.exit:                          ; preds = %BB_8049335.i.i, %.exit
  ...
  %spi345 = ptrtoint[19 x i8]* @str.345 to i32
  store i32 %spi345, i32* %21, align 16
  store i32 134517326, i32* %22, align 4
  %53 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i1.i, i32 inreg noundef %r_edx.1.lcssa.i, i32 noundef %tmp2_v16.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
