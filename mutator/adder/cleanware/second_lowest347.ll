...
@str.345 = constant [19 x i8] c"second lowest: %d\0a\00"
...
.exit:
  ...
  %tmp2_v7.i18.i = add i32 %tmp0_v.i.i, -44
  %14 = inttoptr i32 %tmp2_v7.i18.i to i32*
  store i32 5, i32* %14, align 4
  %tmp2_v8.i19.i = add i32 %tmp0_v.i.i, -40
  ...
  %tmp2_v.i82.i.i = add i32 %tmp0_v.i.i, -88
  %23 = inttoptr i32 %tmp2_v.i82.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %23, align 8
  %tmp2_v1.i85.i.i = add i32 %tmp0_v.i.i, -108
  %24 = inttoptr i32 %tmp2_v1.i85.i.i to i32*
  store i32 134517376, i32* %24, align 4
  %25 = load i32, i32* %21, align 16
  %26 = inttoptr i32 %25 to i32*
  %27 = load i32, i32* %26, align 4
  %tmp2_v1.i25.i.i = add i32 %25, 4
  %28 = inttoptr i32 %tmp2_v1.i25.i.i to i32*
  %29 = load i32, i32* %28, align 4
  %tmp2_v3.i27.i.i = add i32 %tmp0_v.i.i, -100
  %30 = inttoptr i32 %tmp2_v3.i27.i.i to i32*
...
BB_8049335.i.i:                                   ; preds = %BB_80492F5.i.i, %BB_80492D9.i.i, %Func_804930B.exit.i.i
  %r_edx.0.i = phi i32 [ %tmp4_v.i59.i.i, %BB_80492F5.i.i ], [ %tmp4_v.i59.i.i, %Func_804930B.exit.i.i ], [ %tmp4_v.i50.i.i, %BB_80492D9.i.i ]
  %38 = load i32, i32* %35, align 4
  %tmp0_v1.i17.i.i = add i32 %38, 1
  store i32 %tmp0_v1.i17.i.i, i32* %35, align 4
  %39 = load i32, i32* %20, align 4
  %40 = icmp slt i32 %tmp0_v1.i17.i.i, %39
  br i1 %40, label %BB_80492C3.i.i, label %Func_second_lowest.exit

Func_804930B.exit.i.i:                            ; preds = %BB_80492F5.i.i
  store i32 %47, i32* %34, align 16
  br label %BB_8049335.i.i

BB_80492D9.i.i:                                   ; preds = %BB_80492C3.i.i
  store i32 %48, i32* %34, align 16
  %41 = load i32, i32* %35, align 4
  %tmp4_v.i50.i.i = shl i32 %41, 2
  %42 = load i32, i32* %21, align 16
  %tmp0_v6.i53.i.i = add i32 %42, %tmp4_v.i50.i.i
  %43 = inttoptr i32 %tmp0_v6.i53.i.i to i32*
  %44 = load i32, i32* %43, align 4
  store i32 %44, i32* %30, align 4
  br label %BB_8049335.i.i

BB_80492C3.i.i:                                   ; preds = %BB_8049335.i.i, %.exit
  %storemerge19.i = phi i32 [ %tmp0_v1.i17.i.i, %BB_8049335.i.i ], [ 2, %.exit ]
  %tmp4_v.i59.i.i = shl i32 %storemerge19.i, 2
  %45 = load i32, i32* %21, align 16
  %tmp0_v3.i62.i.i = add i32 %45, %tmp4_v.i59.i.i
  %46 = inttoptr i32 %tmp0_v3.i62.i.i to i32*
  %47 = load i32, i32* %46, align 4
  %48 = load i32, i32* %30, align 4
  %.not.i67.i.i = icmp sgt i32 %48, %47
  br i1 %.not.i67.i.i, label %BB_80492D9.i.i, label %BB_80492F5.i.i

BB_80492F5.i.i:                                   ; preds = %BB_80492C3.i.i
  %49 = load i32, i32* %34, align 16
  %.not.i80.i.i = icmp sgt i32 %49, %47
  br i1 %.not.i80.i.i, label %Func_804930B.exit.i.i, label %BB_8049335.i.i
...
Func_second_lowest.exit:                          ; preds = %BB_8049335.i.i, %.exit
  ...
  %tmp2_v.i4.i = add i32 %51, -56
  %52 = inttoptr i32 %tmp2_v.i4.i to i32*
  store i32 %50, i32* %52, align 4
  store i32 %50, i32* %20, align 4
  %spi.bis.345 = ptrtoint[19 x i8]* @str.345 to i32
