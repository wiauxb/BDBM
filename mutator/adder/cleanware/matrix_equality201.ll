...
@str.199 = constant [5 x i8] c"A!=B\00"
...
define internal fastcc void @matrix_equality201(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
label_1.i.i:
  ...
  %tmp2_v8.i.i = add i32 %tmp0_v.i2.i, -132
...
BB_8049342.i.i:                                   ; preds = %BB_8049342.i.3.i, %label_1.i.i
  ...
  %tmp0_v1.i.i.1.i = shl i32 %49, 4
  %50 = load i32, i32* %35, align 16
  %tmp0_v4.i.i.1.i = or i32 %tmp0_v1.i.i.1.i, 4
...
BB_8049342.i.1.i:                                 ; preds = %BB_8049342.i.i
  ...
  %tmp0_v1.i.i.2.i = shl i32 %57, 4
  %58 = load i32, i32* %35, align 16
  %tmp0_v4.i.i.2.i = or i32 %tmp0_v1.i.i.2.i, 8
...
BB_8049342.i.2.i:                                 ; preds = %BB_8049342.i.1.i
  ...
  %tmp0_v1.i.i.3.i = shl i32 %65, 4
  %66 = load i32, i32* %35, align 16
  %tmp0_v4.i.i.3.i = or i32 %tmp0_v1.i.i.3.i, 12
...
BB_8049342.i.3.i:                                 ; preds = %BB_8049342.i.2.i
  ...
  %tmp0_v1.i12.i.i = add i32 %73, 1
  store i32 %tmp0_v1.i12.i.i, i32* %39, align 16
  store i32 0, i32* %40, align 4
  %74 = load i32, i32* %39, align 16
  %tmp0_v1.i.i.i = shl i32 %74, 4
  %75 = load i32, i32* %35, align 16
  %tmp2_v7.i.i.i = add i32 %tmp0_v1.i.i.i, %75
  %76 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  %77 = load i32, i32* %76, align 4
  %78 = load i32, i32* %34, align 4
  %tmp2_v19.i.i.i = add i32 %78, %tmp0_v1.i.i.i
...
Func_matrix_equality.exit:                        ; preds = %BB_8049342.i.3.i, %BB_8049342.i.2.i, %BB_8049342.i.1.i, %BB_8049342.i.i, %label_1.i.i
  %spi199 = ptrtoint[5 x i8]* @str.199 to i32
  store i32 %spi199, i32* %35, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @matrix_equality201(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
