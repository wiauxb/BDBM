...
define internal fastcc void @variablesm15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !24 {
  ...
  %tmp2_v.i20.i = add i32 %tmp0_v.i53.i, -44
  %8 = inttoptr i32 %tmp2_v.i20.i to i32*
  store i32 10, i32* %8, align 4
  %tmp2_v1.i.i = add i32 %tmp0_v.i53.i, -40
  %9 = inttoptr i32 %tmp2_v1.i.i to i32*
  store i32 2, i32* %9, align 8
  %tmp2_v2.i21.i = add i32 %tmp0_v.i53.i, -36
  %10 = inttoptr i32 %tmp2_v2.i21.i to i32*
  store i32 3, i32* %10, align 4
  %tmp2_v3.i22.i = add i32 %tmp0_v.i53.i, -32
  ...
  %tmp2_v1.i42.i = add i32 %tmp0_v.i53.i, -28
  %tmp6_v.i43.i = tail call fastcc i32 @helper_fsts_ST0()
  %13 = inttoptr i32 %tmp2_v1.i42.i to i32*
  store i32 %tmp6_v.i43.i, i32* %13, align 4
  ...
  %tmp2_v5.i46.i = add i32 %tmp0_v.i53.i, -24
  %tmp5_v6.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %15 = inttoptr i32 %tmp2_v5.i46.i to i64*
  store i64 %tmp5_v6.i.i, i64* %15, align 8
  tail call fastcc void @helper_fpop()
  %tmp2_v8.i47.i = add i32 %tmp0_v.i53.i, -45
  %16 = inttoptr i32 %tmp2_v8.i47.i to i8*
  store i8 89, i8* %16, align 1
  %17 = load i32, i32* %8, align 4
  %tmp2_v12.i.i = add i32 %tmp0_v.i53.i, -60
  %18 = inttoptr i32 %tmp2_v12.i.i to i32*
  store i32 %17, i32* %18, align 4
  %tmp2_v15.i.i = add i32 %tmp0_v.i53.i, -64
  %19 = inttoptr i32 %tmp2_v15.i.i to i32*
  store i32 134520840, i32* %19, align 16
  %tmp2_v16.i50.i = add i32 %tmp0_v.i53.i, -68
  %20 = inttoptr i32 %tmp2_v16.i50.i to i32*
  store i32 134517243, i32* %20, align 4
  %21 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i52.i, i32 inreg noundef 0, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %22 = lshr i64 %21, 32
  %23 = trunc i64 %22 to i32
  %24 = load i32, i32* %11, align 16
  store i32 %24, i32* %7, align 4
  %25 = load i32, i32* %10, align 4
  %tmp2_v5.i.i = add i32 %tmp0_v.i53.i, -56
  %26 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 %25, i32* %26, align 8
  %27 = load i32, i32* %9, align 8
  store i32 %27, i32* %18, align 4
  store i32 134520854, i32* %19, align 16
  store i32 134517267, i32* %20, align 4
  %28 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i52.i, i32 inreg noundef %23, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %29 = lshr i64 %28, 32
  %30 = trunc i64 %29 to i32
  %31 = load i32, i32* %13, align 4
  tail call fastcc void @helper_flds_ST0(i32 %31)
  %tmp5_v.i33.i = tail call fastcc i64 @helper_fstl_ST0()
  %32 = inttoptr i32 %tmp2_v12.i.i to i64*
  store i64 %tmp5_v.i33.i, i64* %32, align 4
  tail call fastcc void @helper_fpop()
  store i32 134520875, i32* %19, align 16
  store i32 134517295, i32* %20, align 4
  %33 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i52.i, i32 inreg noundef %30, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %34 = lshr i64 %33, 32
  %35 = trunc i64 %34 to i32
  %tmp2_v.i67.i = add i32 %tmp0_v.i53.i, -20
  %36 = inttoptr i32 %tmp2_v.i67.i to i32*
  %37 = load i32, i32* %36, align 4
  store i32 %37, i32* %26, align 8
  %38 = inttoptr i32 %tmp2_v5.i46.i to i32*
  %39 = load i32, i32* %38, align 8
  store i32 %39, i32* %18, align 4
  store i32 134520887, i32* %19, align 16
  store i32 134517319, i32* %20, align 4
  %40 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i52.i, i32 inreg noundef %35, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %41 = lshr i64 %40, 32
  %42 = trunc i64 %41 to i32
  %43 = load i8, i8* %16, align 1
  %tmp0_v1.i.i = sext i8 %43 to i32
  store i32 %tmp0_v1.i.i, i32* %18, align 4
  store i32 134520902, i32* %19, align 16
  store i32 134517342, i32* %20, align 4
  %44 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i52.i, i32 inreg noundef %42, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %45 = lshr i64 %44, 32
  ...
  %49 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i52.i, i32 inreg noundef %46, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  ret void
}
...
!25 = !{!"printf"}
  ...
  tail call fastcc void @variablesm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
