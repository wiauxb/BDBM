...
define internal fastcc void @fill_random213(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v.i.i = add i32 %tmp0_v.i28.i, -440
  %14 = inttoptr i32 %tmp2_v.i.i to i32*
  store i32 200, i32* %14, align 8
  %tmp2_v2.i.i = add i32 %tmp0_v.i28.i, -444
  %15 = inttoptr i32 %tmp2_v2.i.i to i32*
  store i32 100, i32* %15, align 4
  %tmp2_v3.i.i = add i32 %tmp0_v.i28.i, -420
  store i32 %tmp2_v3.i.i, i32* %11, align 16
  store i32 134517364, i32* %12, align 4
  %tmp2_v.i8.i.i = add i32 %tmp0_v.i28.i, -456
  %16 = inttoptr i32 %tmp2_v.i8.i.i to i32*
  store i32 %tmp2_v4.i31.i, i32* %16, align 8
  %tmp2_v1.i10.i.i = add i32 %tmp0_v.i28.i, -460
  %17 = inttoptr i32 %tmp2_v1.i10.i.i to i32*
  store i32 134529024, i32* %17, align 4
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i28.i, -484
  %18 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  store i32 134517481, i32* %18, align 4
  %tmp4_v.i.i.i.i = add i32 %tmp0_v.i28.i, -480
  %mrv.i.i = insertvalue { i32, i32 } undef, i32 %tmp4_v.i.i.i.i, 0
  %tmp2_v.i3.i.i = add i32 %tmp0_v.i28.i, -468
...
BB_80492F8.i.i:                                   ; preds = %BB_80492F8.i.i, %0
  ...
  %tmp4_v.i18.i.i = shl i32 %36, 2
  %37 = load i32, i32* %11, align 16
  %tmp0_v7.i.i.i = add i32 %37, %tmp4_v.i18.i.i
...
Func_fill_random.exit:                            ; preds = %Func_fill_random.exit.loopexit, %0
  ...
  %r_ecx.0.lcssa.i = phi i32 [ %tmp2_v.i27.i, %0 ], [ %42, %Func_fill_random.exit.loopexit ]
  ...
  %tmp0_v.i.i.i = add i32 %r_esp.0.le.i, 20
  %43 = inttoptr i32 %tmp0_v.i.i.i to i32*
  %44 = load i32, i32* %43, align 4
  %tmp4_v.i.i.i4 = add i32 %r_esp.0.le.i, 24
  %45 = inttoptr i32 %tmp4_v.i.i.i4 to i32*
  %46 = load i32, i32* %45, align 4
  %tmp4_v5.i.i.i = add i32 %r_esp.0.le.i, 32
  %tmp2_v.i7.i = add i32 %46, -416
  %47 = inttoptr i32 %tmp2_v.i7.i to i32*
  %tmp2_v1.i11.i = add i32 %46, -412
  %tmp2_v5.i15.i = add i32 %r_esp.0.le.i, 40
  %48 = inttoptr i32 %tmp2_v5.i15.i to i32*
...
BB_8049283.i:                                     ; preds = %BB_8049283.i, %Func_fill_random.exit
  ...
  %storemerge10 = phi i32 [ 0, %Func_fill_random.exit ], [ %tmp0_v2.i50.i, %BB_8049283.i ]
  %tmp4_v.i12.i = shl i32 %storemerge10, 2
  %tmp2_v2.i13.i = add i32 %tmp2_v1.i11.i, %tmp4_v.i12.i
  %52 = inttoptr i32 %tmp2_v2.i13.i to i32*
  ...
  %tmp0_v2.i50.i = add i32 %58, 1
  store i32 %tmp0_v2.i50.i, i32* %47, align 4
  %59 = icmp slt i32 %tmp0_v2.i50.i, 100
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @fill_random213(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
