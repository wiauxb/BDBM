...
define internal fastcc void @count_words802(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v.i109.i.i = add i32 %tmp0_v.i28.i, -88
  %20 = inttoptr i32 %tmp2_v.i109.i.i to i32*
  store i32 %tmp2_v4.i30.i, i32* %20, align 8
  %tmp2_v1.i111.i.i = add i32 %tmp0_v.i28.i, -92
  %21 = inttoptr i32 %tmp2_v1.i111.i.i to i32*
  store i32 134529024, i32* %21, align 4
  %tmp2_v2.i114.i.i = add i32 %tmp0_v.i28.i, -148
  %22 = inttoptr i32 %tmp2_v2.i114.i.i to i32*
  store i32 134517422, i32* %22, align 4
  %23 = load i32, i32* %18, align 16
  %tmp2_v2.i14.i.i = add i32 %tmp0_v.i28.i, -132
  %24 = inttoptr i32 %tmp2_v2.i14.i.i to i32*
  store i32 %23, i32* %24, align 4
  %tmp4_v.i15.i.b.i = load i1, i1* @segs.0, align 1
  %25 = inttoptr i32 %arg_esp to i32*
  %26 = load i32, i32* %25, align 4
  %tmp2_v5.i.i.i = add i32 %tmp0_v.i28.i, -100
  %27 = inttoptr i32 %tmp2_v5.i.i.i to i32*
  store i32 %26, i32* %27, align 4
  %28 = load i32, i32* %24, align 4
  %tmp2_v9.i.i.i = add i32 %tmp0_v.i28.i, -160
  %29 = inttoptr i32 %tmp2_v9.i.i.i to i32*
  store i32 %28, i32* %29, align 16
  %tmp2_v10.i.i.i = add i32 %tmp0_v.i28.i, -164
  ...
  %tmp2_v.i94.i.i = add i32 %tmp0_v.i28.i, -112
  %32 = inttoptr i32 %tmp2_v.i94.i.i to i32*
  store i32 %31, i32* %32, align 16
  %tmp2_v1.i96.i.i = add i32 %tmp0_v.i28.i, -120
  %33 = inttoptr i32 %tmp2_v1.i96.i.i to i32*
  store i32 0, i32* %33, align 8
  %tmp2_v2.i97.i.i = add i32 %tmp0_v.i28.i, -107
  %34 = inttoptr i32 %tmp2_v2.i97.i.i to i32*
  store i32 992751136, i32* %34, align 4
  %tmp2_v3.i98.i.i = add i32 %tmp0_v.i28.i, -103
  %35 = inttoptr i32 %tmp2_v3.i98.i.i to i16*
  store i16 2314, i16* %35, align 2
  %tmp2_v4.i99.i.i = add i32 %tmp0_v.i28.i, -101
  %36 = inttoptr i32 %tmp2_v4.i99.i.i to i8*
  store i8 0, i8* %36, align 1
  %tmp2_v5.i100.i.i = add i32 %tmp0_v.i28.i, -116
  %37 = inttoptr i32 %tmp2_v5.i100.i.i to i32*
...
BB_804931D.i.preheader.lr.ph.i:                   ; preds = %.exit
  %tmp2_v7.i67.i.i = add i32 %tmp0_v.i28.i, -156
  %40 = inttoptr i32 %tmp2_v7.i67.i.i to i32*
  br label %BB_804931D.i.preheader.i

BB_8049327.i.i:                                   ; preds = %BB_804931D.i.preheader.i, %BB_8049319.i.i
  %.lcssa.i = phi i32 [ %58, %BB_804931D.i.preheader.i ], [ %tmp0_v1.i4.i.i, %BB_8049319.i.i ]
...
BB_8049319.i.i:                                   ; preds = %BB_804931D.i.preheader.i, %BB_8049319.i.i
  ...
  %tmp0_v3.i63.i.i = add i32 %46, %tmp0_v1.i4.i.i
  %47 = inttoptr i32 %tmp0_v3.i63.i.i to i8*
  %48 = load i8, i8* %47, align 1
  %tmp0_v5.i.i.i = sext i8 %48 to i32
  store i32 %tmp0_v5.i.i.i, i32* %40, align 4
  store i32 %tmp2_v2.i97.i.i, i32* %29, align 16
  store i32 134517522, i32* %30, align 4
  %arg.i.i4.i = load i32, i32* %29, align 16
  %arg2.i.i.i = load i32, i32* %40, align 4
  %49 = tail call i32 @strchr(i32 %arg.i.i4.i, i32 %arg2.i.i.i)
  %.not.i.i.i = icmp eq i32 %49, 0
  br i1 %.not.i.i.i, label %BB_8049319.i.i, label %BB_8049327.i.i

BB_8049350.i.i:                                   ; preds = %BB_804932E.i.i
  %tmp0_v1.i21.i.i = add i32 %.pre.pre.i, 1
  store i32 %tmp0_v1.i21.i.i, i32* %37, align 4
  %50 = load i32, i32* %32, align 16
  %51 = icmp slt i32 %tmp0_v1.i21.i.i, %50
  br i1 %51, label %BB_804932E.i.i, label %BB_804935F.i.i

BB_804932E.i.i:                                   ; preds = %BB_8049350.i.i, %BB_8049327.i.i
  %52 = phi i32 [ %tmp0_v1.i21.i.i, %BB_8049350.i.i ], [ %42, %BB_8049327.i.i ]
  %53 = load i32, i32* %24, align 4
  %tmp0_v3.i75.i.i = add i32 %53, %52
  %54 = inttoptr i32 %tmp0_v3.i75.i.i to i8*
  %55 = load i8, i8* %54, align 1
  %tmp0_v5.i77.i.i = sext i8 %55 to i32
  store i32 %tmp0_v5.i77.i.i, i32* %40, align 4
  store i32 %tmp2_v2.i97.i.i, i32* %29, align 16
...
BB_804931D.i.preheader.i:                         ; preds = %BB_804935F.i.i, %BB_804931D.i.preheader.lr.ph.i
  %58 = phi i32 [ 0, %BB_804931D.i.preheader.lr.ph.i ], [ %tmp0_v1.i118.i.i, %BB_804935F.i.i ]
  %59 = load i32, i32* %24, align 4
  %tmp0_v3.i63.i11.i = add i32 %59, %58
  %60 = inttoptr i32 %tmp0_v3.i63.i11.i to i8*
  %61 = load i8, i8* %60, align 1
  %tmp0_v5.i.i12.i = sext i8 %61 to i32
  store i32 %tmp0_v5.i.i12.i, i32* %40, align 4
  store i32 %tmp2_v2.i97.i.i, i32* %29, align 16
  store i32 134517522, i32* %30, align 4
  %arg.i.i413.i = load i32, i32* %29, align 16
  %arg2.i.i14.i = load i32, i32* %40, align 4
  %62 = tail call i32 @strchr(i32 %arg.i.i413.i, i32 %arg2.i.i14.i)
  %.not.i.i15.i = icmp eq i32 %62, 0
  br i1 %.not.i.i15.i, label %BB_8049319.i.i, label %BB_8049327.i.i

BB_804935F.i.i:                                   ; preds = %BB_804932E.i.i, %BB_8049350.i.i, %BB_8049327.i.i
  %63 = phi i32 [ %42, %BB_8049327.i.i ], [ %tmp0_v1.i21.i.i, %BB_8049350.i.i ], [ %.pre.pre.i, %BB_804932E.i.i ]
  %r_edx.2.i = phi i32 [ %.lcssa.i, %BB_8049327.i.i ], [ %52, %BB_804932E.i.i ], [ %52, %BB_8049350.i.i ]
  %tmp0_v1.i118.i.i = add i32 %63, 1
...
Func_word_count.exit:                             ; preds = %BB_804935F.i.i, %.exit
  ...
  %tmp2_v.i10.i = add i32 %71, -48
  %72 = inttoptr i32 %tmp2_v.i10.i to i32*
  store i32 %66, i32* %72, align 4
  %tmp2_v4.i14.i = add i32 %tmp0_v.i28.i, -76
  %73 = inttoptr i32 %tmp2_v4.i14.i to i32*
  store i32 %66, i32* %73, align 4
  %tmp2_v5.i16.i = add i32 %70, -8184
  store i32 %tmp2_v5.i16.i, i32* %18, align 16
  store i32 134517371, i32* %19, align 4
  %74 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v4.i.i.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v13.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @count_words802(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
