...
@str.320 = constant [14 x i8] c"array[%d]=%d\0a\00"
@str.321 = constant [14 x i8] c"array[%d]=%d\0a\00"
...
define internal fastcc void @constants322(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i.i, -152
...
BB_8049309.i.lr.ph.i:                             ; preds = %.exit
  %tmp2_v6.i.i.i = add i32 %tmp0_v.i.i, -168
  %31 = inttoptr i32 %tmp2_v6.i.i.i to i32*
  %tmp2_v9.i.i.i = add i32 %tmp0_v.i.i, -172
  %32 = inttoptr i32 %tmp2_v9.i.i.i to i32*
  %tmp2_v11.i.i.i = add i32 %tmp0_v.i.i, -176
  %33 = inttoptr i32 %tmp2_v11.i.i.i to i32*
  %tmp2_v12.i.i.i = add i32 %tmp0_v.i.i, -180
...
BB_8049309.i.i:                                   ; preds = %BB_8049309.i.i, %BB_8049309.i.lr.ph.i
  ...
  %spi321 = ptrtoint[14 x i8]* @str.321 to i32
  store i32 %spi321, i32* %33, align 16
...
Func_print_array.exit:                            ; preds = %BB_8049309.i.i, %.exit
  ...
  %tmp2_v.i32.i = add i32 %44, -56
  %46 = inttoptr i32 %tmp2_v.i32.i to i32*
  store i32 0, i32* %46, align 4
  %tmp2_v1.i.i = add i32 %44, -52
  %47 = inttoptr i32 %tmp2_v1.i.i to i32*
  store i32 1, i32* %47, align 4
  %tmp2_v2.i33.i = add i32 %44, -48
  %48 = inttoptr i32 %tmp2_v2.i33.i to i32*
  store i32 2, i32* %48, align 4
  %tmp2_v3.i34.i = add i32 %44, -44
  %49 = inttoptr i32 %tmp2_v3.i34.i to i32*
  store i32 3, i32* %49, align 4
  %tmp2_v4.i35.i = add i32 %44, -40
  %50 = inttoptr i32 %tmp2_v4.i35.i to i32*
  store i32 4, i32* %50, align 4
  %tmp2_v5.i36.i = add i32 %44, -36
  %51 = inttoptr i32 %tmp2_v5.i36.i to i32*
  store i32 5, i32* %51, align 4
  %tmp2_v6.i37.i = add i32 %44, -32
  %52 = inttoptr i32 %tmp2_v6.i37.i to i32*
  store i32 6, i32* %52, align 4
  %tmp2_v7.i38.i = add i32 %44, -28
  %53 = inttoptr i32 %tmp2_v7.i38.i to i32*
  store i32 7, i32* %53, align 4
  %tmp2_v8.i39.i = add i32 %44, -24
  %54 = inttoptr i32 %tmp2_v8.i39.i to i32*
  store i32 8, i32* %54, align 4
  %tmp2_v9.i40.i = add i32 %44, -20
  %55 = inttoptr i32 %tmp2_v9.i40.i to i32*
  store i32 9, i32* %55, align 4
  %tmp2_v10.i41.i = add i32 %44, -16
  %56 = inttoptr i32 %tmp2_v10.i41.i to i32*
  store i32 10, i32* %56, align 4
  store i32 11, i32* %20, align 4
  store i32 %tmp2_v.i32.i, i32* %21, align 16
...
BB_8049309.i.lr.ph.i14:                           ; preds = %Func_print_array.exit
  %tmp2_v6.i.i.i10 = add i32 %tmp0_v.i.i, -168
  %60 = inttoptr i32 %tmp2_v6.i.i.i10 to i32*
  %tmp2_v9.i.i.i11 = add i32 %tmp0_v.i.i, -172
  %61 = inttoptr i32 %tmp2_v9.i.i.i11 to i32*
  %tmp2_v11.i.i.i12 = add i32 %tmp0_v.i.i, -176
  %62 = inttoptr i32 %tmp2_v11.i.i.i12 to i32*
  %tmp2_v12.i.i.i13 = add i32 %tmp0_v.i.i, -180
...
BB_8049309.i.i19:                                 ; preds = %BB_8049309.i.i19, %BB_8049309.i.lr.ph.i14
  %storemerge15.i15 = phi i32 [ 0, %BB_8049309.i.lr.ph.i14 ], [ %tmp0_v2.i27.i.i18, %BB_8049309.i.i19 ]
  ...
  %spi320 = ptrtoint[14 x i8]* @str.320 to i32
  store i32 %spi320, i32* %62, align 16
  ...
  %tmp0_v2.i27.i.i18 = add i32 %69, 1
  store i32 %tmp0_v2.i27.i.i18, i32* %28, align 8
  %70 = load i32, i32* %27, align 4
  %71 = icmp slt i32 %tmp0_v2.i27.i.i18, %70
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @constants322(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
