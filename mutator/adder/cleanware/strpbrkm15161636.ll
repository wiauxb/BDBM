...
define internal fastcc void @strpbrkm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_8049271.exit.i:
  ...
  %tmp2_v5.i9.i = add i32 %tmp0_v.i7.i, -12
  ...
  %tmp2_v.i3.i = add i32 %tmp0_v.i7.i, -60
  %22 = inttoptr i32 %tmp2_v.i3.i to i32*
  ...
  %tmp2_v.i26.i = add i32 %tmp0_v.i7.i, -51
  %25 = inttoptr i32 %tmp2_v.i26.i to i32*
  ...
  %tmp2_v.i35.i = add i32 %tmp0_v.i7.i, -56
  %27 = inttoptr i32 %tmp2_v.i35.i to i32*
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @strpbrkm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
