...
@str.bis.527 = constant [12 x i8] c"\52\65\73\75\6c\74\3a\20\25\73\0a\00"
@str.bis.528 = constant [4 x i8] c"\05\76\2d\00"
...
define internal fastcc void @own_strcat530(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %7 = inttoptr i32 %tmp2_v7.i24.i to i32*
  store i32 %tmp2_v.i16.i, i32* %7, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i17.i, -1076
  ...
  %tmp2_v2.i11.i = add i32 %tmp0_v.i17.i, -36
  %11 = inttoptr i32 %tmp2_v2.i11.i to i32*
  store i32 %10, i32* %11, align 4
  %tmp2_v3.i12.i = add i32 %tmp0_v.i17.i, -1060
  %12 = inttoptr i32 %tmp2_v3.i12.i to i32*
  store i32 1936877894, i32* %12, align 4
  %tmp2_v4.i13.i = add i32 %tmp0_v.i17.i, -1056
  %13 = inttoptr i32 %tmp2_v4.i13.i to i32*
  store i32 116, i32* %13, align 16
  %tmp2_v5.i14.i = add i32 %tmp0_v.i17.i, -1052
  br label %Func_804920C.exit.i

BB_804920E.i:                                     ; preds = %Func_804920C.exit.i
  %tmp2_v.i2.i = add i32 %tmp0_v.i17.i, -1067
  %14 = inttoptr i32 %tmp2_v.i2.i to i32*
  store i32 1868784979, i32* %14, align 4
  %tmp2_v1.i.i = add i32 %tmp0_v.i17.i, -1063
  %15 = inttoptr i32 %tmp2_v1.i.i to i16*
  store i16 25710, i16* %15, align 2
  %tmp2_v2.i3.i = add i32 %tmp0_v.i17.i, -1061
  %16 = inttoptr i32 %tmp2_v2.i3.i to i8*
  store i8 0, i8* %16, align 1
  %tmp2_v4.i.i = add i32 %tmp0_v.i17.i, -1084
  %17 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 %tmp2_v.i2.i, i32* %17, align 4
  %tmp2_v6.i.i = add i32 %tmp0_v.i17.i, -1088
  %18 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 %tmp2_v3.i12.i, i32* %18, align 16
  %tmp2_v7.i.i = add i32 %tmp0_v.i17.i, -1092
  %19 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 134517310, i32* %19, align 4
  %tmp2_v.i10.i.i = add i32 %tmp0_v.i17.i, -1096
  %20 = inttoptr i32 %tmp2_v.i10.i.i to i32*
  store i32 %tmp2_v4.i19.i, i32* %20, align 8
  %tmp2_v1.i13.i.i = add i32 %tmp0_v.i17.i, -1116
  %21 = inttoptr i32 %tmp2_v1.i13.i.i to i32*
  %spi.bis.528 = ptrtoint[4 x i8]* @str.bis.528 to i32
  store i32 %spi.bis.528, i32* %21, align 4
  %tmp2_v.i16.i.i = add i32 %tmp0_v.i17.i, -1104
  %22 = inttoptr i32 %tmp2_v.i16.i.i to i32*
  store i32 0, i32* %22, align 16
  %tmp2_v1.i17.i.i = add i32 %tmp0_v.i17.i, -1100
  %23 = inttoptr i32 %tmp2_v1.i17.i.i to i32*
  store i32 0, i32* %23, align 4
  %24 = load i32, i32* %18, align 16
  %25 = load i32, i32* %22, align 16
  %tmp0_v3.i6.i13.i = add i32 %25, %24
  %26 = inttoptr i32 %tmp0_v3.i6.i13.i to i8*
  %27 = load i8, i8* %26, align 1
  %.not.i8.i14.i = icmp eq i8 %27, 0
  br i1 %.not.i8.i14.i, label %BB_80492D1.i.preheader.i, label %BB_804929F.i.i
...
BB_80492D1.i.preheader.i:                         ; preds = %BB_80492D1.i.preheader.loopexit.i, %BB_804920E.i
  ...
  %29 = phi i32 [ %41, %BB_80492D1.i.preheader.loopexit.i ], [ %24, %BB_804920E.i ]
  %30 = phi i32 [ %.pre.i, %BB_80492D1.i.preheader.loopexit.i ], [ 0, %BB_804920E.i ]
  %31 = load i32, i32* %17, align 4
  %tmp0_v3.i.i16.i = add i32 %31, %30
  %32 = inttoptr i32 %tmp0_v3.i.i16.i to i8*
  %33 = load i8, i8* %32, align 1
  %.not.i.i17.i = icmp eq i8 %33, 0
...
BB_80492B4.i.i.preheader:                         ; preds = %BB_80492D1.i.preheader.i
  ...
  %tmp0_v3.i.i.i15 = add i32 %37, %tmp0_v15.i.i.i14
  %38 = inttoptr i32 %tmp0_v3.i.i.i15 to i8*
  %39 = load i8, i8* %38, align 1
  %.not.i.i.i16 = icmp eq i8 %39, 0
...
BB_804929F.i.i:                                   ; preds = %BB_804929F.i.i, %BB_804920E.i
  %40 = phi i32 [ %tmp0_v1.i.i.i, %BB_804929F.i.i ], [ %25, %BB_804920E.i ]
  %tmp0_v1.i.i.i = add i32 %40, 1
  store i32 %tmp0_v1.i.i.i, i32* %22, align 16
  %41 = load i32, i32* %18, align 16
  %tmp0_v3.i6.i.i = add i32 %41, %tmp0_v1.i.i.i
  %42 = inttoptr i32 %tmp0_v3.i6.i.i to i8*
  %43 = load i8, i8* %42, align 1
  %.not.i8.i.i = icmp eq i8 %43, 0
  br i1 %.not.i8.i.i, label %BB_80492D1.i.preheader.loopexit.i, label %BB_804929F.i.i

BB_80492B4.i.BB_80492B4.i_crit_edge.i:            ; preds = %BB_80492B4.i.BB_80492B4.i_crit_edge.i, %BB_80492B4.i.i.preheader
  %44 = phi i8 [ %50, %BB_80492B4.i.BB_80492B4.i_crit_edge.i ], [ %39, %BB_80492B4.i.i.preheader ]
  ...
  %46 = load i32, i32* %22, align 16
  %tmp0_v12.i.i.i = add i32 %46, 1
  store i32 %tmp0_v12.i.i.i, i32* %22, align 16
  %47 = load i32, i32* %23, align 4
  %tmp0_v15.i.i.i = add i32 %47, 1
  store i32 %tmp0_v15.i.i.i, i32* %23, align 4
  %48 = load i32, i32* %17, align 4
  %tmp0_v3.i.i.i = add i32 %48, %tmp0_v15.i.i.i
...
Func__strcat.exit:                                ; preds = %.exit.loopexit.i, %BB_80492D1.i.preheader.i
  ...
  %tmp0_v3.i23.i.i = add i32 %52, %51
  %53 = inttoptr i32 %tmp0_v3.i23.i.i to i8*
  store i8 0, i8* %53, align 1
  %54 = load i32, i32* %20, align 8
  %tmp2_v.i37.i = add i32 %54, -1052
  store i32 %tmp2_v.i37.i, i32* %17, align 4
  %spi.bis.527 = ptrtoint[12 x i8]* @str.bis.527 to i32
  store i32 %spi.bis.527, i32* %18, align 16
  store i32 134517335, i32* %19, align 4
  %55 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %r_ecx.0.lcssa.i, i32 inreg noundef %52, i32 noundef %tmp2_v6.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void

Func_804920C.exit.i:                              ; preds = %Func_804920C.exit.i, %0
  %r_ecx.011 = phi i32 [ 254, %0 ], [ %tmp4_v3.i.i, %Func_804920C.exit.i ]
  %r_edi.010 = phi i32 [ %tmp2_v5.i14.i, %0 ], [ %tmp4_v.i45.i, %Func_804920C.exit.i ]
