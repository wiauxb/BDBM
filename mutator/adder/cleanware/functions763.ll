...
@str.756 = constant [9 x i8] c"INT: %d\0a\00"
@str.758 = constant [17 x i8] c"Mult output: %d\0a\00"
@str.760 = constant [12 x i8] c"Output: %d\0a\00"
@str.761 = constant [27 x i8] c"Another printf statements!\00"
@str.762 = constant [14 x i8] c"Hello, World!\00"
...
define internal fastcc void @functions763(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v2.i52.i = add i32 %tmp0_v.i23.i, -48
  %8 = inttoptr i32 %tmp2_v2.i52.i to i32*
  %spi762 = ptrtoint[14 x i8]* @str.762 to i32
  store i32 %spi762, i32* %8, align 16
  %tmp2_v3.i53.i = add i32 %tmp0_v.i23.i, -52
  %9 = inttoptr i32 %tmp2_v3.i53.i to i32*
  ...
  %spi761 = ptrtoint[27 x i8]* @str.761 to i32
  store i32 %spi761, i32* %8, align 16
  ...
  %tmp2_v.i45.i = add i32 %tmp0_v.i23.i, -44
  %14 = inttoptr i32 %tmp2_v.i45.i to i32*
  store i32 5, i32* %14, align 4
  store i32 4, i32* %8, align 16
  store i32 134517255, i32* %9, align 4
  %tmp2_v.i1.i.i = add i32 %tmp0_v.i23.i, -56
  %15 = inttoptr i32 %tmp2_v.i1.i.i to i32*
  store i32 %tmp2_v4.i26.i, i32* %15, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i23.i, -76
  ...
  %tmp2_v5.i.i.i = add i32 %tmp0_v.i23.i, -60
  %19 = inttoptr i32 %tmp2_v5.i.i.i to i32*
  store i32 %tmp0_v4.i.i.i, i32* %19, align 4
  %20 = load i32, i32* %15, align 8
  %tmp2_v.i33.i = add i32 %20, -16
  %21 = inttoptr i32 %tmp2_v.i33.i to i32*
  store i32 %tmp0_v4.i.i.i, i32* %21, align 4
  store i32 %tmp0_v4.i.i.i, i32* %14, align 4
  %spi760 = ptrtoint[12 x i8]* @str.760 to i32
  store i32 %spi760, i32* %8, align 16
  store i32 134517279, i32* %9, align 4
  %22 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i22.i, i32 inreg noundef %17, i32 noundef %tmp2_v2.i52.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %23 = lshr i64 %22, 32
  ...
  %tmp2_v.i.i.i = add i32 %tmp0_v.i23.i, -64
...
BB_80492AD.i.lr.ph.i:                             ; preds = %0
  %tmp2_v4.i28.i.i = add i32 %tmp0_v.i23.i, -80
  %28 = inttoptr i32 %tmp2_v4.i28.i.i to i32*
  %tmp2_v5.i.i.i5 = add i32 %tmp0_v.i23.i, -84
  %29 = inttoptr i32 %tmp2_v5.i.i.i5 to i32*
  %tmp2_v.i1.i.i.i = add i32 %tmp0_v.i23.i, -88
  %30 = inttoptr i32 %tmp2_v.i1.i.i.i to i32*
  %tmp2_v1.i.i.i.i = add i32 %tmp0_v.i23.i, -108
  %31 = inttoptr i32 %tmp2_v1.i.i.i.i to i32*
  %tmp2_v5.i.i.i.i = add i32 %tmp0_v.i23.i, -92
...
BB_80492AD.i.i:                                   ; preds = %BB_80492AD.i.i, %BB_80492AD.i.lr.ph.i
  ...
  %tmp2_v.i23.i.i = add i32 %r_ebp.019.i, 12
  ...
  %tmp2_v.i15.i.i = add i32 %39, -8
  %40 = inttoptr i32 %tmp2_v.i15.i.i to i32*
  store i32 %tmp0_v4.i.i.i.i, i32* %40, align 4
  %tmp2_v1.i17.i.i = add i32 %39, -4
  %41 = inttoptr i32 %tmp2_v1.i17.i.i to i32*
  %42 = load i32, i32* %41, align 4
  %tmp0_v3.i.i.i = add i32 %42, 1
  store i32 %tmp0_v3.i.i.i, i32* %41, align 4
  %tmp2_v1.i4.i.i = add i32 %39, 8
  %43 = inttoptr i32 %tmp2_v1.i4.i.i to i32*
  %44 = load i32, i32* %43, align 4
  %45 = icmp slt i32 %tmp0_v3.i.i.i, %44
  br i1 %45, label %BB_80492AD.i.i, label %.exit.loopexit.i

.exit.loopexit.i:                                 ; preds = %BB_80492AD.i.i
  %46 = inttoptr i32 %tmp2_v.i15.i.i to i32*
  %47 = inttoptr i32 %tmp2_v1.i4.i.i to i32*
...
Func_mult.exit:                                   ; preds = %.exit.loopexit.i, %0
  ...
  %tmp2_v1.i4.i.lcssa.i = phi i32 [ %tmp2_v2.i52.i, %0 ], [ %tmp2_v1.i4.i.i, %.exit.loopexit.i ]
  ...
  %tmp2_v4.i.i = add i32 %tmp2_v1.i4.i.lcssa.i, 4
  %51 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 %48, i32* %51, align 4
  %spi758 = ptrtoint[17 x i8]* @str.758 to i32
  store i32 %spi758, i32* %.pre-phi, align 4
  %tmp2_v7.i.i = add i32 %tmp2_v1.i4.i.lcssa.i, -4
  %52 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 134517318, i32* %52, align 4
  %53 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i22.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v1.i4.i.lcssa.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  store i32 5, i32* %.pre-phi, align 4
  store i32 134517331, i32* %52, align 4
  %tmp2_v.i.i.i13 = add i32 %tmp2_v1.i4.i.lcssa.i, -8
  %54 = inttoptr i32 %tmp2_v.i.i.i13 to i32*
  store i32 %49, i32* %54, align 4
  %tmp2_v1.i.i.i14 = add i32 %tmp2_v1.i4.i.lcssa.i, -12
  %55 = inttoptr i32 %tmp2_v1.i.i.i14 to i32*
  store i32 134529024, i32* %55, align 4
  %tmp2_v2.i.i.i15 = add i32 %tmp2_v1.i4.i.lcssa.i, -20
  %56 = inttoptr i32 %tmp2_v2.i.i.i15 to i32*
  store i32 134517471, i32* %56, align 4
  %57 = load i32, i32* %.pre-phi, align 4
  %tmp2_v3.i.i.i = add i32 %tmp2_v1.i4.i.lcssa.i, -28
  %58 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  store i32 %57, i32* %58, align 4
  %tmp2_v5.i.i.i16 = add i32 %tmp2_v1.i4.i.lcssa.i, -32
  %59 = inttoptr i32 %tmp2_v5.i.i.i16 to i32*
  %spi756 = ptrtoint[9 x i8]* @str.756 to i32
  store i32 %spi756, i32* %59, align 4
  %tmp2_v6.i.i.i = add i32 %tmp2_v1.i4.i.lcssa.i, -36
  %60 = inttoptr i32 %tmp2_v6.i.i.i to i32*
  store i32 134517496, i32* %60, align 4
  %61 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i22.i, i32 inreg noundef 134520910, i32 noundef %tmp2_v5.i.i.i16, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @functions763(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
