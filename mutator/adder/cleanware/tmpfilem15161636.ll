...
define internal fastcc void @tmpfilem15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v.i24.i = add i32 %tmp0_v.i3.i, -64
...
BB_804939F.i:                                     ; preds = %BB_804930E.i, %BB_804939F.i
  ...
  store i32 134520865, i32* %8, align 16
  store i32 134517696, i32* %9, align 4
  %16 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %tmp4_v.i.i, i32 noundef %tmp2_v.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %17 = load i32, i32* %38, align 16
  %tmp0_v2.i87.i = add i32 %17, 1
  store i32 %tmp0_v2.i87.i, i32* %38, align 16
  %18 = icmp slt i32 %tmp0_v2.i87.i, 10
  br i1 %18, label %BB_804939F.i, label %.exit

BB_80492F0.i:                                     ; preds = %BB_80492F0.i, %0
  %storemerge27 = phi i32 [ 0, %0 ], [ %tmp0_v8.i.i, %BB_80492F0.i ]
  %tmp4_v.i67.i = shl i32 %storemerge27, 2
  %19 = load i32, i32* %11, align 4
  %tmp0_v3.i70.i = add i32 %19, %tmp4_v.i67.i
  %20 = inttoptr i32 %tmp0_v3.i70.i to i32*
...
BB_804930E.i:                                     ; preds = %BB_80492F0.i
  ...
  %tmp2_v.i102.i = add i32 %tmp0_v.i3.i, -24
  %24 = inttoptr i32 %tmp2_v.i102.i to i32*
  store i32 %23, i32* %24, align 8
  store i32 %23, i32* %7, align 4
  %tmp2_v2.i42.i = add i32 %tmp0_v.i3.i, -56
  %25 = inttoptr i32 %tmp2_v2.i42.i to i32*
  store i32 10, i32* %25, align 8
  %tmp2_v3.i43.i = add i32 %tmp0_v.i3.i, -60
  %26 = inttoptr i32 %tmp2_v3.i43.i to i32*
  ...
  %tmp2_v.i95.i = add i32 %tmp0_v.i3.i, -20
  ...
  %tmp2_v.i81.i = add i32 %tmp0_v.i3.i, -32
  %38 = inttoptr i32 %tmp2_v.i81.i to i32*
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @tmpfilem15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
