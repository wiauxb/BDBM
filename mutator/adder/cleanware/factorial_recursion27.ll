...
@str.bis.25 = constant [20 x i8] c"\66\61\63\74\6f\72\69\61\6c\28\25\64\29\20\3d\20\25\64\0a\00"
...
BB_80491C0.i.preheader:
  ...
  %tmp2_v.i10.i = add i32 %tmp0_v.i22.i, -20
  %7 = inttoptr i32 %tmp2_v.i10.i to i32*
  store i32 1, i32* %7, align 4
  %tmp4_v.i.i.i = add i32 %tmp0_v.i22.i, -32
...
BB_80491C0.i:                                     ; preds = %BB_80491C0.i, %BB_80491C0.i.preheader
  ...
  %r_ebp.06 = phi i32 [ %14, %BB_80491C0.i ], [ %tmp2_v4.i24.i, %BB_80491C0.i.preheader ]
  ...
  %11 = tail call fastcc { i32, i32, i32 } @Func_factorial(i32 %tmp2_v3.i.i, i32 %r_ebp.06)
  %12 = extractvalue { i32, i32, i32 } %11, 0
  %13 = extractvalue { i32, i32, i32 } %11, 1
  %14 = extractvalue { i32, i32, i32 } %11, 2
  %tmp2_v.i14.i = add i32 %12, 8
  %15 = inttoptr i32 %tmp2_v.i14.i to i32*
  store i32 %13, i32* %15, align 4
  %tmp2_v2.i16.i = add i32 %14, -12
  %16 = inttoptr i32 %tmp2_v2.i16.i to i32*
  %17 = load i32, i32* %16, align 4
  %tmp2_v4.i18.i = add i32 %12, 4
  %18 = inttoptr i32 %tmp2_v4.i18.i to i32*
  store i32 %17, i32* %18, align 4
  %19 = inttoptr i32 %12 to i32*
  %spi.bis.25 = ptrtoint[20 x i8]* @str.bis.25 to i32
  ...
  %21 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i21.i, i32 inreg noundef %r_edx.05, i32 noundef %12, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %22 = lshr i64 %21, 32
...
BB_804921E.i:                                     ; preds = %Func_804920C.exit.i
  ...
  %6 = tail call fastcc { i32, i32, i32 } @Func_factorial(i32 %tmp2_v4.i.i, i32 %tmp2_v.i12.i)
  %7 = extractvalue { i32, i32, i32 } %6, 1
  %8 = extractvalue { i32, i32, i32 } %6, 2
  %tmp2_v.i8.i = add i32 %8, 8
  %9 = inttoptr i32 %tmp2_v.i8.i to i32*
...
.exit:                                            ; preds = %BB_804921E.i, %Func_804920C.exit.i..exit_crit_edge
  %tmp4_v2.i.i.pre-phi = phi i32 [ %.pre14, %Func_804920C.exit.i..exit_crit_edge ], [ %tmp2_v.i8.i, %BB_804921E.i ]
