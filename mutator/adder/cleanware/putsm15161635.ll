...
define internal fastcc void @putsm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_804925F.exit.i:
  ...
  %tmp2_v5.i34.i = add i32 %tmp0_v.i7.i, -64
  %10 = inttoptr i32 %tmp2_v5.i34.i to i32*
  store i32 134520840, i32* %10, align 16
  %tmp2_v6.i35.i = add i32 %tmp0_v.i7.i, -68
  %11 = inttoptr i32 %tmp2_v6.i35.i to i32*
  ...
  store i32 134520861, i32* %10, align 16
  ...
  %tmp2_v1.i41.i = add i32 %tmp0_v.i7.i, -48
  %16 = inttoptr i32 %tmp2_v1.i41.i to i32*
  ...
  %tmp2_v.i48.i = add i32 %tmp0_v.i7.i, -41
  %19 = inttoptr i32 %tmp2_v.i48.i to i32*
  store i32 1769108563, i32* %19, align 4
  %tmp2_v1.i49.i = add i32 %tmp0_v.i7.i, -37
  %20 = inttoptr i32 %tmp2_v1.i49.i to i32*
  store i32 1763731310, i32* %20, align 4
  %tmp2_v2.i50.i = add i32 %tmp0_v.i7.i, -33
  %21 = inttoptr i32 %tmp2_v2.i50.i to i32*
  store i32 1751326830, i32* %21, align 4
  %tmp2_v3.i51.i = add i32 %tmp0_v.i7.i, -29
  %22 = inttoptr i32 %tmp2_v3.i51.i to i32*
  store i32 1629516385, i32* %22, align 4
  %tmp2_v4.i52.i = add i32 %tmp0_v.i7.i, -25
  %23 = inttoptr i32 %tmp2_v4.i52.i to i32*
  store i32 2036429426, i32* %23, align 4
  %tmp2_v5.i53.i = add i32 %tmp0_v.i7.i, -21
  %24 = inttoptr i32 %tmp2_v5.i53.i to i8*
  store i8 0, i8* %24, align 1
  store i32 %tmp2_v.i48.i, i32* %10, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @putsm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
