...
.exit:
  ...
  %tmp2_v3.i22.i = add i32 %tmp0_v.i3.i, -49
  %10 = inttoptr i32 %tmp2_v3.i22.i to i32*
  store i32 1936287828, i32* %10, align 4
  %tmp2_v4.i23.i = add i32 %tmp0_v.i3.i, -45
  %11 = inttoptr i32 %tmp2_v4.i23.i to i32*
  store i32 745761056, i32* %11, align 4
  %tmp2_v5.i24.i = add i32 %tmp0_v.i3.i, -41
  %12 = inttoptr i32 %tmp2_v5.i24.i to i32*
  store i32 1701344288, i32* %12, align 4
  %tmp2_v6.i25.i = add i32 %tmp0_v.i3.i, -37
  %13 = inttoptr i32 %tmp2_v6.i25.i to i32*
  store i32 2036430624, i32* %13, align 4
  %tmp2_v7.i26.i = add i32 %tmp0_v.i3.i, -33
  %14 = inttoptr i32 %tmp2_v7.i26.i to i32*
  store i32 1849761838, i32* %14, align 4
  %tmp2_v8.i27.i = add i32 %tmp0_v.i3.i, -29
  %15 = inttoptr i32 %tmp2_v8.i27.i to i32*
  store i32 1701344367, i32* %15, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i3.i, -25
  %16 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 774778482, i32* %16, align 4
  %tmp2_v10.i.i = add i32 %tmp0_v.i3.i, -21
  %17 = inttoptr i32 %tmp2_v10.i.i to i8*
  store i8 0, i8* %17, align 1
  %tmp2_v13.i.i = add i32 %tmp0_v.i3.i, -80
  %18 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 %tmp2_v3.i22.i, i32* %18, align 16
  %tmp2_v14.i.i = add i32 %tmp0_v.i3.i, -84
  %19 = inttoptr i32 %tmp2_v14.i.i to i32*
  store i32 134517347, i32* %19, align 4
  %tmp2_v.i115.i.i = add i32 %tmp0_v.i3.i, -88
  %20 = inttoptr i32 %tmp2_v.i115.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %20, align 8
  %tmp2_v1.i117.i.i = add i32 %tmp0_v.i3.i, -92
  %21 = inttoptr i32 %tmp2_v1.i117.i.i to i32*
  store i32 134529024, i32* %21, align 4
  %tmp2_v2.i120.i.i = add i32 %tmp0_v.i3.i, -148
  %22 = inttoptr i32 %tmp2_v2.i120.i.i to i32*
  store i32 134517422, i32* %22, align 4
  %23 = load i32, i32* %18, align 16
  %tmp2_v2.i76.i.i = add i32 %tmp0_v.i3.i, -132
  %24 = inttoptr i32 %tmp2_v2.i76.i.i to i32*
  store i32 %23, i32* %24, align 4
  %tmp4_v.i77.i.b.i = load i1, i1* @segs.0, align 1
  %25 = inttoptr i32 %arg_esp to i32*
  %26 = load i32, i32* %25, align 4
  %tmp2_v5.i80.i.i = add i32 %tmp0_v.i3.i, -100
  %27 = inttoptr i32 %tmp2_v5.i80.i.i to i32*
  store i32 %26, i32* %27, align 4
  %28 = load i32, i32* %24, align 4
  %tmp2_v9.i84.i.i = add i32 %tmp0_v.i3.i, -160
  %29 = inttoptr i32 %tmp2_v9.i84.i.i to i32*
  store i32 %28, i32* %29, align 16
  %tmp2_v10.i85.i.i = add i32 %tmp0_v.i3.i, -164
  %30 = inttoptr i32 %tmp2_v10.i85.i.i to i32*
  ...
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i3.i, -120
  %33 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 0, i32* %33, align 8
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i3.i, -107
  %34 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  store i32 992751136, i32* %34, align 4
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i3.i, -103
  %35 = inttoptr i32 %tmp2_v3.i.i.i to i16*
  store i16 2314, i16* %35, align 2
  %tmp2_v4.i.i.i = add i32 %tmp0_v.i3.i, -101
  %36 = inttoptr i32 %tmp2_v4.i.i.i to i8*
...
BB_804931D.i.preheader.lr.ph.i:                   ; preds = %.exit
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i3.i, -156
...
BB_8049350.i.i:                                   ; preds = %BB_804932E.i.i
  ...
  %41 = load i32, i32* %32, align 16
  %42 = icmp slt i32 %tmp0_v1.i.i.i, %41
  br i1 %42, label %BB_804932E.i.i, label %BB_804935F.i.i

BB_8049319.i.i:                                   ; preds = %BB_804931D.i.preheader.i, %BB_8049319.i.i
  %43 = load i32, i32* %37, align 4
  %tmp0_v1.i41.i.i = add i32 %43, 1
  store i32 %tmp0_v1.i41.i.i, i32* %37, align 4
  %44 = load i32, i32* %24, align 4
  %tmp0_v3.i53.i.i = add i32 %44, %tmp0_v1.i41.i.i
  %45 = inttoptr i32 %tmp0_v3.i53.i.i to i8*
  %46 = load i8, i8* %45, align 1
  %tmp0_v5.i.i.i = sext i8 %46 to i32
  store i32 %tmp0_v5.i.i.i, i32* %40, align 4
  store i32 %tmp2_v2.i.i.i, i32* %29, align 16
  store i32 134517522, i32* %30, align 4
  %arg.i.i5.i = load i32, i32* %29, align 16
  %arg2.i.i.i = load i32, i32* %40, align 4
  %47 = tail call i32 @strchr(i32 %arg.i.i5.i, i32 %arg2.i.i.i)
...
BB_804931D.i.preheader.i:                         ; preds = %BB_804935F.i.i, %BB_804931D.i.preheader.lr.ph.i
  %48 = phi i32 [ 0, %BB_804931D.i.preheader.lr.ph.i ], [ %tmp0_v1.i107.i.i, %BB_804935F.i.i ]
  %49 = load i32, i32* %24, align 4
  %tmp0_v3.i53.i12.i = add i32 %49, %48
  %50 = inttoptr i32 %tmp0_v3.i53.i12.i to i8*
  %51 = load i8, i8* %50, align 1
  %tmp0_v5.i.i13.i = sext i8 %51 to i32
  ...
  %.not.i.i16.i = icmp eq i32 %52, 0
  br i1 %.not.i.i16.i, label %BB_8049319.i.i, label %BB_8049327.i.i

BB_804932E.i.i:                                   ; preds = %BB_8049327.i.i, %BB_8049350.i.i
  %53 = phi i32 [ %tmp0_v1.i.i.i, %BB_8049350.i.i ], [ %60, %BB_8049327.i.i ]
  %54 = load i32, i32* %24, align 4
  %tmp0_v3.i91.i.i = add i32 %54, %53
  %55 = inttoptr i32 %tmp0_v3.i91.i.i to i8*
  %56 = load i8, i8* %55, align 1
  %tmp0_v5.i93.i.i = sext i8 %56 to i32
  store i32 %tmp0_v5.i93.i.i, i32* %40, align 4
  store i32 %tmp2_v2.i.i.i, i32* %29, align 16
  store i32 134517577, i32* %30, align 4
  %arg.i.i8.i = load i32, i32* %29, align 16
  %arg2.i.i9.i = load i32, i32* %40, align 4
  %57 = tail call i32 @strchr(i32 %arg.i.i8.i, i32 %arg2.i.i9.i)
  %58 = icmp eq i32 %57, 0
  %.pre.pre.i = load i32, i32* %37, align 4
  br i1 %58, label %BB_804935F.i.i, label %BB_8049350.i.i

BB_8049327.i.i:                                   ; preds = %BB_804931D.i.preheader.i, %BB_8049319.i.i
  %.lcssa.i = phi i32 [ %48, %BB_804931D.i.preheader.i ], [ %tmp0_v1.i41.i.i, %BB_8049319.i.i ]
  %59 = load i32, i32* %33, align 8
  %tmp0_v1.i103.i.i = add i32 %59, 1
  store i32 %tmp0_v1.i103.i.i, i32* %33, align 8
  %60 = load i32, i32* %37, align 4
  %61 = load i32, i32* %32, align 16
  %62 = icmp slt i32 %60, %61
  br i1 %62, label %BB_804932E.i.i, label %BB_804935F.i.i

BB_804935F.i.i:                                   ; preds = %BB_8049327.i.i, %BB_804932E.i.i, %BB_8049350.i.i
  %63 = phi i32 [ %60, %BB_8049327.i.i ], [ %tmp0_v1.i.i.i, %BB_8049350.i.i ], [ %.pre.pre.i, %BB_804932E.i.i ]
  %r_edx.2.i = phi i32 [ %.lcssa.i, %BB_8049327.i.i ], [ %53, %BB_804932E.i.i ], [ %53, %BB_8049350.i.i ]
  %tmp0_v1.i107.i.i = add i32 %63, 1
  store i32 %tmp0_v1.i107.i.i, i32* %37, align 4
  %64 = load i32, i32* %32, align 16
  %65 = icmp slt i32 %tmp0_v1.i107.i.i, %64
...
Func_word_count.exit:                             ; preds = %BB_804935F.i.i, %.exit
  ...
  %tmp4_v.i60.i.b.i = load i1, i1* @segs.0, align 1
  %68 = inttoptr i32 %arg_esp to i32*
  %69 = load i32, i32* %68, align 4
  %tmp0_v4.i63.i.i = xor i32 %69, %67
  %70 = load i32, i32* %21, align 4
  %71 = load i32, i32* %20, align 8
  %tmp2_v.i8.i = add i32 %71, -48
  %72 = inttoptr i32 %tmp2_v.i8.i to i32*
  store i32 %66, i32* %72, align 4
  %tmp2_v4.i12.i = add i32 %tmp0_v.i3.i, -76
  %73 = inttoptr i32 %tmp2_v4.i12.i to i32*
  store i32 %66, i32* %73, align 4
  %tmp2_v5.i14.i = add i32 %70, -8184
  store i32 %tmp2_v5.i14.i, i32* %18, align 16
  store i32 134517371, i32* %19, align 4
  %74 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v4.i63.i.i, i32 inreg noundef %r_edx.1.lcssa.i, i32 noundef %tmp2_v13.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
