...
@str.826 = constant [2 x i8] c"\0a\00"
@str.827 = constant [4 x i8] c"%d \00"
...
Func_80492CA.exit.i:
  ...
  %tmp2_v.i18.i = add i32 %arg_esp, 8
  %2 = inttoptr i32 %tmp2_v.i18.i to i32*
  %3 = load i32, i32* %2, align 4
  %.not.i20.i = icmp eq i32 %3, 0
  br i1 %.not.i20.i, label %.exit, label %Func_80492DF.exit.i

BB_804931D.i:                                     ; preds = %Func_80492DF.exit.i
  %4 = load i32, i32* %.pre28, align 4
  ...
  %.not.i.i = icmp slt i32 %6, %10
  br i1 %.not.i.i, label %BB_804932B.i, label %BB_804935D.i

BB_804932B.i:                                     ; preds = %Func_80492DF.exit.i.BB_804932B.i_crit_edge, %BB_804931D.i
  %.pre-phi31 = phi i32* [ %.pre30, %Func_80492DF.exit.i.BB_804932B.i_crit_edge ], [ %7, %BB_804931D.i ]
  %11 = load i32, i32* %.pre28, align 4
  %12 = inttoptr i32 %11 to i32*
  %13 = load i32, i32* %12, align 4
  %tmp2_v2.i13.i = add i32 %arg_esp, 20
  %14 = inttoptr i32 %tmp2_v2.i13.i to i32*
  %15 = load i32, i32* %14, align 4
  %16 = inttoptr i32 %15 to i32*
  store i32 %13, i32* %16, align 4
  %17 = load i32, i32* %14, align 4
  %tmp2_v6.i.i = add i32 %17, 4
  %18 = load i32, i32* %2, align 4
  %tmp2_v9.i.i = add i32 %18, -1
  %19 = load i32, i32* %.pre28, align 4
  %tmp0_v12.i.i = add i32 %19, 4
  %tmp2_v14.i.i = add i32 %arg_esp, -28
  %20 = inttoptr i32 %tmp2_v14.i.i to i32*
  store i32 %tmp2_v6.i.i, i32* %20, align 4
  %21 = load i32, i32* %32, align 4
  %tmp2_v17.i.i = add i32 %arg_esp, -32
  %22 = inttoptr i32 %tmp2_v17.i.i to i32*
  store i32 %21, i32* %22, align 4
  %23 = load i32, i32* %.pre-phi31, align 4
  ...
  store i32 %tmp2_v9.i.i, i32* %25, align 4
  %tmp2_v22.i.i = add i32 %arg_esp, -44
  %26 = inttoptr i32 %tmp2_v22.i.i to i32*
  store i32 %tmp0_v12.i.i, i32* %26, align 4
  %tmp2_v23.i.i = add i32 %arg_esp, -48
  %27 = inttoptr i32 %tmp2_v23.i.i to i32*
  store i32 134517592, i32* %27, align 4
  %28 = tail call fastcc { i32, i32, i32, i32 } @Func_merge(i32 %tmp2_v23.i.i, i32 %tmp2_v9.i.i, i32 %tmp2_v.i3.i, i32 %tmp2_v6.i.i)
...
Func_80492DF.exit.i:                              ; preds = %Func_80492CA.exit.i
  %tmp2_v.i51.i = add i32 %arg_esp, 16
  %32 = inttoptr i32 %tmp2_v.i51.i to i32*
  %33 = load i32, i32* %32, align 4
  %34 = icmp eq i32 %33, 0
  %.pre = add i32 %arg_esp, 4
  %.pre28 = inttoptr i32 %.pre to i32*
  br i1 %34, label %Func_80492DF.exit.i.BB_804932B.i_crit_edge, label %BB_804931D.i
...
BB_804935D.i:                                     ; preds = %BB_804931D.i
  ...
  %35 = inttoptr i32 %tmp2_v2.i31.i to i32*
  %36 = load i32, i32* %35, align 4
  %37 = inttoptr i32 %36 to i32*
  store i32 %10, i32* %37, align 4
  %38 = load i32, i32* %35, align 4
  %tmp2_v6.i35.i = add i32 %38, 4
  %39 = load i32, i32* %32, align 4
  %tmp2_v9.i38.i = add i32 %39, -1
  %40 = load i32, i32* %7, align 4
  %tmp0_v12.i41.i = add i32 %40, 4
  %tmp2_v14.i44.i = add i32 %arg_esp, -28
  %41 = inttoptr i32 %tmp2_v14.i44.i to i32*
  store i32 %tmp2_v6.i35.i, i32* %41, align 4
  %tmp2_v15.i45.i = add i32 %arg_esp, -32
  %42 = inttoptr i32 %tmp2_v15.i45.i to i32*
  store i32 %tmp2_v9.i38.i, i32* %42, align 4
  %tmp2_v16.i.i = add i32 %arg_esp, -36
  %43 = inttoptr i32 %tmp2_v16.i.i to i32*
  store i32 %tmp0_v12.i41.i, i32* %43, align 4
  %44 = load i32, i32* %2, align 4
  %tmp2_v19.i.i = add i32 %arg_esp, -40
  %45 = inttoptr i32 %tmp2_v19.i.i to i32*
  store i32 %44, i32* %45, align 4
  %46 = load i32, i32* %.pre28, align 4
  %tmp2_v22.i48.i = add i32 %arg_esp, -44
  %47 = inttoptr i32 %tmp2_v22.i48.i to i32*
  store i32 %46, i32* %47, align 4
  %tmp2_v23.i49.i = add i32 %arg_esp, -48
  %48 = inttoptr i32 %tmp2_v23.i49.i to i32*
  store i32 134517642, i32* %48, align 4
  %49 = tail call fastcc { i32, i32, i32, i32 } @Func_merge(i32 %tmp2_v23.i49.i, i32 %tmp2_v9.i38.i, i32 %tmp2_v.i3.i, i32 %tmp2_v6.i35.i)
...
.exit:                                            ; preds = %BB_804935D.i, %BB_804932B.i, %Func_80492CA.exit.i
  %r_ecx.0 = phi i32 [ %31, %BB_804932B.i ], [ %52, %BB_804935D.i ], [ %arg_ecx, %Func_80492CA.exit.i ]
  %r_ebp.0 = phi i32 [ %30, %BB_804932B.i ], [ %51, %BB_804935D.i ], [ %tmp2_v.i3.i, %Func_80492CA.exit.i ]
  %r_edx.0 = phi i32 [ %29, %BB_804932B.i ], [ %50, %BB_804935D.i ], [ %arg_edx, %Func_80492CA.exit.i ]
...
define internal fastcc void @merge_sorted_arrays_recursively829(i32 %arg_esp) unnamed_addr  norecurse  !retregs !13 {
  ...
  %tmp2_v4.i6.i = add i32 %tmp0_v.i21.i, -72
  %12 = inttoptr i32 %tmp2_v4.i6.i to i32*
  ...
  %tmp2_v.i32.i = add i32 %29, -88
  %31 = inttoptr i32 %tmp2_v.i32.i to i32*
  %tmp2_v1.i.i = add i32 %29, -48
  %tmp2_v5.i14.i = add i32 %27, 20
  %32 = inttoptr i32 %tmp2_v5.i14.i to i32*
  %tmp2_v7.i17.i = add i32 %27, 16
  %33 = inttoptr i32 %tmp2_v7.i17.i to i32*
  %tmp2_v8.i18.i = add i32 %27, 12
  %34 = inttoptr i32 %tmp2_v8.i18.i to i32*
...
BB_8049265.i:                                     ; preds = %BB_8049265.i, %0
  ...
  %tmp2_v2.i11.i = add i32 %tmp2_v1.i.i, %tmp4_v.i10.i
  %35 = inttoptr i32 %tmp2_v2.i11.i to i32*
  %36 = load i32, i32* %35, align 4
  store i32 %36, i32* %32, align 4
  %spi827 = ptrtoint[4 x i8]* @str.827 to i32
  store i32 %spi827, i32* %33, align 4
  store i32 134517372, i32* %34, align 4
  %37 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %30, i32 inreg noundef %r_edx.04, i32 noundef %tmp2_v7.i17.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  %38 = lshr i64 %37, 32
  %39 = trunc i64 %38 to i32
  %40 = load i32, i32* %31, align 4
  %tmp0_v2.i56.i = add i32 %40, 1
  store i32 %tmp0_v2.i56.i, i32* %31, align 4
  %41 = icmp slt i32 %tmp0_v2.i56.i, 9
  br i1 %41, label %BB_8049265.i, label %BB_8049289.i

BB_8049289.i:                                     ; preds = %BB_8049265.i
  %spi826 = ptrtoint[2 x i8]* @str.826 to i32
  store i32 %spi826, i32* %33, align 4
