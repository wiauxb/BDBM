...
@str.109 = constant [20 x i8] c"second highest: %d\0a\00"
...
define internal fastcc void @second_highest110(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v3.i.i = add i32 %tmp0_v.i20.i, -60
  %10 = inttoptr i32 %tmp2_v3.i.i to i32*
  store i32 0, i32* %10, align 4
  %tmp2_v4.i14.i = add i32 %tmp0_v.i20.i, -56
  %11 = inttoptr i32 %tmp2_v4.i14.i to i32*
  store i32 1, i32* %11, align 8
  %tmp2_v5.i15.i = add i32 %tmp0_v.i20.i, -52
  %12 = inttoptr i32 %tmp2_v5.i15.i to i32*
  store i32 2, i32* %12, align 4
  %tmp2_v6.i.i = add i32 %tmp0_v.i20.i, -48
  %13 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 3, i32* %13, align 16
  %tmp2_v7.i16.i = add i32 %tmp0_v.i20.i, -44
  %14 = inttoptr i32 %tmp2_v7.i16.i to i32*
  store i32 4, i32* %14, align 4
  %tmp2_v8.i.i = add i32 %tmp0_v.i20.i, -40
  ...
  %tmp2_v16.i.i = add i32 %tmp0_v.i20.i, -80
  %21 = inttoptr i32 %tmp2_v16.i.i to i32*
  store i32 %tmp2_v3.i.i, i32* %21, align 16
  %tmp2_v17.i.i = add i32 %tmp0_v.i20.i, -84
  %22 = inttoptr i32 %tmp2_v17.i.i to i32*
  store i32 134517302, i32* %22, align 4
  %tmp2_v.i1.i.i = add i32 %tmp0_v.i20.i, -88
  %23 = inttoptr i32 %tmp2_v.i1.i.i to i32*
  store i32 %tmp2_v4.i22.i, i32* %23, align 8
  %tmp2_v1.i4.i.i = add i32 %tmp0_v.i20.i, -108
  ...
  %tmp2_v1.i14.i.i = add i32 %25, 4
  %28 = inttoptr i32 %tmp2_v1.i14.i.i to i32*
  %29 = load i32, i32* %28, align 4
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i20.i, -100
  %30 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  store i32 %29, i32* %30, align 4
  %31 = load i32, i32* %21, align 16
  %32 = inttoptr i32 %31 to i32*
  %33 = load i32, i32* %32, align 4
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i20.i, -96
  %34 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  store i32 %33, i32* %34, align 16
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i20.i, -92
...
Func_80492C3.exit.i.i:                            ; preds = %Func_80492C3.exit.i.i, %.exit
  ...
  %tmp4_v.i43.i.i = shl i32 %39, 2
  %40 = load i32, i32* %21, align 16
  %tmp0_v6.i46.i.i = add i32 %40, %tmp4_v.i43.i.i
  %41 = inttoptr i32 %tmp0_v6.i46.i.i to i32*
...
Func_second_highest.exit:                         ; preds = %Func_80492C3.exit.i.i, %.exit
  %r_edx.0.lcssa.i = phi i32 [ %27, %.exit ], [ %tmp4_v.i43.i.i, %Func_80492C3.exit.i.i ]
  %46 = load i32, i32* %34, align 16
  %47 = load i32, i32* %23, align 8
  %tmp2_v.i.i = add i32 %47, -56
  %48 = inttoptr i32 %tmp2_v.i.i to i32*
  store i32 %46, i32* %48, align 4
  store i32 %46, i32* %20, align 4
  %spi109 = ptrtoint[20 x i8]* @str.109 to i32
  store i32 %spi109, i32* %21, align 16
  store i32 134517326, i32* %22, align 4
  %49 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i19.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v16.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @second_highest110(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
