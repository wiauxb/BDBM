...
@str.205 = constant [9 x i8] c"max: %d\0a\00"
...
define internal fastcc { i32, i32, i32, i32 } @Func_max(i32 %arg_esp, i32 %arg_ebp) unnamed_addr  nofree nosync nounwind  !retregs !12 {
Func_8049283.exit.i:
  %tmp2_v.i30.i = add i32 %arg_esp, -4
  %0 = inttoptr i32 %tmp2_v.i30.i to i32*
  store i32 %arg_ebp, i32* %0, align 4
  %tmp2_v1.i33.i = add i32 %arg_esp, -32
  %1 = inttoptr i32 %tmp2_v1.i33.i to i32*
  store i32 134517379, i32* %1, align 4
  %tmp2_v.i37.i = add i32 %arg_esp, 8
  %2 = inttoptr i32 %tmp2_v.i37.i to i32*
  %3 = load i32, i32* %2, align 4
  %.not.i40.i = icmp eq i32 %3, 1
  br i1 %.not.i40.i, label %BB_804928E.i, label %BB_80492A6.i
...
BB_80492A6.i:                                     ; preds = %Func_8049283.exit.i
  ...
  store i32 %tmp0_v1.i14.i, i32* %7, align 4
  %tmp2_v4.i17.i = add i32 %arg_esp, 4
  %8 = inttoptr i32 %tmp2_v4.i17.i to i32*
  ...
  %12 = tail call fastcc { i32, i32, i32, i32 } @Func_max(i32 %tmp2_v7.i.i, i32 %tmp2_v.i30.i)
  ...
  %tmp0_v3.i8.i = shl i32 %17, 2
  %tmp4_v.i9.i = add i32 %tmp0_v3.i8.i, -4
  %tmp2_v4.i.i = add i32 %14, 8
  %18 = inttoptr i32 %tmp2_v4.i.i to i32*
  %19 = load i32, i32* %18, align 4
  %tmp0_v6.i.i = add i32 %tmp4_v.i9.i, %19
  %20 = inttoptr i32 %tmp0_v6.i.i to i32*
  %21 = load i32, i32* %20, align 4
  %.not.i.i = icmp sgt i32 %13, %21
  %spec.select = select i1 %.not.i.i, i32* %15, i32* %20
...
.exit:                                            ; preds = %BB_80492A6.i, %BB_804928E.i
  ...
  %r_edx.0 = phi i32 [ %tmp4_v.i9.i, %BB_80492A6.i ], [ 0, %BB_804928E.i ]
...
define internal fastcc void @find_array_max_recursive207(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !13 {
.exit:
  ...
  %24 = tail call fastcc { i32, i32, i32, i32 } @Func_max(i32 %tmp2_v20.i.i, i32 %tmp2_v4.i16.i)
  %25 = extractvalue { i32, i32, i32, i32 } %24, 0
  %26 = extractvalue { i32, i32, i32, i32 } %24, 1
  %27 = extractvalue { i32, i32, i32, i32 } %24, 2
  %tmp2_v.i3.i = add i32 %25, 4
  %28 = inttoptr i32 %tmp2_v.i3.i to i32*
  store i32 %26, i32* %28, align 4
  %29 = inttoptr i32 %25 to i32*
  %spi205 = ptrtoint[9 x i8]* @str.205 to i32
  store i32 %spi205, i32* %29, align 4
  %tmp2_v4.i4.i = add i32 %25, -4
  %30 = inttoptr i32 %tmp2_v4.i4.i to i32*
