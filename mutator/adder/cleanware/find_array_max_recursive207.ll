...
@str.bis.205 = constant [9 x i8] c"\6d\61\78\3a\20\25\64\0a\00"
...
.exit:
  ...
  %spi.bis.205 = ptrtoint[9 x i8]* @str.bis.205 to i32
  ...
  %31 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i7.i, i32 inreg noundef %27, i32 noundef %25, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  ret void
}
