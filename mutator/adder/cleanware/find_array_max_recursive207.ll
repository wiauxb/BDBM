...
define internal fastcc void @find_array_max_recursive207(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v19.i.i = add i32 %tmp0_v.i2.i, -80
  %22 = inttoptr i32 %tmp2_v19.i.i to i32*
  store i32 %tmp2_v3.i18.i, i32* %22, align 16
  %tmp2_v20.i.i = add i32 %tmp0_v.i2.i, -84
  %23 = inttoptr i32 %tmp2_v20.i.i to i32*
  store i32 134517310, i32* %23, align 4
  %24 = tail call fastcc { i32, i32, i32, i32 } @Func_max(i32 %tmp2_v20.i.i, i32 %tmp2_v4.i3.i)
  %25 = extractvalue { i32, i32, i32, i32 } %24, 0
  %26 = extractvalue { i32, i32, i32, i32 } %24, 1
  %27 = extractvalue { i32, i32, i32, i32 } %24, 2
  %tmp2_v.i8.i = add i32 %25, 4
  %28 = inttoptr i32 %tmp2_v.i8.i to i32*
  store i32 %26, i32* %28, align 4
  %29 = inttoptr i32 %25 to i32*
  %spi.bis.205 = ptrtoint[9 x i8]* @str.205 to i32
  store i32 %spi.bis.205, i32* %29, align 4
  %tmp2_v4.i10.i = add i32 %25, -4
  %30 = inttoptr i32 %tmp2_v4.i10.i to i32*
  store i32 134517329, i32* %30, align 4
  %31 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i1.i, i32 inreg noundef %27, i32 noundef %25, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}

; Function Attrs: nofree nosync nounwind
define internal fastcc { i32, i32, i32, i32 } @Func_max(i32 %arg_esp, i32 %arg_ebp) unnamed_addr  nofree nosync nounwind  !retregs !14 {
Func_8049283.exit.i:
  %tmp2_v.i21.i = add i32 %arg_esp, -4
  %0 = inttoptr i32 %tmp2_v.i21.i to i32*
  store i32 %arg_ebp, i32* %0, align 4
  %tmp2_v1.i24.i = add i32 %arg_esp, -32
  ...
  %.not.i18.i = icmp eq i32 %3, 1
  br i1 %.not.i18.i, label %BB_804928E.i, label %BB_80492A6.i
...
BB_80492A6.i:                                     ; preds = %Func_8049283.exit.i
  ...
  %tmp2_v4.i10.i = add i32 %arg_esp, 4
  %5 = inttoptr i32 %tmp2_v4.i10.i to i32*
  ...
  %9 = tail call fastcc { i32, i32, i32, i32 } @Func_max(i32 %tmp2_v7.i.i, i32 %tmp2_v.i21.i)
...
.exit:                                            ; preds = %BB_804928E.i, %BB_80492A6.i
  ...
  %r_edx.0 = phi i32 [ %tmp4_v.i3.i, %BB_80492A6.i ], [ 0, %BB_804928E.i ]
