...
Func_8049252.exit.i:
  ...
  %tmp2_v8.i25.i = add i32 %tmp0_v.i4.i, -37
  ...
  store i32 %tmp2_v8.i25.i, i32* %20, align 4
  ...
  %spi801 = ptrtoint[8 x i8]* @str.801 to i32
  store i32 %spi801, i32* %21, align 16
