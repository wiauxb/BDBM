...
@stack802 = internal global [8092 x i32] zeroinitializer, align 16
@segs.0 = internal unnamed_addr global i1 false
@_ZL6segmem = internal global [1024 x i8] zeroinitializer, align 1
@onUnfallback = common local_unnamed_addr global i1 false
@str.801 = constant [8 x i8] c"s1 > s2\00"
...
define internal fastcc void @strcmp803(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
Func_8049252.exit.i:
  ...
  %spi.bis.801 = ptrtoint[8 x i8]* @str.801 to i32
  store i32 %spi.bis.801, i32* %21, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @strcmp803 (i32 ptrtoint (i32* getelementptr inbounds ([8092 x i32], [8092 x i32]* @stack802, i32 0, i32 8092) to i32)) nounwind
