...
@str.569 = constant [4 x i8] c"%d \00"
@str.570 = constant [2 x i8] c"\0a\00"
...
define internal fastcc void @reverse_array_recursive572(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v8.i54.i = add i32 %tmp0_v.i46.i, -84
  ...
  %tmp2_v2.i25.i = add i32 %tmp0_v.i46.i, -68
  %10 = inttoptr i32 %tmp2_v2.i25.i to i32*
  store i32 %9, i32* %10, align 4
  %tmp4_v.i26.i.b = load i1, i1* @segs.0, align 1
  %11 = inttoptr i32 %arg_esp to i32*
  %12 = load i32, i32* %11, align 4
  %tmp2_v5.i29.i = add i32 %tmp0_v.i46.i, -20
  %13 = inttoptr i32 %tmp2_v5.i29.i to i32*
  store i32 %12, i32* %13, align 4
  %tmp2_v6.i30.i = add i32 %tmp0_v.i46.i, -52
  %14 = inttoptr i32 %tmp2_v6.i30.i to i32*
  store i32 1, i32* %14, align 4
  %tmp2_v7.i31.i = add i32 %tmp0_v.i46.i, -48
  %15 = inttoptr i32 %tmp2_v7.i31.i to i32*
  store i32 2, i32* %15, align 16
  %tmp2_v8.i32.i = add i32 %tmp0_v.i46.i, -44
  %16 = inttoptr i32 %tmp2_v8.i32.i to i32*
  store i32 3, i32* %16, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i46.i, -40
  %17 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 4, i32* %17, align 8
  %tmp2_v10.i.i = add i32 %tmp0_v.i46.i, -36
  %18 = inttoptr i32 %tmp2_v10.i.i to i32*
  store i32 5, i32* %18, align 4
  %tmp2_v11.i.i = add i32 %tmp0_v.i46.i, -32
  %19 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 6, i32* %19, align 16
  %tmp2_v12.i.i = add i32 %tmp0_v.i46.i, -28
  %20 = inttoptr i32 %tmp2_v12.i.i to i32*
  store i32 7, i32* %20, align 4
  %tmp2_v13.i.i = add i32 %tmp0_v.i46.i, -24
  %21 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 8, i32* %21, align 8
  %tmp2_v14.i.i = add i32 %tmp0_v.i46.i, -56
  %22 = inttoptr i32 %tmp2_v14.i.i to i32*
  store i32 8, i32* %22, align 8
  %tmp2_v18.i.i = add i32 %tmp0_v.i46.i, -92
  %23 = inttoptr i32 %tmp2_v18.i.i to i32*
  store i32 8, i32* %23, align 4
  %tmp2_v20.i.i = add i32 %tmp0_v.i46.i, -96
  %24 = inttoptr i32 %tmp2_v20.i.i to i32*
  store i32 %tmp2_v6.i30.i, i32* %24, align 16
  %tmp2_v21.i.i = add i32 %tmp0_v.i46.i, -100
  %25 = inttoptr i32 %tmp2_v21.i.i to i32*
  store i32 134517336, i32* %25, align 4
  %tmp2_v.i7.i.i = add i32 %tmp0_v.i46.i, -104
  %26 = inttoptr i32 %tmp2_v.i7.i.i to i32*
  store i32 %tmp2_v4.i49.i, i32* %26, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i46.i, -116
  %27 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 134517451, i32* %27, align 4
  %28 = load i32, i32* %23, align 4
  %tmp0_v2.i4.i.i = add i32 %28, -1
  %tmp2_v4.i.i.i = add i32 %tmp0_v.i46.i, -120
  %29 = inttoptr i32 %tmp2_v4.i.i.i to i32*
  store i32 %tmp0_v2.i4.i.i, i32* %29, align 8
  %tmp2_v5.i.i.i = add i32 %tmp0_v.i46.i, -124
  %30 = inttoptr i32 %tmp2_v5.i.i.i to i32*
  store i32 0, i32* %30, align 4
  %31 = load i32, i32* %24, align 16
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i46.i, -128
  %32 = inttoptr i32 %tmp2_v8.i.i.i to i32*
  store i32 %31, i32* %32, align 16
  %tmp2_v9.i.i.i = add i32 %tmp0_v.i46.i, -132
  %33 = inttoptr i32 %tmp2_v9.i.i.i to i32*
  store i32 134517476, i32* %33, align 4
  %34 = tail call fastcc { i32, i32, i32 } @Func_reverse(i32 %tmp2_v9.i.i.i, i32 0, i32 %tmp2_v.i7.i.i, i32 %tmp2_v.i45.i)  nounwind 
  ...
  %tmp2_v.i37.i = add i32 %36, -52
  %37 = inttoptr i32 %tmp2_v.i37.i to i32*
...
BB_8049264.i.lr.ph:                               ; preds = %0
  ...
  %tmp2_v1.i14.i = add i32 %36, -44
  %tmp2_v5.i18.i = add i32 %newret2.i, 12
  %41 = inttoptr i32 %tmp2_v5.i18.i to i32*
...
BB_804928A.i:                                     ; preds = %BB_8049264.i, %.BB_804928A.i_crit_edge
  ...
  %spi570 = ptrtoint[2 x i8]* @str.570 to i32
  store i32 %spi570, i32* %.pre-phi, align 4
...
BB_8049264.i:                                     ; preds = %BB_8049264.i, %BB_8049264.i.lr.ph
  ...
  %tmp2_v2.i15.i = add i32 %tmp2_v1.i14.i, %tmp4_v.i.i
  %46 = inttoptr i32 %tmp2_v2.i15.i to i32*
  %47 = load i32, i32* %46, align 4
  store i32 %47, i32* %41, align 4
  %spi569 = ptrtoint[4 x i8]* @str.569 to i32
  store i32 %spi569, i32* %42, align 4
...
Func_80492F9.exit.i:
  ...
  %tmp2_v1.i18.i = add i32 %arg_esp, -32
  %1 = inttoptr i32 %tmp2_v1.i18.i to i32*
...
BB_8049306.i:                                     ; preds = %Func_80492F9.exit.i
  ...
  %28 = tail call fastcc { i32, i32, i32 } @Func_reverse(i32 %tmp2_v39.i.i, i32 %tmp2_v29.i.i, i32 %tmp2_v.i15.i, i32 %tmp4_v14.i.i)
...
!14 = !{i32 0, i32 1, i32 2, i32 3}
  ...
  tail call fastcc void @reverse_array_recursive572(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
