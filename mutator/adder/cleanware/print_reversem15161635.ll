...
define internal fastcc void @print_reversem15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v2.i4.i = add i32 %tmp0_v.i30.i, -100
  %8 = inttoptr i32 %tmp2_v2.i4.i to i32*
  ...
  %tmp2_v5.i6.i = add i32 %tmp0_v.i30.i, -20
  %11 = inttoptr i32 %tmp2_v5.i6.i to i32*
  store i32 %10, i32* %11, align 4
  %tmp2_v6.i7.i = add i32 %tmp0_v.i30.i, -84
  %12 = inttoptr i32 %tmp2_v6.i7.i to i32*
  store i32 5, i32* %12, align 4
  %tmp2_v7.i8.i = add i32 %tmp0_v.i30.i, -80
  %13 = inttoptr i32 %tmp2_v7.i8.i to i32*
  store i32 6, i32* %13, align 16
  %tmp2_v8.i9.i = add i32 %tmp0_v.i30.i, -76
  %14 = inttoptr i32 %tmp2_v8.i9.i to i32*
  store i32 7, i32* %14, align 4
  %tmp2_v9.i10.i = add i32 %tmp0_v.i30.i, -72
  %15 = inttoptr i32 %tmp2_v9.i10.i to i32*
  store i32 8, i32* %15, align 8
  %tmp2_v10.i.i = add i32 %tmp0_v.i30.i, -68
  %16 = inttoptr i32 %tmp2_v10.i.i to i32*
  store i32 9, i32* %16, align 4
  %tmp2_v11.i11.i = add i32 %tmp0_v.i30.i, -64
  %17 = inttoptr i32 %tmp2_v11.i11.i to i32*
  store i32 10, i32* %17, align 16
  %tmp2_v12.i12.i = add i32 %tmp0_v.i30.i, -88
  %18 = inttoptr i32 %tmp2_v12.i12.i to i32*
...
BB_80492E1.i.i:                                   ; preds = %BB_80492E1.i.i, %BB_80492E1.i.lr.ph.i
  ...
  %33 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i29.i, i32 inreg noundef %tmp4_v.i.i.i1, i32 noundef %tmp2_v8.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
...
Func_print_reverse.exit:                          ; preds = %BB_80492E1.i.i, %..exit_crit_edge.i
  ...
  %tmp2_v11.i.i = add i32 %tmp0_v.i30.i, -124
  %48 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 10, i32* %48, align 4
  store i32 %tmp2_v.i.i, i32* %20, align 16
  %tmp2_v14.i.i = add i32 %tmp0_v.i30.i, -132
  %49 = inttoptr i32 %tmp2_v14.i.i to i32*
  store i32 134517407, i32* %49, align 4
  %tmp2_v.i7.i.i2 = add i32 %tmp0_v.i30.i, -136
  %50 = inttoptr i32 %tmp2_v.i7.i.i2 to i32*
  store i32 %37, i32* %50, align 8
  %tmp2_v1.i9.i.i3 = add i32 %tmp0_v.i30.i, -140
  %51 = inttoptr i32 %tmp2_v1.i9.i.i3 to i32*
  store i32 %36, i32* %51, align 4
  %tmp2_v2.i.i.i4 = add i32 %tmp0_v.i30.i, -164
  %52 = inttoptr i32 %tmp2_v2.i.i.i4 to i32*
  store i32 134517456, i32* %52, align 4
  %tmp2_v3.i.i.i6 = add i32 %tmp0_v.i30.i, -148
...
..exit_crit_edge.i13:                             ; preds = %Func_print_reverse.exit
  %.pre.i9 = add i32 %tmp0_v.i30.i, -176
  %.pre21.i10 = inttoptr i32 %.pre.i9 to i32*
  %.pre22.i11 = add i32 %tmp0_v.i30.i, -180
...
BB_80492E1.i.lr.ph.i17:                           ; preds = %Func_print_reverse.exit
  %tmp2_v6.i.i.i14 = add i32 %tmp0_v.i30.i, -172
  %55 = inttoptr i32 %tmp2_v6.i.i.i14 to i32*
  %tmp2_v8.i.i.i15 = add i32 %tmp0_v.i30.i, -176
  %56 = inttoptr i32 %tmp2_v8.i.i.i15 to i32*
  %tmp2_v9.i.i.i16 = add i32 %tmp0_v.i30.i, -180
...
BB_80492E1.i.i23:                                 ; preds = %BB_80492E1.i.i23, %BB_80492E1.i.lr.ph.i17
  ...
  store i32 134520840, i32* %56, align 16
  store i32 134517506, i32* %57, align 4
  %61 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i29.i, i32 inreg noundef %tmp4_v.i.i.i19, i32 noundef %tmp2_v8.i.i.i15, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @print_reversem15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
