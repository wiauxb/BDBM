...
@str.413 = constant [12 x i8] c"Result: %s\0a\00"
...
define internal fastcc void @own_strcat415(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %tmp2_v4.i.i = add i32 %tmp0_v.i19.i, -8
  ...
  store i32 %tmp2_v.i18.i, i32* %7, align 4
  %tmp2_v9.i.i = add i32 %tmp0_v.i19.i, -1076
  ...
  %tmp2_v2.i32.i = add i32 %tmp0_v.i19.i, -36
  %11 = inttoptr i32 %tmp2_v2.i32.i to i32*
  store i32 %10, i32* %11, align 4
  %tmp2_v3.i33.i = add i32 %tmp0_v.i19.i, -1060
  %12 = inttoptr i32 %tmp2_v3.i33.i to i32*
  store i32 1936877894, i32* %12, align 4
  %tmp2_v4.i34.i = add i32 %tmp0_v.i19.i, -1056
  %13 = inttoptr i32 %tmp2_v4.i34.i to i32*
  store i32 116, i32* %13, align 16
  %tmp2_v5.i35.i = add i32 %tmp0_v.i19.i, -1052
...
Func_804920C.exit.i:                              ; preds = %Func_804920C.exit.i, %0
  ...
  %r_edi.010 = phi i32 [ %tmp2_v5.i35.i, %0 ], [ %tmp4_v.i15.i, %Func_804920C.exit.i ]
  %14 = inttoptr i32 %r_edi.010 to i32*
  store i32 0, i32* %14, align 4
  %tmp0_v.i13.i = load i32, i32* @df, align 4
  %tmp0_v1.i14.i = shl i32 %tmp0_v.i13.i, 2
  %tmp4_v.i15.i = add i32 %tmp0_v1.i14.i, %r_edi.010
...
BB_804929F.i.i:                                   ; preds = %BB_804929F.i.i, %BB_804920E.i
  ...
  %tmp0_v3.i8.i.i = add i32 %30, %tmp0_v1.i.i.i
  %31 = inttoptr i32 %tmp0_v3.i8.i.i to i8*
  %32 = load i8, i8* %31, align 1
  %.not.i9.i.i = icmp eq i8 %32, 0
  br i1 %.not.i9.i.i, label %BB_80492D1.i.preheader.loopexit.i, label %BB_804929F.i.i
...
BB_80492D1.i.preheader.i:                         ; preds = %BB_80492D1.i.preheader.loopexit.i, %BB_804920E.i
  ...
  %tmp0_v3.i20.i16.i = add i32 %36, %35
  %37 = inttoptr i32 %tmp0_v3.i20.i16.i to i8*
  %38 = load i8, i8* %37, align 1
  %.not.i22.i17.i = icmp eq i8 %38, 0
  br i1 %.not.i22.i17.i, label %Func__strcat.exit, label %BB_80492B4.i.i.preheader
...
BB_80492B4.i.i.preheader:                         ; preds = %BB_80492D1.i.preheader.i
  ...
  %tmp0_v3.i20.i.i15 = add i32 %42, %tmp0_v15.i.i.i14
  %43 = inttoptr i32 %tmp0_v3.i20.i.i15 to i8*
  %44 = load i8, i8* %43, align 1
  %.not.i22.i.i16 = icmp eq i8 %44, 0
  br i1 %.not.i22.i.i16, label %.exit.loopexit.i, label %BB_80492B4.i.BB_80492B4.i_crit_edge.i
...
BB_80492B4.i.BB_80492B4.i_crit_edge.i:            ; preds = %BB_80492B4.i.BB_80492B4.i_crit_edge.i, %BB_80492B4.i.i.preheader
  ...
  %tmp0_v3.i20.i.i = add i32 %49, %tmp0_v15.i.i.i
  %50 = inttoptr i32 %tmp0_v3.i20.i.i to i8*
  %51 = load i8, i8* %50, align 1
  %.not.i22.i.i = icmp eq i8 %51, 0
  br i1 %.not.i22.i.i, label %.exit.loopexit.i, label %BB_80492B4.i.BB_80492B4.i_crit_edge.i
...
Func__strcat.exit:                                ; preds = %.exit.loopexit.i, %BB_80492D1.i.preheader.i
  ...
  %tmp0_v3.i29.i.i = add i32 %53, %52
  %54 = inttoptr i32 %tmp0_v3.i29.i.i to i8*
  store i8 0, i8* %54, align 1
  %55 = load i32, i32* %21, align 8
  %tmp2_v.i4.i = add i32 %55, -1052
  store i32 %tmp2_v.i4.i, i32* %18, align 4
  %spi413 = ptrtoint[12 x i8]* @str.413 to i32
  store i32 %spi413, i32* %19, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @own_strcat415(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
