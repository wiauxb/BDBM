...
@str.635 = constant [23 x i8] c"failed to find string!\00"
@str.636 = constant [9 x i8] c"the: %s\0a\00"
...
define internal fastcc void @strstr637(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
Func_804928B.exit.i:
  ...
  %tmp2_v8.i35.i = add i32 %tmp0_v.i2.i, -45
  %15 = inttoptr i32 %tmp2_v8.i35.i to i32*
  store i32 6645876, i32* %15, align 4
  %tmp2_v11.i.i = add i32 %tmp0_v.i2.i, -76
  %16 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 %tmp2_v8.i35.i, i32* %16, align 4
  ...
  %tmp2_v.i49.i = add i32 %tmp0_v.i2.i, -56
  %20 = inttoptr i32 %tmp2_v.i49.i to i32*
  store i32 %19, i32* %20, align 8
  store i32 %19, i32* %16, align 4
  %spi636 = ptrtoint[9 x i8]* @str.636 to i32
  store i32 %spi636, i32* %17, align 16
  store i32 134517361, i32* %18, align 4
  %21 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i1.i, i32 inreg noundef 0, i32 noundef %tmp2_v13.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %tmp2_v.i18.i = add i32 %tmp0_v.i2.i, -41
  %22 = inttoptr i32 %tmp2_v.i18.i to i32*
  store i32 7827310, i32* %22, align 4
  store i32 %tmp2_v.i18.i, i32* %16, align 4
  store i32 %tmp2_v3.i31.i, i32* %17, align 16
  ...
  %tmp2_v.i8.i = add i32 %tmp0_v.i2.i, -52
  %24 = inttoptr i32 %tmp2_v.i8.i to i32*
  store i32 %23, i32* %24, align 4
  %spi635 = ptrtoint[23 x i8]* @str.635 to i32
  store i32 %spi635, i32* %17, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @strstr637(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
