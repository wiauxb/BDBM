...
@str.416 = constant [4 x i8] c"%d\0a\00"
...
define internal fastcc void @print_unique418(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
  ...
  %tmp2_v3.i11.i = add i32 %tmp0_v.i.i, -72
  %9 = inttoptr i32 %tmp2_v3.i11.i to i32*
  store i32 1, i32* %9, align 8
  %tmp2_v4.i12.i = add i32 %tmp0_v.i.i, -68
  %10 = inttoptr i32 %tmp2_v4.i12.i to i32*
  store i32 2, i32* %10, align 4
  %tmp2_v5.i13.i = add i32 %tmp0_v.i.i, -64
  ...
  %tmp2_v7.i14.i = add i32 %tmp0_v.i.i, -56
  ...
  store i32 %tmp2_v3.i11.i, i32* %23, align 16
  ...
  %tmp2_v.i71.i.i = add i32 %tmp0_v.i.i, -120
  %28 = inttoptr i32 %tmp2_v.i71.i.i to i32*
...
BB_8049289.i.lr.ph.i:                             ; preds = %.exit
  %tmp2_v.i23.i.i = add i32 %tmp0_v.i.i, -121
  %31 = inttoptr i32 %tmp2_v.i23.i.i to i8*
  %tmp2_v1.i24.i.i = add i32 %tmp0_v.i.i, -116
  %32 = inttoptr i32 %tmp2_v1.i24.i.i to i32*
  %tmp2_v6.i.i.i = add i32 %tmp0_v.i.i, -140
  %33 = inttoptr i32 %tmp2_v6.i.i.i to i32*
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i.i, -144
...
BB_80492DF.i.i:                                   ; preds = %BB_80492D4.i.i
  ...
  %spi416 = ptrtoint[4 x i8]* @str.416 to i32
  store i32 %spi416, i32* %34, align 16
  store i32 134517504, i32* %35, align 4
  %40 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %r_ecx.1.lcssa.i, i32 inreg noundef %tmp4_v.i.i.i2, i32 noundef %tmp2_v8.i.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  br label %BB_8049303.i.i

BB_8049296.i.i:                                   ; preds = %BB_80492C8.i.i, %BB_8049289.i.i
  %storemerge27.i = phi i32 [ %tmp0_v1.i87.i.i, %BB_80492C8.i.i ], [ 0, %BB_8049289.i.i ]
  %41 = load i32, i32* %28, align 8
  %tmp4_v.i10.i.i = shl i32 %41, 2
  %42 = load i32, i32* %23, align 16
  %tmp0_v3.i13.i.i = add i32 %42, %tmp4_v.i10.i.i
  %43 = inttoptr i32 %tmp0_v3.i13.i.i to i32*
...
BB_8049289.i.i:                                   ; preds = %BB_8049303.i.i, %BB_8049289.i.lr.ph.i
  ...
  br i1 %49, label %BB_8049296.i.i, label %BB_80492D4.i.i
...
BB_80492D4.i.i:                                   ; preds = %BB_80492C8.i.i, %BB_8049289.i.i
  ...
  %51 = icmp eq i8 %50, 1
  br i1 %51, label %BB_8049303.i.i, label %BB_80492DF.i.i
...
BB_8049303.i.i:                                   ; preds = %BB_80492D4.i.i, %BB_80492DF.i.i
  ...
  %tmp0_v1.i62.i.i = add i32 %52, 1
  store i32 %tmp0_v1.i62.i.i, i32* %28, align 8
  %53 = load i32, i32* %22, align 4
  %54 = icmp slt i32 %tmp0_v1.i62.i.i, %53
  br i1 %54, label %BB_8049289.i.i, label %Func_print_unique.exit

BB_80492C8.i.i:                                   ; preds = %BB_80492C4.i.i, %BB_8049296.i.i
  %55 = phi i32 [ %storemerge27.i, %BB_8049296.i.i ], [ %.pre.i, %BB_80492C4.i.i ]
  %tmp0_v1.i87.i.i = add i32 %55, 1
  store i32 %tmp0_v1.i87.i.i, i32* %32, align 4
  %56 = load i32, i32* %22, align 4
  %57 = icmp slt i32 %tmp0_v1.i87.i.i, %56
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @print_unique418(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
