...
Func_8049373.exit.i:
  ...
  %tmp2_v1.i16.i = add i32 %arg_esp, -8
  %1 = inttoptr i32 %tmp2_v1.i16.i to i32*
  store i32 %arg_ebx, i32* %1, align 4
  %tmp2_v2.i18.i = add i32 %arg_esp, -32
  %2 = inttoptr i32 %tmp2_v2.i18.i to i32*
  store i32 134517585, i32* %2, align 4
  %tmp2_v.i41.i = add i32 %arg_esp, 4
  %3 = inttoptr i32 %tmp2_v.i41.i to i32*
  %4 = load i32, i32* %3, align 4
  %tmp2_v3.i43.i = add i32 %arg_esp, -44
  %5 = inttoptr i32 %tmp2_v3.i43.i to i32*
  ...
  %tmp2_v.i8.i = add i32 %arg_esp, -16
  %12 = inttoptr i32 %tmp2_v.i8.i to i32*
...
BB_8049388.i:                                     ; preds = %Func_8049373.exit.i
  %tmp2_v.i12.i = add i32 %arg_esp, -24
  %14 = inttoptr i32 %tmp2_v.i12.i to i32*
...
BB_8049391.i:                                     ; preds = %BB_80493C0.i, %BB_8049388.i
  %17 = phi i32 [ %26, %BB_80493C0.i ], [ %15, %BB_8049388.i ]
  %storemerge.neg30 = phi i32 [ %storemerge.neg, %BB_80493C0.i ], [ 0, %BB_8049388.i ]
  %storemerge29 = phi i32 [ %tmp0_v1.i54.i, %BB_80493C0.i ], [ 0, %BB_8049388.i ]
  %18 = load i32, i32* %8, align 4
  %tmp0_v2.i24.i = add i32 %18, %storemerge.neg30
  %19 = load i32, i32* %3, align 4
  %tmp0_v5.i.i = add i32 %tmp0_v2.i24.i, %19
  %20 = inttoptr i32 %tmp0_v5.i.i to i8*
  %21 = load i8, i8* %20, align 1
  %tmp0_v6.i.i = zext i8 %21 to i32
  %tmp0_v11.i.i = add i32 %17, %storemerge.neg30
  %22 = load i32, i32* %9, align 4
  %tmp0_v14.i.i = add i32 %tmp0_v11.i.i, %22
  %23 = inttoptr i32 %tmp0_v14.i.i to i8*
  %24 = load i8, i8* %23, align 1
  %tmp0_v15.i.i = zext i8 %24 to i32
  %cc_dst_v.i26.i = sub nsw i32 %tmp0_v6.i.i, %tmp0_v15.i.i
  %tmp4_v.i27.i = and i32 %cc_dst_v.i26.i, 255
  %25 = icmp eq i32 %tmp4_v.i27.i, 0
  %tmp0_v1.i54.i = add nuw nsw i32 %storemerge29, 1
  br i1 %25, label %BB_80493C0.i, label %.exit

BB_80493C0.i:                                     ; preds = %BB_8049391.i
  %storemerge.neg = xor i32 %storemerge29, -1
  store i32 %tmp0_v1.i54.i, i32* %14, align 4
  %26 = load i32, i32* %12, align 4
  %27 = icmp sgt i32 %26, %tmp0_v1.i54.i
  br i1 %27, label %BB_8049391.i, label %.exit

.exit:                                            ; preds = %BB_80493C0.i, %BB_8049391.i, %BB_8049388.i, %Func_8049373.exit.i
  %r_eax.0 = phi i32 [ 0, %Func_8049373.exit.i ], [ 1, %BB_8049388.i ], [ 0, %BB_8049391.i ], [ 1, %BB_80493C0.i ]
  %28 = load i32, i32* %1, align 4
  %29 = load i32, i32* %0, align 4
  %mrv = insertvalue { i32, i32, i32, i32 } undef, i32 %tmp2_v.i41.i, 0
...
; Function Attrs: norecurse
define internal fastcc void @endswithm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !11 {
Func_8049234.exit.i:
  ...
  %tmp2_v2.i57.i = add i32 %tmp0_v.i33.i, -20
  %9 = inttoptr i32 %tmp2_v2.i57.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i58.i = add i32 %tmp0_v.i33.i, -65
  %10 = inttoptr i32 %tmp2_v3.i58.i to i32*
  store i32 1702063954, i32* %10, align 4
  %tmp2_v4.i59.i = add i32 %tmp0_v.i33.i, -61
  %11 = inttoptr i32 %tmp2_v4.i59.i to i32*
  store i32 1918967923, i32* %11, align 4
  %tmp2_v5.i60.i = add i32 %tmp0_v.i33.i, -57
  %12 = inttoptr i32 %tmp2_v5.i60.i to i32*
  store i32 1701978213, i32* %12, align 4
  %tmp2_v6.i61.i = add i32 %tmp0_v.i33.i, -53
  %13 = inttoptr i32 %tmp2_v6.i61.i to i16*
  store i16 100, i16* %13, align 2
  %tmp2_v7.i62.i = add i32 %tmp0_v.i33.i, -74
  %14 = inttoptr i32 %tmp2_v7.i62.i to i32*
  store i32 6579570, i32* %14, align 4
  %tmp2_v10.i64.i = add i32 %tmp0_v.i33.i, -92
  %15 = inttoptr i32 %tmp2_v10.i64.i to i32*
  store i32 %tmp2_v7.i62.i, i32* %15, align 4
  %tmp2_v12.i66.i = add i32 %tmp0_v.i33.i, -96
  %16 = inttoptr i32 %tmp2_v12.i66.i to i32*
  store i32 %tmp2_v3.i58.i, i32* %16, align 16
  %tmp2_v13.i.i = add i32 %tmp0_v.i33.i, -100
  %17 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 134517300, i32* %17, align 4
  %18 = tail call fastcc { i32, i32, i32, i32 } @Func_endswith(i32 %tmp2_v13.i.i, i32 %tmp2_v4.i35.i, i32 134529024)
  %19 = extractvalue { i32, i32, i32, i32 } %18, 0
  %20 = extractvalue { i32, i32, i32, i32 } %18, 2
  %21 = extractvalue { i32, i32, i32, i32 } %18, 3
  %tmp2_v.i70.i = add i32 %21, -8184
  %22 = inttoptr i32 %19 to i32*
  store i32 %tmp2_v.i70.i, i32* %22, align 4
  %tmp2_v2.i72.i = add i32 %19, -4
  %23 = inttoptr i32 %tmp2_v2.i72.i to i32*
  ...
  %tmp2_v.i42.i = add i32 %20, -62
  %26 = inttoptr i32 %tmp2_v.i42.i to i32*
  store i32 1702194274, i32* %26, align 4
  %tmp2_v1.i43.i = add i32 %20, -58
  %27 = inttoptr i32 %tmp2_v1.i43.i to i8*
  store i8 0, i8* %27, align 1
  %tmp2_v3.i47.i = add i32 %19, 4
  %28 = inttoptr i32 %tmp2_v3.i47.i to i32*
  store i32 %tmp2_v.i42.i, i32* %28, align 4
  %tmp2_v4.i48.i = add i32 %20, -57
  store i32 %tmp2_v4.i48.i, i32* %22, align 4
  store i32 134517372, i32* %23, align 4
  %29 = tail call fastcc { i32, i32, i32, i32 } @Func_endswith(i32 %tmp2_v2.i72.i, i32 %20, i32 %21)
  %30 = extractvalue { i32, i32, i32, i32 } %29, 0
  %31 = extractvalue { i32, i32, i32, i32 } %29, 2
  %32 = extractvalue { i32, i32, i32, i32 } %29, 3
  %tmp2_v.i.i = add i32 %32, -8096
  %33 = inttoptr i32 %30 to i32*
  store i32 %tmp2_v.i.i, i32* %33, align 4
  %tmp2_v2.i.i = add i32 %30, -4
  ...
  %tmp2_v.i23.i = add i32 %31, -43
  %37 = inttoptr i32 %tmp2_v.i23.i to i32*
  store i32 1702063954, i32* %37, align 4
  %tmp2_v1.i24.i = add i32 %31, -39
  %38 = inttoptr i32 %tmp2_v1.i24.i to i32*
  store i32 1918967923, i32* %38, align 4
  %tmp2_v2.i25.i = add i32 %31, -35
  %39 = inttoptr i32 %tmp2_v2.i25.i to i32*
  ...
  store i32 %tmp2_v.i23.i, i32* %46, align 4
  %tmp2_v12.i.i = add i32 %31, -57
  store i32 %tmp2_v12.i.i, i32* %33, align 4
  store i32 134517492, i32* %34, align 4
  %47 = tail call fastcc { i32, i32, i32, i32 } @Func_endswith(i32 %tmp2_v2.i.i, i32 %31, i32 %32)
  %48 = extractvalue { i32, i32, i32, i32 } %47, 0
  %49 = extractvalue { i32, i32, i32, i32 } %47, 3
  %tmp2_v.i18.i = add i32 %49, -8038
  %50 = inttoptr i32 %48 to i32*
  store i32 %tmp2_v.i18.i, i32* %50, align 4
  %tmp2_v2.i20.i = add i32 %48, -4
  %51 = inttoptr i32 %tmp2_v2.i20.i to i32*
...
!11 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @endswithm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
