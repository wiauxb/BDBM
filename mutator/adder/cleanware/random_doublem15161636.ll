...
define internal fastcc void @random_doublem15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !22 {
BB_8049239.i.lr.ph:
  ...
  %tmp2_v.i.i = add i32 %tmp0_v.i27.i, -48
  %7 = inttoptr i32 %tmp2_v.i.i to i32*
  store i32 0, i32* %7, align 16
  %tmp2_v2.i.i = add i32 %tmp0_v.i27.i, -52
...
BB_8049239.i:                                     ; preds = %BB_8049239.i, %BB_8049239.i.lr.ph
  %r_ebp.011 = phi i32 [ %tmp2_v4.i30.i, %BB_8049239.i.lr.ph ], [ %46, %BB_8049239.i ]
  %r_edx.010 = phi i32 [ 0, %BB_8049239.i.lr.ph ], [ %49, %BB_8049239.i ]
  %r_ebx.09 = phi i32 [ 134529024, %BB_8049239.i.lr.ph ], [ %45, %BB_8049239.i ]
  %tmp2_v.i35.i = add i32 %r_ebx.09, -8176
  %29 = inttoptr i32 %tmp2_v.i35.i to i64*
  ...
  %tmp2_v4.i38.i = add i32 %r_ebx.09, -8168
  %31 = inttoptr i32 %tmp2_v4.i38.i to i64*
  ...
  store i64 %tmp5_v.i.i, i64* %28, align 4
  tail call fastcc void @helper_fpop()
  %tmp2_v2.i13.i = add i32 %45, -8184
  store i32 %tmp2_v2.i13.i, i32* %7, align 16
  store i32 134517361, i32* %8, align 4
  %47 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i26.i, i32 inreg noundef %r_edx.010, i32 noundef %tmp2_v.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !23
  %48 = lshr i64 %47, 32
  %49 = trunc i64 %48 to i32
  %tmp2_v.i18.i = add i32 %46, -12
  %50 = inttoptr i32 %tmp2_v.i18.i to i32*
...
!23 = !{!"printf"}
  ...
  tail call fastcc void @random_doublem15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
