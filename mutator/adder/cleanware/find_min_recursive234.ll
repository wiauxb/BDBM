...
@str.232 = constant [9 x i8] c"min: %d\0a\00"
...
BB_80492A6.i:                                     ; preds = %Func_8049283.exit.i
  ...
  %12 = tail call fastcc { i32, i32, i32, i32 } @Func_min(i32 %tmp2_v7.i.i, i32 %tmp2_v.i14.i)
  %13 = extractvalue { i32, i32, i32, i32 } %12, 1
  %14 = extractvalue { i32, i32, i32, i32 } %12, 3
  %tmp2_v.i30.i = add i32 %14, -12
  %15 = inttoptr i32 %tmp2_v.i30.i to i32*
  store i32 %13, i32* %15, align 4
  %tmp2_v1.i32.i = add i32 %14, 12
  %16 = inttoptr i32 %tmp2_v1.i32.i to i32*
  %17 = load i32, i32* %16, align 4
  %tmp0_v3.i34.i = shl i32 %17, 2
  %tmp4_v.i35.i = add i32 %tmp0_v3.i34.i, -4
  %tmp2_v4.i36.i = add i32 %14, 8
  %18 = inttoptr i32 %tmp2_v4.i36.i to i32*
  %19 = load i32, i32* %18, align 4
  %tmp0_v6.i38.i = add i32 %tmp4_v.i35.i, %19
  %20 = inttoptr i32 %tmp0_v6.i38.i to i32*
  %21 = load i32, i32* %20, align 4
  %.not.i40.i = icmp slt i32 %13, %21
  %spec.select = select i1 %.not.i40.i, i32* %15, i32* %20
  %.pre = inttoptr i32 %14 to i32*
  br label %.exit

.exit:                                            ; preds = %BB_80492A6.i, %BB_804928E.i
  %tmp4_v2.i.i.pre-phi = phi i32 [ %tmp2_v4.i36.i, %BB_80492A6.i ], [ %.pre19, %BB_804928E.i ]
  %.pre-phi = phi i32* [ %.pre, %BB_80492A6.i ], [ %0, %BB_804928E.i ]
  %r_eax.0.in = phi i32* [ %spec.select, %BB_80492A6.i ], [ %6, %BB_804928E.i ]
  %r_edx.0 = phi i32 [ %tmp4_v.i35.i, %BB_80492A6.i ], [ 0, %BB_804928E.i ]
...
define internal fastcc void @find_min_recursive234(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !13 {
.exit:
  ...
  %tmp2_v17.i.i = add i32 %tmp0_v.i10.i, -76
  %21 = inttoptr i32 %tmp2_v17.i.i to i32*
  store i32 10, i32* %21, align 4
  %tmp2_v19.i.i = add i32 %tmp0_v.i10.i, -80
  %22 = inttoptr i32 %tmp2_v19.i.i to i32*
  store i32 %tmp2_v3.i.i, i32* %22, align 16
  %tmp2_v20.i.i = add i32 %tmp0_v.i10.i, -84
  %23 = inttoptr i32 %tmp2_v20.i.i to i32*
  store i32 134517310, i32* %23, align 4
  %24 = tail call fastcc { i32, i32, i32, i32 } @Func_min(i32 %tmp2_v20.i.i, i32 %tmp2_v4.i12.i)
  %25 = extractvalue { i32, i32, i32, i32 } %24, 0
  %26 = extractvalue { i32, i32, i32, i32 } %24, 1
  %27 = extractvalue { i32, i32, i32, i32 } %24, 2
  %tmp2_v.i28.i = add i32 %25, 4
  %28 = inttoptr i32 %tmp2_v.i28.i to i32*
  store i32 %26, i32* %28, align 4
  %29 = inttoptr i32 %25 to i32*
  %spi.bis.232 = ptrtoint[9 x i8]* @str.232 to i32
  store i32 %spi.bis.232, i32* %29, align 4
  %tmp2_v4.i31.i = add i32 %25, -4
  %30 = inttoptr i32 %tmp2_v4.i31.i to i32*
  store i32 134517329, i32* %30, align 4
  %31 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i9.i, i32 inreg noundef %27, i32 noundef %25, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !14
  ret void
}
