...
.exit:
  ...
  store i32 %tmp2_v3.i19.i, i32* %22, align 16
  ...
  %spi232 = ptrtoint[9 x i8]* @str.232 to i32
  store i32 %spi232, i32* %29, align 4
...
Func_8049283.exit.i:
  ...
  %0 = inttoptr i32 %tmp2_v.i18.i to i32*
...
BB_80492A6.i:                                     ; preds = %Func_8049283.exit.i
  %tmp0_v1.i40.i = add i32 %3, -1
  %tmp2_v3.i.i = add i32 %arg_esp, -40
  %7 = inttoptr i32 %tmp2_v3.i.i to i32*
  store i32 %tmp0_v1.i40.i, i32* %7, align 4
  %tmp2_v4.i43.i = add i32 %arg_esp, 4
  %8 = inttoptr i32 %tmp2_v4.i43.i to i32*
  ...
  %12 = tail call fastcc { i32, i32, i32, i32 } @Func_min(i32 %tmp2_v7.i.i, i32 %tmp2_v.i18.i)
  %13 = extractvalue { i32, i32, i32, i32 } %12, 1
  %14 = extractvalue { i32, i32, i32, i32 } %12, 3
  %tmp2_v.i27.i = add i32 %14, -12
  %15 = inttoptr i32 %tmp2_v.i27.i to i32*
  store i32 %13, i32* %15, align 4
  %tmp2_v1.i29.i = add i32 %14, 12
  %16 = inttoptr i32 %tmp2_v1.i29.i to i32*
  %17 = load i32, i32* %16, align 4
  %tmp0_v3.i30.i = shl i32 %17, 2
  %tmp4_v.i31.i = add i32 %tmp0_v3.i30.i, -4
  %tmp2_v4.i.i = add i32 %14, 8
  %18 = inttoptr i32 %tmp2_v4.i.i to i32*
  %19 = load i32, i32* %18, align 4
  %tmp0_v6.i33.i = add i32 %tmp4_v.i31.i, %19
  %20 = inttoptr i32 %tmp0_v6.i33.i to i32*
  %21 = load i32, i32* %20, align 4
  %.not.i35.i = icmp slt i32 %13, %21
  %spec.select = select i1 %.not.i35.i, i32* %15, i32* %20
...
.exit:                                            ; preds = %BB_80492A6.i, %BB_804928E.i
  ...
  %r_edx.0 = phi i32 [ %tmp4_v.i31.i, %BB_80492A6.i ], [ 0, %BB_804928E.i ]
