...
@str.678 = constant [14 x i8] c"|||%-8.3f|||\0a\00"
@str.679 = constant [13 x i8] c"|||%-10d|||\0a\00"
@str.680 = constant [8 x i8] c"str: %s\00"
@str.681 = constant [8 x i8] c"z: %f \0a\00"
@str.682 = constant [8 x i8] c"y: %f \0a\00"
@str.684 = constant [7 x i8] c"c: %c\0a\00"
@str.685 = constant [13 x i8] c"%d, %d, %d \0a\00"
@str.686 = constant [8 x i8] c"x: %d \0a\00"
@str.687 = constant [4 x i8] c" \ \00"
@str.688 = constant [17 x i8] c"double quote: \22 \00"
@str.690 = constant [15 x i8] c"Hello, World! \00"
...
define internal fastcc void @printf691(i32 %arg_esp) unnamed_addr  norecurse  !retregs !24 {
.exit:
  ...
  %5 = inttoptr i32 %tmp2_v6.i115.i to i32*
  store i32 %tmp2_v.i107.i, i32* %5, align 16
  %tmp2_v8.i117.i = add i32 %tmp0_v.i108.i, -84
  %6 = inttoptr i32 %tmp2_v8.i117.i to i32*
  store i32 134517233, i32* %6, align 4
  %tmp4_v.i71.i.b = load i1, i1* @segs.0, align 1
  %7 = inttoptr i32 %arg_esp to i32*
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i75.i = add i32 %tmp0_v.i108.i, -20
  %9 = inttoptr i32 %tmp2_v2.i75.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v5.i79.i = add i32 %tmp0_v.i108.i, -96
  %10 = inttoptr i32 %tmp2_v5.i79.i to i32*
  %spi690 = ptrtoint[15 x i8]* @str.690 to i32
  store i32 %spi690, i32* %10, align 16
  %tmp2_v6.i80.i = add i32 %tmp0_v.i108.i, -100
  %11 = inttoptr i32 %tmp2_v6.i80.i to i32*
  ...
  store i32 134520855, i32* %10, align 16
  ...
  %spi688 = ptrtoint[17 x i8]* @str.688 to i32
  store i32 %spi688, i32* %10, align 16
  ...
  %spi687 = ptrtoint[4 x i8]* @str.687 to i32
  store i32 %spi687, i32* %10, align 16
  ...
  %tmp2_v.i90.i = add i32 %tmp0_v.i108.i, -64
  %20 = inttoptr i32 %tmp2_v.i90.i to i32*
  store i32 5, i32* %20, align 16
  %tmp2_v4.i94.i = add i32 %tmp0_v.i108.i, -92
  %21 = inttoptr i32 %tmp2_v4.i94.i to i32*
  store i32 5, i32* %21, align 4
  %spi686 = ptrtoint[8 x i8]* @str.686 to i32
  store i32 %spi686, i32* %10, align 16
  store i32 134517347, i32* %11, align 4
  %22 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i107.i, i32 inreg noundef 0, i32 noundef %tmp2_v5.i79.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %23 = load i32, i32* %20, align 16
  %tmp2_v2.i123.i = add i32 %23, 2
  %tmp0_v5.i126.i = add i32 %23, 1
  store i32 %tmp2_v2.i123.i, i32* %6, align 4
  %tmp2_v7.i128.i = add i32 %tmp0_v.i108.i, -88
  %24 = inttoptr i32 %tmp2_v7.i128.i to i32*
  store i32 %tmp0_v5.i126.i, i32* %24, align 8
  %25 = load i32, i32* %20, align 16
  store i32 %25, i32* %21, align 4
  %spi685 = ptrtoint[13 x i8]* @str.685 to i32
  store i32 %spi685, i32* %10, align 16
  store i32 134517379, i32* %11, align 4
  %26 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i107.i, i32 inreg noundef %tmp2_v2.i123.i, i32 noundef %tmp2_v5.i79.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %27 = lshr i64 %26, 32
  %28 = trunc i64 %27 to i32
  %tmp2_v.i8.i = add i32 %tmp0_v.i108.i, -65
  %29 = inttoptr i32 %tmp2_v.i8.i to i8*
  store i8 81, i8* %29, align 1
  store i32 81, i32* %21, align 4
  %spi684 = ptrtoint[7 x i8]* @str.684 to i32
  store i32 %spi684, i32* %10, align 16
  store i32 134517406, i32* %11, align 4
  %30 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i107.i, i32 inreg noundef %28, i32 noundef %tmp2_v5.i79.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %31 = lshr i64 %30, 32
  %32 = trunc i64 %31 to i32
  %33 = load i64, i64* inttoptr (i32 134520984 to i64*), align 8
  tail call fastcc void @helper_fldl_ST0(i64 %33)
  %tmp2_v1.i62.i = add i32 %tmp0_v.i108.i, -56
  %tmp5_v2.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %34 = inttoptr i32 %tmp2_v1.i62.i to i64*
  store i64 %tmp5_v2.i.i, i64* %34, align 8
  tail call fastcc void @helper_fpop()
  %tmp2_v6.i63.i = add i32 %tmp0_v.i108.i, -52
  %35 = inttoptr i32 %tmp2_v6.i63.i to i32*
  %36 = load i32, i32* %35, align 4
  store i32 %36, i32* %24, align 8
  %37 = inttoptr i32 %tmp2_v1.i62.i to i32*
  %38 = load i32, i32* %37, align 8
  store i32 %38, i32* %21, align 4
  %spi682 = ptrtoint[8 x i8]* @str.682 to i32
  store i32 %spi682, i32* %10, align 16
  store i32 134517439, i32* %11, align 4
  %39 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i107.i, i32 inreg noundef %32, i32 noundef %tmp2_v5.i79.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %40 = lshr i64 %39, 32
  %41 = trunc i64 %40 to i32
  %42 = load i32, i32* inttoptr (i32 134520992 to i32*), align 32
  tail call fastcc void @helper_flds_ST0(i32 %42)
  %tmp2_v2.i39.i = add i32 %tmp0_v.i108.i, -60
  %tmp6_v.i.i = tail call fastcc i32 @helper_fsts_ST0()
  %43 = inttoptr i32 %tmp2_v2.i39.i to i32*
  ...
  %45 = inttoptr i32 %tmp2_v4.i94.i to i64*
  store i64 %tmp5_v.i.i, i64* %45, align 4
  tail call fastcc void @helper_fpop()
  %spi681 = ptrtoint[8 x i8]* @str.681 to i32
  store i32 %spi681, i32* %10, align 16
  store i32 134517476, i32* %11, align 4
  %46 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i107.i, i32 inreg noundef %41, i32 noundef %tmp2_v5.i79.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %47 = lshr i64 %46, 32
  %48 = trunc i64 %47 to i32
  %tmp2_v.i14.i = add i32 %tmp0_v.i108.i, -41
  %49 = inttoptr i32 %tmp2_v.i14.i to i32*
  store i32 1953701953, i32* %49, align 4
  %tmp2_v1.i15.i = add i32 %tmp0_v.i108.i, -37
  %50 = inttoptr i32 %tmp2_v1.i15.i to i32*
  store i32 1735289202, i32* %50, align 4
  %tmp2_v2.i16.i = add i32 %tmp0_v.i108.i, -33
  %51 = inttoptr i32 %tmp2_v2.i16.i to i32*
  store i32 544175136, i32* %51, align 4
  %tmp2_v3.i17.i = add i32 %tmp0_v.i108.i, -29
  %52 = inttoptr i32 %tmp2_v3.i17.i to i32*
  store i32 1886680431, i32* %52, align 4
  %tmp2_v4.i18.i = add i32 %tmp0_v.i108.i, -25
  %53 = inttoptr i32 %tmp2_v4.i18.i to i32*
  store i32 169964661, i32* %53, align 4
  %tmp2_v5.i19.i = add i32 %tmp0_v.i108.i, -21
  %54 = inttoptr i32 %tmp2_v5.i19.i to i8*
  store i8 0, i8* %54, align 1
  store i32 %tmp2_v.i14.i, i32* %21, align 4
  %spi680 = ptrtoint[8 x i8]* @str.680 to i32
  store i32 %spi680, i32* %10, align 16
  store i32 134517537, i32* %11, align 4
  %55 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i107.i, i32 inreg noundef %48, i32 noundef %tmp2_v5.i79.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %56 = lshr i64 %55, 32
  %57 = trunc i64 %56 to i32
  store i32 5, i32* %21, align 4
  %spi679 = ptrtoint[13 x i8]* @str.679 to i32
  store i32 %spi679, i32* %10, align 16
  store i32 134517557, i32* %11, align 4
  %58 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i107.i, i32 inreg noundef %57, i32 noundef %tmp2_v5.i79.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  %59 = lshr i64 %58, 32
  ...
  %spi678 = ptrtoint[14 x i8]* @str.678 to i32
  store i32 %spi678, i32* %10, align 16
  store i32 134517581, i32* %11, align 4
  %63 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i107.i, i32 inreg noundef %60, i32 noundef %tmp2_v5.i79.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !25
  ret void
}
...
!25 = !{!"printf"}
  ...
  tail call fastcc void @printf691(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
