...
@str.517 = constant [7 x i8] c"z: %d\0a\00"
@str.518 = constant [14 x i8] c"%d / %d = %f\0a\00"
@str.519 = constant [14 x i8] c"%d / %d = %d\0a\00"
...
define internal fastcc void @typecast520(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !22 {
.exit:
  ...
  %tmp2_v.i23.i = add i32 %tmp0_v.i3.i, -48
  %7 = inttoptr i32 %tmp2_v.i23.i to i32*
  store i32 5, i32* %7, align 16
  %tmp2_v1.i24.i = add i32 %tmp0_v.i3.i, -44
  %8 = inttoptr i32 %tmp2_v1.i24.i to i32*
  ...
  %tmp2_v8.i26.i = add i32 %tmp0_v.i3.i, -32
  %tmp5_v.i27.i = tail call fastcc i64 @helper_fstl_ST0()
  %11 = inttoptr i32 %tmp2_v8.i26.i to i64*
  store i64 %tmp5_v.i27.i, i64* %11, align 16
  tail call fastcc void @helper_fpop()
  ...
  %tmp2_v19.i34.i = add i32 %tmp0_v.i3.i, -72
  %27 = inttoptr i32 %tmp2_v19.i34.i to i32*
  store i32 %26, i32* %27, align 8
  %28 = load i32, i32* %7, align 16
  %tmp2_v22.i35.i = add i32 %tmp0_v.i3.i, -76
  %29 = inttoptr i32 %tmp2_v22.i35.i to i32*
  store i32 %28, i32* %29, align 4
  %tmp2_v25.i36.i = add i32 %tmp0_v.i3.i, -80
  %30 = inttoptr i32 %tmp2_v25.i36.i to i32*
  %spi519 = ptrtoint[14 x i8]* @str.519 to i32
  store i32 %spi519, i32* %30, align 16
  %tmp2_v26.i.i = add i32 %tmp0_v.i3.i, -84
  %31 = inttoptr i32 %tmp2_v26.i.i to i32*
  store i32 134517226, i32* %31, align 4
  %32 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %25, i32 noundef %tmp2_v25.i36.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !23
  %33 = lshr i64 %32, 32
  %34 = trunc i64 %33 to i32
  %tmp2_v.i12.i = add i32 %tmp0_v.i3.i, -28
  %35 = inttoptr i32 %tmp2_v.i12.i to i32*
  %36 = load i32, i32* %35, align 4
  store i32 %36, i32* %30, align 16
  %37 = inttoptr i32 %tmp2_v8.i26.i to i32*
  %38 = load i32, i32* %37, align 16
  store i32 %38, i32* %31, align 4
  %39 = load i32, i32* %8, align 4
  %tmp2_v9.i16.i = add i32 %tmp0_v.i3.i, -88
  %40 = inttoptr i32 %tmp2_v9.i16.i to i32*
  store i32 %39, i32* %40, align 8
  %41 = load i32, i32* %7, align 16
  %tmp2_v12.i17.i = add i32 %tmp0_v.i3.i, -92
  %42 = inttoptr i32 %tmp2_v12.i17.i to i32*
  store i32 %41, i32* %42, align 4
  %tmp2_v14.i19.i = add i32 %tmp0_v.i3.i, -96
  %43 = inttoptr i32 %tmp2_v14.i19.i to i32*
  %spi518 = ptrtoint[14 x i8]* @str.518 to i32
  store i32 %spi518, i32* %43, align 16
  %tmp2_v15.i.i = add i32 %tmp0_v.i3.i, -100
  %44 = inttoptr i32 %tmp2_v15.i.i to i32*
  store i32 134517256, i32* %44, align 4
  %45 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %34, i32 noundef %tmp2_v14.i19.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !23
  %46 = lshr i64 %45, 32
  %47 = trunc i64 %46 to i32
  %tmp2_v.i.i = add i32 %tmp0_v.i3.i, -40
  %48 = inttoptr i32 %tmp2_v.i.i to i32*
  store i32 2, i32* %48, align 8
  %49 = load i64, i64* inttoptr (i32 134520880 to i64*), align 16
  tail call fastcc void @helper_fldl_ST0(i64 %49)
  %tmp2_v3.i.i = add i32 %tmp0_v.i3.i, -24
  %tmp5_v4.i.i = tail call fastcc i64 @helper_fstl_ST0()
  %50 = inttoptr i32 %tmp2_v3.i.i to i64*
  ...
  %spi517 = ptrtoint[7 x i8]* @str.517 to i32
  store i32 %spi517, i32* %30, align 16
  store i32 134517324, i32* %31, align 4
  %60 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %47, i32 noundef %tmp2_v25.i36.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !23
  ret void
}
...
!23 = !{!"printf"}
  ...
  tail call fastcc void @typecast520(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
