...
define internal fastcc void @randomm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v4.i.i = add i32 %tmp0_v.i29.i, -8
  ...
  %tmp2_v.i11.i = add i32 %tmp0_v.i29.i, -48
  %8 = inttoptr i32 %tmp2_v.i11.i to i32*
  store i32 0, i32* %8, align 16
  %tmp2_v2.i12.i = add i32 %tmp0_v.i29.i, -52
  ...
  %tmp2_v.i4.i = add i32 %tmp0_v.i29.i, -24
  %11 = inttoptr i32 %tmp2_v.i4.i to i32*
  store i32 0, i32* %11, align 8
  %tmp2_v9.i.i = add i32 %tmp0_v.i29.i, -20
  %12 = inttoptr i32 %tmp2_v9.i.i to i32*
  %tmp2_v13.i.i = add i32 %tmp0_v.i29.i, -44
...
BB_8049239.i:                                     ; preds = %BB_8049239.i, %0
  ...
  %tmp0_v2.i42.i = ashr i32 %15, 3
  %tmp0_v3.i.i.neg = lshr i32 %14, 31
  %tmp0_v4.i43.i = add nsw i32 %tmp0_v2.i42.i, %tmp0_v3.i.i.neg
  %tmp0_v7.i45.i.neg = mul i32 %tmp0_v4.i43.i, -20
  %tmp0_v8.i.i = add i32 %tmp0_v7.i45.i.neg, %14
  %tmp2_v.i46.i = add i32 %tmp0_v8.i.i, 1
  store i32 %tmp2_v.i46.i, i32* %12, align 4
  store i32 %tmp2_v.i46.i, i32* %13, align 4
  store i32 134520840, i32* %8, align 16
  store i32 134517369, i32* %9, align 4
  %16 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v8.i.i, i32 inreg noundef %tmp0_v8.i.i, i32 noundef %tmp2_v.i11.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %17 = load i32, i32* %11, align 8
  %tmp0_v2.i23.i = add i32 %17, 1
  store i32 %tmp0_v2.i23.i, i32* %11, align 8
  %18 = icmp slt i32 %tmp0_v2.i23.i, 6
...
.exit:                                            ; preds = %BB_8049239.i
  ...
  store i32 134520844, i32* %8, align 16
  store i32 134517402, i32* %9, align 4
  %21 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v8.i.i, i32 inreg noundef %20, i32 noundef %tmp2_v.i11.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @randomm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
