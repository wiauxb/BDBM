...
define internal fastcc void @unionsm15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !18 {
Func_8049396.exit.i:
  ...
  %tmp2_v12.i.i = add i32 %tmp0_v.i9.i, -8260
  %6 = inttoptr i32 %tmp2_v12.i.i to i32*
  store i32 134517253, i32* %6, align 4
  %tmp4_v.i62.i.b = load i1, i1* @segs.0, align 1
  %7 = select i1 %tmp4_v.i62.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i66.i = add i32 %tmp0_v.i9.i, -20
  %9 = inttoptr i32 %tmp2_v2.i66.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i67.i = add i32 %tmp0_v.i9.i, -8248
  %10 = inttoptr i32 %tmp2_v3.i67.i to i32*
  ...
  %12 = inttoptr i32 %tmp2_v3.i67.i to i64*
  store i64 %tmp5_v2.i.i, i64* %12, align 8
  tail call fastcc void @helper_fpop()
  store i32 1953719668, i32* %10, align 8
  %tmp2_v5.i19.i = add i32 %tmp0_v.i9.i, -8244
  %13 = inttoptr i32 %tmp2_v5.i19.i to i32*
  store i32 858927392, i32* %13, align 4
  %tmp2_v6.i20.i = add i32 %tmp0_v.i9.i, -8240
  %14 = inttoptr i32 %tmp2_v6.i20.i to i8*
  store i8 0, i8* %14, align 16
  %15 = load i32, i32* %10, align 8
  %tmp2_v9.i.i = add i32 %tmp0_v.i9.i, -8268
  %16 = inttoptr i32 %tmp2_v9.i.i to i32*
  store i32 %15, i32* %16, align 4
  %tmp2_v12.i24.i = add i32 %tmp0_v.i9.i, -8272
  %17 = inttoptr i32 %tmp2_v12.i24.i to i32*
  store i32 134520840, i32* %17, align 16
  %tmp2_v13.i.i = add i32 %tmp0_v.i9.i, -8276
  %18 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 134517337, i32* %18, align 4
  %19 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef 0, i32 noundef %tmp2_v12.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %20 = lshr i64 %19, 32
  ...
  tail call fastcc void @helper_fpop()
  store i32 134520855, i32* %17, align 16
  store i32 134517368, i32* %18, align 4
  %24 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %21, i32 noundef %tmp2_v12.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %25 = lshr i64 %24, 32
  %26 = trunc i64 %25 to i32
  store i32 %tmp2_v3.i67.i, i32* %16, align 4
  store i32 134520870, i32* %17, align 16
  store i32 134517393, i32* %18, align 4
  %27 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %26, i32 noundef %tmp2_v12.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %28 = lshr i64 %27, 32
  ...
  %30 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %29, i32 noundef %tmp2_v12.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %31 = lshr i64 %30, 32
  %32 = trunc i64 %31 to i32
  %33 = load i64, i64* inttoptr (i32 134520976 to i64*), align 16
  tail call fastcc void @helper_fldl_ST0(i64 %33)
  %tmp5_v2.i110.i = tail call fastcc i64 @helper_fstl_ST0()
  store i64 %tmp5_v2.i110.i, i64* %12, align 8
  tail call fastcc void @helper_fpop()
  ...
  %35 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %32, i32 noundef %tmp2_v12.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %36 = lshr i64 %35, 32
  ...
  %38 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %37, i32 noundef %tmp2_v12.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %39 = lshr i64 %38, 32
  %40 = trunc i64 %39 to i32
  store i32 32, i32* %16, align 4
  store i32 134520885, i32* %17, align 16
  store i32 134517539, i32* %18, align 4
  %41 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %40, i32 noundef %tmp2_v12.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %42 = lshr i64 %41, 32
  %43 = trunc i64 %42 to i32
  store i32 1, i32* %16, align 4
  store i32 134520902, i32* %17, align 16
  store i32 134517559, i32* %18, align 4
  %44 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %43, i32 noundef %tmp2_v12.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %45 = lshr i64 %44, 32
  %46 = trunc i64 %45 to i32
  store i32 44, i32* %16, align 4
  store i32 134520917, i32* %17, align 16
  store i32 134517579, i32* %18, align 4
  %47 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %46, i32 noundef %tmp2_v12.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %48 = lshr i64 %47, 32
  %49 = trunc i64 %48 to i32
  %tmp2_v1.i144.i = add i32 %tmp0_v.i9.i, -8252
  %50 = inttoptr i32 %tmp2_v1.i144.i to i32*
  store i32 %tmp2_v3.i67.i, i32* %50, align 4
  store i32 %tmp2_v3.i67.i, i32* %16, align 4
  store i32 134520935, i32* %17, align 16
  store i32 134517616, i32* %18, align 4
  %51 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %49, i32 noundef %tmp2_v12.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %tmp2_v.i37.i = add i32 %tmp0_v.i9.i, -8216
  %52 = inttoptr i32 %tmp2_v.i37.i to i32*
  store i32 0, i32* %52, align 8
  %tmp2_v2.i39.i = add i32 %tmp0_v.i9.i, -8264
  %53 = inttoptr i32 %tmp2_v2.i39.i to i32*
  store i32 1024, i32* %53, align 8
  store i32 116, i32* %16, align 4
  %tmp0_v5.i.i = add i32 %tmp0_v.i9.i, -8212
  ...
  %tmp2_v.i33.i = add i32 %tmp0_v.i9.i, -8256
  %56 = inttoptr i32 %tmp2_v.i33.i to i32*
  store i32 0, i32* %56, align 16
  br label %BB_80493AF.i

BB_80493AF.i:                                     ; preds = %BB_80493AF.i, %Func_8049396.exit.i
  %storemerge14 = phi i32 [ 0, %Func_8049396.exit.i ], [ %tmp0_v2.i169.i, %BB_80493AF.i ]
  %tmp0_v2.i128.i = add i32 %storemerge14, %tmp0_v5.i.i
  %57 = inttoptr i32 %tmp0_v2.i128.i to i8*
  %58 = load i8, i8* %57, align 1
  %tmp0_v4.i.i = sext i8 %58 to i32
  store i32 %tmp0_v4.i.i, i32* %53, align 8
  %59 = load i32, i32* %56, align 16
  store i32 %59, i32* %16, align 4
  store i32 134520948, i32* %17, align 16
  store i32 134517721, i32* %18, align 4
  %60 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i8.i, i32 inreg noundef %tmp0_v5.i.i, i32 noundef %tmp2_v12.i24.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !19
  %61 = load i32, i32* %56, align 16
  %tmp0_v2.i169.i = add i32 %61, 1
  store i32 %tmp0_v2.i169.i, i32* %56, align 16
  %62 = icmp slt i32 %tmp0_v2.i169.i, 1024
...
!19 = !{!"printf"}
  ...
  tail call fastcc void @unionsm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
