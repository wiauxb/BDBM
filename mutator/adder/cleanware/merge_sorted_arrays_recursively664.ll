...
@str.662 = constant [2 x i8] c"\0a\00"
@str.663 = constant [4 x i8] c"%d \00"
...
define internal fastcc void @merge_sorted_arrays_recursively664(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v8.i60.i = add i32 %tmp0_v.i52.i, -100
  ...
  %tmp2_v17.i.i = add i32 %tmp0_v.i52.i, -120
  %22 = inttoptr i32 %tmp2_v17.i.i to i32*
  store i32 %tmp2_v8.i.i, i32* %22, align 8
  %tmp2_v18.i.i = add i32 %tmp0_v.i52.i, -124
  %23 = inttoptr i32 %tmp2_v18.i.i to i32*
  store i32 5, i32* %23, align 4
  %tmp2_v20.i.i = add i32 %tmp0_v.i52.i, -128
  %24 = inttoptr i32 %tmp2_v20.i.i to i32*
  store i32 %tmp2_v3.i.i, i32* %24, align 16
  %tmp2_v21.i.i = add i32 %tmp0_v.i52.i, -132
  %25 = inttoptr i32 %tmp2_v21.i.i to i32*
  store i32 134517337, i32* %25, align 4
  %26 = tail call fastcc { i32, i32, i32, i32 } @Func_merge(i32 %tmp2_v21.i.i, i32 0, i32 %tmp2_v4.i55.i, i32 %tmp2_v.i51.i)
  ...
  %tmp2_v.i11.i = add i32 %29, -88
  %31 = inttoptr i32 %tmp2_v.i11.i to i32*
  %tmp2_v1.i.i = add i32 %29, -48
  %tmp2_v5.i19.i = add i32 %27, 20
  %32 = inttoptr i32 %tmp2_v5.i19.i to i32*
  %tmp2_v7.i22.i = add i32 %27, 16
  %33 = inttoptr i32 %tmp2_v7.i22.i to i32*
  %tmp2_v8.i23.i = add i32 %27, 12
  %34 = inttoptr i32 %tmp2_v8.i23.i to i32*
  store i32 0, i32* %31, align 4
  br label %BB_8049265.i

BB_8049265.i:                                     ; preds = %BB_8049265.i, %0
  %r_edx.04 = phi i32 [ %28, %0 ], [ %39, %BB_8049265.i ]
  %storemerge3 = phi i32 [ 0, %0 ], [ %tmp0_v2.i.i, %BB_8049265.i ]
  %tmp4_v.i15.i = shl i32 %storemerge3, 2
  %tmp2_v2.i16.i = add i32 %tmp2_v1.i.i, %tmp4_v.i15.i
  %35 = inttoptr i32 %tmp2_v2.i16.i to i32*
  %36 = load i32, i32* %35, align 4
  store i32 %36, i32* %32, align 4
  %spi663 = ptrtoint[4 x i8]* @str.663 to i32
  store i32 %spi663, i32* %33, align 4
  store i32 134517372, i32* %34, align 4
  %37 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %30, i32 inreg noundef %r_edx.04, i32 noundef %tmp2_v7.i22.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %38 = lshr i64 %37, 32
  %39 = trunc i64 %38 to i32
  %40 = load i32, i32* %31, align 4
  %tmp0_v2.i.i = add i32 %40, 1
  store i32 %tmp0_v2.i.i, i32* %31, align 4
  %41 = icmp slt i32 %tmp0_v2.i.i, 9
  br i1 %41, label %BB_8049265.i, label %BB_8049289.i

BB_8049289.i:                                     ; preds = %BB_8049265.i
  %spi662 = ptrtoint[2 x i8]* @str.662 to i32
  store i32 %spi662, i32* %33, align 4
...
define internal fastcc { i32, i32, i32, i32 } @Func_merge(i32 %arg_esp, i32 %arg_edx, i32 %arg_ebp, i32 %arg_ecx) unnamed_addr  nofree nosync nounwind  !retregs !14 {
Func_80492CA.exit.i:
  ...
  %2 = inttoptr i32 %tmp2_v.i9.i to i32*
  %3 = load i32, i32* %2, align 4
  %.not.i.i = icmp eq i32 %3, 0
  br i1 %.not.i.i, label %.exit, label %Func_80492DF.exit.i

Func_80492DF.exit.i:                              ; preds = %Func_80492CA.exit.i
  %tmp2_v.i13.i = add i32 %arg_esp, 16
  %4 = inttoptr i32 %tmp2_v.i13.i to i32*
  %5 = load i32, i32* %4, align 4
  %6 = icmp eq i32 %5, 0
  %.pre = add i32 %arg_esp, 4
  %.pre27 = inttoptr i32 %.pre to i32*
  br i1 %6, label %Func_80492DF.exit.i.BB_804932B.i_crit_edge, label %BB_804931D.i
...
BB_804931D.i:                                     ; preds = %Func_80492DF.exit.i
  ...
  %.not.i25.i = icmp slt i32 %9, %13
  br i1 %.not.i25.i, label %BB_804932B.i, label %BB_804935D.i

BB_804932B.i:                                     ; preds = %BB_804931D.i, %Func_80492DF.exit.i.BB_804932B.i_crit_edge
  %.pre-phi30 = phi i32* [ %.pre29, %Func_80492DF.exit.i.BB_804932B.i_crit_edge ], [ %10, %BB_804931D.i ]
  %14 = load i32, i32* %.pre27, align 4
  %15 = inttoptr i32 %14 to i32*
  %16 = load i32, i32* %15, align 4
  %tmp2_v2.i31.i = add i32 %arg_esp, 20
  %17 = inttoptr i32 %tmp2_v2.i31.i to i32*
  %18 = load i32, i32* %17, align 4
  %19 = inttoptr i32 %18 to i32*
  store i32 %16, i32* %19, align 4
  %20 = load i32, i32* %17, align 4
  %tmp2_v6.i.i = add i32 %20, 4
  %21 = load i32, i32* %2, align 4
  %tmp2_v9.i.i = add i32 %21, -1
  %22 = load i32, i32* %.pre27, align 4
  %tmp0_v12.i.i = add i32 %22, 4
  %tmp2_v14.i.i = add i32 %arg_esp, -28
  %23 = inttoptr i32 %tmp2_v14.i.i to i32*
  store i32 %tmp2_v6.i.i, i32* %23, align 4
  %24 = load i32, i32* %4, align 4
  %tmp2_v17.i.i = add i32 %arg_esp, -32
  %25 = inttoptr i32 %tmp2_v17.i.i to i32*
  store i32 %24, i32* %25, align 4
  %26 = load i32, i32* %.pre-phi30, align 4
  %tmp2_v20.i.i = add i32 %arg_esp, -36
  %27 = inttoptr i32 %tmp2_v20.i.i to i32*
  store i32 %26, i32* %27, align 4
  %tmp2_v21.i.i = add i32 %arg_esp, -40
  %28 = inttoptr i32 %tmp2_v21.i.i to i32*
  store i32 %tmp2_v9.i.i, i32* %28, align 4
  %tmp2_v22.i.i = add i32 %arg_esp, -44
  %29 = inttoptr i32 %tmp2_v22.i.i to i32*
  store i32 %tmp0_v12.i.i, i32* %29, align 4
  %tmp2_v23.i.i = add i32 %arg_esp, -48
  %30 = inttoptr i32 %tmp2_v23.i.i to i32*
  store i32 134517592, i32* %30, align 4
  %31 = tail call fastcc { i32, i32, i32, i32 } @Func_merge(i32 %tmp2_v23.i.i, i32 %tmp2_v9.i.i, i32 %tmp2_v.i.i, i32 %tmp2_v6.i.i)
  %32 = extractvalue { i32, i32, i32, i32 } %31, 1
  %33 = extractvalue { i32, i32, i32, i32 } %31, 2
  %34 = extractvalue { i32, i32, i32, i32 } %31, 3
  br label %.exit
...
BB_804935D.i:                                     ; preds = %BB_804931D.i
  ...
  %tmp2_v15.i58.i = add i32 %arg_esp, -32
  %42 = inttoptr i32 %tmp2_v15.i58.i to i32*
  store i32 %tmp2_v9.i51.i, i32* %42, align 4
  %tmp2_v16.i.i = add i32 %arg_esp, -36
  %43 = inttoptr i32 %tmp2_v16.i.i to i32*
  store i32 %tmp0_v12.i54.i, i32* %43, align 4
  %44 = load i32, i32* %2, align 4
  %tmp2_v19.i.i = add i32 %arg_esp, -40
  %45 = inttoptr i32 %tmp2_v19.i.i to i32*
  store i32 %44, i32* %45, align 4
  %46 = load i32, i32* %.pre27, align 4
  ...
  store i32 134517642, i32* %48, align 4
  %49 = tail call fastcc { i32, i32, i32, i32 } @Func_merge(i32 %tmp2_v23.i62.i, i32 %tmp2_v9.i51.i, i32 %tmp2_v.i.i, i32 %tmp2_v6.i48.i)
  %50 = extractvalue { i32, i32, i32, i32 } %49, 1
  %51 = extractvalue { i32, i32, i32, i32 } %49, 2
  %52 = extractvalue { i32, i32, i32, i32 } %49, 3
  br label %.exit

.exit:                                            ; preds = %BB_804935D.i, %BB_804932B.i, %Func_80492CA.exit.i
  %r_ecx.0 = phi i32 [ %34, %BB_804932B.i ], [ %52, %BB_804935D.i ], [ %arg_ecx, %Func_80492CA.exit.i ]
  %r_edx.0 = phi i32 [ %32, %BB_804932B.i ], [ %50, %BB_804935D.i ], [ %arg_edx, %Func_80492CA.exit.i ]
  %r_ebp.0 = phi i32 [ %33, %BB_804932B.i ], [ %51, %BB_804935D.i ], [ %tmp2_v.i.i, %Func_80492CA.exit.i ]
...
!14 = !{i32 0, i32 1, i32 2, i32 3}
  ...
  tail call fastcc void @merge_sorted_arrays_recursively664(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
