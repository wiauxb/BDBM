...
define internal fastcc void @memmovem15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
  ...
  %8 = select i1 %tmp4_v.i70.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %9 = load i32, i32* %8, align 4
  %tmp2_v2.i74.i = add i32 %tmp0_v.i51.i, -20
  %10 = inttoptr i32 %tmp2_v2.i74.i to i32*
  store i32 %9, i32* %10, align 4
  %tmp2_v3.i75.i = add i32 %tmp0_v.i51.i, -100
  %11 = inttoptr i32 %tmp2_v3.i75.i to i32*
  store i32 1, i32* %11, align 4
  %tmp2_v4.i76.i = add i32 %tmp0_v.i51.i, -96
  %12 = inttoptr i32 %tmp2_v4.i76.i to i32*
  store i32 2, i32* %12, align 16
  %tmp2_v5.i77.i = add i32 %tmp0_v.i51.i, -92
  %13 = inttoptr i32 %tmp2_v5.i77.i to i32*
  store i32 3, i32* %13, align 4
  %tmp2_v6.i78.i = add i32 %tmp0_v.i51.i, -88
  %14 = inttoptr i32 %tmp2_v6.i78.i to i32*
  store i32 4, i32* %14, align 8
  %tmp2_v7.i.i = add i32 %tmp0_v.i51.i, -84
  %15 = inttoptr i32 %tmp2_v7.i.i to i32*
  store i32 5, i32* %15, align 4
  %tmp2_v8.i79.i = add i32 %tmp0_v.i51.i, -80
  %16 = inttoptr i32 %tmp2_v8.i79.i to i32*
  store i32 6, i32* %16, align 16
  %tmp2_v9.i80.i = add i32 %tmp0_v.i51.i, -76
  %17 = inttoptr i32 %tmp2_v9.i80.i to i32*
  store i32 7, i32* %17, align 4
  %tmp2_v10.i81.i = add i32 %tmp0_v.i51.i, -72
  %18 = inttoptr i32 %tmp2_v10.i81.i to i32*
  store i32 8, i32* %18, align 8
  %tmp2_v11.i82.i = add i32 %tmp0_v.i51.i, -68
  %19 = inttoptr i32 %tmp2_v11.i82.i to i32*
...
BB_804926D.i:                                     ; preds = %BB_804926D.i, %0
  ...
  %53 = icmp slt i32 %tmp0_v2.i.i, 10
  br i1 %53, label %BB_804926D.i, label %BB_8049294.i

BB_804929D.i:                                     ; preds = %BB_8049294.i, %BB_804929D.i
  %r_edx.110 = phi i32 [ %62, %BB_8049294.i ], [ %59, %BB_804929D.i ]
  %storemerge19 = phi i32 [ 0, %BB_8049294.i ], [ %tmp0_v2.i44.i, %BB_804929D.i ]
  %tmp4_v.i21.i = shl i32 %storemerge19, 2
  %tmp2_v2.i22.i = add i32 %tmp4_v.i21.i, %tmp2_v3.i75.i
  %54 = inttoptr i32 %tmp2_v2.i22.i to i32*
  %55 = load i32, i32* %54, align 4
  store i32 %55, i32* %42, align 8
  %56 = load i32, i32* %63, align 8
  store i32 %56, i32* %43, align 4
  store i32 134520860, i32* %44, align 16
  store i32 134517431, i32* %45, align 4
  %57 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i50.i, i32 inreg noundef %r_edx.110, i32 noundef %tmp2_v10.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %58 = lshr i64 %57, 32
  %59 = trunc i64 %58 to i32
  %60 = load i32, i32* %63, align 8
  %tmp0_v2.i44.i = add i32 %60, 1
  store i32 %tmp0_v2.i44.i, i32* %63, align 8
  %61 = icmp slt i32 %tmp0_v2.i44.i, 10
  br i1 %61, label %BB_804929D.i, label %.exit

BB_8049294.i:                                     ; preds = %BB_804926D.i
  %62 = trunc i64 %50 to i32
  %tmp2_v.i84.i = add i32 %tmp0_v.i51.i, -104
  %63 = inttoptr i32 %tmp2_v.i84.i to i32*
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @memmovem15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
