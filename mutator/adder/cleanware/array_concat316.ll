...
define internal fastcc void @array_concat316(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %6 = inttoptr i32 %tmp2_v6.i7.i to i32*
  ...
  %tmp2_v2.i48.i = add i32 %tmp0_v.i3.i, -84
  ...
  %tmp2_v18.i.i = add i32 %tmp0_v.i3.i, -104
  ...
  %tmp2_v.i10.i.i = add i32 %tmp0_v.i3.i, -120
  %28 = inttoptr i32 %tmp2_v.i10.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %28, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i3.i, -124
  %29 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 134529024, i32* %29, align 4
  %tmp2_v2.i13.i.i = add i32 %tmp0_v.i3.i, -148
  %30 = inttoptr i32 %tmp2_v2.i13.i.i to i32*
  ...
  %tmp2_v.i17.i.i = add i32 %tmp0_v.i3.i, -132
  %36 = inttoptr i32 %tmp2_v.i17.i.i to i32*
  store i32 %35, i32* %36, align 4
  %37 = load i32, i32* %25, align 4
  %tmp0_v3.i19.i.i = shl i32 %37, 2
  %tmp2_v5.i21.i.i = add i32 %tmp0_v.i3.i, -152
  %38 = inttoptr i32 %tmp2_v5.i21.i.i to i32*
  store i32 %tmp0_v3.i19.i.i, i32* %38, align 8
  %39 = load i32, i32* %26, align 16
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i3.i, -156
  ...
  %tmp2_v.i68.i = add i32 %52, -56
  %53 = inttoptr i32 %tmp2_v.i68.i to i32*
  store i32 %50, i32* %53, align 4
  %tmp2_v1.i69.i = add i32 %52, -60
  %54 = inttoptr i32 %tmp2_v1.i69.i to i32*
  %tmp2_v10.i.i = add i32 %51, -8184
  store i32 0, i32* %54, align 4
  br label %BB_80492D0.i

BB_80492D0.i:                                     ; preds = %BB_80492D0.i, %0
  %storemerge5 = phi i32 [ 0, %0 ], [ %tmp0_v2.i23.i, %BB_80492D0.i ]
  %tmp4_v.i.i = shl i32 %storemerge5, 2
  %55 = load i32, i32* %53, align 4
  %tmp0_v3.i.i = add i32 %55, %tmp4_v.i.i
  %56 = inttoptr i32 %tmp0_v3.i.i to i32*
  ...
  %59 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp4_v4.i.i.i, i32 inreg noundef %tmp4_v.i.i, i32 noundef %tmp2_v21.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %60 = load i32, i32* %54, align 4
  %tmp0_v2.i23.i = add i32 %60, 1
  store i32 %tmp0_v2.i23.i, i32* %54, align 4
  %61 = icmp slt i32 %tmp0_v2.i23.i, 10
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @array_concat316(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
