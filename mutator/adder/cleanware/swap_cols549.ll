...
define internal fastcc void @swap_cols549(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @swap_cols549(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
