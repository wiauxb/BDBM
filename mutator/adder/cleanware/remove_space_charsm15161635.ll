...
define internal fastcc void @remove_space_charsm15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v8.i30.i = add i32 %tmp0_v.i.i, -27
  ...
  store i32 %tmp2_v3.i26.i, i32* %18, align 4
  ...
  %21 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i.i, i32 inreg noundef 0, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  store i32 %tmp2_v3.i26.i, i32* %19, align 16
  store i32 134517336, i32* %20, align 4
  %tmp2_v.i36.i.i = add i32 %tmp0_v.i.i, -72
  %22 = inttoptr i32 %tmp2_v.i36.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %22, align 8
  %tmp2_v1.i38.i.i = add i32 %tmp0_v.i.i, -76
  %23 = inttoptr i32 %tmp2_v1.i38.i.i to i32*
  store i32 134529024, i32* %23, align 4
  %tmp2_v2.i40.i.i = add i32 %tmp0_v.i.i, -100
  ...
  %tmp2_v4.i19.i.i = add i32 %tmp0_v.i.i, -116
  ...
  %tmp2_v2.i4.i.i = add i32 %tmp0_v.i.i, -88
  %31 = inttoptr i32 %tmp2_v2.i4.i.i to i32*
...
BB_80492F1.i.i:                                   ; preds = %BB_80492D8.i.i, %BB_80492C9.i.i
  %34 = phi i32 [ %storemerge19.i, %BB_80492C9.i.i ], [ %.pre.i, %BB_80492D8.i.i ]
  ...
  br i1 %36, label %BB_80492C9.i.i, label %Func_remove_spaces.exit
...
BB_80492C9.i.i:                                   ; preds = %BB_80492F1.i.i, %.exit
  ...
  %tmp0_v3.i9.i.i = add i32 %37, %storemerge19.i
  %38 = inttoptr i32 %tmp0_v3.i9.i.i to i8*
  %39 = load i8, i8* %38, align 1
  %40 = icmp eq i8 %39, 32
  br i1 %40, label %BB_80492F1.i.i, label %BB_80492D8.i.i

BB_80492D8.i.i:                                   ; preds = %BB_80492C9.i.i
  %41 = load i32, i32* %30, align 4
  %tmp0_v8.i.i.i = add i32 %41, %37
...
Func_remove_spaces.exit:                          ; preds = %BB_80492F1.i.i, %.exit
  ...
  %tmp2_v.i15.i = add i32 %48, -39
  store i32 %tmp2_v.i15.i, i32* %18, align 4
  %tmp2_v3.i17.i = add i32 %47, -8168
  store i32 %tmp2_v3.i17.i, i32* %19, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @remove_space_charsm15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
