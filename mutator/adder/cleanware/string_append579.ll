...
@str.578 = constant [11 x i8] c"first: %s\0a\00"
...
define internal fastcc void @string_append579(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %spi578 = ptrtoint[11 x i8]* @str.578 to i32
  store i32 %spi578, i32* %19, align 16
  store i32 134517439, i32* %20, align 4
  %22 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i12.i, i32 inreg noundef 0, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %tmp2_v.i33.i = add i32 %tmp0_v.i13.i, -59
  %23 = inttoptr i32 %tmp2_v.i33.i to i32*
  store i32 6513249, i32* %23, align 4
  %tmp2_v1.i.i = add i32 %tmp0_v.i13.i, -55
  %24 = inttoptr i32 %tmp2_v1.i.i to i32*
  store i32 2054781047, i32* %24, align 4
  %tmp2_v2.i34.i = add i32 %tmp0_v.i13.i, -51
  %25 = inttoptr i32 %tmp2_v2.i34.i to i8*
  store i8 0, i8* %25, align 1
  store i32 %tmp2_v1.i.i, i32* %18, align 4
  store i32 %tmp2_v.i33.i, i32* %19, align 16
  store i32 134517476, i32* %20, align 4
  %tmp2_v.i65.i.i = add i32 %tmp0_v.i13.i, -88
  %26 = inttoptr i32 %tmp2_v.i65.i.i to i32*
  store i32 %tmp2_v4.i15.i, i32* %26, align 8
  %tmp2_v1.i67.i.i = add i32 %tmp0_v.i13.i, -92
  %27 = inttoptr i32 %tmp2_v1.i67.i.i to i32*
  store i32 134529024, i32* %27, align 4
  %tmp2_v2.i70.i.i = add i32 %tmp0_v.i13.i, -132
  %28 = inttoptr i32 %tmp2_v2.i70.i.i to i32*
  store i32 134517565, i32* %28, align 4
  %29 = load i32, i32* %19, align 16
  %tmp2_v3.i29.i.i = add i32 %tmp0_v.i13.i, -144
  %30 = inttoptr i32 %tmp2_v3.i29.i.i to i32*
  store i32 %29, i32* %30, align 16
  %tmp2_v4.i30.i.i = add i32 %tmp0_v.i13.i, -148
  %31 = inttoptr i32 %tmp2_v4.i30.i.i to i32*
  store i32 134517582, i32* %31, align 4
  %arg.i.i.i = load i32, i32* %30, align 16
  %32 = tail call i32 @strlen(i32 %arg.i.i.i)
  %tmp2_v.i41.i.i = add i32 %tmp0_v.i13.i, -112
  %33 = inttoptr i32 %tmp2_v.i41.i.i to i32*
  ...
  %tmp2_v.i17.i.i = add i32 %tmp0_v.i13.i, -108
  %36 = inttoptr i32 %tmp2_v.i17.i.i to i32*
  store i32 %35, i32* %36, align 4
  %37 = load i32, i32* %33, align 16
  %tmp0_v5.i21.i.i = add i32 %35, 1
  %tmp0_v6.i.i.i = add i32 %tmp0_v5.i21.i.i, %37
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i13.i, -104
  %38 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  store i32 %tmp0_v6.i.i.i, i32* %38, align 8
  %tmp2_v11.i.i.i = add i32 %tmp0_v.i13.i, -140
  ...
  %tmp2_v.i.i.i = add i32 %tmp0_v.i13.i, -100
  %41 = inttoptr i32 %tmp2_v.i.i.i to i32*
  store i32 %40, i32* %41, align 4
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i13.i, -120
...
BB_80493BA.i.i:                                   ; preds = %BB_80493B1.i.i, %BB_80493BA.i.i
  ...
  %tmp0_v3.i.i.i = add i32 %45, %storemerge2735.i
  ...
  %48 = inttoptr i32 %tmp0_v3.i.i.i to i8*
...
BB_80493B1.i.i:                                   ; preds = %BB_8049390.i.i, %.exit
  %r_ecx.0.lcssa.i = phi i32 [ %tmp2_v.i12.i, %.exit ], [ %storemerge34.i, %BB_8049390.i.i ]
  %tmp2_v.i13.i.i = add i32 %tmp0_v.i13.i, -116
  %54 = inttoptr i32 %tmp2_v.i13.i.i to i32*
...
BB_8049390.i.i:                                   ; preds = %BB_8049390.i.i, %.exit
  %storemerge34.i = phi i32 [ %tmp0_v12.i58.i.i, %BB_8049390.i.i ], [ 0, %.exit ]
  %57 = load i32, i32* %19, align 16
  %tmp0_v3.i50.i.i = add i32 %57, %storemerge34.i
  %58 = load i32, i32* %41, align 4
  %tmp0_v8.i55.i.i = add i32 %58, %storemerge34.i
  %59 = inttoptr i32 %tmp0_v3.i50.i.i to i8*
  %60 = load i8, i8* %59, align 1
  %61 = inttoptr i32 %tmp0_v8.i55.i.i to i8*
  store i8 %60, i8* %61, align 1
  %62 = load i32, i32* %42, align 8
  %tmp0_v12.i58.i.i = add i32 %62, 1
  store i32 %tmp0_v12.i58.i.i, i32* %42, align 8
  %63 = load i32, i32* %33, align 16
  %64 = icmp slt i32 %tmp0_v12.i58.i.i, %63
  br i1 %64, label %BB_8049390.i.i, label %BB_80493B1.i.i

Func_string_append.exit:                          ; preds = %BB_80493B1.i.i, %BB_80493BA.i.i
  %r_ecx.1.lcssa.i = phi i32 [ %r_ecx.0.lcssa.i, %BB_80493B1.i.i ], [ %tmp0_v8.i.i.i, %BB_80493BA.i.i ]
  ...
  %72 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %r_ecx.1.lcssa.i, i32 inreg noundef %tmp2_v1.i74.i.i, i32 noundef %tmp2_v15.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @string_append579(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
