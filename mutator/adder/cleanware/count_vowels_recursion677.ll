...
define internal fastcc void @count_vowels_recursion677(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
...
Func_8049295.exit.i:
  ...
  %3 = inttoptr i32 %tmp2_v.i19.i to i32*
...
BB_80492FA.i:                                     ; preds = %BB_80492CB.i
  ...
  store i32 %tmp0_v1.i.i, i32* %12, align 4
  store i32 134517513, i32* %13, align 4
  %8 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_count_vowels(i32 %tmp2_v5.i.i, i32 %tmp2_v.i13.i, i32 134529024)
...
BB_80492AB.i:                                     ; preds = %Func_8049295.exit.i
  %tmp0_v2.i5.i = sext i8 %6 to i32
  %tmp2_v4.i7.i = add i32 %arg_esp, -44
  %12 = inttoptr i32 %tmp2_v4.i7.i to i32*
  store i32 %tmp0_v2.i5.i, i32* %12, align 4
  ...
  br i1 %17, label %BB_80492E3.i, label %BB_80492CB.i

BB_80492E3.i:                                     ; preds = %BB_80492CB.i, %BB_80492CB.i, %BB_80492CB.i, %BB_80492CB.i, %BB_80492AB.i
  %18 = load i32, i32* %3, align 4
  %tmp0_v1.i29.i = add i32 %18, 1
  store i32 %tmp0_v1.i29.i, i32* %12, align 4
  store i32 134517490, i32* %13, align 4
  %19 = tail call fastcc { i32, i32, i32, i32, i32 } @Func_count_vowels(i32 %tmp2_v5.i.i, i32 %tmp2_v.i13.i, i32 134529024)
  %20 = extractvalue { i32, i32, i32, i32, i32 } %19, 1
  %21 = extractvalue { i32, i32, i32, i32, i32 } %19, 2
  %22 = extractvalue { i32, i32, i32, i32, i32 } %19, 3
  %tmp0_v1.i11.i = add i32 %20, 1
  br label %.exit
...
.exit:                                            ; preds = %BB_80492E3.i, %BB_80492FA.i, %Func_8049295.exit.i
  %r_ebp.0 = phi i32 [ %22, %BB_80492E3.i ], [ %11, %BB_80492FA.i ], [ %tmp2_v.i13.i, %Func_8049295.exit.i ]
  %r_eax.0 = phi i32 [ %tmp0_v1.i11.i, %BB_80492E3.i ], [ %9, %BB_80492FA.i ], [ 0, %Func_8049295.exit.i ]
  %r_edx.0 = phi i32 [ %21, %BB_80492E3.i ], [ %10, %BB_80492FA.i ], [ 0, %Func_8049295.exit.i ]
  %tmp2_v.i65.i = add i32 %r_ebp.0, -4
  %25 = inttoptr i32 %tmp2_v.i65.i to i32*
...
!14 = !{i32 0, i32 3, i32 4}
  ...
  tail call fastcc void @count_vowels_recursion677(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
