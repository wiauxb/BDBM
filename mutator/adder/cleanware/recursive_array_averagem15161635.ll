...
define internal fastcc void @recursive_array_averagem15161635(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !22 {
Func_80491F6.exit.i:
  ...
  %9 = select i1 %tmp4_v.i39.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %10 = load i32, i32* %9, align 4
  %tmp2_v2.i43.i = add i32 %tmp0_v.i.i, -36
  %11 = inttoptr i32 %tmp2_v2.i43.i to i32*
  store i32 %10, i32* %11, align 4
  %tmp2_v3.i44.i = add i32 %tmp0_v.i.i, -120
  ...
  %tmp4_v3.i.i = add i32 %tmp0_v2.i26.i, %tmp2_v3.i44.i
  ...
  store i32 134520864, i32* %79, align 4
  %tmp2_v5.i6.i = add i32 %76, -4
  %80 = inttoptr i32 %tmp2_v5.i6.i to i32*
  store i32 134517287, i32* %80, align 4
  %81 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef 0, i32 inreg noundef %77, i32 noundef %76, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !23
  ret void
}

; Function Attrs: nofree nosync nounwind
define internal fastcc { i32, i32, i32 } @Func_average(i32 %arg_esp, i32 %arg_ebp) unnamed_addr  nofree nosync nounwind  !retregs !24 {
Func_804925B.exit.i:
...
BB_804927E.i:                                     ; preds = %Func_804925B.exit.i
  %tmp0_v1.i4.i = add i32 %3, -1
  %tmp2_v3.i7.i = add i32 %arg_esp, -40
  %4 = inttoptr i32 %tmp2_v3.i7.i to i32*
  store i32 %tmp0_v1.i4.i, i32* %4, align 4
  %tmp2_v4.i8.i = add i32 %arg_esp, 4
  %5 = inttoptr i32 %tmp2_v4.i8.i to i32*
  %6 = load i32, i32* %5, align 4
  %tmp2_v6.i.i = add i32 %arg_esp, -44
  %7 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 %6, i32* %7, align 4
  %tmp2_v7.i10.i = add i32 %arg_esp, -48
  %8 = inttoptr i32 %tmp2_v7.i10.i to i32*
  store i32 134517392, i32* %8, align 4
  %9 = tail call fastcc { i32, i32, i32 } @Func_average(i32 %tmp2_v7.i10.i, i32 %tmp2_v.i26.i)
  ...
  %tmp0_v12.i.i = add i32 %tmp4_v.i.i, %16
...
.exit:                                            ; preds = %BB_8049266.i, %BB_804927E.i
  ...
  %r_edx.0 = phi i32 [ 0, %BB_8049266.i ], [ %tmp4_v.i.i, %BB_804927E.i ]
...
!20 = !{!21, !21, i64 0}
!21 = !{!"int", !18, i64 0}
!22 = !{i32 0, i32 0, i32 0, i32 0, i32 0}
!23 = !{!"printf"}
!24 = !{i32 0, i32 2}

  tail call fastcc void @recursive_array_averagem15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
