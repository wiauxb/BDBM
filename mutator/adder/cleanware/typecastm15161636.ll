...
define internal fastcc void @typecastm15161636(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !22 {
.exit:
  ...
  %tmp2_v.i12.i = add i32 %tmp0_v.i.i, -48
  ...
  %tmp2_v8.i14.i = add i32 %tmp0_v.i.i, -32
  ...
  %tmp2_v.i4.i = add i32 %tmp0_v.i.i, -28
  ...
  store i32 134520854, i32* %43, align 16
  %tmp2_v15.i.i = add i32 %tmp0_v.i.i, -100
  ...
  store i32 134520868, i32* %30, align 16
...
!23 = !{!"printf"}
  ...
  tail call fastcc void @typecastm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
