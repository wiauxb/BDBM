...
@str.727 = constant [14 x i8] c"RAND_MAX: %d\0a\00"
@str.728 = constant [4 x i8] c"%d\0a\00"
...
define internal fastcc void @random730(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v.i.i = add i32 %tmp0_v.i21.i, -48
  %8 = inttoptr i32 %tmp2_v.i.i to i32*
  store i32 0, i32* %8, align 16
  %tmp2_v2.i.i = add i32 %tmp0_v.i21.i, -52
  ...
  %tmp2_v.i44.i = add i32 %tmp0_v.i21.i, -24
  %11 = inttoptr i32 %tmp2_v.i44.i to i32*
  store i32 0, i32* %11, align 8
  %tmp2_v9.i.i = add i32 %tmp0_v.i21.i, -20
  %12 = inttoptr i32 %tmp2_v9.i.i to i32*
  %tmp2_v13.i.i = add i32 %tmp0_v.i21.i, -44
...
BB_8049239.i:                                     ; preds = %BB_8049239.i, %0
  ...
  %tmp0_v2.i11.i = ashr i32 %15, 3
  %tmp0_v3.i.i.neg = lshr i32 %14, 31
  %tmp0_v4.i12.i = add nsw i32 %tmp0_v2.i11.i, %tmp0_v3.i.i.neg
  %tmp0_v7.i.i.neg = mul i32 %tmp0_v4.i12.i, -20
  %tmp0_v8.i.i = add i32 %tmp0_v7.i.i.neg, %14
  %tmp2_v.i13.i = add i32 %tmp0_v8.i.i, 1
  store i32 %tmp2_v.i13.i, i32* %12, align 4
  store i32 %tmp2_v.i13.i, i32* %13, align 4
  %spi728 = ptrtoint[4 x i8]* @str.728 to i32
  store i32 %spi728, i32* %8, align 16
  store i32 134517369, i32* %9, align 4
  %16 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v8.i.i, i32 inreg noundef %tmp0_v8.i.i, i32 noundef %tmp2_v.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  %17 = load i32, i32* %11, align 8
  %tmp0_v2.i.i = add i32 %17, 1
  store i32 %tmp0_v2.i.i, i32* %11, align 8
  %18 = icmp slt i32 %tmp0_v2.i.i, 6
...
.exit:                                            ; preds = %BB_8049239.i
  ...
  %spi727 = ptrtoint[14 x i8]* @str.727 to i32
  store i32 %spi727, i32* %8, align 16
  store i32 134517402, i32* %9, align 4
  %21 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp0_v8.i.i, i32 inreg noundef %20, i32 noundef %tmp2_v.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
