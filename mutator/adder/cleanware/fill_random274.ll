...
define internal fastcc void @fill_random274(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
  ...
  %tmp2_v6.i39.i = add i32 %tmp0_v.i32.i, -16
  %6 = inttoptr i32 %tmp2_v6.i39.i to i32*
  store i32 %tmp2_v.i31.i, i32* %6, align 16
  %tmp2_v8.i41.i = add i32 %tmp0_v.i32.i, -436
  ...
  %tmp2_v4.i11.i = add i32 %tmp0_v.i32.i, -448
  %11 = inttoptr i32 %tmp2_v4.i11.i to i32*
  store i32 0, i32* %11, align 16
  %tmp2_v5.i.i = add i32 %tmp0_v.i32.i, -452
  ...
  %tmp2_v.i50.i = add i32 %tmp0_v.i32.i, -440
  %14 = inttoptr i32 %tmp2_v.i50.i to i32*
  store i32 200, i32* %14, align 8
  %tmp2_v2.i51.i = add i32 %tmp0_v.i32.i, -444
  %15 = inttoptr i32 %tmp2_v2.i51.i to i32*
  store i32 100, i32* %15, align 4
  %tmp2_v3.i53.i = add i32 %tmp0_v.i32.i, -420
  store i32 %tmp2_v3.i53.i, i32* %11, align 16
  store i32 134517364, i32* %12, align 4
  %tmp2_v.i11.i.i = add i32 %tmp0_v.i32.i, -456
  %16 = inttoptr i32 %tmp2_v.i11.i.i to i32*
  store i32 %tmp2_v4.i35.i, i32* %16, align 8
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i32.i, -460
  %17 = inttoptr i32 %tmp2_v1.i.i.i to i32*
  store i32 134529024, i32* %17, align 4
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i32.i, -484
  %18 = inttoptr i32 %tmp2_v2.i.i.i to i32*
  store i32 134517481, i32* %18, align 4
  %tmp4_v.i.i.i.i = add i32 %tmp0_v.i32.i, -480
  %mrv.i.i = insertvalue { i32, i32 } undef, i32 %tmp4_v.i.i.i.i, 0
  %tmp2_v.i.i.i = add i32 %tmp0_v.i32.i, -468
...
BB_80492F8.i.i:                                   ; preds = %BB_80492F8.i.i, %0
  ...
  %tmp2_v.i9.i.i = add i32 %r_esp.05.i, -4
  %22 = inttoptr i32 %tmp2_v.i9.i.i to i32*
  store i32 134517501, i32* %22, align 4
  %23 = tail call i32 @rand()
  %tmp0_v.i2.i.i = ashr i32 %23, 31
  %24 = load i32, i32* %14, align 8
  %25 = zext i32 %23 to i64
  %26 = zext i32 %tmp0_v.i2.i.i to i64
  ...
  %tmp0_v7.i.i.i = add i32 %37, %tmp4_v.i7.i.i
...
Func_fill_random.exit:                            ; preds = %Func_fill_random.exit.loopexit, %0
  ...
  %r_ecx.0.lcssa.i = phi i32 [ %tmp2_v.i31.i, %0 ], [ %42, %Func_fill_random.exit.loopexit ]
  ...
  %tmp2_v.i58.i = add i32 %46, -416
  %47 = inttoptr i32 %tmp2_v.i58.i to i32*
  %tmp2_v1.i15.i = add i32 %46, -412
  %tmp2_v5.i20.i = add i32 %r_esp.0.le.i, 40
  %48 = inttoptr i32 %tmp2_v5.i20.i to i32*
...
BB_8049283.i:                                     ; preds = %BB_8049283.i, %Func_fill_random.exit
  ...
  %storemerge10 = phi i32 [ 0, %Func_fill_random.exit ], [ %tmp0_v2.i27.i, %BB_8049283.i ]
  %tmp4_v.i16.i = shl i32 %storemerge10, 2
  %tmp2_v2.i17.i = add i32 %tmp2_v1.i15.i, %tmp4_v.i16.i
  %52 = inttoptr i32 %tmp2_v2.i17.i to i32*
  ...
  %tmp0_v2.i27.i = add i32 %58, 1
  store i32 %tmp0_v2.i27.i, i32* %47, align 4
  %59 = icmp slt i32 %tmp0_v2.i27.i, 100
