...
define internal fastcc void @count_punct172(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v.i2.i.i = add i32 %tmp0_v.i.i, -88
  %21 = inttoptr i32 %tmp2_v.i2.i.i to i32*
  store i32 %tmp2_v4.i.i, i32* %21, align 8
  %tmp2_v1.i4.i.i = add i32 %tmp0_v.i.i, -92
  %22 = inttoptr i32 %tmp2_v1.i4.i.i to i32*
  store i32 134529024, i32* %22, align 4
  %tmp2_v2.i6.i.i = add i32 %tmp0_v.i.i, -116
  %23 = inttoptr i32 %tmp2_v2.i6.i.i to i32*
  ...
  %tmp2_v4.i50.i.i = add i32 %tmp0_v.i.i, -132
  %26 = inttoptr i32 %tmp2_v4.i50.i.i to i32*
  ...
  %tmp2_v2.i.i.i = add i32 %tmp0_v.i.i, -104
...
BB_8049304.i.i:                                   ; preds = %BB_80492DE.i.i
  ...
  %tmp0_v1.i26.i.i = add i32 %33, 1
  store i32 %tmp0_v1.i26.i.i, i32* %29, align 4
...
BB_8049308.i.i:                                   ; preds = %BB_80492DE.i.i, %BB_8049304.i.i
  ...
  store i32 %tmp0_v1.i37.i.i, i32* %30, align 8
  %35 = load i32, i32* %28, align 4
  %36 = icmp slt i32 %tmp0_v1.i37.i.i, %35
...
BB_80492DE.i.i:                                   ; preds = %BB_8049308.i.i, %.exit
  ...
  %tmp0_v4.i21.i.i = add i32 %41, %40
  %42 = inttoptr i32 %tmp0_v4.i21.i.i to i8*
...
Func_count_punct.exit:                            ; preds = %BB_8049308.i.i, %.exit
  %r_ecx.0.lcssa.i = phi i32 [ %tmp2_v.i.i, %.exit ], [ %40, %BB_8049308.i.i ]
  %r_edx.0.lcssa.i = phi i32 [ 0, %.exit ], [ %tmp0_v7.i.i.i, %BB_8049308.i.i ]
  %48 = load i32, i32* %29, align 4
  %49 = load i32, i32* %22, align 4
  %50 = load i32, i32* %21, align 8
  %tmp2_v.i20.i = add i32 %50, -52
  %51 = inttoptr i32 %tmp2_v.i20.i to i32*
  store i32 %48, i32* %51, align 4
  %tmp2_v4.i24.i = add i32 %tmp0_v.i.i, -76
  %52 = inttoptr i32 %tmp2_v4.i24.i to i32*
  store i32 %48, i32* %52, align 4
  %tmp2_v5.i26.i = add i32 %49, -8184
  store i32 %tmp2_v5.i26.i, i32* %19, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @count_punct172(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
