...
@str.271 = constant [8 x i8] c"The End\00"
@str.272 = constant [23 x i8] c"goto statement jumping\00"
@str.273 = constant [12 x i8] c"Statement 3\00"
@str.274 = constant [12 x i8] c"Statement 1\00"
...
define internal fastcc void @goto275(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
label_1.i17.i:
  ...
  %tmp2_v2.i54.i = add i32 %tmp0_v.i2.i, -48
  %7 = inttoptr i32 %tmp2_v2.i54.i to i32*
  %spi274 = ptrtoint[12 x i8]* @str.274 to i32
  store i32 %spi274, i32* %7, align 16
  %tmp2_v3.i55.i = add i32 %tmp0_v.i2.i, -52
  %8 = inttoptr i32 %tmp2_v3.i55.i to i32*
  ...
  %spi273 = ptrtoint[12 x i8]* @str.273 to i32
  store i32 %spi273, i32* %7, align 16
  ...
  %tmp2_v.i21.i = add i32 %tmp0_v.i2.i, -28
  %13 = inttoptr i32 %tmp2_v.i21.i to i32*
  store i32 0, i32* %13, align 4
  %tmp2_v.i5.i = add i32 %tmp0_v.i2.i, -24
  %14 = inttoptr i32 %tmp2_v.i5.i to i32*
  store i32 0, i32* %14, align 8
  %tmp2_v.i34.i = add i32 %tmp0_v.i2.i, -20
  %15 = inttoptr i32 %tmp2_v.i34.i to i32*
  store i32 5, i32* %15, align 4
  %spi272 = ptrtoint[23 x i8]* @str.272 to i32
  store i32 %spi272, i32* %7, align 16
  ...
  %spi271 = ptrtoint[8 x i8]* @str.271 to i32
  store i32 %spi271, i32* %7, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @goto275(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
