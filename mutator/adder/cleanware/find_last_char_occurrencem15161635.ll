...
define internal fastcc void @find_last_char_occurrencem15161635(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
Func_804922F.exit.i:
  ...
  %tmp2_v8.i38.i = add i32 %tmp0_v.i30.i, -52
  %6 = inttoptr i32 %tmp2_v8.i38.i to i32*
  store i32 134517233, i32* %6, align 4
  %tmp4_v.i5.i.b = load i1, i1* @segs.0, align 1
  %7 = select i1 %tmp4_v.i5.i.b, i32* inttoptr (i32 add (i32 ptrtoint ([1024 x i8]* @_ZL6segmem to i32), i32 20) to i32*), i32* inttoptr (i32 20 to i32*)
  %8 = load i32, i32* %7, align 4
  %tmp2_v2.i.i = add i32 %tmp0_v.i30.i, -20
  %9 = inttoptr i32 %tmp2_v2.i.i to i32*
  store i32 %8, i32* %9, align 4
  %tmp2_v3.i.i = add i32 %tmp0_v.i30.i, -31
  %10 = inttoptr i32 %tmp2_v3.i.i to i32*
  store i32 1684234849, i32* %10, align 4
  %tmp2_v4.i9.i = add i32 %tmp0_v.i30.i, -27
  %11 = inttoptr i32 %tmp2_v4.i9.i to i32*
  store i32 1751606885, i32* %11, align 4
  %tmp2_v5.i.i = add i32 %tmp0_v.i30.i, -23
  %12 = inttoptr i32 %tmp2_v5.i.i to i16*
  store i16 25185, i16* %12, align 2
  %tmp2_v6.i.i = add i32 %tmp0_v.i30.i, -21
  %13 = inttoptr i32 %tmp2_v6.i.i to i8*
  store i8 0, i8* %13, align 1
  %tmp2_v7.i.i = add i32 %tmp0_v.i30.i, -37
  %14 = inttoptr i32 %tmp2_v7.i.i to i8*
  store i8 122, i8* %14, align 1
  %tmp2_v11.i.i = add i32 %tmp0_v.i30.i, -60
  %15 = inttoptr i32 %tmp2_v11.i.i to i32*
  store i32 122, i32* %15, align 4
  %tmp2_v13.i.i = add i32 %tmp0_v.i30.i, -64
  %16 = inttoptr i32 %tmp2_v13.i.i to i32*
  store i32 %tmp2_v3.i.i, i32* %16, align 16
  %tmp2_v14.i.i = add i32 %tmp0_v.i30.i, -68
  %17 = inttoptr i32 %tmp2_v14.i.i to i32*
  store i32 134517295, i32* %17, align 4
  %tmp2_v.i25.i.i = add i32 %tmp0_v.i30.i, -72
  %18 = inttoptr i32 %tmp2_v.i25.i.i to i32*
  store i32 %tmp2_v4.i33.i, i32* %18, align 8
  %tmp2_v1.i27.i.i = add i32 %tmp0_v.i30.i, -76
  %19 = inttoptr i32 %tmp2_v1.i27.i.i to i32*
  store i32 134529024, i32* %19, align 4
  %tmp2_v2.i29.i.i = add i32 %tmp0_v.i30.i, -116
  %20 = inttoptr i32 %tmp2_v2.i29.i.i to i32*
  store i32 134517406, i32* %20, align 4
  %21 = load i32, i32* %15, align 4
  %tmp2_v2.i16.i.i = add i32 %tmp0_v.i30.i, -100
  %22 = trunc i32 %21 to i8
  %23 = inttoptr i32 %tmp2_v2.i16.i.i to i8*
  store i8 %22, i8* %23, align 4
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i30.i, -92
  %24 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  store i32 -1, i32* %24, align 4
  %25 = load i32, i32* %16, align 16
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i30.i, -128
  %26 = inttoptr i32 %tmp2_v7.i.i.i to i32*
  store i32 %25, i32* %26, align 16
  %tmp2_v8.i.i.i = add i32 %tmp0_v.i30.i, -132
  ...
  %tmp2_v.i3.i.i = add i32 %tmp0_v.i30.i, -84
  %29 = inttoptr i32 %tmp2_v.i3.i.i to i32*
  store i32 %28, i32* %29, align 4
  %tmp2_v1.i.i.i = add i32 %tmp0_v.i30.i, -88
...
Func_last_occurrence.exit:                        ; preds = %BB_80492E6.i.i
  ...
  %tmp2_v.i12.i = add i32 %35, -29
  %37 = inttoptr i32 %tmp2_v.i12.i to i8*
  %38 = load i8, i8* %37, align 1
  %tmp0_v.i13.i = sext i8 %38 to i32
  store i32 %tmp0_v.i13.i, i32* %15, align 4
  %tmp2_v3.i18.i = add i32 %34, -8184
  store i32 %tmp2_v3.i18.i, i32* %16, align 16
  store i32 134517327, i32* %17, align 4
  %39 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i29.i, i32 inreg noundef %r_edx.0.i, i32 noundef %tmp2_v13.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @find_last_char_occurrencem15161635(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
