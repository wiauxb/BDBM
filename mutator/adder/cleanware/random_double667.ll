...
BB_8049239.i.lr.ph:
  ...
  %tmp2_v.i11.i = add i32 %tmp0_v.i3.i, -48
  %7 = inttoptr i32 %tmp2_v.i11.i to i32*
  store i32 0, i32* %7, align 16
  %tmp2_v2.i.i = add i32 %tmp0_v.i3.i, -52
  ...
  %tmp2_v.i33.i = add i32 %tmp0_v.i3.i, -20
  %10 = inttoptr i32 %tmp2_v.i33.i to i32*
  store i32 0, i32* %10, align 4
  %tmp2_v1.i.i = add i32 %tmp0_v.i3.i, -40
  %11 = inttoptr i32 %tmp2_v1.i.i to i64*
  %12 = inttoptr i32 %tmp2_v.i11.i to i64*
...
BB_8049239.i:                                     ; preds = %BB_8049239.i, %BB_8049239.i.lr.ph
  %r_ebx.011 = phi i32 [ 134529024, %BB_8049239.i.lr.ph ], [ %45, %BB_8049239.i ]
  %r_ebp.010 = phi i32 [ %tmp2_v4.i.i, %BB_8049239.i.lr.ph ], [ %46, %BB_8049239.i ]
  %r_edx.09 = phi i32 [ 0, %BB_8049239.i.lr.ph ], [ %49, %BB_8049239.i ]
  %tmp2_v.i27.i = add i32 %r_ebx.011, -8176
  %29 = inttoptr i32 %tmp2_v.i27.i to i64*
  ...
  %tmp2_v4.i29.i = add i32 %r_ebx.011, -8168
  %31 = inttoptr i32 %tmp2_v4.i29.i to i64*
  ...
  store i32 %r_ebp.010, i32* %13, align 8
  store i32 %r_ebx.011, i32* %14, align 4
  ...
  %tmp5_v.i38.i = tail call fastcc i64 @helper_fstl_ST0()
  store i64 %tmp5_v.i38.i, i64* %28, align 4
  tail call fastcc void @helper_fpop()
  %tmp2_v2.i40.i = add i32 %45, -8184
  store i32 %tmp2_v2.i40.i, i32* %7, align 16
  store i32 134517361, i32* %8, align 4
  %47 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %r_edx.09, i32 noundef %tmp2_v.i11.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !23
  %48 = lshr i64 %47, 32
