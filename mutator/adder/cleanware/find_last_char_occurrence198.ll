...
define internal fastcc void @find_last_char_occurrence198(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
Func_804922F.exit.i:
  ...
  %tmp2_v8.i24.i = add i32 %tmp0_v.i16.i, -52
  ...
  %23 = inttoptr i32 %tmp2_v2.i14.i.i to i8*
  store i8 %22, i8* %23, align 4
  %tmp2_v3.i.i.i = add i32 %tmp0_v.i16.i, -92
  %24 = inttoptr i32 %tmp2_v3.i.i.i to i32*
  store i32 -1, i32* %24, align 4
  %25 = load i32, i32* %16, align 16
  %tmp2_v7.i.i.i = add i32 %tmp0_v.i16.i, -128
  ...
  %tmp2_v.i4.i.i = add i32 %tmp0_v.i16.i, -84
  %29 = inttoptr i32 %tmp2_v.i4.i.i to i32*
  store i32 %28, i32* %29, align 4
  %tmp2_v1.i5.i.i = add i32 %tmp0_v.i16.i, -88
  %30 = inttoptr i32 %tmp2_v1.i5.i.i to i32*
  br label %BB_80492E6.i.i

BB_80492E6.i.i:                                   ; preds = %BB_80492E6.i.i, %Func_804922F.exit.i
  %storemerge.i = phi i32 [ 0, %Func_804922F.exit.i ], [ %tmp0_v1.i20.i.i, %BB_80492E6.i.i ]
  ...
  %tmp0_v1.i20.i.i = add nuw nsw i32 %storemerge.i, 1
...
Func_last_occurrence.exit:                        ; preds = %BB_80492E6.i.i
  ...
  %tmp2_v.i6.i = add i32 %35, -28
  %36 = inttoptr i32 %tmp2_v.i6.i to i32*
  ...
  %39 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i15.i, i32 inreg noundef %r_edx.0.i, i32 noundef %tmp2_v13.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @find_last_char_occurrence198(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
