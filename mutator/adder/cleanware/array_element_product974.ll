...
@stack973 = internal global [8092 x i32] zeroinitializer, align 16
@segs.0 = internal unnamed_addr global i1 false
@_ZL6segmem = internal global [1024 x i8] zeroinitializer, align 1
@onUnfallback = common local_unnamed_addr global i1 false
@str.bis.972 = constant [13 x i8] c"\70\72\6f\64\75\63\74\3a\20\25\64\0a\00"
...
define internal fastcc void @array_element_product974(i32 %arg_esp) unnamed_addr  norecurse nounwind  !retregs !12 {
.exit:
...
BB_8049272.i.i:                                   ; preds = %BB_8049272.i.i, %.exit
  ...
  %tmp4_v.i7.i.i = shl i32 %storemerge1.i, 2
  %24 = load i32, i32* %16, align 16
  %tmp0_v3.i.i.i = add i32 %24, %tmp4_v.i7.i.i
...
Func_element_product.exit:                        ; preds = %BB_8049272.i.i, %.exit
  ...
  %tmp2_v.i.i = add i32 %32, -36
  %33 = inttoptr i32 %tmp2_v.i.i to i32*
  store i32 %31, i32* %33, align 4
  store i32 %31, i32* %15, align 4
  %spi.bis.972 = ptrtoint[13 x i8]* @str.bis.972 to i32
  store i32 %spi.bis.972, i32* %16, align 16
  store i32 134517291, i32* %17, align 4
  %34 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i2.i, i32 inreg noundef %r_edx.0.lcssa.i, i32 noundef %tmp2_v11.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  ret void
}
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @array_element_product974 (i32 ptrtoint (i32* getelementptr inbounds ([8092 x i32], [8092 x i32]* @stack973, i32 0, i32 8092) to i32)) nounwind
