...
define internal fastcc void @make_lower420(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
.exit:
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @make_lower420(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
