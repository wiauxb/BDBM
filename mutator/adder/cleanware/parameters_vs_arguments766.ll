...
define internal fastcc void @parameters_vs_arguments766(i32 %arg_esp) unnamed_addr  mustprogress nofree norecurse nosync nounwind willreturn  !retregs !10 {
  ...
  %tmp2_v1.i7.i = add i32 %arg_esp, -28
  %3 = inttoptr i32 %tmp2_v1.i7.i to i32*
  store i32 10, i32* %3, align 4
  %tmp2_v2.i8.i = add i32 %arg_esp, -32
  %4 = inttoptr i32 %tmp2_v2.i8.i to i32*
...
!10 = !{i32 0, i32 0}
  ...
  tail call fastcc void @parameters_vs_arguments766(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
