...
define internal fastcc void @make_upper381(i32 %arg_esp) unnamed_addr  norecurse  !retregs !10 {
.exit:
  ...
  %tmp2_v.i15.i.i = add i32 %tmp0_v.i.i, -100
  %29 = inttoptr i32 %tmp2_v.i15.i.i to i32*
  store i32 %28, i32* %29, align 4
  %tmp2_v1.i17.i.i = add i32 %tmp0_v.i.i, -104
  %30 = inttoptr i32 %tmp2_v1.i17.i.i to i32*
...
BB_80492D6.i.i:                                   ; preds = %BB_80492D6.i.i, %BB_80492D6.i.preheader.i
  ...
  %tmp0_v3.i23.i.i = add i32 %33, %storemerge23.i
  %34 = inttoptr i32 %tmp0_v3.i23.i.i to i8*
  %35 = load i8, i8* %34, align 1
  %tmp0_v5.i.i.i = sext i8 %35 to i32
  %36 = inttoptr i32 %r_esp.0.in26.i to i32*
  store i32 %tmp0_v5.i.i.i, i32* %36, align 4
  %tmp2_v8.i27.i.i = add i32 %r_esp.0.in26.i, -4
  %37 = inttoptr i32 %tmp2_v8.i27.i.i to i32*
...
Func_make_upper.exit:                             ; preds = %BB_80492D6.i.i, %.exit
  ...
  %tmp2_v.i22.i = add i32 %46, -52
  store i32 %tmp2_v.i22.i, i32* %20, align 16
...
!10 = !{i32 0, i32 0, i32 0}
  ...
  tail call fastcc void @make_upper381(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
