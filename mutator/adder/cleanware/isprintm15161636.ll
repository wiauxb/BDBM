...
define internal fastcc void @isprintm15161636(i32 %arg_esp) unnamed_addr  norecurse  !retregs !12 {
.exit:
  ...
  %tmp2_v.i7.i = add i32 %tmp0_v.i14.i, -17
  %7 = inttoptr i32 %tmp2_v.i7.i to i8*
  store i8 0, i8* %7, align 1
  %tmp2_v4.i.i = add i32 %tmp0_v.i14.i, -44
  ...
  %11 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %tmp2_v.i13.i, i32 inreg noundef 0, i32 noundef %tmp2_v6.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32))  nobuiltin nounwind "no-builtins" , !funcname !13
  store i32 134517271, i32* %6, align 4
  %12 = tail call i32 @__ctype_b_loc()
  store i32 134520873, i32* %9, align 16
...
!13 = !{!"printf"}
  ...
  tail call fastcc void @isprintm15161636(i32 ptrtoint (i32* getelementptr inbounds ([4194304 x i32], [4194304 x i32]* @stack, i32 0, i32 4194300) to i32)) nounwind
