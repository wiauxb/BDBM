...
def inject_vm_detect(project):
    ...
    inject_vm_detect_at(project, start_main, end_main)

    save_mutation(project, "vm")

def inject_vm_detect_at(project, start_main, end_main):
    """
...
def get_vm_detect_code(ind):
    ...
    """
    code = f""";----------------------------
  ; Detect that we are running inside a vm
