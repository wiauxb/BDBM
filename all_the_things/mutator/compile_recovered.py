...
from ..binrec_module.binrec import project
from ..binrec_module.binrec.env import BINREC_LIB, BINREC_LINK_LD, BINREC_RUNLIB, llvm_command
from ..binrec_module.binrec.errors import BinRecError
from ..binrec_module.binrec.lib import binrec_lift, binrec_link, convert_lib_error
...
def main() -> None:
    ...
    from ..binrec_module.binrec.core import enable_binrec_debug_mode, init_binrec
    ...
    if args.verbose:
        ...
        if args.verbose > 1:
            from ..binrec_module.binrec.audit import enable_python_audit_log
