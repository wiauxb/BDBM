...
load_dotenv(".env")
mut_dir = os.environ.get('MUTATOR_ROOT')
...
def sys_calls(num_calls, project):
    ...
    with open(mut_dir + "/adder/sys_call_llvm.txt", "r") as f:
    ...
    for i in range(num_calls):
        ...
        while compiled_check == False:
            ...
            try:
                ...
                command = "just link_recompile " + project + " \""+ mut_dir +"/escape/detect.bc\" \""+ mut_dir +"/strings/bytecodes/base64.bc\"" #FIXME wrong paths
